...
def get_overlay_modules_list():
    if "chagall" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_device_modules.append("drivers/gpu/drm/panel/panel-p12a-36-02-0a-dsc-vdo.ko")
        mgk_64_device_modules.append("drivers/gpu/drm/panel/panel-p12a-42-02-0b-dsc-vdo.ko")
        ...
        mgk_64_device_modules.append("drivers/mihw/perf_actuator/perf-actuator.ko")
