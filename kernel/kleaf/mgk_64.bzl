...
mgk_64_kleaf_device_modules_srcs = [
    ...
    "//kernel_device_modules-{}/drivers/misc/mediatek/swpm/modules/debug/v6991:srcs".format(kernel_version),
...
mgk_64_kleaf_device_modules = [
    ...
    "//kernel_device_modules-{}/drivers/leds/flash:leds-mt6370-flash".format(kernel_version),
    "//kernel_device_modules-{}/drivers/leds/flash:leds-mt6379".format(kernel_version),
    "//kernel_device_modules-{}/drivers/leds:leds-mt6360".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/misc/mediatek/swpm/modules/debug/v6991:mtk-swpm-isp-dbg-v6991".format(kernel_version),
    ...
    "//kernel_device_modules-{}/drivers/misc/mediatek/mm_monitor:mm-monitor-platform-mt6991".format(kernel_version),
    "//kernel_device_modules-{}/drivers/misc/mediatek/mm_monitor:mm-monitor-platform-mt6993".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-common".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6853".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6886".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6893".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6897".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6983".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6985".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6989".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6768".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6761".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6789".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6991".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6765".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6993".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6781".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6833".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6855".format(kernel_version),
    "//kernel_device_modules-{}/drivers/interconnect/mediatek:mmqos-mt6877".format(kernel_version),
...
mgk_64_kleaf_platform_modules = {
    ...
    "//kernel_device_modules-{}/drivers/soc/mediatek:mtk-scpsys-bringup".format(kernel_version): "mt6765 mt6781 mt6833 mt6853 mt6897 mt6886 mt6893 mt6983 mt6989 mt8192 mt8188 mt6895 mt6899",
...
mgk_64_device_modules = [
    ...
    "drivers/misc/mediatek/mbraink/perf/mtk_mbraink_perf.ko",
...
def get_overlay_modules_list():
    ...
    if "entry_level.config" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_kleaf_device_modules.append("//kernel_device_modules-{}/drivers/misc/mediatek/cm_mgr_legacy_v1:mtk_cm_mgr".format(kernel_version))
        mgk_64_kleaf_device_modules.append("//kernel_device_modules-{}/drivers/misc/mediatek/cm_mgr_legacy_v1:mtk_cm_ipi".format(kernel_version))
    ...
    if "mt6877_overlay.config" in DEFCONFIG_OVERLAYS:
        ...
        mgk_64_kleaf_device_modules.remove("//kernel_device_modules-{}/drivers/misc/mediatek/swpm/modules/debug/v6991:mtk-swpm-isp-dbg-v6991".format(kernel_version))
