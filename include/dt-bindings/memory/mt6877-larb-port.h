...
#define M4U_PORT_L0_DISP_UFBC_WDMA0		MTK_M4U_DOM_ID(0, 0, 3)
#define M4U_PORT_L0_DISP_FAKE0			MTK_M4U_DOM_ID(0, 0, 4)
/* larb1 -- 7 */
...
#define M4U_PORT_L1_OVL_2L_RDMA1_HDR		MTK_M4U_DOM_ID(0, 1, 5)
#define M4U_PORT_L1_OVL_2L_RDMA1		MTK_M4U_DOM_ID(0, 1, 6)
/* larb2 -- 5 */
...
#define M4U_PORT_L4_VDEC_RG_CTRL_DMA_EXT	MTK_M4U_DOM_ID(1, 4, 11)
/* larb5 -- null */
/* larb6 -- null */
/* larb7 -- 15 */
...
#define M4U_PORT_L7_VENC_SUB_W_LUMA		MTK_M4U_DOM_ID(1, 7, 3)
#define M4U_PORT_L7_VENC_SV_COMV		MTK_M4U_DOM_ID(1, 7, 4)
#define M4U_PORT_L7_VENC_RD_COMV		MTK_M4U_DOM_ID(1, 7, 5)
#define M4U_PORT_L7_JPGENC_Y_RDMA		MTK_M4U_DOM_ID(1, 7, 6)
#define M4U_PORT_L7_JPGENC_C_RDMA		MTK_M4U_DOM_ID(1, 7, 7)
#define M4U_PORT_L7_JPGENC_Q_TABLE		MTK_M4U_DOM_ID(1, 7, 8)
#define M4U_PORT_L7_JPGENC_BSDMA		MTK_M4U_DOM_ID(1, 7, 9)
#define M4U_PORT_L7_VENC_SUB_R_LUMA		MTK_M4U_DOM_ID(1, 7, 10)
#define M4U_PORT_L7_VENC_CUR_LUMA		MTK_M4U_DOM_ID(1, 7, 11)
#define M4U_PORT_L7_VENC_CUR_CHROMA		MTK_M4U_DOM_ID(1, 7, 12)
#define M4U_PORT_L7_VENC_REF_LUMA		MTK_M4U_DOM_ID(1, 7, 13)
#define M4U_PORT_L7_VENC_REF_CHROMA		MTK_M4U_DOM_ID(1, 7, 14)
/* larb8 -- null */
/* larb9 -- 29 */
...
#define M4U_PORT_L13_CAM_PADI0			MTK_M4U_DOM_ID(2, 13, 12)
#define M4U_PORT_L13_CAM_PADI1			MTK_M4U_DOM_ID(2, 13, 13)
#define M4U_PORT_L13_CAM_PDAO			MTK_M4U_DOM_ID(2, 13, 14)
...
#define M4U_PORT_L14_CAMSV7			MTK_M4U_DOM_ID(2, 14, 6)
#define M4U_PORT_L14_CAMSV8			MTK_M4U_DOM_ID(2, 14, 7)
#define M4U_PORT_L14_CAMSV9			MTK_M4U_DOM_ID(2, 14, 8)
#define M4U_PORT_L14_CAMSV10			MTK_M4U_DOM_ID(2, 14, 9)
...
/* fake larb -- 5 */
#define M4U_PORT_L21_APU_FAKE_CODE		MTK_M4U_DOM_ID(6, APU_PSEUDO_LARBID, 0)
#define M4U_PORT_L21_APU_FAKE_DATA		MTK_M4U_DOM_ID(6, APU_PSEUDO_LARBID, 1)
#define M4U_PORT_L21_APU_FAKE_VLM		MTK_M4U_DOM_ID(7, APU_PSEUDO_LARBID, 2)
#define M4U_PORT_L22_CCU0			MTK_M4U_DOM_ID(3, CCU0_PSEUDO_LARBID, 0)
#define M4U_PORT_L23_CCU1			MTK_M4U_DOM_ID(4, CCU1_PSEUDO_LARBID, 0)

#define M4U_PORT_GPU				MTK_M4U_DOM_ID(0, 31, 31)
