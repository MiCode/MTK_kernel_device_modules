...
enum disp_feature_id {
	...
	DISP_FEATURE_DYNAMIC_ELVSS_LEVEL = 41,
	DISP_FEATURE_MAX,
};
...
enum disp_event_type {
	...
	MI_DISP_EVENT_MQS_COMMON_LOG_CAPTURE = 16,
	MI_DISP_EVENT_MAX,
};
...
enum disp_count_info_type {
	...
	DISP_COUNT_INFO_DBI_AGING_COUNT = 6,
	DISP_COUNT_INFO_MAX,
};
...
static inline const char *get_disp_event_type_name(__u32 event_type)
{
	...
	case MI_DISP_EVENT_MQS_COMMON_LOG_CAPTURE:
		return "mqs_common_log_capture";
	default:
		return "Unknown";
	}
}
...
#define MI_DISP_IOCTL_SET_FP_UNLOCK_STATE      _IOW('D', 0x10, struct disp_fingerprint_unlock_state)
