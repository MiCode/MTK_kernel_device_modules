...
enum{
	...
	HARDWARE_SUB_CHARGER_MASTER,//Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
	HARDWARE_SUB_CHARGER_SLAVE,//Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
	HARDWARE_USB_PD,//Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
	HARDWARE_MAX_ITEM
};
...
#define HARDWARE_BMS_GAUGE_GET     	     		  _IOWR(HARDWARE_ID, 0x41, char[HARDWARE_MAX_ITEM_LONGTH])//Bug489541 gudi.wt,MODIFIY,20191107,S89730 add charge ic and QG info
#define HARDWARE_SUB_CHARGER_MASTER_GET     	     		  _IOWR(HARDWARE_ID, 0x89, char[HARDWARE_MAX_ITEM_LONGTH]) //Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
#define HARDWARE_SUB_CHARGER_SLAVE_GET     	     		  _IOWR(HARDWARE_ID, 0x8A, char[HARDWARE_MAX_ITEM_LONGTH]) //Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
#define HARDWARE_USB_PD_GET     	     		  _IOWR(HARDWARE_ID, 0x8B, char[HARDWARE_MAX_ITEM_LONGTH]) //Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
