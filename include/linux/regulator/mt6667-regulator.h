...
#define MT6667_BUCK1_OP_EN_0                        (0x14a1)
#define MT6667_BUCK1_OP_EN_0_SET                    (0x14a2)
#define MT6667_BUCK1_OP_EN_0_CLR                    (0x14a3)
#define MT6667_BUCK2_OP_EN_0                        (0x1521)
#define MT6667_BUCK2_OP_EN_0_SET                    (0x1522)
#define MT6667_BUCK2_OP_EN_0_CLR                    (0x1523)
#define MT6667_BUCK3_OP_EN_0                        (0x15a1)
#define MT6667_BUCK3_OP_EN_0_SET                    (0x15a2)
#define MT6667_BUCK3_OP_EN_0_CLR                    (0x15a3)
#define MT6667_BUCK4_OP_EN_0                        (0x1621)
#define MT6667_BUCK4_OP_EN_0_SET                    (0x1622)
#define MT6667_BUCK4_OP_EN_0_CLR                    (0x1623)
...
#define MT6667_PMIC_RG_BUCK1_OP_EN_0_SET_ADDR       (0x14a2)
#define MT6667_PMIC_RG_BUCK1_OP_EN_0_SET_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK1_OP_EN_0_SET_SHIFT      (0)
#define MT6667_PMIC_RG_BUCK1_OP_EN_0_CLR_ADDR       (0x14a3)
#define MT6667_PMIC_RG_BUCK1_OP_EN_0_CLR_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK1_OP_EN_0_CLR_SHIFT      (0)
...
#define MT6667_PMIC_RG_BUCK2_OP_EN_0_SET_ADDR       (0x1522)
#define MT6667_PMIC_RG_BUCK2_OP_EN_0_SET_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK2_OP_EN_0_SET_SHIFT      (0)
#define MT6667_PMIC_RG_BUCK2_OP_EN_0_CLR_ADDR       (0x1523)
#define MT6667_PMIC_RG_BUCK2_OP_EN_0_CLR_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK2_OP_EN_0_CLR_SHIFT      (0)
...
#define MT6667_PMIC_RG_BUCK3_OP_EN_0_SET_ADDR       (0x15a2)
#define MT6667_PMIC_RG_BUCK3_OP_EN_0_SET_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK3_OP_EN_0_SET_SHIFT      (0)
#define MT6667_PMIC_RG_BUCK3_OP_EN_0_CLR_ADDR       (0x15a3)
#define MT6667_PMIC_RG_BUCK3_OP_EN_0_CLR_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK3_OP_EN_0_CLR_SHIFT      (0)
...
#define MT6667_PMIC_RG_BUCK4_OP_EN_0_SET_ADDR       (0x1622)
#define MT6667_PMIC_RG_BUCK4_OP_EN_0_SET_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK4_OP_EN_0_SET_SHIFT      (0)
#define MT6667_PMIC_RG_BUCK4_OP_EN_0_CLR_ADDR       (0x1623)
#define MT6667_PMIC_RG_BUCK4_OP_EN_0_CLR_MASK       (0xff)
#define MT6667_PMIC_RG_BUCK4_OP_EN_0_CLR_SHIFT      (0)
