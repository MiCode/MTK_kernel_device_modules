...
#define MTK_SIP_KERNEL_THROTTLE_CONTROL \
	MTK_SIP_SMC_CMD(0x545)
...
#define MTK_SIP_KERNEL_CPU_CONTROL \
	MTK_SIP_SMC_CMD(0x521)
#define MTK_SIP_KERNEL_DSU_CONTROL \
	MTK_SIP_SMC_CMD(0x549)

/* EFUSE */
#define MTK_SIP_KERNEL_EFUSE_CONTROL \
	MTK_SIP_SMC_CMD(0x515)
