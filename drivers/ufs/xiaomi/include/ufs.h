...
enum attr_idn {
	...
	QUERY_ATTR_IDN_WB_PARTIAL_FLUSH_MODE	= 0x3F,
	QUERY_ATTR_IDN_WB_PINNED_CUR_WB_BUFF_SIZE	= 0x42,
	QUERY_ATTR_IDN_WB_PINNED_AVAIL_PERCENTAGE	= 0x43,
	QUERY_ATTR_IDN_WB_PINNED_CUMM_WRITE_SIZE	= 0x44,
	QUERY_ATTR_IDN_WB_PINNED_ALLOC_SIZE	= 0x45,
	QUERY_ATTR_IDN_WB_NONPINNED_ALLOC_SIZE	= 0x46
};
...
enum device_desc_param {
	...
	DEVICE_DESC_PARAM_WB_EXTENDED_WB_SUPPORT = 0x4D,
