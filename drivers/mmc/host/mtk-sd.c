...
#define MSDC_PATCH_BIT_RD_DAT_SEL BIT(3)
...
/* MSDC_TOP_DLL mask  */
#define DLL_LOCK_VALUE		GENMASK(15, 8)	/* RO */
#define DLL_DLY_SEL		BIT(4)		/* RO */
#define DLL_LOCK_DONE		BIT(3)		/* RO */
#define DLL_LOCK_ERR		BIT(2)		/* RO */
#define DLL_RST			BIT(1)		/* RW */
#define DLL_EN			BIT(0)		/* RW */
#define DLL_MASK		GENMASK(4, 0)
#define DLL_PHASE_SEL		GENMASK(26, 24)	/* RW */
#define DLL_START_POINT		GENMASK(23, 16)	/* RW */
#define DLL_RANGE_SEL		GENMASK(28, 27)	/* RW */
...
static const struct mtk_mmc_compatible mt8668_compat = {
	.clk_div_bits = 12,
	.recheck_sdio_irq = false,
	.hs400_tune = false,
	.pad_tune_reg = MSDC_PAD_TUNE0,
...
static const struct mtk_mmc_compatible mt8678_compat = {
	.clk_div_bits = 12,
	.recheck_sdio_irq = false,
	.hs400_tune = false,
	.pad_tune_reg = MSDC_PAD_TUNE0,
...
static const struct of_device_id msdc_of_ids[] = {
	...
	{ .compatible = "mediatek,mt8668-mmc", .data = &mt8668_compat},
	{ .compatible = "mediatek,mt8678-mmc", .data = &mt8678_compat},
...
static void msdc_set_mclk(struct msdc_host *host, unsigned char timing, u32 hz)
{
	...
	if (!host->dev_comp->prohibit_gate_cg)
		clk_disable_unprepare(host->src_clk_cg);
	if (host->dev_comp->clk_div_bits == 8)
...
static void msdc_init_hw(struct msdc_host *host)
{
	...
	if (host->dev_comp->stop_clk_fix) {
		if (host->dev_comp->stop_clk_cnt)
			sdr_set_field(host->base + MSDC_PATCH_BIT1,
				      MSDC_PATCH_BIT1_STOP_DLY,
				      host->dev_comp->stop_clk_cnt & 0xf);
		else
			sdr_set_field(host->base + MSDC_PATCH_BIT1,
