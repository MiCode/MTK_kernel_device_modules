...
static const struct resource mt6661_regulators_resources[] = {
	...
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LD20_1_LP_OC, "LD20_1_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LD20_2_LP_OC, "LD20_2_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LDC0_3_LP_OC, "LDC0_3_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LDC0_4_LP_OC, "LDC0_4_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LN60_5_LP_OC, "LN60_5_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LN60_6_LP_OC, "LN60_6_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LNC0_10_LP_OC, "LNC0_10_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LN60_7_LP_OC, "LN60_7_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LNC0_8_LP_OC, "LNC0_8_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LNC0_9_LP_OC, "LNC0_9_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LNC0_S_11_LP_OC, "LNC0_S_11_LP"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_LNC0_S_12_LP_OC, "LNC0_S_12_LP"),
};

static const struct resource mt6661_keys_resources[] = {
	DEFINE_RES_IRQ(MT6661_IRQ_PWRKEY),
	DEFINE_RES_IRQ(MT6661_IRQ_HOMEKEY),
	DEFINE_RES_IRQ(MT6661_IRQ_HOMEKEY_2),
	DEFINE_RES_IRQ(MT6661_IRQ_PWRKEY_R),
	DEFINE_RES_IRQ(MT6661_IRQ_HOMEKEY_R),
	DEFINE_RES_IRQ(MT6661_IRQ_HOMEKEY_2_R),
};

static const struct resource mt6661_lvsys_notify_resources[] = {
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_NI_LVSYS_INT1_FALLING, "LVSYS1_F"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_NI_LVSYS_INT1_RISING, "LVSYS1_R"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_NI_LVSYS_INT2_FALLING, "LVSYS2_F"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_NI_LVSYS_INT2_RISING, "LVSYS2_R"),
	DEFINE_RES_IRQ_NAMED(MT6661_IRQ_NI_LVSYS_INT3_FALLING, "LVSYS3_F"),
};

static const struct resource mt6667_regulators_resources[] = {
	DEFINE_RES_IRQ_NAMED(MT6667_IRQ_BUCK1_OC, "BUCK1"),
	DEFINE_RES_IRQ_NAMED(MT6667_IRQ_BUCK2_OC, "BUCK2"),
	DEFINE_RES_IRQ_NAMED(MT6667_IRQ_BUCK3_OC, "BUCK3"),
	DEFINE_RES_IRQ_NAMED(MT6667_IRQ_BUCK4_OC, "BUCK4"),
};
