...
static int eusb2_repeater_probe(struct platform_device *pdev)
{
	...
	*/
	...
	if(rptr->project_no == PROJECT_CN){
		rptr->repeater_product_enable = 1;
		//rptr->repeater_storage_enable = 1;
		rptr->repeater_not_single_port = 1;
	} else if(rptr->project_no == PROJECT_GL){
		rptr->repeater_global_enable = 1;
		rptr->repeater_product_enable = 1;
		//rptr->repeater_storage_enable = 1;
		rptr->repeater_not_single_port = 1;
	}
