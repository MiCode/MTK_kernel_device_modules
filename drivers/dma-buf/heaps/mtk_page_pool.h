...
extern bool need_free_to_reserve_pool(int order_index);
extern void mtk_sys_heap_reserve_pool_init(struct mtk_dmabuf_page_pool **global_pools);
extern struct page *mtk_extend_sys_heap_alloc_largest_available(struct mtk_dmabuf_page_pool **global_pools,
                                                unsigned long size, unsigned int max_order);
extern struct reserve_extend reserve_extend_info;
extern bool reserve_pool_enable;
extern u64 totalram;
...
struct page *mtk_dmabuf_page_pool_remove(struct mtk_dmabuf_page_pool *pool, int index);
