...
static const struct fmeter_clk fclks[] = {
	/* CKGEN Part */
	FMCLK2(CKGEN, FM_AXI_CK, "fm_axi_ck", 0x0270, 31, 1),
	FMCLK2(CKGEN, FM_MEM_SUB_CK, "fm_mem_sub_ck", 0x0270, 30, 1),
	FMCLK2(CKGEN, FM_IO_NOC_CK, "fm_io_noc_ck", 0x0270, 29, 1),
	FMCLK2(CKGEN, FM_P_AXI_CK, "fm_p_axi_ck", 0x0270, 28, 1),
	FMCLK2(CKGEN, FM_PEXTP0_AXI_CK, "fm_pextp0_axi_ck", 0x0270, 27, 1),
	FMCLK2(CKGEN, FM_PEXTP1_USB_AXI_CK, "fm_pextp1_usb_axi_ck", 0x0270, 26, 1),
	FMCLK2(CKGEN, FM_P_FMEM_SUB_CK, "fm_p_fmem_sub_ck", 0x0270, 25, 1),
	FMCLK2(CKGEN, FM_PEXPT0_MEM_SUB_CK, "fm_pexpt0_mem_sub_ck", 0x0270, 24, 1),
	FMCLK2(CKGEN, FM_PEXTP1_USB_MEM_SUB_CK, "fm_pextp1_usb_mem_sub_ck", 0x0270, 23, 1),
	FMCLK2(CKGEN, FM_P_NOC_CK, "fm_p_noc_ck", 0x0270, 22, 1),
	FMCLK2(CKGEN, FM_EMI_N_CK, "fm_emi_n_ck", 0x0270, 21, 1),
	FMCLK2(CKGEN, FM_EMI_S_CK, "fm_emi_s_ck", 0x0270, 20, 1),
	FMCLK2(CKGEN, FM_EMI_SLICE_N_CK, "fm_emi_slice_n_ck", 0x0270, 19, 1),
	FMCLK2(CKGEN, FM_EMI_SLICE_S_CK, "fm_emi_slice_s_ck", 0x0270, 18, 1),
	FMCLK2(CKGEN, FM_AP2CONN_HOST_CK, "fm_ap2conn_host_ck", 0x0270, 17, 1),
	FMCLK2(CKGEN, FM_ATB_CK, "fm_atb_ck", 0x0270, 16, 1),
	FMCLK2(CKGEN, FM_CIRQ_CK, "fm_cirq_ck", 0x0270, 15, 1),
	FMCLK2(CKGEN, FM_PBUS_156M_CK, "fm_pbus_156m_ck", 0x0270, 14, 1),
	FMCLK2(CKGEN, FM_NOC_LOW_CK, "fm_noc_low_ck", 0x0270, 13, 1),
	FMCLK2(CKGEN, FM_NOC_MID_CK, "fm_noc_mid_ck", 0x0270, 12, 1),
	FMCLK2(CKGEN, FM_EFUSE_CK, "fm_efuse_ck", 0x0270, 11, 1),
	FMCLK2(CKGEN, FM_MCL3GIC_CK, "fm_mcl3gic_ck", 0x0270, 10, 1),
	FMCLK2(CKGEN, FM_MCINFRA_CK, "fm_mcinfra_ck", 0x0270, 9, 1),
	FMCLK2(CKGEN, FM_DSP_CK, "fm_dsp_ck", 0x0270, 8, 1),
	FMCLK2(CKGEN, FM_MFG_REF_CK, "fm_mfg_ref_ck", 0x0270, 7, 1),
	FMCLK2(CKGEN, FM_MFGSC_REF_CK, "fm_mfgsc_ref_ck", 0x0270, 6, 1),
	FMCLK2(CKGEN, FM_MFG_EB_CK, "fm_mfg_eb_ck", 0x0270, 5, 1),
	FMCLK2(CKGEN, FM_UART_CK, "fm_uart_ck", 0x0270, 4, 1),
	FMCLK2(CKGEN, FM_SPI0_B_CK, "fm_spi0_b_ck", 0x0270, 3, 1),
	FMCLK2(CKGEN, FM_SPI1_B_CK, "fm_spi1_b_ck", 0x0270, 2, 1),
	FMCLK2(CKGEN, FM_SPI2_B_CK, "fm_spi2_b_ck", 0x0270, 1, 1),
	FMCLK2(CKGEN, FM_SPI3_B_CK, "fm_spi3_b_ck", 0x0270, 0, 1),
	FMCLK2(CKGEN, FM_SPI4_B_CK, "fm_spi4_b_ck", 0x0274, 31, 1),
	FMCLK2(CKGEN, FM_SPI5_B_CK, "fm_spi5_b_ck", 0x0274, 30, 1),
	FMCLK2(CKGEN, FM_SPI6_B_CK, "fm_spi6_b_ck", 0x0274, 29, 1),
	FMCLK2(CKGEN, FM_SPI7_B_CK, "fm_spi7_b_ck", 0x0274, 28, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_1P_CK, "fm_msdc_macro_1p_ck", 0x0274, 27, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_2P_CK, "fm_msdc_macro_2p_ck", 0x0274, 26, 1),
	FMCLK2(CKGEN, FM_MSDC30_1_CK, "fm_msdc30_1_ck", 0x0274, 25, 1),
	FMCLK2(CKGEN, FM_MSDC30_2_CK, "fm_msdc30_2_ck", 0x0274, 24, 1),
	FMCLK2(CKGEN, FM_DISP_PWM_CK, "fm_disp_pwm_ck", 0x0274, 23, 1),
	FMCLK2(CKGEN, FM_USB_1P_CK, "fm_usb_1p_ck", 0x0274, 22, 1),
	FMCLK2(CKGEN, FM_USB_XHCI_1P_CK, "fm_usb_xhci_1p_ck", 0x0274, 21, 1),
	FMCLK2(CKGEN, FM_USB_FMCNT_P1_CK, "fm_usb_fmcnt_p1_ck", 0x0274, 20, 1),
	FMCLK2(CKGEN, FM_I2C_P_CK, "fm_i2c_p_ck", 0x0274, 19, 1),
	FMCLK2(CKGEN, FM_I2C_EAST_CK, "fm_i2c_east_ck", 0x0274, 18, 1),
	FMCLK2(CKGEN, FM_I2C_WEST_CK, "fm_i2c_west_ck", 0x0274, 17, 1),
	FMCLK2(CKGEN, FM_I2C_NORTH_CK, "fm_i2c_north_ck", 0x0274, 16, 1),
	FMCLK2(CKGEN, FM_AES_UFSFDE_CK, "fm_aes_ufsfde_ck", 0x0274, 15, 1),
	FMCLK2(CKGEN, FM_CK, "fm_ck", 0x0274, 14, 1),
	FMCLK2(CKGEN, FM_MBIST_CK, "fm_mbist_ck", 0x0274, 13, 1),
	FMCLK2(CKGEN, FM_PEXTP_MBIST_CK, "fm_pextp_mbist_ck", 0x0274, 12, 1),
	FMCLK2(CKGEN, FM_AUD_1_CK, "fm_aud_1_ck", 0x0274, 11, 1),
	FMCLK2(CKGEN, FM_AUD_2_CK, "fm_aud_2_ck", 0x0274, 10, 1),
	FMCLK2(CKGEN, FM_ADSP_CK, "fm_adsp_ck", 0x0274, 9, 1),
	FMCLK2(CKGEN, FM_ADSP_UARTHUB_B_CK, "fm_adsp_uarthub_b_ck", 0x0274, 8, 1),
	FMCLK2(CKGEN, FM_DPMAIF_MAIN_CK, "fm_dpmaif_main_ck", 0x0274, 7, 1),
	FMCLK2(CKGEN, FM_PWM_CK, "fm_pwm_ck", 0x0274, 6, 1),
	FMCLK2(CKGEN, FM_MCUPM_CK, "fm_mcupm_ck", 0x0274, 5, 1),
	FMCLK2(CKGEN, FM_SFLASH_CK, "fm_sflash_ck", 0x0274, 4, 1),
	FMCLK2(CKGEN, FM_IPSEAST_CK, "fm_ipseast_ck", 0x0274, 3, 1),
	FMCLK2(CKGEN, FM_IPSWEST_CK, "fm_ipswest_ck", 0x0274, 2, 1),
	FMCLK2(CKGEN, FM_TL_CK, "fm_tl_ck", 0x0274, 1, 1),
	FMCLK2(CKGEN, FM_TL_P1_CK, "fm_tl_p1_ck", 0x0274, 0, 1),
	FMCLK2(CKGEN, FM_TL_P2_CK, "fm_tl_p2_ck", 0x0278, 31, 1),
	FMCLK2(CKGEN, FM_EMI_INTERFACE_546_CK, "fm_emi_interface_546_ck", 0x0278, 30, 1),
	FMCLK2(CKGEN, FM_SDF_CK, "fm_sdf_ck", 0x0278, 29, 1),
	FMCLK2(CKGEN, FM_UARTHUB_B_CK, "fm_uarthub_b_ck", 0x0278, 28, 1),
	FMCLK2(CKGEN, FM_DPSW_CMP_26M_CK, "fm_dpsw_cmp_26m_ck", 0x0278, 27, 1),
	FMCLK2(CKGEN, FM_SMAPCK_CK, "fm_smapck_ck", 0x0278, 26, 1),
	FMCLK2(CKGEN, FM_SSR_PKA_CK, "fm_ssr_pka_ck", 0x0278, 25, 1),
	FMCLK2(CKGEN, FM_SSR_DMA_CK, "fm_ssr_dma_ck", 0x0278, 24, 1),
	FMCLK2(CKGEN, FM_SSR_KDF_CK, "fm_ssr_kdf_ck", 0x0278, 23, 1),
	FMCLK2(CKGEN, FM_SSR_RNG_CK, "fm_ssr_rng_ck", 0x0278, 22, 1),
	FMCLK2(CKGEN, FM_SPU0_CK, "fm_spu0_ck", 0x0278, 21, 1),
	FMCLK2(CKGEN, FM_SPU1_CK, "fm_spu1_ck", 0x0278, 20, 1),
	FMCLK2(CKGEN, FM_DXCC_CK, "fm_dxcc_ck", 0x0278, 19, 1),
	FMCLK2(CKGEN, FM_SPU0_BOOT_CK, "fm_spu0_boot_ck", 0x0278, 18, 1),
	FMCLK2(CKGEN, FM_SPU1_BOOT_CK, "fm_spu1_boot_ck", 0x0278, 17, 1),
	FMCLK2(CKGEN, FM_SGMII0_REF_325M_CK, "fm_sgmii0_ref_325m_ck", 0x0278, 16, 1),
	FMCLK2(CKGEN, FM_SGMII0_CK, "fm_sgmii0_ck", 0x0278, 15, 1),
	FMCLK2(CKGEN, FM_SGMII1_REF_325M_CK, "fm_sgmii1_ref_325m_ck", 0x0278, 14, 1),
	FMCLK2(CKGEN, FM_SGMII1_CK, "fm_sgmii1_ck", 0x0278, 13, 1),
	FMCLK2(CKGEN, FM_GMAC_312P5M_CK, "fm_gmac_312p5m_ck", 0x0278, 12, 1),
	FMCLK2(CKGEN, FM_GMAC_125M_CK, "fm_gmac_125m_ck", 0x0278, 11, 1),
	FMCLK2(CKGEN, FM_GMAC_RMII_CK, "fm_gmac_rmii_ck", 0x0278, 10, 1),
	FMCLK2(CKGEN, FM_GMAC_62P4M_PTP_CK, "fm_gmac_62p4m_ptp_ck", 0x0278, 9, 1),
	/* ABIST Part */
	...
	/* CKGEN_CK2 Part */
	FMCLK2(CKGEN_CK2, FM_SENINF0_CK, "fm_seninf0_ck", 0x0174, 31, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF1_CK, "fm_seninf1_ck", 0x0174, 30, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF2_CK, "fm_seninf2_ck", 0x0174, 29, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF3_CK, "fm_seninf3_ck", 0x0174, 28, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF4_CK, "fm_seninf4_ck", 0x0174, 27, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF5_CK, "fm_seninf5_ck", 0x0174, 26, 1),
	FMCLK2(CKGEN_CK2, FM_IMG1_CK, "fm_img1_ck", 0x0174, 25, 1),
	FMCLK2(CKGEN_CK2, FM_IPE_CK, "fm_ipe_ck", 0x0174, 24, 1),
	FMCLK2(CKGEN_CK2, FM_CAM_CK, "fm_cam_ck", 0x0174, 23, 1),
	FMCLK2(CKGEN_CK2, FM_CAMTM_CK, "fm_camtm_ck", 0x0174, 22, 1),
	FMCLK2(CKGEN_CK2, FM_DPE_CK, "fm_dpe_ck", 0x0174, 21, 1),
	FMCLK2(CKGEN_CK2, FM_VDEC_CK, "fm_vdec_ck", 0x0174, 20, 1),
	FMCLK2(CKGEN_CK2, FM_CCUSYS_CK, "fm_ccusys_ck", 0x0174, 19, 1),
	FMCLK2(CKGEN_CK2, FM_CCUTM_CK, "fm_ccutm_ck", 0x0174, 18, 1),
	FMCLK2(CKGEN_CK2, FM_VENC_CK, "fm_venc_ck", 0x0174, 17, 1),
	FMCLK2(CKGEN_CK2, FM_DVO_CK, "fm_dvo_ck", 0x0174, 16, 1),
	FMCLK2(CKGEN_CK2, FM_DVO_FAVT_CK, "fm_dvo_favt_ck", 0x0174, 15, 1),
	FMCLK2(CKGEN_CK2, FM_DP1_CK, "fm_dp1_ck", 0x0174, 14, 1),
	FMCLK2(CKGEN_CK2, FM_DP0_CK, "fm_dp0_ck", 0x0174, 13, 1),
	FMCLK2(CKGEN_CK2, FM_DISP_CK, "fm_disp_ck", 0x0174, 12, 1),
	FMCLK2(CKGEN_CK2, FM_MDP_CK, "fm_mdp_ck", 0x0174, 11, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_CK, "fm_mminfra_ck", 0x0174, 10, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_SNOC_CK, "fm_mminfra_snoc_ck", 0x0174, 9, 1),
	FMCLK2(CKGEN_CK2, FM_MMUP_CK, "fm_mmup_ck", 0x0174, 8, 1),
	FMCLK2(CKGEN_CK2, FM_DUMMY1_CK, "fm_dummy1_ck", 0x0174, 7, 1),
	FMCLK2(CKGEN_CK2, FM_DUMMY2_CK, "fm_dummy2_ck", 0x0174, 6, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_AO_CK, "fm_mminfra_ao_ck", 0x0174, 5, 1),
	/* ABIST_CK2 Part */
	...
	FMCLK2(VLPCK, FM_SCP_IIC_HS_CK, "fm_scp_iic_hs_ck", 0x0010, 31, 1),
	FMCLK2(VLPCK, FM_PWRAP_ULPOSC_CK, "fm_pwrap_ulposc_ck", 0x0020, 7, 1),
	FMCLK2(VLPCK, FM_SPMI_32KCK, "fm_spmi_32kck", 0x0020, 15, 1),
	FMCLK2(VLPCK, FM_APXGPT_26M_B_CK, "fm_apxgpt_26m_b_ck", 0x0020, 23, 1),
	FMCLK2(VLPCK, FM_DPSW_CK, "fm_dpsw_ck", 0x0020, 31, 1),
	FMCLK2(VLPCK, FM_DPSW_CENTRAL_CK, "fm_dpsw_central_ck", 0x0030, 7, 1),
	...
	FMCLK2(VLPCK, FM_CAMTG0_CK, "fm_camtg0_ck", 0x0050, 7, 1),
	FMCLK2(VLPCK, FM_CAMTG1_CK, "fm_camtg1_ck", 0x0050, 15, 1),
	FMCLK2(VLPCK, FM_CAMTG2_CK, "fm_camtg2_ck", 0x0050, 23, 1),
	FMCLK2(VLPCK, FM_CAMTG3_CK, "fm_camtg3_ck", 0x0050, 31, 1),
	FMCLK2(VLPCK, FM_CAMTG4_CK, "fm_camtg4_ck", 0x0060, 7, 1),
	FMCLK2(VLPCK, FM_CAMTG5_CK, "fm_camtg5_ck", 0x0060, 15, 1),
	FMCLK2(VLPCK, FM_CAMTG6_CK, "fm_camtg6_ck", 0x0060, 23, 1),
	FMCLK2(VLPCK, FM_CAMTG7_CK, "fm_camtg7_ck", 0x0060, 31, 1),
	FMCLK2(VLPCK, FM_IPS_CK, "fm_ips_ck", 0x0070, 7, 1),
	FMCLK2(VLPCK, FM_SSPM_26M_CK, "fm_sspm_26m_ck", 0x0070, 15, 1),
	FMCLK2(VLPCK, FM_ULPOSC_SSPM_CK, "fm_ulposc_sspm_ck", 0x0070, 23, 1),
	FMCLK2(VLPCK, FM_VLP_PBUS_26M_CK, "fm_vlp_pbus_26m_ck", 0x0070, 31, 1),
	FMCLK2(VLPCK, FM_DEBUG_ERR_FLAG_VLP_26M_CK, "fm_debug_err_flag_vlp_26m_ck", 0x0080, 7, 1),
	FMCLK2(VLPCK, FM_DPMSRDMA_CK, "fm_dpmsrdma_ck", 0x0080, 15, 1),
	FMCLK2(VLPCK, FM_VLP_PBUS_156M_CK, "fm_vlp_pbus_156m_ck", 0x0080, 23, 1),
	FMCLK2(VLPCK, FM_SPM_CK, "fm_spm_ck", 0x0080, 31, 1),
	FMCLK2(VLPCK, FM_MMINFRA_VLP_CK, "fm_mminfra_vlp_ck", 0x0090, 7, 1),
	FMCLK2(VLPCK, FM_USB_CK, "fm_usb_ck", 0x0090, 15, 1),
	FMCLK2(VLPCK, FM_USB_XHCI_CK, "fm_usb_xhci_ck", 0x0090, 23, 1),
	FMCLK2(VLPCK, FM_NOC_VLP_CK, "fm_noc_vlp_ck", 0x0090, 31, 1),
	FMCLK2(VLPCK, FM_AUDIO_H_CK, "fm_audio_h_ck", 0x00A0, 7, 1),
	FMCLK2(VLPCK, FM_AUD_ENGEN1_CK, "fm_aud_engen1_ck", 0x00A0, 15, 1),
	FMCLK2(VLPCK, FM_AUD_ENGEN2_CK, "fm_aud_engen2_ck", 0x00A0, 23, 1),
	FMCLK2(VLPCK, FM_AUD_INTBUS_CK, "fm_aud_intbus_ck", 0x00A0, 31, 1),
	FMCLK2(VLPCK, FM_SPVLP_26M_CK, "fm_spvlp_26m_ck", 0x00B0, 7, 1),
	FMCLK2(VLPCK, FM_SPU0_VLP_CK, "fm_spu0_vlp_ck", 0x00B0, 15, 1),
	FMCLK2(VLPCK, FM_SPU1_VLP_CK, "fm_spu1_vlp_ck", 0x00B0, 23, 1),
	FMCLK2(VLPCK, FM_VLP_DUMMY1_CK, "fm_vlp_dummy1_ck", 0x00B0, 31, 1),
	FMCLK2(VLPCK, FM_VLP_DUMMY2_CK, "fm_vlp_dummy2_ck", 0x00C0, 7, 1),
