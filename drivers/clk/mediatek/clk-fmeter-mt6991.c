...
static const struct fmeter_clk fclks[] = {
	...
	FMCLK2(CKGEN, FM_MEM_SUB_CK, "fm_mem_sub_ck", 0x0010, 15, 1),
	FMCLK2(CKGEN, FM_IO_NOC_CK, "fm_io_noc_ck", 0x0010, 23, 1),
	FMCLK2(CKGEN, FM_P_AXI_CK, "fm_p_axi_ck", 0x0010, 31, 1),
	FMCLK2(CKGEN, FM_PEXTP0_AXI_CK, "fm_pextp0_axi_ck", 0x0020, 7, 1),
	FMCLK2(CKGEN, FM_PEXTP1_USB_AXI_CK, "fm_pextp1_usb_axi_ck", 0x0020, 15, 1),
	FMCLK2(CKGEN, FM_P_FMEM_SUB_CK, "fm_p_fmem_sub_ck", 0x0020, 23, 1),
	FMCLK2(CKGEN, FM_PEXPT0_MEM_SUB_CK, "fm_pexpt0_mem_sub_ck", 0x0020, 31, 1),
	FMCLK2(CKGEN, FM_PEXTP1_USB_MEM_SUB_CK, "fm_pextp1_usb_mem_sub_ck", 0x0030, 7, 1),
	FMCLK2(CKGEN, FM_P_NOC_CK, "fm_p_noc_ck", 0x0030, 15, 1),
	FMCLK2(CKGEN, FM_EMI_N_CK, "fm_emi_n_ck", 0x0030, 23, 1),
	FMCLK2(CKGEN, FM_EMI_S_CK, "fm_emi_s_ck", 0x0030, 31, 1),
	FMCLK2(CKGEN, FM_EMI_SLICE_N_CK, "fm_emi_slice_n_ck", 0x0040, 7, 1),
	FMCLK2(CKGEN, FM_EMI_SLICE_S_CK, "fm_emi_slice_s_ck", 0x0040, 15, 1),
	FMCLK2(CKGEN, FM_AP2CONN_HOST_CK, "fm_ap2conn_host_ck", 0x0040, 23, 1),
	FMCLK2(CKGEN, FM_ATB_CK, "fm_atb_ck", 0x0040, 31, 1),
	FMCLK2(CKGEN, FM_CIRQ_CK, "fm_cirq_ck", 0x0050, 7, 1),
	FMCLK2(CKGEN, FM_PBUS_156M_CK, "fm_pbus_156m_ck", 0x0050, 15, 1),
	FMCLK2(CKGEN, FM_NOC_LOW_CK, "fm_noc_low_ck", 0x0050, 23, 1),
	FMCLK2(CKGEN, FM_NOC_MID_CK, "fm_noc_mid_ck", 0x0050, 31, 1),
	FMCLK2(CKGEN, FM_EFUSE_CK, "fm_efuse_ck", 0x0060, 7, 1),
	FMCLK2(CKGEN, FM_MCL3GIC_CK, "fm_mcl3gic_ck", 0x0060, 15, 1),
	FMCLK2(CKGEN, FM_MCINFRA_CK, "fm_mcinfra_ck", 0x0060, 23, 1),
	FMCLK2(CKGEN, FM_DSP_CK, "fm_dsp_ck", 0x0060, 31, 1),
	FMCLK2(CKGEN, FM_MFG_REF_CK, "fm_mfg_ref_ck", 0x0070, 7, 1),
	FMCLK2(CKGEN, FM_MFGSC_REF_CK, "fm_mfgsc_ref_ck", 0x0070, 15, 1),
	FMCLK2(CKGEN, FM_MFG_EB_CK, "fm_mfg_eb_ck", 0x0070, 23, 1),
	FMCLK2(CKGEN, FM_UART_CK, "fm_uart_ck", 0x0070, 31, 1),
	FMCLK2(CKGEN, FM_SPI0_B_CK, "fm_spi0_b_ck", 0x0080, 7, 1),
	FMCLK2(CKGEN, FM_SPI1_B_CK, "fm_spi1_b_ck", 0x0080, 15, 1),
	FMCLK2(CKGEN, FM_SPI2_B_CK, "fm_spi2_b_ck", 0x0080, 23, 1),
	FMCLK2(CKGEN, FM_SPI3_B_CK, "fm_spi3_b_ck", 0x0080, 31, 1),
	FMCLK2(CKGEN, FM_SPI4_B_CK, "fm_spi4_b_ck", 0x0090, 7, 1),
	FMCLK2(CKGEN, FM_SPI5_B_CK, "fm_spi5_b_ck", 0x0090, 15, 1),
	FMCLK2(CKGEN, FM_SPI6_B_CK, "fm_spi6_b_ck", 0x0090, 23, 1),
	FMCLK2(CKGEN, FM_SPI7_B_CK, "fm_spi7_b_ck", 0x0090, 31, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_1P_CK, "fm_msdc_macro_1p_ck", 0x00A0, 7, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_2P_CK, "fm_msdc_macro_2p_ck", 0x00A0, 15, 1),
	FMCLK2(CKGEN, FM_MSDC30_1_CK, "fm_msdc30_1_ck", 0x00A0, 23, 1),
	FMCLK2(CKGEN, FM_MSDC30_2_CK, "fm_msdc30_2_ck", 0x00A0, 31, 1),
	...
	FMCLK2(CKGEN, FM_USB_FMCNT_P1_CK, "fm_usb_fmcnt_p1_ck", 0x00B0, 31, 1),
	FMCLK2(CKGEN, FM_I2C_P_CK, "fm_i2c_p_ck", 0x00C0, 7, 1),
	FMCLK2(CKGEN, FM_I2C_EAST_CK, "fm_i2c_east_ck", 0x00C0, 15, 1),
	FMCLK2(CKGEN, FM_I2C_WEST_CK, "fm_i2c_west_ck", 0x00C0, 23, 1),
	FMCLK2(CKGEN, FM_I2C_NORTH_CK, "fm_i2c_north_ck", 0x00C0, 31, 1),
	FMCLK2(CKGEN, FM_AES_UFSFDE_CK, "fm_aes_ufsfde_ck", 0x00D0, 7, 1),
	FMCLK2(CKGEN, FM_CK, "fm_ck", 0x00D0, 15, 1),
	FMCLK2(CKGEN, FM_MBIST_CK, "fm_mbist_ck", 0x00D0, 23, 1),
	...
	FMCLK2(CKGEN, FM_ADSP_UARTHUB_B_CK, "fm_adsp_uarthub_b_ck", 0x00E0, 31, 1),
	FMCLK2(CKGEN, FM_DPMAIF_MAIN_CK, "fm_dpmaif_main_ck", 0x00F0, 7, 1),
	FMCLK2(CKGEN, FM_PWM_CK, "fm_pwm_ck", 0x00F0, 15, 1),
	FMCLK2(CKGEN, FM_MCUPM_CK, "fm_mcupm_ck", 0x00F0, 23, 1),
	FMCLK2(CKGEN, FM_SFLASH_CK, "fm_sflash_ck", 0x00F0, 31, 1),
	FMCLK2(CKGEN, FM_IPSEAST_CK, "fm_ipseast_ck", 0x0100, 7, 1),
	FMCLK2(CKGEN, FM_IPSWEST_CK, "fm_ipswest_ck", 0x0100, 15, 1),
	FMCLK2(CKGEN, FM_TL_CK, "fm_tl_ck", 0x0100, 23, 1),
	FMCLK2(CKGEN, FM_TL_P1_CK, "fm_tl_p1_ck", 0x0100, 31, 1),
	FMCLK2(CKGEN, FM_TL_P2_CK, "fm_tl_p2_ck", 0x0110, 7, 1),
	FMCLK2(CKGEN, FM_EMI_INTERFACE_546_CK, "fm_emi_interface_546_ck", 0x0110, 15, 1),
	FMCLK2(CKGEN, FM_SDF_CK, "fm_sdf_ck", 0x0110, 23, 1),
	FMCLK2(CKGEN, FM_UARTHUB_B_CK, "fm_uarthub_b_ck", 0x0110, 31, 1),
	FMCLK2(CKGEN, FM_DPSW_CMP_26M_CK, "fm_dpsw_cmp_26m_ck", 0x0120, 7, 1),
	FMCLK2(CKGEN, FM_SMAPCK_CK, "fm_smapck_ck", 0x0120, 15, 1),
	FMCLK2(CKGEN, FM_SSR_PKA_CK, "fm_ssr_pka_ck", 0x0120, 23, 1),
	FMCLK2(CKGEN, FM_SSR_DMA_CK, "fm_ssr_dma_ck", 0x0120, 31, 1),
	FMCLK2(CKGEN, FM_SSR_KDF_CK, "fm_ssr_kdf_ck", 0x0130, 7, 1),
	FMCLK2(CKGEN, FM_SSR_RNG_CK, "fm_ssr_rng_ck", 0x0130, 15, 1),
	FMCLK2(CKGEN, FM_SPU0_CK, "fm_spu0_ck", 0x0130, 23, 1),
	FMCLK2(CKGEN, FM_SPU1_CK, "fm_spu1_ck", 0x0130, 31, 1),
	FMCLK2(CKGEN, FM_DXCC_CK, "fm_dxcc_ck", 0x0140, 7, 1),
	FMCLK2(CKGEN, FM_SPU0_BOOT_CK, "fm_spu0_boot_ck", 0x0140, 15, 1),
	FMCLK2(CKGEN, FM_SPU1_BOOT_CK, "fm_spu1_boot_ck", 0x0140, 23, 1),
	FMCLK2(CKGEN, FM_SGMII0_REF_325M_CK, "fm_sgmii0_ref_325m_ck", 0x0140, 31, 1),
	FMCLK2(CKGEN, FM_SGMII0_CK, "fm_sgmii0_ck", 0x0150, 7, 1),
	FMCLK2(CKGEN, FM_SGMII1_REF_325M_CK, "fm_sgmii1_ref_325m_ck", 0x0150, 15, 1),
	FMCLK2(CKGEN, FM_SGMII1_CK, "fm_sgmii1_ck", 0x0150, 23, 1),
	FMCLK2(CKGEN, FM_GMAC_312P5M_CK, "fm_gmac_312p5m_ck", 0x0150, 31, 1),
	FMCLK2(CKGEN, FM_GMAC_125M_CK, "fm_gmac_125m_ck", 0x0160, 7, 1),
	FMCLK2(CKGEN, FM_GMAC_RMII_CK, "fm_gmac_rmii_ck", 0x0160, 15, 1),
	FMCLK2(CKGEN, FM_GMAC_62P4M_PTP_CK, "fm_gmac_62p4m_ptp_ck", 0x0160, 23, 1),
	/* ABIST Part */
	...
	/* CKGEN_CK2 Part */
	FMCLK2(CKGEN_CK2, FM_SENINF0_CK, "fm_seninf0_ck", 0x0010, 7, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF1_CK, "fm_seninf1_ck", 0x0010, 15, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF2_CK, "fm_seninf2_ck", 0x0010, 23, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF3_CK, "fm_seninf3_ck", 0x0010, 31, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF4_CK, "fm_seninf4_ck", 0x0020, 7, 1),
	FMCLK2(CKGEN_CK2, FM_SENINF5_CK, "fm_seninf5_ck", 0x0020, 15, 1),
	FMCLK2(CKGEN_CK2, FM_IMG1_CK, "fm_img1_ck", 0x0020, 23, 1),
	FMCLK2(CKGEN_CK2, FM_IPE_CK, "fm_ipe_ck", 0x0020, 31, 1),
	FMCLK2(CKGEN_CK2, FM_CAM_CK, "fm_cam_ck", 0x0030, 7, 1),
	FMCLK2(CKGEN_CK2, FM_CAMTM_CK, "fm_camtm_ck", 0x0030, 15, 1),
	FMCLK2(CKGEN_CK2, FM_DPE_CK, "fm_dpe_ck", 0x0030, 23, 1),
	FMCLK2(CKGEN_CK2, FM_VDEC_CK, "fm_vdec_ck", 0x0030, 31, 1),
	FMCLK2(CKGEN_CK2, FM_CCUSYS_CK, "fm_ccusys_ck", 0x0040, 7, 1),
	FMCLK2(CKGEN_CK2, FM_CCUTM_CK, "fm_ccutm_ck", 0x0040, 15, 1),
	FMCLK2(CKGEN_CK2, FM_VENC_CK, "fm_venc_ck", 0x0040, 23, 1),
	FMCLK2(CKGEN_CK2, FM_DVO_CK, "fm_dvo_ck", 0x0040, 31, 1),
	FMCLK2(CKGEN_CK2, FM_DVO_FAVT_CK, "fm_dvo_favt_ck", 0x0050, 7, 1),
	FMCLK2(CKGEN_CK2, FM_DP1_CK, "fm_dp1_ck", 0x0050, 15, 1),
	FMCLK2(CKGEN_CK2, FM_DP0_CK, "fm_dp0_ck", 0x0050, 23, 1),
	FMCLK2(CKGEN_CK2, FM_DISP_CK, "fm_disp_ck", 0x0050, 31, 1),
	FMCLK2(CKGEN_CK2, FM_MDP_CK, "fm_mdp_ck", 0x0060, 7, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_CK, "fm_mminfra_ck", 0x0060, 15, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_SNOC_CK, "fm_mminfra_snoc_ck", 0x0060, 23, 1),
	FMCLK2(CKGEN_CK2, FM_MMUP_CK, "fm_mmup_ck", 0x0060, 31, 1),
	FMCLK2(CKGEN_CK2, FM_DUMMY1_CK, "fm_dummy1_ck", 0x0070, 7, 1),
	FMCLK2(CKGEN_CK2, FM_DUMMY2_CK, "fm_dummy2_ck", 0x0070, 15, 1),
	FMCLK2(CKGEN_CK2, FM_MMINFRA_AO_CK, "fm_mminfra_ao_ck", 0x0070, 23, 1),
	/* ABIST_CK2 Part */
