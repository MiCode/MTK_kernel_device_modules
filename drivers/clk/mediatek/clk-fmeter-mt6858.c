...
static struct fmeter_data subsys_fm[] = {
	[FM_VLP_CKSYS_TOP] = {FM_VLP_CKSYS_TOP, "fm_vlp_cksys_top",
		0, 0, VLP_FQMTR_CON0, VLP_FQMTR_CON1},
};

const char *comp_list[] = {
	[FM_CKSYS_REG] = "mediatek,mt6858-cksys_reg",
	[FM_APMIXEDSYS] = "mediatek,mt6858-apmixedsys",
	[FM_VLP_CKSYS_TOP] = "mediatek,mt6858-vlp_cksys_top",
};
...
static const struct fmeter_clk fclks[] = {
	...
	FMCLK2(CKGEN, FM_AXI_P_CK, "fm_axi_p_ck", 0x0010, 15, 1),
	FMCLK2(CKGEN, FM_HAXI_UFS_CK, "fm_haxi_ufs_ck", 0x0010, 23, 1),
	FMCLK2(CKGEN, FM_B, "fm_bus_aximem_ck", 0x0010, 31, 1),
	...
	FMCLK2(CKGEN, FM_SPI0_CK, "fm_spi0_ck", 0x0030, 7, 1),
	FMCLK2(CKGEN, FM_SPI1_CK, "fm_spi1_ck", 0x0030, 15, 1),
	FMCLK2(CKGEN, FM_SPI2_CK, "fm_spi2_ck", 0x0030, 23, 1),
	FMCLK2(CKGEN, FM_SPI3_CK, "fm_spi3_ck", 0x0030, 31, 1),
	FMCLK2(CKGEN, FM_SPI4_CK, "fm_spi4_ck", 0x0040, 7, 1),
	FMCLK2(CKGEN, FM_SPI5_CK, "fm_spi5_ck", 0x0040, 15, 1),
	FMCLK2(CKGEN, FM_SPI6_CK, "fm_spi6_ck", 0x0040, 23, 1),
	FMCLK2(CKGEN, FM_SPI7_CK, "fm_spi7_ck", 0x0040, 31, 1),
	FMCLK2(CKGEN, FM_MSDC_MACRO_1P_CK, "fm_msdc_macro_1p_ck", 0x0050, 7, 1),
	FMCLK2(CKGEN, FM_MSDC30_1_CK, "fm_msdc30_1_ck", 0x0050, 15, 1),
	FMCLK2(CKGEN, FM_MSDC30_1_H_CK, "fm_msdc30_1_h_ck", 0x0050, 23, 1),
	FMCLK2(CKGEN, FM_AUD_INTBUS_CK, "fm_aud_intbus_ck", 0x0050, 31, 1),
	FMCLK2(CKGEN, FM_ATB_CK, "fm_atb_ck", 0x0060, 7, 1),
	FMCLK2(CKGEN, FM_DISP_PWM_CK, "fm_disp_pwm_ck", 0x0060, 15, 1),
	FMCLK2(CKGEN, FM_USB_CK, "fm_usb_ck", 0x0060, 23, 1),
	FMCLK2(CKGEN, FM_USB_XHCI_CK, "fm_usb_xhci_ck", 0x0060, 31, 1),
	FMCLK2(CKGEN, FM_I2C_CK, "fm_i2c_ck", 0x0070, 7, 1),
	FMCLK2(CKGEN, FM_SENINF_CK, "fm_seninf_ck", 0x0070, 15, 1),
	FMCLK2(CKGEN, FM_SENINF1_CK, "fm_seninf1_ck", 0x0070, 23, 1),
	FMCLK2(CKGEN, FM_SENINF2_CK, "fm_seninf2_ck", 0x0070, 31, 1),
	FMCLK2(CKGEN, FM_AUD_ENGEN1_CK, "fm_aud_engen1_ck", 0x0080, 7, 1),
	FMCLK2(CKGEN, FM_AUD_ENGEN2_CK, "fm_aud_engen2_ck", 0x0080, 15, 1),
	FMCLK2(CKGEN, FM_AES_UFSFDE_CK, "fm_aes_ufsfde_ck", 0x0080, 23, 1),
	FMCLK2(CKGEN, FM_UFS_CK, "fm_ufs_ck", 0x0080, 31, 1),
	FMCLK2(CKGEN, FM_UFS_MBIST_CK, "fm_ufs_mbist_ck", 0x0090, 7, 1),
	FMCLK2(CKGEN, FM_AUD_1_CK, "fm_aud_1_ck", 0x0090, 15, 1),
	FMCLK2(CKGEN, FM_AUD_2_CK, "fm_aud_2_ck", 0x0090, 23, 1),
	FMCLK2(CKGEN, FM_DPMAIF_MAIN_CK, "fm_dpmaif_main_ck", 0x0090, 31, 1),
	FMCLK2(CKGEN, FM_VENC_CK, "fm_venc_ck", 0x00A0, 7, 1),
	FMCLK2(CKGEN, FM_VDEC_CK, "fm_vdec_ck", 0x00A0, 15, 1),
	FMCLK2(CKGEN, FM_PWM_CK, "fm_pwm_ck", 0x00A0, 23, 1),
	FMCLK2(CKGEN, FM_AUDIO_H_CK, "fm_audio_h_ck", 0x00A0, 31, 1),
	FMCLK2(CKGEN, FM_MCUPM_CK, "fm_mcupm_ck", 0x00B0, 7, 1),
	FMCLK2(CKGEN, FM_MEM_SUB_CK, "fm_mem_sub_ck", 0x00B0, 15, 1),
	FMCLK2(CKGEN, FM_MEM_SUB_P_CK, "fm_mem_sub_p_ck", 0x00B0, 23, 1),
	FMCLK2(CKGEN, FM_MEM_SUB_UFS_CK, "fm_mem_sub_ufs_ck", 0x00B0, 31, 1),
	FMCLK2(CKGEN, FM_EMI_N_CK, "fm_emi_n_ck", 0x00C0, 7, 1),
	FMCLK2(CKGEN, FM_DSI_OCC_CK, "fm_dsi_occ_ck", 0x00C0, 15, 1),
	FMCLK2(CKGEN, FM_AP2CONN_HOST_CK, "fm_ap2conn_host_ck", 0x00C0, 23, 1),
	...
	FMCLK2(CKGEN, FM_EMI_INTERFACE_546_CK, "fm_emi_interface_546_ck", 0x00D0, 31, 1),
	FMCLK2(CKGEN, FM_DXCC_CK, "fm_dxcc_ck", 0x00E0, 7, 1),
	FMCLK2(CKGEN, FM_MFG_REF_CK, "fm_mfg_ref_ck", 0x00E0, 15, 1),
	FMCLK2(CKGEN, FM_MFGSC_REF_CK, "fm_mfgsc_ref_ck", 0x00E0, 23, 1),
	FMCLK2(CKGEN, FM_EFUSE_CK, "fm_efuse_ck", 0x00E0, 31, 1),
	FMCLK2(CKGEN, FM_IRRX_RUN_P_P_CK, "fm_irrx_run_p_p_ck", 0x00F0, 7, 1),
	FMCLK2(CKGEN, FM_UNIPLL_SES_CK, "fm_unipll_ses_ck", 0x00F0, 15, 1),
	FMCLK2(CKGEN, FM_DPM_CK, "fm_dpm_ck", 0x00F0, 23, 1),
	FMCLK2(CKGEN, FM_DRAMULP_CK, "fm_dramulp_ck", 0x00F0, 31, 1),
	FMCLK2(CKGEN, FM_USB_FRMCNT_CK, "fm_usb_frmcnt_ck", 0x0100, 7, 1),
	FMCLK2(CKGEN, FM_IOBIST_208M_CK, "fm_iobist_208m_ck", 0x0100, 15, 1),
	/* ABIST Part */
	...
	FMCLK2(VLPCK, FM_PWRMCCK, "fm_pwrmcck", 0x0020, 7, 1),
	FMCLK2(VLPCK, FM_SSPM_F26M_CK, "fm_sspm_f26m_ck", 0x0020, 15, 1),
	FMCLK2(VLPCK, FM_SRCK_CK, "fm_srck_ck", 0x0020, 23, 1),
	FMCLK2(VLPCK, FM_SCP_SPI_CK, "fm_scp_spi_ck", 0x0020, 31, 1),
	FMCLK2(VLPCK, FM_SCP_IIC_CK, "fm_scp_iic_ck", 0x002C, 7, 1),
	FMCLK2(VLPCK, FM_SCP_SPI_HS_CK, "fm_scp_spi_hs_ck", 0x002C, 15, 1),
	FMCLK2(VLPCK, FM_SCP_IIC_HS_CK, "fm_scp_iic_hs_ck", 0x002C, 23, 1),
	FMCLK2(VLPCK, FM_SSPM_ULPOSC_CK, "fm_sspm_ulposc_ck", 0x002C, 31, 1),
	FMCLK2(VLPCK, FM_TIA_ULPOSC_CK, "fm_tia_ulposc_ck", 0x0038, 7, 1),
	FMCLK2(VLPCK, FM_APXGPT_26M_CK, "fm_apxgpt_26m_ck", 0x0038, 15, 1),
	FMCLK2(VLPCK, FM_CAMTG0_CK, "fm_camtg0_ck", 0x0038, 23, 1),
	FMCLK2(VLPCK, FM_CAMTG1_CK, "fm_camtg1_ck", 0x0038, 31, 1),
	FMCLK2(VLPCK, FM_CAMTG2_CK, "fm_camtg2_ck", 0x0044, 7, 1),
	FMCLK2(VLPCK, FM_CAMTG3_CK, "fm_camtg3_ck", 0x0044, 15, 1),
	FMCLK2(VLPCK, FM_KP_IRQ_GEN_CK, "fm_kp_irq_gen_ck", 0x0044, 23, 1),
	FMCLK2(VLPCK, FM_SSR_PKA_CK, "fm_ssr_pka_ck", 0x0044, 31, 1),
	FMCLK2(VLPCK, FM_SSR_DMA_CK, "fm_ssr_dma_ck", 0x0050, 7, 1),
	FMCLK2(VLPCK, FM_SSR_KDF_CK, "fm_ssr_kdf_ck", 0x0050, 15, 1),
	FMCLK2(VLPCK, FM_SSR_RNG_CK, "fm_ssr_rng_ck", 0x0050, 23, 1),
	FMCLK2(VLPCK, FM_DXCC_CK_2, "fm_dxcc_ck_2", 0x0050, 31, 1),
	FMCLK(VLPCK, FM_ULPOSC_CORE_CK, "fm_ulposc_core_ck", 1),
	/* SUBSYS Part */
	{},
};

const struct fmeter_clk *mt6858_get_fmeter_clks(void)
{
	return fclks;
}
...
static unsigned int mt6858_get_ckgen_freq(unsigned int ID)
{
	return __mt_get_freq(ID, CKGEN);
}

static unsigned int mt6858_get_abist_freq(unsigned int ID)
{
	return __mt_get_freq(ID, ABIST);
}

static unsigned int mt6858_get_vlpck_freq(unsigned int ID)
{
	return __mt_get_freq2(FM_VLP_CKSYS_TOP, ID);
}

static unsigned int mt6858_get_subsys_freq(unsigned int ID)
{
	int output = 0;
	unsigned long flags;
...
static unsigned int mt6858_get_fmeter_freq(unsigned int id,
		enum FMETER_TYPE type)
{
	if (type == CKGEN)
		return mt6858_get_ckgen_freq(id);
	else if (type == ABIST)
		return mt6858_get_abist_freq(id);
	else if (type == SUBSYS)
		return mt6858_get_subsys_freq(id);
	else if (type == VLPCK)
		return mt6858_get_vlpck_freq(id);
...
static struct platform_driver clk_fmeter_mt6858_drv = {
	.probe = clk_fmeter_mt6858_probe,
	.driver = {
		.name = "clk-fmeter-mt6858",
		.owner = THIS_MODULE,
	},
};
...
static int __init clk_fmeter_init(void)
{
	...
	clk_fmeter_dev = platform_device_register_simple("clk-fmeter-mt6858", -1, NULL, 0);
	if (IS_ERR(clk_fmeter_dev))
		pr_warn("unable to register clk-fmeter device");

	return platform_driver_register(&clk_fmeter_mt6858_drv);
}

static void __exit clk_fmeter_exit(void)
{
	platform_driver_unregister(&clk_fmeter_mt6858_drv);
}
