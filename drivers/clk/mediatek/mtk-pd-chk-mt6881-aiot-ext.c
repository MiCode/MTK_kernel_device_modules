...
#include <dt-bindings/power/mt6881-aiot-ext-power.h>

#include "mtk-pd-chk.h"
#include "clkchk-mt6881-aiot-ext.h"
...
static struct pd_sta pd_pwr_sta[] = {
	...
	{MT6881_CHK_PD_PCIE, spm, 0x0E68, GENMASK(31, 30)},
	{MT6881_CHK_PD_PCIE_PHY, spm, 0x0E6C, GENMASK(31, 30)},
};
...
static const struct of_device_id of_match_pdchk_mt6881[] = {
	{
		.compatible = "mediatek,mt6881-pdchk-aiot-ext",
	}, {
		/* sentinel */
	}
};
