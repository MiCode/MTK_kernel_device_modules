...
static const struct mtk_gate mminfra_config_clks[] = {
	...
	GATE_MMINFRA_CONFIG0(CLK_MMINFRA_SMI, "mminfra_smi",
			"mminfra_ck"/* parent */, 2),
	GATE_MMINFRA_CONFIG0_V(CLK_MMINFRA_SMI_GCE, "mminfra_smi_gce",
			"mminfra_smi"/* parent */),
