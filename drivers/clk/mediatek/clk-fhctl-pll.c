...
/* 6858 begin */
#define SIZE_6858 (sizeof(mt6858_top0_data)\
	/sizeof(struct fh_pll_data))

#define DATA_6858_CONVERT(_name) {				\
		.name = _name,						\
		.dds_mask = GENMASK(21, 0),			\
		.postdiv_mask = GENMASK(26, 24),		    \
		.postdiv_offset = 24,				        \
		.slope0_value = 0x0600716D,			\
		.slope1_value = 0x0600716D,			\
		.sfstrx_en = BIT(2),				\
		.frddsx_en = BIT(1),				\
		.fhctlx_en = BIT(0),				\
		.tgl_org = BIT(31),					\
...
// TOP and TINYSYS no set/clr
#define REG_6858_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_con_postdiv = _con_pcw,		\
		.offset_hp_en = 0x0,				\
...
///////////////////////////////////top0
static struct fh_pll_data mt6858_top0_data[] = {
	DATA_6858_CONVERT("mainpll"),
	DATA_6858_CONVERT("msdcpll"),
	DATA_6858_CONVERT("adsppll"),
	DATA_6858_CONVERT("emipll"),
	DATA_6858_CONVERT("mmpll"),
	DATA_6858_CONVERT("tvdpll"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	{}
};
static struct fh_pll_offset mt6858_offset_share[SIZE_6858] = {
	REG_6858_CONVERT(0x003C, 0x0354),  //	DATA_6858_CONVERT("mainpll"),
	REG_6858_CONVERT(0x0050, 0x0364),  //	DATA_6858_CONVERT("msdcpll"),
	REG_6858_CONVERT(0x0064, 0x0384),  //	DATA_6858_CONVERT("adsppll"),
	REG_6858_CONVERT(0x0078, 0x03B4),  //	DATA_6858_CONVERT("emipll"),
	REG_6858_CONVERT(0x008C, 0x03A4),  //	DATA_6858_CONVERT("mmpll"),
	REG_6858_CONVERT(0x00A0, 0x024C),  //	DATA_6858_CONVERT("tvdpll"),
	REG_6858_CONVERT(0x00B4, 0x020C),  //	DATA_6858_CONVERT("armpll-ll"),
	REG_6858_CONVERT(0x00C8, 0x021C),  //	DATA_6858_CONVERT("armpll-bl"),
	REG_6858_CONVERT(0x00DC, 0x023C),  //	DATA_6858_CONVERT("ccipll"),
	{}
};
static struct fh_pll_regs mt6858_top0_regs[SIZE_6858];
static struct fh_pll_domain mt6858_top0 = {
	.name = "top0",
	.data = (struct fh_pll_data *)&mt6858_top0_data,
	.offset = (struct fh_pll_offset *)&mt6858_offset_share,
	.regs = (struct fh_pll_regs *)&mt6858_top0_regs,
	.init = &init_v1,
};
///////////////////////////////////top1 (MCU PLL)
static struct fh_pll_data mt6858_top1_data[] = {
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("nouse"),
	DATA_6858_CONVERT("armpll-ll"),
	DATA_6858_CONVERT("armpll-bl"),
	DATA_6858_CONVERT("ccipll"),
	{}
};
static struct fh_pll_regs mt6858_top1_regs[SIZE_6858];
static struct fh_pll_domain mt6858_top1 = {
	.name = "top1",
	.data = (struct fh_pll_data *)&mt6858_top1_data,
	.offset = (struct fh_pll_offset *)&mt6858_offset_share,
	.regs = (struct fh_pll_regs *)&mt6858_top1_regs,
	.init = &init_v1,
};

static struct fh_pll_domain *mt6858_domain[] = {
	&mt6858_top0,
	&mt6858_top1,
	NULL
};
static struct match mt6858_match = {
	.compatible = "mediatek,mt6858-fhctl",
	.domain_list = (struct fh_pll_domain **)mt6858_domain,
};
/* 6858 end */
...
/* 6881 begin */
#define SIZE_6881_TOP0 (sizeof(mt6881_top0_data)\
	/sizeof(struct fh_pll_data))
#define SIZE_6881_MCU (sizeof(mt6881_mcu0_data)\
	/sizeof(struct fh_pll_data))

#define DATA_6881_CONVERT(_name) {				\
		.name = _name,						\
		.dds_mask = GENMASK(21, 0),			\
		.postdiv_mask = GENMASK(26, 24),		    \
		.postdiv_offset = 24,				        \
...
#define REG_6881_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_con_postdiv = _con_pcw,		\
		.offset_hp_en = 0x0,                \
...
#define REG_6881_TINYSYS_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_con_postdiv = _con_pcw,		\
		.offset_hp_en = 0x0,				\
...
///////////////////////////////////top0
static struct fh_pll_data mt6881_top0_data[] = {
	DATA_6881_CONVERT("mainpll"),
	DATA_6881_CONVERT("msdcpll"),
	DATA_6881_CONVERT("emipll"),
	DATA_6881_CONVERT("mmpll"),
	DATA_6881_CONVERT("tvdpll"),
	{}
};
static struct fh_pll_offset mt6881_top0_offset[SIZE_6881_TOP0] = {
	REG_6881_CONVERT(0x0054, 0x0254),  // DATA_6881_CONVERT("mainpll")
	REG_6881_CONVERT(0x0068, 0x027C),  // DATA_6881_CONVERT("msdcpll")
	REG_6881_CONVERT(0x007C, 0x0290),  // DATA_6881_CONVERT("emipll")
	REG_6881_CONVERT(0x0090, 0x02A4),  // DATA_6881_CONVERT("mmpll")
	REG_6881_CONVERT(0x00A4, 0x02B8),  // DATA_6881_CONVERT("tvdpll")
	{}
};
static struct fh_pll_regs mt6881_top0_regs[SIZE_6881_TOP0];
static struct fh_pll_domain mt6881_top0 = {
	.name = "top0",
	.data = (struct fh_pll_data *)&mt6881_top0_data,
	.offset = (struct fh_pll_offset *)&mt6881_top0_offset,
	.regs = (struct fh_pll_regs *)&mt6881_top0_regs,
	.init = &init_v1,
};
...
static struct fh_pll_offset mt6881_mcu_share_offset[SIZE_6881_MCU] = {
	REG_6881_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6881_mcu0_regs[SIZE_6881_MCU];
static struct fh_pll_domain mt6881_mcu0 = {
	.name = "mcu0",
	.data = (struct fh_pll_data *)&mt6881_mcu0_data,
	.offset = (struct fh_pll_offset *)&mt6881_mcu_share_offset,
	.regs = (struct fh_pll_regs *)&mt6881_mcu0_regs,
	.init = &init_v1,
};
...
static struct fh_pll_domain mt6881_mcu1 = {
	.name = "mcu1",
	.data = (struct fh_pll_data *)&mt6881_mcu1_data,
	.offset = (struct fh_pll_offset *)&mt6881_mcu_share_offset,
	.regs = (struct fh_pll_regs *)&mt6881_mcu1_regs,
	.init = &init_v1,
};

///////////////////////////////////mcu2
static struct fh_pll_data mt6881_mcu2_data[] = {
	DATA_6881_CONVERT("armpll-b"),
	{}
};
static struct fh_pll_regs mt6881_mcu2_regs[SIZE_6881_MCU];
static struct fh_pll_domain mt6881_mcu2 = {
	.name = "mcu2",
	.data = (struct fh_pll_data *)&mt6881_mcu2_data,
	.offset = (struct fh_pll_offset *)&mt6881_mcu_share_offset,
	.regs = (struct fh_pll_regs *)&mt6881_mcu2_regs,
	.init = &init_v1,
};

///////////////////////////////////mcu3
static struct fh_pll_data mt6881_mcu3_data[] = {
	DATA_6881_CONVERT("ptppll"),
	{}
};
static struct fh_pll_regs mt6881_mcu3_regs[SIZE_6881_MCU];
static struct fh_pll_domain mt6881_mcu3 = {
	.name = "mcu3",
	.data = (struct fh_pll_data *)&mt6881_mcu3_data,
	.offset = (struct fh_pll_offset *)&mt6881_mcu_share_offset,
	.regs = (struct fh_pll_regs *)&mt6881_mcu3_regs,
	.init = &init_v1,
};

static struct fh_pll_domain *mt6881_domain[] = {
	&mt6881_top0,
	&mt6881_mcu0,
	&mt6881_mcu1,
	&mt6881_mcu2,
...
static struct match mt6881_match = {
	.compatible = "mediatek,mt6881-fhctl",
	.domain_list = (struct fh_pll_domain **)mt6881_domain,
};
/* 6881 end */
...
/* 6993 begin */
#define SIZE_6993_TOP (sizeof(mt6993_top0_data)\
	/ sizeof(struct fh_pll_data))
#define SIZE_6993_GPU (sizeof(mt6993_gpu0_data)\
	/ sizeof(struct fh_pll_data))

#define DATA_6993_CONVERT(_name) {				\
		.name = _name,						\
		.dds_mask = GENMASK(21, 0),			\
		.postdiv_mask = GENMASK(26, 24),		    \
		.postdiv_offset = 24,				        \
		.slope0_value = 0x6006368,			\
		.slope1_value = 0x6006368,			\
		.sfstrx_en = BIT(2),				\
		.frddsx_en = BIT(1),				\
		.fhctlx_en = BIT(0),				\
		.tgl_org = BIT(31),					\
...
#define REG_6993_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_con_postdiv = _con_pcw,		\
		.offset_hp_en = 0x0,                \
...
//TINYSYS no slope1, map to slope0 for compatibility
#define REG_6993_TINYSYS_CONVERT(_fhctl, _con_pcw) {	\
		.offset_fhctl = _fhctl,				\
		.offset_con_pcw = _con_pcw,			\
		.offset_con_postdiv = _con_pcw,		\
		.offset_hp_en = 0x0,				\
...
///////////////////////////////////top0
static struct fh_pll_data mt6993_top0_data[] = {
	DATA_6993_CONVERT("mainpll"),
	{}
};
static struct fh_pll_offset mt6993_top_share_offset[SIZE_6993_TOP] = {
	REG_6993_CONVERT(0x2c, 0xc),
	{}
};
static struct fh_pll_regs mt6993_top0_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top0 = {
	.name = "top0",
	.data = (struct fh_pll_data *)&mt6993_top0_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top0_regs,
	.init = &init_v1,
};
///////////////////////////////////top1
static struct fh_pll_data mt6993_top1_data[] = {
	DATA_6993_CONVERT("univpll"),
	{}
};
static struct fh_pll_regs mt6993_top1_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top1 = {
	.name = "top1",
	.data = (struct fh_pll_data *)&mt6993_top1_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top1_regs,
	.init = &init_v1,
};
///////////////////////////////////top2
static struct fh_pll_data mt6993_top2_data[] = {
	DATA_6993_CONVERT("msdcpll"),
	{}
};
static struct fh_pll_regs mt6993_top2_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top2 = {
	.name = "top2",
	.data = (struct fh_pll_data *)&mt6993_top2_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top2_regs,
	.init = &init_v1,
};
///////////////////////////////////top3
static struct fh_pll_data mt6993_top3_data[] = {
	DATA_6993_CONVERT("mainpll2"),
	{}
};
static struct fh_pll_regs mt6993_top3_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top3 = {
	.name = "top3",
	.data = (struct fh_pll_data *)&mt6993_top3_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top3_regs,
	.init = &init_v1,
};
///////////////////////////////////top4
static struct fh_pll_data mt6993_top4_data[] = {
	DATA_6993_CONVERT("univpll2"),
	{}
};
static struct fh_pll_regs mt6993_top4_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top4 = {
	.name = "top4",
	.data = (struct fh_pll_data *)&mt6993_top4_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top4_regs,
	.init = &init_v1,
};
///////////////////////////////////top5
static struct fh_pll_data mt6993_top5_data[] = {
	DATA_6993_CONVERT("mmpll"),
	{}
};
static struct fh_pll_regs mt6993_top5_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top5 = {
	.name = "top5",
	.data = (struct fh_pll_data *)&mt6993_top5_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top5_regs,
	.init = &init_v1,
};
///////////////////////////////////top6
static struct fh_pll_data mt6993_top6_data[] = {
	DATA_6993_CONVERT("imgpll"),
	{}
};
static struct fh_pll_regs mt6993_top6_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top6 = {
	.name = "top6",
	.data = (struct fh_pll_data *)&mt6993_top6_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top6_regs,
	.init = &init_v1,
};
///////////////////////////////////top7
static struct fh_pll_data mt6993_top7_data[] = {
	DATA_6993_CONVERT("tvdpll"),
	{}
};
static struct fh_pll_regs mt6993_top7_regs[SIZE_6993_TOP];
static struct fh_pll_domain mt6993_top7 = {
	.name = "top7",
	.data = (struct fh_pll_data *)&mt6993_top7_data,
	.offset = (struct fh_pll_offset *)&mt6993_top_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_top7_regs,
	.init = &init_v1,
};
///////////////////////////////////gpu0
static struct fh_pll_data mt6993_gpu0_data[] = {
	DATA_6993_CONVERT("mfgpll"),
	{}
};
static struct fh_pll_offset mt6993_gpu_share_offset[SIZE_6993_GPU] = {
	REG_6993_TINYSYS_CONVERT(0x14, 0xC),
	{}
};
static struct fh_pll_regs mt6993_gpu0_regs[SIZE_6993_GPU];
static struct fh_pll_domain mt6993_gpu0 = {
	.name = "gpu0",
	.data = (struct fh_pll_data *)&mt6993_gpu0_data,
	.offset = (struct fh_pll_offset *)&mt6993_gpu_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_gpu0_regs,
	.init = &init_v1,
};
///////////////////////////////////gpu1
static struct fh_pll_data mt6993_gpu1_data[] = {
	DATA_6993_CONVERT("mfgpll-sc"),
	{}
};
static struct fh_pll_regs mt6993_gpu1_regs[SIZE_6993_GPU];
static struct fh_pll_domain mt6993_gpu1 = {
	.name = "gpu1",
	.data = (struct fh_pll_data *)&mt6993_gpu1_data,
	.offset = (struct fh_pll_offset *)&mt6993_gpu_share_offset,
	.regs = (struct fh_pll_regs *)&mt6993_gpu1_regs,
	.init = &init_v1,
};

static struct fh_pll_domain *mt6993_domain[] = {
	&mt6993_top0,
	&mt6993_top1,
	&mt6993_top2,
	&mt6993_top3,
...
static struct match mt6993_match = {
	.compatible = "mediatek,mt6993-fhctl",
	.domain_list = (struct fh_pll_domain **)mt6993_domain,
};
/* 6993 end */
