 ...
 */
struct tee_context *tee_client_open_context(
	struct tee_context *start,
...
/**
 * mitee_tee_init() - init tee bus
 */
int mitee_tee_init(void);

/**
 * mitee_tee_init() - deinit tee bus
 */
void mitee_tee_exit(void);
#endif /*__TEE_DRV_H*/
