...
/*[in/out]       value[0].a          sub_cmd: OPTEE_REE_CALLBACK_ALLOCATE_SECMEM / handle
 *[in/out]       value[0].b          module_id / mem_size
 *[in/out]       value[0].c          mem_size / none
 *
 *[in]       value[0].a          sub_cmd: OPTEE_REE_CALLBACK_FREE_SECMEM
 *[in]       value[0].b          module_id
 *[in]       value[0].c          handle
 * */

#define OPTEE_MSG_RPC_CMD_CALLBACK 90
