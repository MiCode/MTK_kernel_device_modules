...
static const char *const xm_chg_dfx_report_text[] = {
	...
	"chgBattCycle",	"PdAuthFail", "CpEnFail", "noneStandartChg", "corrosionDischarge", "CpVbatOVP",
	"AntiBurnTirg",	"SocNotFull", "SmartEnduraTrig", "SmartNaviTrig", "battLinkerAbsent", "CpTdieHot",
	"SmartEnduraSocErr", "SmartNaviSocErr", "TbatCold", "wlsRxI2CErr", "TbatHot", "NotChgInLowTemp",
	"NotChgInHighTemp", "AntiFail", "VoltageDifferenceOver","DualBattAuthFail", "CpVbusOVP", "CpIbusOCP",
	"CpIbatOCP", "BatteryOverVoltage", "RechgSocErr", "NotStopChgErr",
};
...
static int xm_chg_dfx_id[CHG_DFX_MAX_INDEX] = {
	...
	909006010, 909006011, 909009002, 909013004, 909009001, 909005007,
	909005008, 909009003, 909014002, 909007002, 909002004, 909002005,
	909002007, 909010002, 909014020, 909014021,
};
...
struct mtk_charger {
	...
	struct delayed_work otg_wdt_kick_work;
	...
	bool support_otg_wdt_kick;
	bool otg_wdt_enabled;
	bool support_revcable;
	bool support_pchg_policy;
	bool wait_ibus_check;
	...
	bool last_pdo_valid;
	int rqc_blocked;
	int last_rqc_blocked;
	bool stop_monitor_rqc;
...
enum usb_property {
	...
	USB_PROP_TYPEC_IS_IPHONE17_SERIES,
