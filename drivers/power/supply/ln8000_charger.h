...
static const char* ln8000_psy_name[] = {
      [LN8000_STANDALONE] = "cp_master",
      [LN8000_MASTER] = "cp_master",
      [LN8000_SLAVE] = "cp_slave",
};

static const char* ln8000_irq_name[] = {
      [LN8000_STANDALONE] = "ln8000-standalone-irq",
      [LN8000_SLAVE] = "ln8000-slave-irq",
      [LN8000_MASTER] = "ln8000-master-irq",
};

static int ln8000_mode_data[] = {
      [LN8000_STANDALONE] = LN8000_STANDALONE,
      [LN8000_SLAVE] = LN8000_SLAVE,
      [LN8000_MASTER] = LN8000_MASTER,
};
