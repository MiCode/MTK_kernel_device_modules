...
#define AREA_NAME_LEN_MAX	20
#define BATT_INFO_LEN_MAX	32
...
#define SHUTDOWN_DELAY_VOL_LOW		3000
#define SHUTDOWN_DELAY_VOL_COLD_TEMP       2800
#define BATTERY_COLD_TEMP                  0
...
enum bq_fg_mac_cmd {
	...
	FG_MAC_CMD_REPORT_SOC100= 0X0031,
	...
	FG_MAC_CMD_SOH_CALIBRATION_VAL = 0x0069,
	...
	FG_MAC_CMD_FIRST_USAGE_DATE = 0x007B,
	FG_MAC_CMD_UI_SOH = 0x007B,
	FG_MAC_CMD_EIS	= 0x009D,
...
struct bq_fg_chip {
	...
	u8 regs[NUM_REGS];
	char model_name[MODEL_NAME_LEN_MAX];
	char log_tag[I2C_NAME_SIZE];
	char device_chem[FG_DEVICE_CHEM_LEN_MAX];
	char area_name[AREA_NAME_LEN_MAX];
	char batt_info[BATT_INFO_LEN_MAX];
	int device_name;
	bool chip_ok;
	bool batt_fc;
	...
	struct power_supply *bms_file_psy;
...
enum bms_property {
	...
	BMS_PROP_INPUT_SUSPEND,
	BMS_PROP_OTG_UI_SUPPORT,
	BMS_PROP_CID_STATUS,
	BMS_PROP_CC_TOGGLE,
	BMS_PROP_CHARGER_PARTITION_TEST,
	BMS_PROP_CHARGER_PARTITION_POWEROFFMODE,
	BMS_PROP_BATT_ID,
	BMS_PROP_FG_VENDOR,
	BMS_PROP_DOD_COUNT,
	BMS_PROP_REVERSE_QUICK_CHARGE,
	BMS_PROP_REVCHG_BCL,
	BMS_PROP_SHIPMODE,
	BMS_PROP_COUNT_LEVLE1,
	BMS_PROP_COUNT_LEVLE2,
	BMS_PROP_COUNT_LEVLE3,
	BMS_PROP_OVER_VOL_DURATION,
	BMS_PROP_MIN_LIFE_TIME,
	BMS_PROP_MAX_LIFE_TIME,
	BMS_PROP_MIN_LIFE_VOL,
	BMS_PROP_MAX_LIFE_VOL,
	BMS_PROP_REL_SOH_CYCLECOUNT,
	BMS_PROP_REL_SOH,
	BMS_PROP_QMAX_CYCLECOUNT,
	BMS_PROP_QMAX,
	BMS_PROP_EIS_SOH_CYCLECOUNT,
	BMS_PROP_EIS_SOH,
	BMS_PROP_BAT_USE_ENVIRONMENT,
	BMS_PROP_CHARGE_ABSOC,
	#if IS_ENABLED(CONFIG_RUST_DETECTION)
	BAT_PROP_MOISTURE_DETECTION_EN,
	BAT_PROP_MOISTURE_DETECTION_STATUS,
	BMS_PROP_LPD_CHARGING,
	#endif
	BMS_PROP_SOH_NEW,
};
...
struct bq_bms_sysfs_field_info {
	struct device_attribute attr;
	enum bms_property prop;
	int (*set)(struct bq_fg_chip *gm,
		struct bq_bms_sysfs_field_info *attr, int val);
