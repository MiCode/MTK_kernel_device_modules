...
enum bq_fg_reg_idx {
	...
	BQ_FG_REG_REAL_TEMP,    /* NTC Real Temp */
...
enum bq_fg_mac_cmd {
	...
	FG_MAC_CMD_FAST_MODE_STS = 0x00E5,
...
struct bq_fg_chip {
	...
	int	soc_gap;
	int calc_shutdown_vol_current;
	int calc_shutdown_vol_soc;
	int calc_shutdown_vol_after_charging_time_s;
