...
enum bq_fg_type {
	...
	BQ_FG_TYPE_PARALLEL,
	BQ_FG_TYPE_SERIES,
	BQ_FG_TYPE_MAX = BQ_FG_TYPE_SERIES,
};
...
enum bq_fg_reg_idx {
	...
	SC_FG_CHARGING_STATUS,	/* Charging Status */
	SC_FG_VOLT_RANGE,	/* Voltage Range */
	SC_FG_TEMP_RANGE,	/* Temp Range */
...
enum bq_fg_mac_cmd {
	...
	FG_MAC_CMD_MIX_TERM_VOLT   = 0x0050,
	FG_MAC_CMD_SEAL_STATE   = 0x0054,
...
struct bq_fg_chip {
	...
	struct regulator *mt6373_reg_vio28;
	...
	int batt1_control_gpio;
	int batt2_control_gpio;
	int cell_supplier;
...
enum bms_property {
	...
	BMS_PROP_DOD_COUNT,
	BMS_PROP_ADAP_POWER,
	BMS_PROP_CONTROL_BATT_CHG,
	BMS_PROP_CUTOFF_VOL,
	BMS_PROP_BATTERY_NUM,
	BMS_PROP_DESIGN_CAPACITY,
};
...
enum battery_vendor {
	BATTERY_PACK_VENDOR_TI = 0,
	BATTERY_PACK_VENDOR_NFG1000A,
	BATTERY_PACK_VENDOR_NFG1000B,
	BATTERY_PACK_VENDOR_MPC8011B,
	BATTERY_PACK_VENDOR_SC58561,
	BATTERY_PACK_VENDOR_UNKNOWN = 100,
};
...
extern int slave_bms_get_property(enum bms_property bp, int *val);
extern int slave_bms_set_property(enum bms_property bp, int val);
