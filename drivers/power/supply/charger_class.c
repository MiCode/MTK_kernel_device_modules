...
int charger_dev_need_hz_ctrl(struct charger_device *chg_dev)
{
	if (chg_dev != NULL && chg_dev->ops != NULL &&
	    chg_dev->ops->need_hz_ctrl)
		return chg_dev->ops->need_hz_ctrl(chg_dev);

	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(charger_dev_need_hz_ctrl);
...
int charger_dev_cp_device_wls_chg_init(struct charger_device *charger_dev, int value)
{
	if (charger_dev != NULL && charger_dev->ops != NULL &&
					   charger_dev->ops->cp_device_wls_chg_init)
		return charger_dev->ops->cp_device_wls_chg_init(charger_dev, value);

	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(charger_dev_cp_device_wls_chg_init);
...
int charger_dev_get_short_sub_temp(struct charger_device *chg_dev, int *value)
{
	if (chg_dev != NULL && chg_dev->ops != NULL && chg_dev->ops->get_short_sub_temp)
		return chg_dev->ops->get_short_sub_temp(chg_dev, value);

	return -ENOTSUPP;
}
EXPORT_SYMBOL(charger_dev_get_short_sub_temp);

int charger_dev_get_short_ts_temp(struct charger_device *chg_dev, int *value)
{
	if (chg_dev != NULL && chg_dev->ops != NULL && chg_dev->ops->get_short_ts_temp)
		return chg_dev->ops->get_short_ts_temp(chg_dev, value);

	return -ENOTSUPP;
}
EXPORT_SYMBOL(charger_dev_get_short_ts_temp);
...
// reverse chg
int charger_dev_cp_set_revchg(struct charger_device *charger_dev, bool en)
{
	if (charger_dev != NULL && charger_dev->ops != NULL &&
					   charger_dev->ops->cp_set_revchg)
		return charger_dev->ops->cp_set_revchg(charger_dev, en);
...
int charger_dev_after_get_bc12_type(struct charger_device *charger_dev, int after_port, int *type)
{
	if (charger_dev != NULL && charger_dev->ops != NULL &&
					   charger_dev->ops->after_get_bc12_type)
		return charger_dev->ops->after_get_bc12_type(charger_dev, after_port, type);

	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(charger_dev_after_get_bc12_type);

int charger_dev_set_rerun_bc12(struct charger_device *charger_dev)
{
	if (charger_dev != NULL && charger_dev->ops != NULL &&
					   charger_dev->ops->set_rerun_bc12)
		return charger_dev->ops->set_rerun_bc12(charger_dev);

	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(charger_dev_set_rerun_bc12);
#endif
