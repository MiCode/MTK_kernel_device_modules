...
enum {
	...
	SSDEV_APDO_MAX_30W = 30,
	SSDEV_APDO_MAX_27W = 27,
};
...
static int ssdev_typec_filter_apdo_power_for_report(int apdo_max)
{
	...
	else if (apdo_max >= 33 && apdo_max < 40)
		return SSDEV_APDO_MAX_33W;
	else if (apdo_max >= 30 && apdo_max < 33)
		return SSDEV_APDO_MAX_30W;
	else if (apdo_max >= 27 && apdo_max < 30)
		return SSDEV_APDO_MAX_27W;
	else
		return apdo_max;
}
