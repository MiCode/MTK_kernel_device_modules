...
static struct ntc_desc project_ntc_table[] = {
	{-400, 4269100},
	{-350, 3025700},
	{-300, 2166900},
	{-250, 1567500},
...
static int mt6379_get_sub_temp(struct charger_device *chg_dev, int *value)
{
	...
	if (ddata->project_no == PROJECT_CN) {
		ts_ntc_table = project_ntc_table;
		size = sizeof(project_ntc_table) / sizeof(project_ntc_table[0]);
	} else {
