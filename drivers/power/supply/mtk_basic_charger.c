...
retry:
	...
	/* For TC_018, pleasae don't modify the format */
	chr_err("[CHG_CURRENT_LIMIT] m:%d chg1:%d,%d,%d,%d chg2:%d,%d,%d,%d dvchg1:%d sc:%d %d %d type:%d:%d usb_unlimited:%d usbif:%d usbsm:%d ii:%d,%d aicl:%d atm:%d bm:%d b:%d mtbf:%d\n",
		info->config,
