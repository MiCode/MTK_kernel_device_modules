...
struct fg_ops {
	...
	int (*read_real_temp)(struct fg_device *dev, int *real_temp);
	int (*read_voltage_max)(struct fg_device *dev, int *voltage_max);
	int (*read_temp_max)(struct fg_device *dev, int *temp_max);
	int (*read_over_vol_duration)(struct fg_device *dev, int *over_vol_duration);
	...
	int (*fg_get_batt_sn)(struct fg_device *dev, char *buf);
	int (*sc_fg_read_charging_status)(struct fg_device *dev);
	int (*sc_fg_read_volt_range)(struct fg_device *dev);
	int (*sc_fg_read_temp_range)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_operation_status)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_dev_status)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_host_cmd_status)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_term_volt)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_xt_status)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_xt_status2)(struct fg_device *dev);
	int (*sc_fg_ext_cmd_read_xt_status3)(struct fg_device *dev);
};
...
extern int fuelgauge_dev_read_real_temp(struct fg_device *fg_dev, int *real_temp);
extern int fuelgauge_dev_read_voltage_max(struct fg_device *fg_dev, int *voltage_max);
extern int fuelgauge_dev_read_temp_max(struct fg_device *fg_dev, int *temp_max);
extern int fuelgauge_dev_read_over_vol_duration(struct fg_device *fg_dev, int *over_vol_duration);
...
extern int fuelgauge_dev_fg_get_batt_sn(struct fg_device *fg_dev, char *buf);
extern int fuelgauge_dev_sc_fg_read_charging_status(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_read_volt_range(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_read_temp_range(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_operation_status(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_dev_status(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_host_cmd_status(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_term_volt(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_xt_status(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_xt_status2(struct fg_device *fg_dev);
extern int fuelgauge_dev_sc_fg_ext_cmd_read_xt_status3(struct fg_device *fg_dev);
