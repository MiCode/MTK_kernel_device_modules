...
#define STEP_JEITA_FFC_NUM	4
#define STEP_JEITA_HOT_NUM	5
#else
#define STEP_JEITA_TUPLE_COUNT	7
#define STEP_JEITA_FFC_NUM	5
#define STEP_JEITA_HOT_NUM	6
#endif
...
#define TYPEC_NTC_TEMP_RECOVER_THRESHOLD	550
#define TYPEC_NTC_TEMP_FITTING_THRESHOLD	50000
#ifdef CONFIG_SUPPORT_SOUTHCHIP_PDPHY
#define TYPEC_NTC_TEMP_COMBINED_THRESHOLD	650
#define TYPEC_BURN_TEMP_THRESHOLD	700
#else
...
#define ITERM_FCC_WARM		6000
#define ITERM_FCC_WARM_PMIC		3000
#define ENABLE_FCC_ITERM_LEVEL	14
#define WLS_ENABLE_FCC_ITERM_LEVEL	11
#define WARM_TEMP        	481

#define MAXCURR_MONITOR_TIME_S 60
#define FS_START_CURRENT_DEFAULT 17000
