...
int wireless_charger_dev_wls_get_tx_uuid(struct wireless_charger_device *chg_dev, char *buf)
{
	if (chg_dev != NULL && chg_dev->ops != NULL && chg_dev->ops->wls_get_tx_uuid)
		return chg_dev->ops->wls_get_tx_uuid(chg_dev, buf);
	return -ENOTSUPP;
}
EXPORT_SYMBOL(wireless_charger_dev_wls_get_tx_uuid);
...
int wireless_charger_dev_wls_get_hall_n_gpio_status(struct wireless_charger_device *chg_dev, bool *hall_n_gpio_status)
{
	if (chg_dev != NULL && chg_dev->ops != NULL &&
	    chg_dev->ops->wls_get_hall_n_gpio_status)
		return chg_dev->ops->wls_get_hall_n_gpio_status(chg_dev, hall_n_gpio_status);
	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(wireless_charger_dev_wls_get_hall_n_gpio_status);

int wireless_charger_dev_wls_get_hall_s_gpio_status(struct wireless_charger_device *chg_dev, bool *hall_s_gpio_status)
{
	if (chg_dev != NULL && chg_dev->ops != NULL &&
	    chg_dev->ops->wls_get_hall_s_gpio_status)
		return chg_dev->ops->wls_get_hall_s_gpio_status(chg_dev, hall_s_gpio_status);
	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(wireless_charger_dev_wls_get_hall_s_gpio_status);

int wireless_charger_dev_wls_get_power_good_low_debounce(struct wireless_charger_device *chg_dev, bool *pg_low_debounce)
{
	if (chg_dev != NULL && chg_dev->ops != NULL &&
	    chg_dev->ops->wls_get_power_good_low_debounce)
		return chg_dev->ops->wls_get_power_good_low_debounce(chg_dev, pg_low_debounce);
	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(wireless_charger_dev_wls_get_power_good_low_debounce);

int wireless_charger_dev_wls_get_tx_q_value(struct wireless_charger_device *chg_dev, int *tx_q_value)
{
	if (chg_dev != NULL && chg_dev->ops != NULL &&
		chg_dev->ops->wls_get_tx_q_value)
		return chg_dev->ops->wls_get_tx_q_value(chg_dev, tx_q_value);
	return -EOPNOTSUPP;
}
EXPORT_SYMBOL(wireless_charger_dev_wls_get_tx_q_value);
