...
enum wireless_project_vendor {
	...
	WLS_CHIP_VENDOR_FUDA1671,
	WLS_CHIP_VENDOR_MAX,
};

enum WLS_CP_FORWARD_CHARGER_MODE {
	FORWARD_4_1_CHARGER_MODE = 1,
...
struct wireless_charger_ops {
	...
	int (*wls_get_hall_n_gpio_status)(struct wireless_charger_device *dev, bool *hall_n_gpio_status);
	int (*wls_get_hall_s_gpio_status)(struct wireless_charger_device *dev, bool *hall_s_gpio_status);
	int (*wls_get_tx_q_value)(struct wireless_charger_device *dev, int *tx_q_value);
	int (*wls_get_power_good_low_debounce)(struct wireless_charger_device *dev, bool *pg_low_debounce);
	/*For LN8282*/
...
extern int wireless_charger_dev_wls_get_hall_n_gpio_status(struct wireless_charger_device *chg_dev, bool *hall_n_gpio_status);
extern int wireless_charger_dev_wls_get_hall_s_gpio_status(struct wireless_charger_device *chg_dev, bool *hall_s_gpio_status);
extern int wireless_charger_dev_wls_get_tx_q_value(struct wireless_charger_device *chg_dev, int *tx_q_value);
extern int wireless_charger_dev_wls_get_power_good_low_debounce(struct wireless_charger_device *chg_dev, bool *pg_low_debounce);
/* For LN8282 */
