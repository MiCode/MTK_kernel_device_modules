...
int __attribute__ ((weak))
        wireless_charger_dev_wls_get_tx_uuid(struct wireless_charger_device *chg_dev, char *buf)
{
    pr_err("%s: weak func!\n", __func__);
    return -ENOTSUPP;
}
...
int __attribute__ ((weak))
        wireless_charger_dev_wls_get_hall_n_gpio_status(struct wireless_charger_device *chg_dev, bool *hall_n_gpio_status)
{
    pr_err("%s: weak func!\n", __func__);
    return -ENOTSUPP;
}
...
int __attribute__ ((weak))
        wireless_charger_dev_wls_get_hall_s_gpio_status(struct wireless_charger_device *chg_dev, bool *hall_s_gpio_status)
{
    pr_err("%s: weak func!\n", __func__);
    return -ENOTSUPP;
}
...
int __attribute__ ((weak))
        wireless_charger_dev_wls_get_tx_q_value(struct wireless_charger_device *chg_dev, int *tx_q_value)
{
    pr_err("%s: weak func!\n", __func__);
    return -ENOTSUPP;
}
...
int __attribute__ ((weak))
        wireless_charger_dev_wls_get_power_good_low_debounce(struct wireless_charger_device *chg_dev, bool *pg_low_debounce)
{
    pr_err("%s: weak func!\n", __func__);
    return -ENOTSUPP;
}
