...
static const struct mtk_node_desc node_descs_mt6893[] = {
	...
	DEFINE_MNODE(mdp_common0_port2, MASTER_COMMON_PORT(1, 2), 0, false, 0x2, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port3, MASTER_COMMON_PORT(1, 3), 0, false, 0x1, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port4, MASTER_COMMON_PORT(1, 4), 0, false, 0x2, SLAVE_COMMON(1)),
