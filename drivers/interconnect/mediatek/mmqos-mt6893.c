...
static const struct mtk_node_desc node_descs_mt6893[] = {
	...
	DEFINE_MNODE(common0_port5, MASTER_COMMON_PORT(0, 5), 0, false, 0x0, SLAVE_COMMON(0)),
	DEFINE_MNODE(common0_port6, MASTER_COMMON_PORT(0, 6), 0, false, 0x0, SLAVE_COMMON(0)),
	DEFINE_MNODE(common0_port7, MASTER_COMMON_PORT(0, 7), 0, false, 0x0, SLAVE_COMMON(0)),
	DEFINE_MNODE(common0_port8, MASTER_COMMON_PORT(0, 8), 0, false, 0x0, SLAVE_COMMON(0)),
	/* SLAVE_COMMON(1): SMI_MDP_COMMON */
	DEFINE_MNODE(mdp_common0_port0, MASTER_COMMON_PORT(1, 0), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port1, MASTER_COMMON_PORT(1, 1), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port2, MASTER_COMMON_PORT(1, 2), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port3, MASTER_COMMON_PORT(1, 3), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port4, MASTER_COMMON_PORT(1, 4), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port5, MASTER_COMMON_PORT(1, 5), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port6, MASTER_COMMON_PORT(1, 6), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port7, MASTER_COMMON_PORT(1, 7), 0, false, 0x0, SLAVE_COMMON(1)),
	DEFINE_MNODE(mdp_common0_port8, MASTER_COMMON_PORT(1, 8), 0, false, 0x0, SLAVE_COMMON(1)),
	/* SMI COMMON */
	...
	DEFINE_MNODE(larb5, SLAVE_LARB(5), 0, false, 0x0, MASTER_COMMON_PORT(0, 2)),   //vdec
	DEFINE_MNODE(larb7, SLAVE_LARB(7), 0, false, 0x0, MASTER_COMMON_PORT(0, 3)),   //venc
	DEFINE_MNODE(larb11, SLAVE_LARB(11), 0, false, 0x0, MASTER_COMMON_PORT(0, 4)), //img2
	DEFINE_MNODE(larb14, SLAVE_LARB(14), 0, false, 0x0, MASTER_COMMON_PORT(0, 6)), //cam1
	DEFINE_MNODE(larb17, SLAVE_LARB(17), 0, false, 0x0, MASTER_COMMON_PORT(0, 7)), //cam3
	DEFINE_MNODE(larb19, SLAVE_LARB(19), 0, false, 0x0, MASTER_COMMON_PORT(0, 5)), //ipe
	DEFINE_MNODE(larb20, SLAVE_LARB(20), 0, false, 0x0, MASTER_COMMON_PORT(0, 5)), //ipe
	DEFINE_MNODE(larb22, SLAVE_LARB(22), 0, false, 0x1, MASTER_COMMON_PORT(0, 6)), //Virt-CCU
	DEFINE_MNODE(larb23, SLAVE_LARB(23), 0, false, 0x1, MASTER_COMMON_PORT(0, 8)), //Virt-Disp
	/* MDP COMMON */
	DEFINE_MNODE(larb2, SLAVE_LARB(2), 0, false, 0x0, MASTER_COMMON_PORT(1, 0)),   //mdp
	DEFINE_MNODE(larb3, SLAVE_LARB(3), 0, false, 0x0, MASTER_COMMON_PORT(1, 1)),   //mdp
	DEFINE_MNODE(larb4, SLAVE_LARB(4), 0, false, 0x0, MASTER_COMMON_PORT(1, 2)),   //vdec
	DEFINE_MNODE(larb8, SLAVE_LARB(8), 0, false, 0x0, MASTER_COMMON_PORT(1, 3)),   //venc
	DEFINE_MNODE(larb9, SLAVE_LARB(9), 0, false, 0x0, MASTER_COMMON_PORT(1, 4)),   //img1
	DEFINE_MNODE(larb13, SLAVE_LARB(13), 0, false, 0x0, MASTER_COMMON_PORT(1, 6)), //cam1
	DEFINE_MNODE(larb16, SLAVE_LARB(16), 0, false, 0x0, MASTER_COMMON_PORT(1, 7)), //cam2
	DEFINE_MNODE(larb18, SLAVE_LARB(18), 0, false, 0x0, MASTER_COMMON_PORT(1, 5)), //cam4
	DEFINE_MNODE(larb21, SLAVE_LARB(21), 0, true, 0x11, MASTER_COMMON_PORT(1, 6)), //Virt-CCU
	/* LARB0 */
	DEFINE_MNODE(disp_postmask0,
		MASTER_LARB_PORT(M4U_PORT_L0_DISP_POSTMASK0), 8, false, 0x1, SLAVE_LARB(0)),
	DEFINE_MNODE(mdp_rdma4,
		MASTER_LARB_PORT(M4U_PORT_L0_MDP_RDMA4), 8, false, 0x1, SLAVE_LARB(0)),
	...
	DEFINE_MNODE(mdp_rdma5,
		MASTER_LARB_PORT(M4U_PORT_L1_MDP_RDMA5), 8, false, 0x2, SLAVE_LARB(1)),
	...
	DEFINE_MNODE(mdp_rdma0,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_RDMA0), 8, false, 0x11, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_rdma2,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_RDMA2), 8, false, 0x11, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_wrot0,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_WROT0), 9, true, 0x11, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_wrot2,
		MASTER_LARB_PORT(M4U_PORT_L2_MDP_WROT2), 9, true, 0x11, SLAVE_LARB(2)),
	...
	DEFINE_MNODE(mdp_rdma1,
		MASTER_LARB_PORT(M4U_PORT_L3_MDP_RDMA1), 8, false, 0x12, SLAVE_LARB(3)),
	DEFINE_MNODE(mdp_rdma3,
		MASTER_LARB_PORT(M4U_PORT_L3_MDP_RDMA3), 8, false, 0x12, SLAVE_LARB(3)),
	DEFINE_MNODE(mdp_wrot1,
		MASTER_LARB_PORT(M4U_PORT_L3_MDP_WROT1), 9, true, 0x12, SLAVE_LARB(3)),
	DEFINE_MNODE(mdp_wrot3,
		MASTER_LARB_PORT(M4U_PORT_L3_MDP_WROT3), 9, true, 0x12, SLAVE_LARB(3)),
	...
	MASTER_LARB_PORT(M4U_PORT_L5_VDEC_UFO_ENC_EXT_DISP), 7, true, 0x2, SLAVE_LARB(5)),
	/* LARB6 */
	/* LARB7 */
	...
	/* LARB13 */
	DEFINE_MNODE(mrawi,
		MASTER_LARB_PORT(M4U_PORT_L13_CAM_MRAWI_MDP), 7, true, 0x11, SLAVE_LARB(13)),
