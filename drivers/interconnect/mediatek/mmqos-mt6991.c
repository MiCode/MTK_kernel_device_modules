...
static const struct mtk_node_desc node_descs_mt6991[] = {
	...
	DEFINE_MNODE(mdp_rdma0_stash_larb2_9,
		MASTER_LARB_PORT(SMMU_L2_P9_MDP_RDMA0_STASH),              5, true,  0x0, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_wrot0_stash_larb2_10,
		MASTER_LARB_PORT(SMMU_L2_P10_MDP_WROT0_STASH),             5, true,  0x0, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_rrot0_stash_larb2_11,
		MASTER_LARB_PORT(SMMU_L2_P11_MDP_RROT0_STASH),             5, true,  0x0, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_rdma2_stash_larb2_12,
		MASTER_LARB_PORT(SMMU_L2_P12_MDP_RDMA2_STASH),             5, true,  0x0, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_wrot2_stash_larb2_13,
		MASTER_LARB_PORT(SMMU_L2_P13_MDP_WROT2_STASH),             5, true,  0x0, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_rdma1_stash_larb2_14,
		MASTER_LARB_PORT(SMMU_L2_P14_MDP_RDMA1_STASH),             5, true,  0x0, SLAVE_LARB(2)),
	DEFINE_MNODE(mdp_wrot1_stash_larb2_15,
		MASTER_LARB_PORT(SMMU_L2_P15_MDP_WROT1_STASH),             5, true,  0x0, SLAVE_LARB(2)),
