...
static const struct mtk_node_desc node_descs_mt6899[] = {
	...
	DEFINE_MNODE(disp_ovl_rdma0_hdr_larb0_0,
		MASTER_LARB_PORT(M4U_L0_P0_OVL_RDMA0_HDR),         5, false, 0x0, SLAVE_LARB(0)),
	...
	DEFINE_MNODE(disp_ovl_rdma2_hdr_larb0_2,
		MASTER_LARB_PORT(M4U_L0_P2_OVL_RDMA2_HDR),         5, false, 0x0, SLAVE_LARB(0)),
	...
	DEFINE_MNODE(ovl_rdma1_hdr_larb20_0,
		MASTER_LARB_PORT(M4U_L20_P0_OVL_RDMA1_HDR),        5, false, 0x0, SLAVE_LARB(20)),
	...
	DEFINE_MNODE(ovl_rdma3_hdr_larb20_2,
		MASTER_LARB_PORT(M4U_L20_P2_OVL_RDMA3_HDR),        5, false, 0x0, SLAVE_LARB(20)),
	...
	DEFINE_MNODE(ovl_rdma4_hdr_larb20_4,
		MASTER_LARB_PORT(M4U_L20_P4_OVL_RDMA4_HDR),        5, false, 0x0, SLAVE_LARB(20)),
	...
	DEFINE_MNODE(disp_postmask0_larb32_0,
		MASTER_LARB_PORT(M4U_L32_P0_DISP_POSTMASK0),       7, true,  0x0, SLAVE_LARB(32)),
	DEFINE_MNODE(disp_postmask1_larb32_1,
		MASTER_LARB_PORT(M4U_L32_P1_DISP_POSTMASK1),       7, true,  0x0, SLAVE_LARB(32)),
	...
	DEFINE_MNODE(disp_mdp_rdma0_larb32_4,
		MASTER_LARB_PORT(M4U_L32_P4_DISP_MDP_RDMA0),       8, true,  0x0, SLAVE_LARB(32)),
	DEFINE_MNODE(disp_oddmr0_dmrr_larb32_5,
		MASTER_LARB_PORT(M4U_L32_P5_DISP_ODDMR0_DMRR),     7, false, 0x0, SLAVE_LARB(32)),
