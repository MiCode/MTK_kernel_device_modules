...
#include "panel-rm692h5-alpha-cmd-spr-mipichg.h"
...
static struct mtk_panel_params ext_params[MODE_NUM] = {
	...
	[FHD_72_360TE] = {
		...
		.dyn = {
			.switch_en = 1,
			.data_rate = MIPI_DATA_RATE_120HZ - 4,
		},
		.dyn_fps = {
			.switch_en = 1, .vact_timing_fps = 120,
			.data_rate = MIPI_DATA_RATE_120HZ - 4,
	...
	.dyn = {
		.switch_en = 1,
		.data_rate = MIPI_DATA_RATE_120HZ - 6,
	},
	.dyn_fps = {
		.switch_en = 1, .vact_timing_fps = 120,
		.data_rate = MIPI_DATA_RATE_120HZ - 6,
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "mt6991,rm692h5,alpha,cmd,spr,mipichg", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-rm692h5-alpha-cmd-spr-mipichg",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("MT6991 RM692H5 ALPHA CMD SPR MIPICHG Panel Driver");
MODULE_LICENSE("GPL");
