...
bool prox_lcd_reset_keep_high_2nd = false;
void set_prox_lcd_reset_gpio_keep_high_2nd(bool en)
{
	prox_lcd_reset_keep_high_2nd = en;
}
EXPORT_SYMBOL(set_prox_lcd_reset_gpio_keep_high_2nd);
...
#define LCM_DRIVER_NAME "dsi_panel_p15a_46_03_0b_dsc_vdo"
static const char *panel_info = "panel_name=dsi_panel_p15a_46_03_0b_dsc_vdo";
...
static struct LCM_setting_table init_setting[] = {
	...
	{0x00,1,{0x00}},
	{0x2B,4,{0x00,0x00,0x06,0x3F}},//1640
	...
	{0x00,1,{0x80}},
	{0xCA,12,{0xEB,0xD6,0xC5,0xB8,0xAE,0xA5,0x9D,0x97,0x92,0x8C,0x88,0x84}},
	{0x00,1,{0x90}},
	{0xCA,9,{0xFE,0xFF,0x3C,0xFA,0xFF,0x8E,0xFA,0xFF,0x8E}},
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	if (prox_lcd_reset_keep_high_2nd && esd_panel_dead == false) {
		pr_info("[LCM]:prox_lcd_reset_keep_high_2nd = %d\n",prox_lcd_reset_keep_high_2nd);
		pr_info("[LCM]%s:tp_promixity_en\n",__func__);
	return 0;
	}

	if (fts_gesture_flag && (esd_panel_dead == false)) {
...
#define NORMAL_MAX_REG	2760	//noraml段最高寄存器亮度值
#define HBM_MAX_REG	3488	//hbm段最高寄存器亮度值
	...
	void *handle, unsigned int level)
{
	...
	pr_info("HKC %s,brightness 0x%02x level %d\n", __func__, level, brightness);
