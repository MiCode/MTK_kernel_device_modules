...
/* P16 code for HQFEAT-95341 by p-zhangyundan at 2025/3/18 start */
#include <linux/hqsysfs.h>
/* P16 code for HQFEAT-95341 by p-zhangyundan at 2025/3/18 end */
...
/* P16 code for HQFEAT-94423 by p-zhangyundan at 2025/3/11 end */
static const char *panel_name = "panel_name=dsi_p16_42_02_0a_dsc_vdo";
/* P16 code for HQFEAT-94432 by p-liaoxianguo at 2025/3/27 start */
/* P16 code for HQFEAT-93915 by p-zhangyundan at 2025/4/2 start */
#define GIR_ENABLE 1
#define GIR_DISABLE 0
/* P16 code for HQFEAT-93915 by p-zhangyundan at 2025/4/2 end */
#define BACKLIGHT_MIN_LEVEL 15
bool nvt_gesture_flag_csot = false;
void set_nvt_gesture_flag(bool en)
{
	nvt_gesture_flag_csot = en;
}
EXPORT_SYMBOL(set_nvt_gesture_flag);
...
/* P16 code for HQFEAT-94425 by p-zhangyundan at 2025/3/27 start */
...
static struct LCM_setting_table local_hbm_normal_white_200nit[] = {
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x02}},
	{0xBF, 02, {0x00, 0x0B}},
	{0xD1, 06, {0x1A, 0xE0, 0x19, 0x68, 0x20, 0x00}},
	{0x6F, 01, {0x01}},
	{0x8B, 01, {0x01}},
	{0x87, 01, {0x25}},
	{0x51, 02, {0x33, 0x90}},
...
/* P16 code for HQFEAT-89044 by p-zhangyundan at 2025/4/27 end */
	...
	//--CUR_DBV_TH_1~5 = 0,  0,  11558,  13200,  16383
	...
	lcm_dcs_write_seq_static(ctx, 0x55, 0x04);//00-acl off,04-1000nit,05-1800nit
#endif
	//OD ON
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x08);
	lcm_dcs_write_seq_static(ctx, 0xE0, 0x41);
	...
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xDF, 0x21, 0x54);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x63);
	lcm_dcs_write_seq_static(ctx, 0xB2, 0x00, 0x00, 0x04, 0x37);
	...
	lcm_dcs_write_seq_static(ctx, 0xFC, 0x10);
	...
	lcm_dcs_write_seq_static(ctx, 0xA3, 0x81, 0x84, 0x38, 0x2A, 0xAE);
	//aod red
	lcm_dcs_write_seq_static(ctx, 0xF0, 0x55, 0xAA, 0x52, 0x08, 0x01);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x09);
	...
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x22, 0x10);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x02);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x23, 0x3D, 0x00, 0x23, 0x3C, 0x00, 0x23, 0x3D, 0x00, 0x23, 0x3D);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x0E);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x23, 0x3D);
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x11);
	lcm_dcs_write_seq_static(ctx, 0xBC, 0x00, 0x00, 0x68, 0x68, 0x10, 0x00, 0x68, 0x68, 0x68, 0x01);
	//MTP Flash lock
	...
	lcm_dcs_write_seq_static(ctx, 0x6F, 0x04);
	lcm_dcs_write_seq_static(ctx, 0x51, 0x3F, 0xFF);
...
/* p16 code for HQFEAT-90247 by p-zhangyundan at 2025/2/27 start */
#define HFP (104)
#define HSA (4)
#define HBP (20)
#define VFP (56)
...
/* p16 code for HQFEAT-90247 by p-zhangyundan at 2025/2/27 end */
#if defined(CONFIG_MTK_PANEL_EXT)
	...
	void *handle, unsigned int level)
{
	...
	pr_info(" %s start \n", __func__);
/* P16 code for HQFEAT-94083 by p-zhangyundan at 2025/4/8 start */
	if ((0 < level) && (level < BACKLIGHT_MIN_LEVEL))
		level = BACKLIGHT_MIN_LEVEL;
/* P16 code for HQFEAT-94083 by p-zhangyundan at 2025/4/8 end */
	if (level) {
...
/* P16 code for HQFEAT-94083 by p-zhangyundan at 2025/4/13 start */
	if (level == last_bl_level) {
		pr_info("%s:backlight is same, return\n", __func__);
		return 0;
	}
...
static struct mtk_panel_params ext_params = {
	...
	.dyn_fps = {
		...
		.dfps_cmd_table[2] = {0, 25, {0xA9, 0x02, 0x01, 0xB9, 0x1E, 0x1E, 0xB8, 0x01, 0x00, 0xA2, 0x00, 0x06, 0x75, 0x02, 0x01, 0xB9, 0x1E, 0x1E, 0xC2, 0x01, 0x00, 0x2F, 0x00, 0x00, 0x02}},
		.dfps_cmd_table[3] = {0, 6, {0xF0, 0x55, 0xAA, 0x52, 0x08, 0x0A}},
		.dfps_cmd_table[4] = {0, 2, {0x6F, 0x03}},
		.dfps_cmd_table[5] = {0, 2, {0xD0, 0x71}},
...
static struct mtk_panel_params ext_params_mode_3 = {
	...
	.dyn_fps = {
		...
		.dfps_cmd_table[1] = {0, 3, {0x51, 0x3F,0xFF}},
				   ...
				   unsigned int mode)
{
	...
	if (drm_mode_vrefresh(m) == MODE_0_FPS) {
		...
		if (ctx->doze_brightness == DOZE_BRIGHTNESS_HBM) {
			ext_params_mode_3.dyn_fps.dfps_cmd_table[1].para_list[1] = 0x3F;
			ext_params_mode_3.dyn_fps.dfps_cmd_table[1].para_list[2] = 0xFF;
		} else if (ctx->doze_brightness == DOZE_BRIGHTNESS_LBM) {
			ext_params_mode_3.dyn_fps.dfps_cmd_table[1].para_list[1] = 0x05;
...
static const int lhbm_white_high_ratio[27] = {
	1220, 1215, 1210, 1205, 1195,
	1185, 1175, 1165, 1155, 1145,
	1135, 1125, 1115, 1105, 1095,
	1090, 1080, 1070, 1060, 1055,
	1045, 1035, 1030, 1020, 1015,
	1005, 1000
};
static const int lhbm_white_low_ratio[27] = {
	1215, 1210, 1205, 1200, 1190,
	1180, 1170, 1160, 1150, 1140,
	1130, 1120, 1110, 1100, 1090,
	1085, 1075, 1065, 1055, 1050,
	1040, 1030, 1025, 1015, 1010,
	1000, 995
};
enum lhbm_cmd_type {
	TYPE_WHITE_1200 = 0,
...
static int mi_disp_panel_update_lhbm_reg(struct drm_panel *panel, enum lhbm_cmd_type type, int bl_lvl)
{
	...
	case TYPE_WHITE_1200:
		local_hbm_first_cmd[2].para_list[0] = 0x10;
	break;
	case TYPE_WHITE_200:
		local_hbm_first_cmd[2].para_list[0] = 0x06;
	break;
	...
	switch (type) {
	case TYPE_WHITE_1200:
		tempr = ((datar[0] << 8) | datar[1]) * lhbm_white_high_ratio[bl_index] * 4 / 1000;
		tempg = ((datag[0] << 8) | datag[1]) * lhbm_white_high_ratio[bl_index] * 4 / 1000;
		tempb = ((datab[0] << 8) | datab[1]) * lhbm_white_high_ratio[bl_index] * 4 / 1000;
		local_hbm_normal_white_1200nit[2].para_list[0] = (tempr >> 8) & 0xff;
		local_hbm_normal_white_1200nit[2].para_list[1] = tempr & 0xFF;
		local_hbm_normal_white_1200nit[2].para_list[2] = (tempg >> 8) & 0xff;
		local_hbm_normal_white_1200nit[2].para_list[3] = tempg & 0xFF;
		local_hbm_normal_white_1200nit[2].para_list[4] = (tempb >> 8) & 0xff;
		local_hbm_normal_white_1200nit[2].para_list[5] = tempb & 0xFF;
		local_hbm_normal_white_1200nit[6].para_list[0] = (bl_lvl >> 8) & 0xff;
		local_hbm_normal_white_1200nit[6].para_list[1] = bl_lvl & 0xFF;
		break;
	case TYPE_WHITE_200:
		tempr = ((datar[0] << 8) | datar[1]) * lhbm_white_low_ratio[bl_index] * 4 / 1000;
		tempg = ((datag[0] << 8) | datag[1]) * lhbm_white_low_ratio[bl_index] * 4 / 1000;
		tempb = ((datab[0] << 8) | datab[1]) * lhbm_white_low_ratio[bl_index] * 4 / 1000;
		local_hbm_normal_white_200nit[2].para_list[0] = (tempr >> 8) & 0xff;
		local_hbm_normal_white_200nit[2].para_list[1] = tempr & 0xFF;
		local_hbm_normal_white_200nit[2].para_list[2] = (tempg >> 8) & 0xff;
		local_hbm_normal_white_200nit[2].para_list[3] = tempg & 0xFF;
		local_hbm_normal_white_200nit[2].para_list[4] = (tempb >> 8) & 0xff;
		local_hbm_normal_white_200nit[2].para_list[5] = tempb & 0xFF;
		local_hbm_normal_white_200nit[6].para_list[0] = (bl_lvl >> 8) & 0xff;
		local_hbm_normal_white_200nit[6].para_list[1] = bl_lvl & 0xFF;
		break;
	case TYPE_LHBM_OFF:
		break;
	default:
...
/* P16 code for HQFEAT-94425 by p-zhangyundan at 2025/3/27 end */
...
/* P16 code for HQFEAT-94423 by p-zhangyundan at 2025/3/11 end */
/* p16 code for HQFEAT-93998 by p-zhangyundan at 2023/3/25 start */
...
/* p16 code for HQFEAT-93998 by p-zhangyundan at 2023/3/25 end */
...
/* P16 code for HQFEAT-89531 by p-zhangyundan at 2025/3/31 end */
	...
	/* P16 code for HQFEAT-93915 by p-zhangyundan at 2025/4/2 start */
	ctx->gir_status = GIR_ENABLE;
	/* P16 code for HQFEAT-93915 by p-zhangyundan at 2025/3/18 end */
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-p16-42-02-0a-dsc-vdo",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("panel-p16-42-02-0a-dsc-vdo Panel Driver");
