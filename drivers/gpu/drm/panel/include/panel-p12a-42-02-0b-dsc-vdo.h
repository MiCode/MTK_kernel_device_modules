...
#ifndef _PANEL_P12A_42_02_0B_DSC_VDO_H_
#define _PANEL_P12A_42_02_0B_DSC_VDO_H_
...
#include "mi_panel_ext.h"
  ...
  #define REG_DISPLAY_MODE_CTRL  0x2F
  #define MODE_120HZ_30HZ        0x00
  #define MODE_90HZ              0x01
  #define MODE_60HZ              0x02
...
#define CSC_LEVEL_LOW           25
#define CSC_LEVEL_HEIGHT        40
// Notice start
...
static const char *panel_name = "panel_name=dsi_p12a_42_02_0b_dsc_vdo";
...
#define FHD_HFP_90            (21)
#define FHD_HSA_90            (70)
...
static struct LCM_setting_table init_setting_vdo[] = {
	...
	{0x6F, 1, {0x1B}},
	{0xF4, 1, {0x04}},
	{0x88, 5, {0x01,0x02,0x7B,0x09,0xCA}},
	...
	{0xF0, 5, {0x55,0xAA,0x52,0x08,0x03}},
	{0xB6, 1, {0x33 }},
		//LHBM dataremapping ratio
	{0xF0, 5, {0x55,0xAA,0x52,0x08,0x00}},
	{0x6F, 1, {0x70}},
	{0xB4, 20, {0x00,0x00,0x0B,0xF7,0x10,0x65,0x17,0x09,0x21,0x4B,0x31,0xB3,0x3F,0xDC,0x3F,0x3F,0x3F,0xFF,0x3F,0xFF}},
...
static struct LCM_setting_table elvss_level_0[] = {
	...
	{0xBB, 01, {0x01}},
	{0x6F, 01, {0x44}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x28, 0x3C, 0xCC, 0xCC}},
	{0x6F, 01, {0x55}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x28, 0x3C, 0xCC, 0xCC}},
	{0xBB, 01, {0x00}},
};
...
static struct LCM_setting_table elvss_level_1[] = {
	...
	{0xBB, 01, {0x01}},
	{0x6F, 01, {0x44}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x1E, 0x3C, 0xCC, 0xCC}},
	{0x6F, 01, {0x55}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x1E, 0x3C, 0xCC, 0xCC}},
	{0xBB, 01, {0x00}},
};
...
static struct LCM_setting_table elvss_level_2[] = {
	...
	{0xBB, 01, {0x01}},
	{0x6F, 01, {0x44}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x14, 0x3C, 0xCC, 0xCC}},
	{0x6F, 01, {0x55}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x14, 0x3C, 0xCC, 0xCC}},
	{0xBB, 01, {0x00}},
};
...
static struct LCM_setting_table elvss_level_3[] = {
	...
	{0xBB, 01, {0x01}},
	{0x6F, 01, {0x44}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x0A, 0x3C, 0xCC, 0xCC}},
	{0x6F, 01, {0x55}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x0A, 0x3C, 0xCC, 0xCC}},
	{0xBB, 01, {0x00}},
};
...
static struct LCM_setting_table elvss_level_4[] = {
	...
	{0xBB, 01, {0x01}},
	{0x6F, 01, {0x44}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x00, 0x3C, 0xCC, 0xCC}},
	{0x6F, 01, {0x55}},
	{0xC1, 17, {0xAB, 0xAA, 0xEA, 0x03, 0xCC, 0x14, 0x14, 0x14, 0x14, 0x14, 0x14, 0x00, 0x00, 0x00, 0x3C, 0xCC, 0xCC}},
	{0xBB, 01, {0x00}},
};
...
static struct LCM_setting_table lhbm_normal_white_1200nit[] = {
	...
	{0x8B, 01, {0x01}},
	{0x87, 01, {0x25}},
	{0xA9, 18, {0x01,0x00,0x38,0x00,0x00,0x00,0x01,0x00,0x8B,0x01,
	            0x01,0x01,0x01,0x00,0x87,0x00,0x00,0x25}},
	/*gamma value*/
...
static struct LCM_setting_table svm_120hz[] = {
	{0xF0, 5, {0x55,0xAA,0x52,0x08,0x01}},
	{0x6F, 1, {0xE4}},
	{0xE5, 6, {0xFF,0xFF,0xA5,0x4C,0x35,0x19}},
	{0x6F, 1, {0x02}},
	{0xE5, 5, {0x04,0x3C,0x20,0x04,0x00}},
	{0x6F, 1, {0x22}},
	{0xE5, 1, {0x14}},
	{0x6F, 1, {0x50}},
...
static struct LCM_setting_table svm_90hz[] = {
	{0xF0, 5, {0x55,0xAA,0x52,0x08,0x01}},
	{0x6F, 1, {0xE4}},
	{0xE5, 6, {0xFF,0xFF,0x99,0x4C,0x3F,0x19}},
	{0x6F, 1, {0x02}},
	{0xE5, 5, {0x04,0x3C,0x20,0x08,0x00}},
	{0x6F, 1, {0x22}},
	{0xE5, 1, {0x18}},
	{0x6F, 1, {0x50}},
	{0xE7, 3, {0x00,0x00,0x00}},
...
static struct LCM_setting_table svm_60hz[] = {
	{0xF0, 5, {0x55,0xAA,0x52,0x08,0x01}},
	{0x6F, 1, {0xE4}},
	{0xE5, 6, {0xFF,0xFF,0x8C,0x38,0x33,0x19}},
	{0x6F, 1, {0x02}},
	{0xE5, 5, {0x04,0x3C,0x34,0x10,0x04}},
	{0x6F, 1, {0x22}},
	{0xE5, 1, {0x18}},
	{0x6F, 1, {0x50}},
	{0xE7, 3, {0x00,0x00,0x08}},
	{0x6F, 1, {0x5C}},
	{0xE7, 1, {0x00}},
};
...
static unsigned int lhbm_ratio[43][3] = {
	//DBV  1200nit ratio 250nit ratio
	{1180, 1150, 0x002A},
	{1180, 1150, 0x0068},
	{1180, 1150, 0x00F7},
	{1180, 1150, 0x0269},
...
#endif // end of _PANEL_P12A_42_02_0B_DSC_VDO_H_
