...
static const int panel_id = PANEL_2SD;
...
static struct LCM_setting_table init_setting[] = {
	...
	{0xBE, 04, {0x47,0x46,0x4A,0x4F}},
	{0x6F, 01, {0x11}},
	{0xBE, 01, {0x00}},
	{0xBF, 01, {0x0F}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x03}},
	{0x6F, 01, {0x01}},
	{0xB2, 03, {0x00,0x00,0x00}},
	{0x6F, 01, {0x08}},
	{0xB2, 03, {0x00,0x00,0x00}},
	{0x6F, 01, {0x0B}},
	{0xB2, 03, {0x00,0x00,0x00}},
	...
	{0xB0, 03, {0x83,0x27,0x01}},
	{0xB5, 02, {0x06,0x02}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x03}},
	{0xC3, 06, {0x20,0x02,0x22,0x22,0x22,0x22}},
	{0x6F, 01, {0x06}},
	{0xC3, 06, {0x20,0x02,0x22,0x22,0x22,0x22}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x05}},
	{0xC7, 02, {0x07,0x12}},
	...
	{0x6F, 01, {0x34}},
	{0xDF, 01, {0x10}},	/* SGM3838 */
	{0x6F, 01, {0x36}},
	{0xDF, 01, {0x00}},
	{0x6F, 01, {0x37}},
    {0xDF, 03, {0x00,0x00,0x18}},
	{0x6F, 01, {0x3A}},
    {0xDF, 06, {0x00,0x18,0x00,0x18,0x00,0x18}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x01}},
	{0xDE, 01, {0x10}},
	{0x6F, 01, {0x02}},
	{0xDE, 01, {0x10}},
	{0x6F, 01, {0x06}},
	{0xDE, 04, {0x00,0x0E,0x00,0x00}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x07}},
	{0xC0, 03, {0x07,0x01,0xF8}},
	{0x6F, 01, {0x03}},
	{0xC0, 04, {0x00,0x0F,0x00,0x00}},
	...
	{0x6F, 01, {0x25}},
	{0xC9, 07, {0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	...
	{0x6F, 01, {0x25}},
	{0xCA, 07, {0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	...
	{0x6F, 01, {0x25}},
	{0xCB, 07, {0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	...
	{0x6F, 01, {0x25}},
	{0xCC, 07, {0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x08}},
	{0x6F, 01, {0x4A}},
	{0xB8, 02, {0x00,0x00}},
	{0x6F, 01, {0x4C}},
	...
	/* Video trim */
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x01}},
	{0xC3, 41, {0xDD, 0x06, 0x20, 0x12, 0xFF, 0x00,
                0x06, 0x20, 0x12, 0xFF, 0x00, 0x06,
                0x3A, 0x20, 0x06, 0x29, 0x19, 0x06,
                0x34, 0x20, 0x06, 0x29, 0x19, 0x06,
                0x30, 0x20, 0x06, 0x29, 0x19, 0x06,
                0x34, 0x20, 0x06, 0x29, 0x19, 0x06,
                0x2C, 0x20, 0x06, 0x29, 0x19}},
...
/* init code for CNP1 */
static struct LCM_setting_table init_setting_p1[] = {
	/* LVD ON*/
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
	{0x6F, 01, {0x03}},
	{0xC7, 01, {0x47}},
	...
	/* FPR off*/
	{0x87, 01, {0x24}},
	/* Source porch Keep last line */
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x00}},
	{0xC5, 03, {0x44, 0x44, 0x00}},
	/* Enter AOD extend porch & AOD power PMIC */
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
	{0x6F, 01, {0x0E}},
	{0xD2, 05, {0x03, 0x00, 0x00, 0x0A, 0xC0}},
	{0x65, 01, {0x00}},
	/* chopper */
	{0xFF, 04, {0xAA,0x55,0xA5,0x80}},
    {0x6F, 01, {0x2A}},
...
/* init code for CNP2, CNMP */
static struct LCM_setting_table init_setting_p2[] = {
	/* LVD ON*/
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
	{0x6F, 01, {0x03}},
	{0xC7, 01, {0x47}},
	...
	{0xDF, 24, {0x00,0x6A,0x00,0x6A,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xD3,0x00,0xD3,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x6F, 01, {0x34}},
	{0xDF, 01, {0x10}},/*0x16 for SC6010,0x10 for SGM3838*/
	{0x6F, 01, {0x36}},
	{0xDF, 01, {0x00}},
	{0x6F, 01, {0x37}},
	{0xDF, 03, {0x00,0x00,0x18}},
...
static struct LCM_setting_table init_setting_GL[] = {
	...
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x00}},
	{0x6F, 01, {0x07}},
	{0xB5, 04, {0x00, 0x2B, 0x00, 0x00}},
	{0x6F, 01, {0x0C}},
	{0xB5, 04, {0x00, 0x2A, 0x00, 0x00}},
	{0x6F, 01, {0x11}},
	{0xB5, 05, {0x2B, 0x2B, 0x2B, 0x2B, 0x2B}},
	{0x6F, 01, {0x18}},
	{0xB5, 02, {0x09, 0x19}},
	{0x6F, 01, {0x1D}},
	{0xB5, 02, {0x09, 0x19}},
...
/* init code for GLP1 */
static struct LCM_setting_table init_setting_GL_p1[] = {
	/* LVD ON*/
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
	{0x6F, 01, {0x03}},
	{0xC7, 01, {0x47}},
...
/* init code for GLP2 */
static struct LCM_setting_table init_setting_GL_p2[] = {
	/* LVD ON*/
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
	{0x6F, 01, {0x03}},
	{0xC7, 01, {0x47}},
	...
	{0xDF, 24, {0x00,0x6A,0x00,0x6A,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xD3,0x00,0xD3,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},
	{0x6F, 01, {0x34}},
	{0xDF, 01, {0x16}},/*0x16 for SC6010,0x10 for SGM3838*/
	{0x6F, 01, {0x36}},
	{0xDF, 01, {0x00}},
	{0x6F, 01, {0x37}},
	{0xDF, 03, {0x00,0x00,0x18}},
...
/* init code for GLMP */
static struct LCM_setting_table init_setting_GL_mp[] = {
	/* LVD ON*/
	{0xF0, 05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
	{0x6F, 01, {0x03}},
	{0xC7, 01, {0x47}},
...
/* mode switch start */
/*mode switch code for p0 and P1*/
...
/*mode switch code for p2 and mp*/
...
/* lhbm cmd start */
static struct LCM_setting_table lhbm_lut_init[] = {
	/* LHBM LUT */
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x00}},
	{0x6F, 01, {0x33}},
	{0xC0, 03, {0x04,0x44,0x44}},
	{0x6F, 01, {0x01}},
	{0xC7, 01, {0x04}},
	{0xF0, 05, {0x55,0xAA,0x52,0x08,0x04}},
	{0xCB, 01, {0x36}},
	{0x6F, 01, {0x5A}},
	{0xD4, 06, {0x0F,0x0F,0x0f,0x15,0x12,0x08}},
	{0x6F, 01, {0x60}},
	{0xD4, 06, {0x1A,0x1A,0x1a,0x1f,0x15,0x13}},
	{0x6F, 01, {0x66}},
	{0xD4, 06, {0x25,0x25,0x25,0x23,0x29,0x30}},
	{0x6F, 01, {0x6C}},
	{0xD4, 06, {0x79,0x79,0x79,0x79,0x85,0x52}},
	{0x6F, 01, {0x72}},
	{0xD4, 06, {0x79,0x79,0x79,0x83,0x65,0x00}},
	{0x6F, 01, {0x78}},
	{0xD4, 06, {0x0F,0x0F,0x0f,0x15,0x12,0x08}},
	{0x6F, 01, {0x7E}},
	{0xD4, 06, {0x1A,0x1A,0x1a,0x1f,0x15,0x13}},
	...
	{0xD4, 06, {0x79,0x79,0x79,0x79,0x85,0x52}},
	{0x6F, 01, {0x90}},
	{0xD4, 06, {0x79,0x79,0x79,0x83,0x65,0x02}},
	{0x6F, 01, {0x96}},
	{0xD4, 06, {0x0F,0x0F,0x0f,0x15,0x12,0x08}},
	{0x6F, 01, {0x9C}},
	{0xD4, 06, {0x1A,0x1A,0x1a,0x1f,0x15,0x13}},
...
static struct LCM_setting_table doze_enable_h[] = {
	{0x2F, 01, {0x01}},
	{0x51, 06, {0x07, 0xFF, 0x07, 0xFF, 0x0F, 0xFF}},
	{0x39, 01, {0x00}},
};
static struct LCM_setting_table doze_enable_l[] = {
	{0x2F, 01, {0x01}},
	{0x51, 06, {0x07, 0xFF, 0x07, 0xFF, 0x07, 0xFC}},
	{0x39, 01, {0x00}},
};
...
static struct LCM_setting_table backlight_h[] = {
	{0x51, 06, {0x04, 0x00, 0x04, 0x00, 0x0F, 0xFF}},
};
static struct LCM_setting_table backlight_l[] = {
	{0x51, 06, {0x00, 0x3D, 0x00, 0x3D, 0x07, 0xFC}},
};
...
static struct LCM_setting_table cmd_set_osc_tricking_on_1_12_G[] = {
        {0xF0, 0x05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
        {0xC3, 0x29, {0xDD, 0x06, 0x20, 0x12, 0xFF, 0x00, 0x06, 0x20, 0x12, 0xFF, 0x00, 0x06, 0x3A, 0x20, 0x06, 0x29, 0x19, 0x06, 0x34, 0x20, 0x06, 0x29, 0x19, 0x06, 0x30, 0x20, 0x06, 0x29, 0x19, 0x06, 0x34, 0x20, 0x06, 0x29, 0x19, 0x06, 0x2C, 0x20, 0x06, 0x29, 0x19}},
};
static struct LCM_setting_table cmd_set_osc_tricking_on_1_487_G[] = {
        {0xF0, 0x05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
        {0xC3, 0x29, {0xDD, 0x06, 0x20, 0x17, 0xFF, 0x00, 0x06, 0x20, 0x17, 0xFF, 0x00, 0x06, 0x22, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x20, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x1A, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x20, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x1A, 0x2A, 0x06, 0x20, 0x21}},
};
//close tricking
...
static struct LCM_setting_table cmd_set_osc_tricking_off_1_12_G[] = {
        {0xF0, 0x05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
        {0xC3, 0x29, {0xDD, 0x06, 0x20, 0x12, 0x00, 0x00, 0x06, 0x20, 0x12, 0x00, 0x00, 0x06, 0x3A, 0x20, 0x06, 0x29, 0x19, 0x06, 0x34, 0x20, 0x06, 0x29, 0x19, 0x06, 0x30, 0x20, 0x06, 0x29, 0x19, 0x06, 0x34, 0x20, 0x06, 0x29, 0x19, 0x06, 0x2C, 0x20, 0x06, 0x29, 0x19}},
};
static struct LCM_setting_table cmd_set_osc_tricking_off_1_487_G[] = {
        {0xF0, 0x05, {0x55, 0xAA, 0x52, 0x08, 0x01}},
        {0xC3, 0x29, {0xDD, 0x06, 0x20, 0x17, 0x00, 0x00, 0x06, 0x20, 0x17, 0x00, 0x00, 0x06, 0x22, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x20, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x1A, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x20, 0x2A, 0x06, 0x20, 0x21, 0x06, 0x1A, 0x2A, 0x06, 0x20, 0x21}},
};
#endif
