...
#define FHD_VFP_120        (47)
#define FHD_VFP_90         (878)
#define FHD_VFP_60         (2526)
#define FHD_VSA            (10)
#define FHD_VBP            (10)
...
#define HD_VFP_120        (47)
#define HD_VFP_90         (878)
#define HD_VFP_60         (2526)
#define HD_VSA            (10)
#define HD_VBP            (10)
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ jdi,nt36672e,vdo,120hz,frameratev5\n", __func__);
...
static const struct of_device_id jdi_of_match[] = {
	{
	    .compatible = "jdi,nt36672e,vdo,120hz,frameratev5",
	},
	{}
};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "panel-jdi-nt36672e-vdo-120hz-frameratev5",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("JDI NT36672E VDO 120HZ Frameratev5 AMOLED Panel Driver");
MODULE_LICENSE("GPL");
