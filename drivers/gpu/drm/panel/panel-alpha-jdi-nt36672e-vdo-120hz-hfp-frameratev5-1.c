...
#define FHD_HFP_120        (154)
#define FHD_HFP_90         (350)
#define FHD_HFP_60         (750)
#define FHD_HSA            (16)
#define FHD_HBP            (80)
#define FHD_HTOTAL_120     (FHD_FRAME_WIDTH + FHD_HFP_120 + FHD_HSA + FHD_HBP)
#define FHD_HTOTAL_90      (FHD_FRAME_WIDTH + FHD_HFP_90 + FHD_HSA + FHD_HBP)
#define FHD_HTOTAL_60      (FHD_FRAME_WIDTH + FHD_HFP_60 + FHD_HSA + FHD_HBP)
#define FHD_FRAME_HEIGHT   (2400)
#define FHD_VFP_120        (88)
#define FHD_VFP_90         (88)
#define FHD_VFP_60         (88)
#define FHD_VSA            (10)
#define FHD_VBP            (10)
...
#define FHD_FRAME_TOTAL_120 (FHD_VTOTAL_120 * FHD_HTOTAL_120)
#define FHD_FRAME_TOTAL_90  (FHD_VTOTAL_90 * FHD_HTOTAL_90)
#define FHD_FRAME_TOTAL_60  (FHD_VTOTAL_60 * FHD_HTOTAL_60)
...
#define HD_HFP_120        (154)
#define HD_HFP_90         (350)
#define HD_HFP_60         (750)
#define HD_HSA            (12)
#define HD_HBP            (80)
#define HD_HTOTAL_120     (HD_FRAME_WIDTH + HD_HFP_120 + HD_HSA + HD_HBP)
#define HD_HTOTAL_90      (HD_FRAME_WIDTH + HD_HFP_90 + HD_HSA + HD_HBP)
#define HD_HTOTAL_60      (HD_FRAME_WIDTH + HD_HFP_60 + HD_HSA + HD_HBP)
...
#define HD_FRAME_TOTAL_120 (HD_VTOTAL_120 * HD_HTOTAL_120)
#define HD_FRAME_TOTAL_90  (HD_VTOTAL_90 * HD_HTOTAL_90)
#define HD_FRAME_TOTAL_60  (HD_VTOTAL_60 * HD_HTOTAL_60)
...
static const struct drm_display_mode default_mode = {
	...
	.hsync_end = FHD_FRAME_WIDTH + FHD_HFP_60 + FHD_HSA,//HSA
	.htotal = FHD_FRAME_WIDTH + FHD_HFP_60 + FHD_HSA + FHD_HBP,//HBP
	.vdisplay = FHD_FRAME_HEIGHT,
	.vsync_start = FHD_FRAME_HEIGHT + FHD_VFP_60,//VFP
	.vsync_end = FHD_FRAME_HEIGHT + FHD_VFP_60 + FHD_VSA,//VSA
	.vtotal = FHD_FRAME_HEIGHT + FHD_VFP_60 + FHD_VSA + FHD_VBP,//VBP
};
...
static const struct drm_display_mode performance_mode_90hz = {
	...
	.hsync_end = FHD_FRAME_WIDTH + FHD_HFP_90 + FHD_HSA,//HSA
	.htotal = FHD_FRAME_WIDTH + FHD_HFP_90 + FHD_HSA + FHD_HBP,//HBP
	.vdisplay = FHD_FRAME_HEIGHT,
	.vsync_start = FHD_FRAME_HEIGHT + FHD_VFP_90,//VFP
	.vsync_end = FHD_FRAME_HEIGHT + FHD_VFP_90 + FHD_VSA,//VSA
	.vtotal = FHD_FRAME_HEIGHT + FHD_VFP_90 + FHD_VSA + FHD_VBP,//VBP
};
...
static const struct drm_display_mode performance_mode_120hz = {
	...
	.hsync_end = FHD_FRAME_WIDTH + FHD_HFP_120 + FHD_HSA,//HSA
	.htotal = FHD_FRAME_WIDTH + FHD_HFP_120 + FHD_HSA + FHD_HBP,//HBP
	.vdisplay = FHD_FRAME_HEIGHT,
	.vsync_start = FHD_FRAME_HEIGHT + FHD_VFP_120,//VFP
	.vsync_end = FHD_FRAME_HEIGHT + FHD_VFP_120 + FHD_VSA,//VSA
	.vtotal = FHD_FRAME_HEIGHT + FHD_VFP_120 + FHD_VSA + FHD_VBP,//VBP
};

static const struct drm_display_mode hd_mode_60 = {
	.clock = HD_CLK_60,
	.hdisplay = HD_FRAME_WIDTH,
	.hsync_start = HD_FRAME_WIDTH + HD_HFP_60,
	.hsync_end = HD_FRAME_WIDTH + HD_HFP_60 + HD_HSA,
	.htotal = HD_FRAME_WIDTH + HD_HFP_60 + HD_HSA + HD_HBP,
...
static const struct drm_display_mode hd_mode_90 = {
	.clock = HD_CLK_90,
	.hdisplay = HD_FRAME_WIDTH,
	.hsync_start = HD_FRAME_WIDTH + HD_HFP_90,
	.hsync_end = HD_FRAME_WIDTH + HD_HFP_90 + HD_HSA,
	.htotal = HD_FRAME_WIDTH + HD_HFP_90 + HD_HSA + HD_HBP,
	.vdisplay = HD_FRAME_HEIGHT,
...
static const struct drm_display_mode hd_mode_120 = {
	.clock = HD_CLK_120,
	.hdisplay = HD_FRAME_WIDTH,
	.hsync_start = HD_FRAME_WIDTH + HD_HFP_120,
	.hsync_end = HD_FRAME_WIDTH + HD_HFP_120 + HD_HSA,
	.htotal = HD_FRAME_WIDTH + HD_HFP_120 + HD_HSA + HD_HBP,
	.vdisplay = HD_FRAME_HEIGHT,
			...
			struct mtk_dsi_cmd_option *cmd_opt)
{
	...
	pr_info("%s nt36672e-vdo-hfp-frameratev5-1 ++, fps = %d\n", __func__, current_fps);
...
static int lcm_panel_init(struct drm_panel *panel)
{
	...
	pr_info("%s nt36672e-vdo-hfp-frameratev5-1 ++\n", __func__);
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ jdi,nt36672e,vdo,120hz,hfp,frameratev5-1\n", __func__);
...
static const struct of_device_id jdi_of_match[] = {
	{
	    .compatible = "jdi,nt36672e,vdo,120hz,hfp,frameratev5-1",
	},
	{}
};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "panel-jdi-nt36672e-vdo-120hz-hfp-frameratev5-1",
		.owner = THIS_MODULE,
...
MODULE_AUTHOR("shang zhou <shang.zhou@mediatek.com>");
MODULE_DESCRIPTION("JDI NT36672E VDO 120HZ HFP Frameratev5-1 AMOLED Panel Driver");
MODULE_LICENSE("GPL");
