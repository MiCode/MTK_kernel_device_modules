...
#endif
#include "include/panel_p10_42_02_0b_alpha_data.h"
#include "include/panel-p10-42-02-0b-dsc-vdo.h"
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	if (panel_build_id <= PANEL_BUILD_ID_P20) {
		push_table(ctx, od_config, sizeof(od_config) / sizeof(struct LCM_setting_table));
	}
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s p10-42-02-0b-dsc-vdo -\n", __func__);
	return ret;
}
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "p10_42_02_0b_dsc_vdo,lcm", },
	{ }
};
...
MODULE_DESCRIPTION("p10_42_02_0b_dsc_vdo oled panel driver");
