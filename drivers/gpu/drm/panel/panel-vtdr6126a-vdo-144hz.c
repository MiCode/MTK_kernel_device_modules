...
static int g_lcm_fresh_mode = MODE_0_FPS; //default 144hz
		...
		unsigned int dst_mode, enum MTK_PANEL_MODE_SWITCH_STAGE stage)
{
	...
	if (drm_mode_vrefresh(m) == MODE_0_FPS)
		cmd_table_set_fps[0].para_list[0] = 0x00; //144Hz
	else
		ret = 1;
			...
			struct mtk_dsi_cmd_option *cmd_opt)
{
	...
	pr_info("%s vtdr6126a-vdo-144hz ++, fps = %d\n", __func__, g_lcm_fresh_mode);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "vtdr6126a,vdo,144hz", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.driver = {
		.name = "panel-vtdr6126a-vdo-144hz",
		.owner = THIS_MODULE,
