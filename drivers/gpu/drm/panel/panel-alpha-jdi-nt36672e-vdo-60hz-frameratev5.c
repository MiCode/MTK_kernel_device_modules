...
static const struct drm_display_mode default_mode = {
	.clock = 197722,
	.hdisplay = 1080,
	.hsync_start = 1080 + 180,//HFP
	.hsync_end = 1080 + 180 + 12,//HSA
	.htotal = 1080 + 180 + 12 + 60,//HBP
	.vdisplay = 2400,
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	if (of_property_read_bool(dsi_node, "init-panel-off")) {
		ctx->prepared = false;
		ctx->enabled = false;
		pr_info("nt36672e,60hz,frameratev5 dsi_node:%s set prepared = enabled = false\n",
					dsi_node->full_name);
	}
	...
	pr_info("%s- jdi,nt36672e,vdo,60hz,frameratev5\n", __func__);
...
static const struct of_device_id jdi_of_match[] = {
	{
	    .compatible = "jdi,nt36672e,vdo,60hz,frameratev5",
	},
	{}
};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "panel-jdi-nt36672e-vdo-60hz-frameratev5",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("JDI NT36672E VDO 60HZ FRAMERATEV5 AMOLED Panel Driver");
MODULE_LICENSE("GPL");
