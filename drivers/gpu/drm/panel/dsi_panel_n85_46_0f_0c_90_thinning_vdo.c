...
#define  MODE_1_VFP (1032)

#define  MODE_2_FPS (50)
#define  MODE_2_VFP (1512)

#define  MODE_3_FPS (48)
#define  MODE_3_VFP (1632)

#define HBM_MAP_MAX_BRIGHTNESS      4095
#define NORMAL_MAX_BRIGHTNESS       2047
#define REG_MAX_BRIGHTNESS          2047
#define REG_HBM_BRIGHTNESS_FOR_KTZ8864         1750
#define REG_HBM_BRIGHTNESS_FOR_AW9967          1755
//the max brightness value write to 51 reg when  the current of the backlight ic reaches 20mA
#define REG_NORMAL_MAX_BRIGHTNESS_FOR_KTZ8864       1455
#define REG_NORMAL_MAX_BRIGHTNESS_FOR_AW9967       1465
...
char lcm_cabc_setting_ui[] = {
0xE1,0x0A,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7E,0x84,0xA0,0xB0,0xC0,0xD0,0xE0,0xEA,0xF6,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFC,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
};
char lcm_cabc_setting_ui1[] = {
0xE2,0x39,0x98,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3C,0xCB,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7
};

char lcm_cabc_setting_still[] = {
0xE1,0x0A,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7E,0x84,0xA0,0xB0,0xC0,0xD0,0xE0,0xEA,0xCA,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xDC,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
};
char lcm_cabc_setting_still1[] = {
0xE2,0x19,0x99,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x2C,0xCC,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7
};

char lcm_cabc_setting_mv[] = {
0xE1,0x0A,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7E,0x84,0xA0,0xB0,0xC0,0xD0,0xE0,0xEA,0xDD,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xF0,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
};
char lcm_cabc_setting_mv1[] = {
0xE2,0x2C,0xCC,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x36,0x65,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7,0x3E,0xB7
};

char lcm_cabc_setting_disable[] = {
0xE1,0x0A,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7E,0x84,0xA0,0xB0,0xC0,0xD0,0xE0,0xEA,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
};
char lcm_cabc_setting_disable1[] = {
0xE2,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF
};
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0xBC,0xFE,0xF8,0xF0,0x00,0x00,0x00,0x00,0x04,0x00,0x05,0x80,0x02,0x14,0x03,0x9A,0x99,0x99,0x00,0xC4,0x09,0xC3,0x86,0x03,0x2E,0x11);
	lcm_dcs_write_seq_static(ctx,0xC0,0x40);
	lcm_dcs_write_seq_static(ctx,0xC1,0x00,0xE6,0x00,0x30,0x00,0x20,0x04,0x4F,0x4F,0x04,0x05,0x3C,0x05,0x31,0xC0,0x22,0x7F,0x8F,0xFF,0xFF,0x0F,0xE7);
	lcm_dcs_write_seq_static(ctx,0xC4,0x0C,0x35,0x28,0x49,0x00,0x3F,0x00,0x50,0x00,0x1F,0x00,0xA3,0xF0,0xEF);
	lcm_dcs_write_seq_static(ctx,0xC5,0x03,0x13,0x10,0x57,0x5D,0x37,0x04,0x05,0x05,0x04,0x99,0x00,0xA0,0x2C,0x2B,0x2B,0xBB,0xAC,0x20,0x00,0x02,0x00,0xA0,0x0D,0x14,0x06,0x13,0x64,0xFF,0x03,0x20,0xFF);
	lcm_dcs_write_seq_static(ctx,0xC8,0x42,0x00,0x49,0x02,0xE0,0x00,0x23,0x00,0x00);
	lcm_dcs_write_seq_static(ctx,0xD0,0x0C,0x23,0x18,0xFF,0xFF,0x00,0x80,0x0C,0xFF,0x0E,0x40,0x00,0x08,0x10);
	lcm_dcs_write_seq_static(ctx,0xE0,0x0C,0x00,0xB0,0x0C,0x00,0x08,0x58,0x69,0x04,0x81,0x1F,0x00,0x00,0x00,0x00,0x1E,0x0F,0x08,0x10,0x48,0x47,0x00,0x00);

	lcm_dcs_write_seq_static(ctx,0x35,0x00);
	lcm_dcs_write_seq_static(ctx,0x53,0x2C);
	lcm_dcs_write_seq_static(ctx,0x5E,0x00,0x07);//7/2048
	lcm_dcs_write_seq_static(ctx,0x55,0x01);
	lcm_mdelay(2);
	//cabc mode off start
	lcm_dcs_write_seq_static(ctx,0xE1,0x0A,0x1F,0x2F,0x3F,0x4F,0x5F,0x6F,0x7F,0x84,0xA0,0xB0,0xC0,0xD0,0xE0,0xEA,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF);
	lcm_dcs_write_seq_static(ctx,0xE2,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF,0x3F,0xFF);
	//cabc mode off end
...
bool icnl_90hz_proximity_thinnin_status = false;
void panel_90hz_check_proximity_thinning_mode(bool proximity_mode)
{
	icnl_90hz_proximity_thinnin_status = proximity_mode;
	pr_info("[cts] %s proxmity_status = %d\n", __func__, icnl_90hz_proximity_thinnin_status);
}
EXPORT_SYMBOL_GPL(panel_90hz_check_proximity_thinning_mode);

bool icnl_90hz_gesture_thinning_status = false;
void panel_90hz_check_gesture_thinning_mode(bool gst_mode)
{
	icnl_90hz_gesture_thinning_status = gst_mode;
	pr_info("[icnl9951] %s gst_status = %d\n", __func__, icnl_90hz_gesture_thinning_status);
}
EXPORT_SYMBOL_GPL(panel_90hz_check_gesture_thinning_mode);
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	pr_info("[CTS] : %s +++ tp_notify_data.blank = MTK_DRM_BLANK_POWERDOWN +++", __func__);
	if (icnl_90hz_proximity_thinnin_status == true) {
		lcm_dcs_write_seq_static(ctx, MIPI_DCS_SET_DISPLAY_OFF);
		lcm_mdelay(20);
		lcm_dcs_write_seq_static(ctx,0xF0,0x5A,0x59);
		lcm_dcs_write_seq_static(ctx,0xF1,0xA5,0xA6);
		lcm_dcs_write_seq_static(ctx,0xC1,0x00,0xE6,0x00,0x30,0x00,0x20,0x04,0x4F,0x4F,0x04,0x05,0x3C,0x01,0x01,0xC0,0x22,0x7F,0x8F,0xFF,0xFF,0x0F,0xE7);
		lcm_mdelay(50);
		pr_info("[cts] %s 0x10 proximity_status = %d\n", __func__, icnl_90hz_proximity_thinnin_status);
		goto nvt_90hz_proximity_switch_out;
	}

	if (icnl_90hz_gesture_thinning_status == true) {
		lcm_dcs_write_seq_static(ctx, 0xAC,0x0A);
		lcm_dcs_write_seq_static(ctx, MIPI_DCS_SET_DISPLAY_OFF);
		lcm_mdelay(20);
		lcm_dcs_write_seq_static(ctx, MIPI_DCS_ENTER_SLEEP_MODE);
		lcm_mdelay(120);
		pr_info("[cts] %s gst_status = %d\n", __func__, icnl_90hz_gesture_thinning_status);
		goto nvt_90hz_proximity_switch_out;
	} else {
		lcm_dcs_write_seq_static(ctx, 0xAC,0x0A);
		lcm_dcs_write_seq_static(ctx, MIPI_DCS_SET_DISPLAY_OFF);
...
static int lcm_prepare(struct drm_panel *panel)
{
	...
	pr_info("[CTS] : %s +++ tp_notify_data.blank = MTK_DRM_BLANK_UNBLANK +++", __func__);
...
static int lcm_set_cabc_mode(struct drm_panel *panel, void *dsi, dcs_write_gce cb, void *handle, unsigned int mode)
{
	...
	switch (mode)
	{
		case DDIC_CABC_UI_ON:
			//push_table(ctx, lcm_cabc_setting_ui,sizeof(lcm_cabc_setting_ui) / sizeof(struct LCM_setting_table));
			cb(dsi, handle, lcm_cabc_setting_ui, ARRAY_SIZE(lcm_cabc_setting_ui));
			cb(dsi, handle, lcm_cabc_setting_ui1, ARRAY_SIZE(lcm_cabc_setting_ui1));
			ctx->cabc_status = mode;
			break;
		case DDIC_CABC_STILL_ON:
			//push_table(ctx, lcm_cabc_setting_still,sizeof(lcm_cabc_setting_still) / sizeof(struct LCM_setting_table));
			cb(dsi, handle, lcm_cabc_setting_still, ARRAY_SIZE(lcm_cabc_setting_still));
			cb(dsi, handle, lcm_cabc_setting_still1, ARRAY_SIZE(lcm_cabc_setting_still1));
			ctx->cabc_status = mode;
			break;
		case DDIC_CABC_MOVIE_ON:
			//push_table(ctx, lcm_cabc_setting_mv,sizeof(lcm_cabc_setting_mv) / sizeof(struct LCM_setting_table));
			cb(dsi, handle, lcm_cabc_setting_mv, ARRAY_SIZE(lcm_cabc_setting_mv));
			cb(dsi, handle, lcm_cabc_setting_mv1, ARRAY_SIZE(lcm_cabc_setting_mv1));
			ctx->cabc_status = mode;
			break;
		case DDIC_CABC_OFF:
			//push_table(ctx, lcm_cabc_setting_disable,sizeof(lcm_cabc_setting_disable) / sizeof(struct LCM_setting_table));
			cb(dsi, handle, lcm_cabc_setting_disable, ARRAY_SIZE(lcm_cabc_setting_disable));
			cb(dsi, handle, lcm_cabc_setting_disable1, ARRAY_SIZE(lcm_cabc_setting_disable1));
			ctx->cabc_status = mode;
			break;
		default:
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	if (lcm_name) {
		...
		if (strcmp("dsi_panel_n85_46_0f_0c_90_thinning_vdo_lcm_drv",videolfb_tag->lcmname) == 0 ){
			pr_info(" find lcm: %s \n",videolfb_tag->lcmname);
		}
		else {
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "dsi_panel_n85_46_0f_0c_90_thinning_vdo",
		.owner = THIS_MODULE,
