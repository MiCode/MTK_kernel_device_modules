...
static struct LCD_setting_table lcm_init_setting_120hz[] = {
	{ 0x02, {0XFF, 0X10} },
	//REGR 0XFE,0X10
	{ 0x02, {0XFB, 0X01} },
	{ 0x02, {0XB0, 0X00} },
	...
	{ 0x02, {0XFF, 0X20} },
	{ 0x02, {0XFB, 0X01} },
	{ 0x11, {0XB0, 0X00, 0XE2, 0X00, 0XE9, 0X00, 0XF6, 0X01, 0X01, 0X01,
		0X0C, 0X01, 0X15, 0X01, 0X20, 0X01, 0X28} },
	{ 0x11, {0XB1, 0X01, 0X33, 0X01, 0X51, 0X01, 0X6E, 0X01, 0X9A, 0X01,
		0XC0, 0X01, 0XFD, 0X02, 0X34, 0X02, 0X35} },
	{ 0x11, {0XB2, 0X02, 0X6B, 0X02, 0XA9, 0X02, 0XD1, 0X03, 0X04, 0X03,
		0X25, 0X03, 0X51, 0X03, 0X5F, 0X03, 0X6D} },
	{ 0xF, {0XB3, 0X03, 0X7D, 0X03, 0X90, 0X03, 0XA7, 0X03, 0XBB, 0X03,
		0XD4, 0X03, 0XD8, 0X00, 0X00} },
	{ 0x11, {0XB4, 0X00, 0XAA, 0X00, 0XB3, 0X00, 0XC4, 0X00, 0XD4, 0X00,
		0XE2, 0X00, 0XF0, 0X00, 0XFC, 0X01, 0X08} },
	{ 0x11, {0XB5, 0X01, 0X12, 0X01, 0X39, 0X01, 0X58, 0X01, 0X8C, 0X01,
		0XB5, 0X01, 0XF7, 0X02, 0X30, 0X02, 0X31} },
	{ 0x11, {0XB6, 0X02, 0X68, 0X02, 0XA6, 0X02, 0XCE, 0X03, 0X01, 0X03,
		0X23, 0X03, 0X4E, 0X03, 0X5C, 0X03, 0X6A} },
	{ 0xF, {0XB7, 0X03, 0X7B, 0X03, 0X8E, 0X03, 0XA5, 0X03, 0XBB, 0X03,
		0XD4, 0X03, 0XD8, 0X00, 0X00} },
	{ 0x11, {0XB8, 0X00, 0X00, 0X00, 0X20, 0X00, 0X47, 0X00, 0X65, 0X00,
		0X85, 0X00, 0X99, 0X00, 0XAD, 0X00, 0XC0} },
	{ 0x11, {0XB9, 0X00, 0XD2, 0X01, 0X06, 0X01, 0X30, 0X01, 0X70, 0X01,
		0X9F, 0X01, 0XE8, 0X02, 0X25, 0X02, 0X26} },
	{ 0x11, {0XBA, 0X02, 0X5F, 0X02, 0X9F, 0X02, 0XC7, 0X02, 0XFD, 0X03,
		0X20, 0X03, 0X52, 0X03, 0X63, 0X03, 0X67} },
	{ 0xF, {0XBB, 0X03, 0X78, 0X03, 0X8B, 0X03, 0XA3, 0X03, 0XB9, 0X03,
		0XD4, 0X03, 0XD8, 0X00, 0X00} },
	{ 0x02, {0XFF, 0X21} },
	{ 0x02, {0XFB, 0X01} },
	{ 0x11, {0XB0, 0X00, 0XE2, 0X00, 0XE9, 0X00, 0XF6, 0X01, 0X01, 0X01,
	...
	//{ 0x02, {0x51, 0xff} }, no need?
};

static struct LCD_setting_table lcm_init_setting_90hz[] = {
	{ 0x02, {0XFF, 0X10} },
	//REGR 0XFE,0X10
	{ 0x02, {0XFB, 0X01} },
	{ 0x02, {0XB0, 0X00} },
	...
	//{ 0x02, {0x51, 0xff} },// no_need?
};

static struct LCD_setting_table lcm_init_setting_60hz[] = {
	{ 0x02, {0XFF, 0X10} },
	//REGR 0XFE,0X10
	{ 0x02, {0XFB, 0X01} },
	{ 0x02, {0XB0, 0X00} },
			...
			struct drm_connector *connector, unsigned int mode)
{
	...
	if (!m) {
		pr_err("%s:%d error, invalid display_mode\n", __func__, __LINE__);
		return ret;
	}
			...
			struct mtk_dsi_cmd_option *cmd_opt)
{
	int ret = 0;
	struct jdi *ctx = panel_to_jdi(panel);
	static struct mipi_dsi_msg init_120hz[ARRAY_SIZE(lcm_init_setting_120hz)] = { 0 };
	static struct mipi_dsi_msg init_90hz[ARRAY_SIZE(lcm_init_setting_90hz)] = { 0 };
	static struct mipi_dsi_msg init_60hz[ARRAY_SIZE(lcm_init_setting_60hz)] = { 0 };
	static int flag;
	int i;
	...
	if (!flag) {
		flag = 1;
		for (i = 0; i < ARRAY_SIZE(lcm_init_setting_120hz); i++) {
			init_120hz[i].tx_len= lcm_init_setting_120hz[i].count;
			init_120hz[i].tx_buf = lcm_init_setting_120hz[i].para_list;
		}
		for (i = 0; i < ARRAY_SIZE(lcm_init_setting_90hz); i++) {
			init_90hz[i].tx_len= lcm_init_setting_90hz[i].count;
			init_90hz[i].tx_buf = lcm_init_setting_90hz[i].para_list;
		}
		for (i = 0; i < ARRAY_SIZE(lcm_init_setting_60hz); i++) {
			init_60hz[i].tx_len= lcm_init_setting_60hz[i].count;
			init_60hz[i].tx_buf = lcm_init_setting_60hz[i].para_list;
		}
	}
	struct mtk_dsi_cmd_msg fhd_120hz_cmd = {
		.is_rd = 0, /* 0:write 1:read */
		.is_package = 0,
		.rd_to_slot = 0,
		.cmd_num = ARRAY_SIZE(lcm_init_setting_120hz),
		.transfer_mode = PACKET_LP_MODE,
		.cmd_msg = init_120hz,
	};

	struct mtk_dsi_cmd_msg fhd_90hz_cmd = {
		.is_rd = 0, /* 0:write 1:read */
		.is_package = 0,
		.rd_to_slot = 0,
		.cmd_num = ARRAY_SIZE(lcm_init_setting_90hz),
		.transfer_mode = PACKET_LP_MODE,
		.cmd_msg = init_90hz,
	};

	struct mtk_dsi_cmd_msg fhd_60hz_cmd = {
		.is_rd = 0, /* 0:write 1:read */
		.is_package = 0,
		.rd_to_slot = 0,
		.cmd_num = ARRAY_SIZE(lcm_init_setting_60hz),
		.transfer_mode = PACKET_LP_MODE,
		.cmd_msg = init_60hz,
	};
	...
	if (current_fps == 120)
		ret = cb(dsi_drv, handle, cmd_opt, &fhd_120hz_cmd);
	else if (current_fps == 90)
		ret = cb(dsi_drv, handle, cmd_opt, &fhd_90hz_cmd);
	else if (current_fps == 60)
		ret = cb(dsi_drv, handle, cmd_opt, &fhd_60hz_cmd);
	else {
