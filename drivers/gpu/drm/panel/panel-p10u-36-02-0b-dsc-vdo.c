...
#endif
#include "include/panel_p10u_36_02_0b_alpha_data.h"
#include "include/panel-p10u-36-02-0b-dsc-vdo.h"
...
static int panel_set_gray_by_temperature (struct drm_panel *panel, int level)
{
	...
	if (level < TEMP_INDEX_26) {
		...
		mi_disp_panel_ddic_send_cmd(gray_3d_lut, ARRAY_SIZE(gray_3d_lut), format);
	} else if (level >= TEMP_INDEX_40 && level < TEMP_INDEX_45) {
		gray_3d_lut[0].para_list[1] = 0x28;
		mi_disp_panel_ddic_send_cmd(gray_3d_lut, ARRAY_SIZE(gray_3d_lut), format);
	} else if (level >= TEMP_INDEX_45) {
		gray_3d_lut[0].para_list[1] = 0x2D;
		mi_disp_panel_ddic_send_cmd(gray_3d_lut, ARRAY_SIZE(gray_3d_lut), format);
	}
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("[LCM]%s p10u-36-02-0b-dsc +\n", __func__);
	...
	pr_info("[LCM]%s p10u-36-02-0b-dsc-vdo -\n", __func__);
	return ret;
}
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "p10u_36_02_0b_dsc_vdo,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "p10u_36_02_0b_dsc_vdo,lcm",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("p10u_36_02_0b_dsc_vdo oled panel driver");
