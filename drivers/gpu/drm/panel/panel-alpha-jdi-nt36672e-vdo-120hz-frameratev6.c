			...
			struct mtk_dsi_cmd_option *cmd_opt)
{
	...
	pr_info("%s nt36672e-vdo-frameratev6 ++, fps = %d\n", __func__, current_fps);
...
static int lcm_panel_init(struct drm_panel *panel)
{
	...
	pr_info("%s nt36672e-vdo-frameratev6 ++\n", __func__);
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s+ jdi,nt36672e,vdo,120hz,frameratev6\n", __func__);
...
static const struct of_device_id jdi_of_match[] = {
	{
	    .compatible = "jdi,nt36672e,vdo,120hz,frameratev6",
	},
	{}
};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "panel-jdi-nt36672e-vdo-120hz-frameratev6",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("JDI NT36672E VDO 120HZ Frameratev6 AMOLED Panel Driver");
MODULE_LICENSE("GPL");
