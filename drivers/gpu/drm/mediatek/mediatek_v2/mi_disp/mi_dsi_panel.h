...
#define mipi_dsi_host_to_dsi(h)		\
	container_of(h, struct mtk_dsi, host);
...
enum mqs_log_capture_type {
	MQS_LOG_CAPTURE_CMDQ_TIMEOUT = 0,
	MQS_LOG_CAPTURE_BUFFER_UNDERRUN = 1,
	MQS_ERROR_TYPE_MAX
};
...
int mi_dsi_panel_get_ic_type(struct mtk_dsi *dsi, u32 *ic_type);
