...
static int mtk_mipi_tx_pll_prepare_mt6858(struct clk_hw *hw)
{
#ifndef CONFIG_FPGA_EARLY_PORTING
	struct mtk_mipi_tx *mipi_tx = mtk_mipi_tx_from_clk_hw(hw);
	unsigned int txdiv, txdiv0, txdiv1, tmp;
...
static int mtk_mipi_tx_pll_cphy_prepare_mt6858(struct clk_hw *hw)
{
#ifndef CONFIG_FPGA_EARLY_PORTING
	struct mtk_mipi_tx *mipi_tx = mtk_mipi_tx_from_clk_hw(hw);
	unsigned int txdiv, txdiv0, txdiv1, tmp;
...
static void mtk_mipi_tx_pll_unprepare_mt6858(struct clk_hw *hw)
{
#ifndef CONFIG_FPGA_EARLY_PORTING
	struct mtk_mipi_tx *mipi_tx = mtk_mipi_tx_from_clk_hw(hw);
...
static void mtk_mipi_tx_pll_cphy_unprepare_mt6858(struct clk_hw *hw)
{
#ifndef CONFIG_FPGA_EARLY_PORTING
	struct mtk_mipi_tx *mipi_tx = mtk_mipi_tx_from_clk_hw(hw);
...
static void backup_mipitx_impedance_mt6881(struct mtk_mipi_tx *mipi_tx)
{
	...
	efuse_value[0] = read_efuse_test_code(100);		//190
	efuse_value[1] = read_efuse_test_code(101);		//194
	efuse_value[2] = read_efuse_test_code(102);		//198
...
static const struct mtk_mipitx_data mt6858_mipitx_data = {
	...
	.ck_sw_lptx_pre_oe = MIPITX_CK_SW_LPTX_PRE_OE,
	.ckc_sw_lptx_pre_oe = MIPITX_CKC_SW_LPTX_PRE_OE,
	.pll_prepare = mtk_mipi_tx_pll_prepare_mt6858,
	.pll_unprepare = mtk_mipi_tx_pll_unprepare_mt6858,
	.dsi_get_pcw = _dsi_get_pcw,
	.dsi_get_data_rate = _dsi_get_data_rate,
	.backup_mipitx_impedance = backup_mipitx_impedance,
	.refill_mipitx_impedance = refill_mipitx_impedance,
...
static const struct mtk_mipitx_data mt6858_mipitx_cphy_data = {
	...
	.ck_sw_lptx_pre_oe = MIPITX_CK_SW_LPTX_PRE_OE,
	.ckc_sw_lptx_pre_oe = MIPITX_CKC_SW_LPTX_PRE_OE,
	.pll_prepare = mtk_mipi_tx_pll_cphy_prepare_mt6858,
	.pll_unprepare = mtk_mipi_tx_pll_cphy_unprepare_mt6858,
	.dsi_get_pcw = _dsi_get_pcw,
	.dsi_get_data_rate = _dsi_get_data_rate,
	.backup_mipitx_impedance = backup_mipitx_impedance,
	.refill_mipitx_impedance = refill_mipitx_impedance,
...
static const struct mtk_mipitx_data mt6881_mipitx_cphy_data = {
	.mppll_preserve = (0 << 8),
	.dsi_pll_sdm_pcw_chg = RG_DSI_PLL_SDM_PCW_CHG_MT6983,
	.dsi_pll_en = RG_DSI_PLL_EN_MT6983,
	.dsi_ssc_en = RG_DSI_PLL_SDM_SSC_EN_MT6983,
...
static const struct mtk_mipitx_data mt6881_mipitx_data = {
	.mppll_preserve = (0 << 8),
	.dsi_pll_sdm_pcw_chg = RG_DSI_PLL_SDM_PCW_CHG_MT6983,
	.dsi_pll_en = RG_DSI_PLL_EN_MT6983,
	.dsi_ssc_en = RG_DSI_PLL_SDM_SSC_EN_MT6983,
...
static const struct of_device_id mtk_mipi_tx_match[] = {
	...
	{.compatible = "mediatek,mt6881-mipi-tx", .data = &mt6881_mipitx_data},
	...
	{.compatible = "mediatek,mt6881-mipi-tx-cphy",
		.data = &mt6881_mipitx_cphy_data},
	{},
};
