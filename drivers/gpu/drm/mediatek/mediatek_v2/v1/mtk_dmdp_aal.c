...
static void disp_mdp_aal_remove(struct platform_device *pdev)
{
...
static const struct mtk_dmdp_aal_data mt6993_dmdp_aal_driver_data = {
	.support_shadow = false,
	.need_bypass_shadow = true,
	.block_info_00_mask = 0xFFFFFFFF,
};
...
static const struct of_device_id mtk_dmdp_aal_driver_dt_match[] = {
	...
	{ .compatible = "mediatek,mt6993-dmdp-aal", .data = &mt6993_dmdp_aal_driver_data},
	{},
};
