...
static void mtk_atomic_doze_update_pq(struct drm_crtc *crtc, unsigned int stage, bool old_state)
{
	...
	if (mtk_state->doze_changed) {
		...
		&& (stage == 1) && (mtk_crtc->cur_usage == DISP_ENABLE)
		&& (index < MAX_CRTC)) {
	...
	if (mtk_drm_helper_get_opt(priv->helper_opt, MTK_DRM_OPT_SPHRT) && index < MAX_CRTC) {
		if ((index == 3) && ((mtk_crtc->cur_usage == DISP_OPENING) || (!mtk_crtc->enabled))) {
			...
			DDPINFO("%s %d wait for opening or enabled, disp_state:%d, crtc_enabled:%d, backup bypass:%d\n",
...
static const enum mtk_ddp_comp_id mt6881_mtk_ddp_main[] = {
#if IS_ENABLED(CONFIG_MTK_DISPLAY_DUAL_PIPE_DUAL_PORT_SUPPORT)
	DDP_COMPONENT_OVL0_2L,
	DDP_COMPONENT_OVL1_2L,
	DDP_COMPONENT_PQ0_IN_CB0,
...
static const struct mtk_addon_module_data mt6878_addon_wdma1_data[] = {
	{DISP_WDMA1_v5, ADDON_AFTER, DDP_COMPONENT_SPLIT_OUT_CB2},
};
...
static const struct mtk_addon_module_data mt6881_addon_wdma1_data[] = {
	{DISP_WDMA1_v5, ADDON_AFTER, DDP_COMPONENT_SPLIT_OUT_CB2},
};

static const struct mtk_addon_module_data mt6881_addon_wdma1_ovl_data[] = {
	{DISP_WDMA1_v5_OVL, ADDON_AFTER, DDP_COMPONENT_PQ0_IN_CB0},
};

static const struct mtk_addon_module_data mt6881_addon_rsz_data[] = {
	{DISP_RSZ_v7, ADDON_EMBED, DDP_COMPONENT_OVL0_2L},
};
...
static const struct mtk_addon_scenario_data mt6881_addon_main[ADDON_SCN_NR] = {
	[NONE] = {
		.module_num = 0,
		.hrt_type = HRT_TB_TYPE_GENERAL1,
	},
	[WDMA_WRITE_BACK_OVL] = {
		.module_num = ARRAY_SIZE(mt6881_addon_wdma1_ovl_data),
		.module_data = mt6881_addon_wdma1_ovl_data,
		.hrt_type = HRT_TB_TYPE_GENERAL1,
	},
	[WDMA_WRITE_BACK] = {
		.module_num = ARRAY_SIZE(mt6881_addon_wdma1_data),
		.module_data = mt6881_addon_wdma1_data,
		.hrt_type = HRT_TB_TYPE_GENERAL1,
	},
	[TRIPLE_DISP] = {
		.module_num = 0,
	...
	[ONE_SCALING] = {
		.module_num = ARRAY_SIZE(mt6881_addon_rsz_data),
		.module_data = mt6881_addon_rsz_data,
		.hrt_type = HRT_TB_TYPE_GENERAL1,
	},
};
...
static const struct mtk_crtc_path_data mt6881_mtk_main_path_data = {
	.path[DDP_MAJOR][0] = mt6881_mtk_ddp_main,
...
const struct mtk_session_mode_tb mt6881_mode_tb[MTK_DRM_SESSION_NUM] = {
		[MTK_DRM_SESSION_DL] = {
...
static const struct mtk_fake_eng_reg mt6881_fake_eng_reg[] = {
	{.CG_idx = 0, .CG_bit = 28, .share_port = false},
	{.CG_idx = 0, .CG_bit = 29, .share_port = false},
};

static const struct mtk_fake_eng_data mt6881_fake_eng_data = {
	.fake_eng_num =  ARRAY_SIZE(mt6881_fake_eng_reg),
	.fake_eng_reg = mt6881_fake_eng_reg,
};
...
static const struct mtk_mmsys_driver_data mt6881_mmsys_driver_data = {
	.main_path_data = &mt6881_mtk_main_path_data,
	// .ext_path_data = &mt6881_mtk_third_path_data,
	// .third_path_data = &mt6881_mtk_third_path_data,
	// .fourth_path_data_secondary = &mt6881_mtk_secondary_path_data,
	.fake_eng_data = &mt6881_fake_eng_data,
...
static void mtk_drm_kms_lateinit(struct kthread_work *work)
{
	...
	if (mtk_drm_helper_get_opt(private->helper_opt, MTK_DRM_OPT_MMDVFS_SUPPORT))
		mtk_drm_mmdvfs_init(drm->dev, mtk_drm_helper_get_opt(private->helper_opt,
...
//	 .data = (void *)MTK_DISP_RDMA},
	...
	{.compatible = "mediatek,mt6878-disp-ccorr",
	 .data = (void *)MTK_DISP_CCORR},
	{.compatible = "mediatek,mt6881-disp-ccorr",
	 .data = (void *)MTK_DISP_CCORR},
	...
	{.compatible = "mediatek,mt6878-disp-c3d",
	 .data = (void *)MTK_DISP_C3D},
	{.compatible = "mediatek,mt6881-disp-c3d",
	 .data = (void *)MTK_DISP_C3D},
	...
	{.compatible = "mediatek,mt6878-disp-tdshp",
	 .data = (void *)MTK_DISP_TDSHP},
	{.compatible = "mediatek,mt6881-disp-tdshp",
	 .data = (void *)MTK_DISP_TDSHP},
	...
	{.compatible = "mediatek,mt6878-disp-color",
	 .data = (void *)MTK_DISP_COLOR},
	{.compatible = "mediatek,mt6881-disp-color",
	 .data = (void *)MTK_DISP_COLOR},
	...
	{.compatible = "mediatek,mt6878-disp-aal",
	 .data = (void *)MTK_DISP_AAL},
	{.compatible = "mediatek,mt6881-disp-aal",
	 .data = (void *)MTK_DISP_AAL},
	...
	{.compatible = "mediatek,mt6878-disp-gamma",
	 .data = (void *)MTK_DISP_GAMMA},
	{.compatible = "mediatek,mt6881-disp-gamma",
	 .data = (void *)MTK_DISP_GAMMA},
	...
	{.compatible = "mediatek,mt6878-disp-dither",
	 .data = (void *)MTK_DISP_DITHER},
	{.compatible = "mediatek,mt6881-disp-dither",
	 .data = (void *)MTK_DISP_DITHER},
	...
	{.compatible = "mediatek,mt6878-dsi",
	 .data = (void *)MTK_DSI},
	{.compatible = "mediatek,mt6881-dsi",
	 .data = (void *)MTK_DSI},
	...
	{.compatible = "mediatek,mt6878-disp-pwm",
	 .data = (void *)MTK_DISP_PWM},
	{.compatible = "mediatek,mt6881-disp-pwm",
	 .data = (void *)MTK_DISP_PWM},
	...
	{.compatible = "mediatek,mt6878-disp-rsz",
	 .data = (void *)MTK_DISP_RSZ},
	{.compatible = "mediatek,mt6881-disp-rsz",
	 .data = (void *)MTK_DISP_RSZ},
	...
	{.compatible = "mediatek,mt6878-disp-postmask",
	 .data = (void *)MTK_DISP_POSTMASK},
	{.compatible = "mediatek,mt6881-disp-postmask",
	 .data = (void *)MTK_DISP_POSTMASK},
...
//	 .data = (void *)MTK_DISP_CM},
	...
	{.compatible = "mediatek,mt6878-disp-dsc",
	 .data = (void *)MTK_DISP_DSC},
	{.compatible = "mediatek,mt6881-disp-dsc",
	 .data = (void *)MTK_DISP_DSC},
...
static unsigned int mtk_drm_get_boot_mode_from_dts(void)
{
	...
	if (node) {
		...
		DDPPR_ERR("[%s] error, of_chosen not found\n", __func__);

	if (tags) {
		ret = tags->bootmode;
		DDPMSG("[%s] 'atag,boot' mode %d\n", __func__, ret);
	} else
		DDPPR_ERR("[%s] error, 'atag,boot' not found\n", __func__);
...
static const struct of_device_id mtk_drm_of_ids[] = {
	...
	{.compatible = "mediatek,mt6881-disp",
	 .data = &mt6881_mmsys_driver_data},
