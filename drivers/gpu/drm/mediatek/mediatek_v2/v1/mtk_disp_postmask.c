...
static const struct mtk_disp_postmask_data mt6993_postmask_driver_data = {
	.is_support_34bits = true,
	.need_bypass_shadow = true,
};

static const struct mtk_disp_postmask_data mt6858_postmask_driver_data = {
	.is_support_34bits = true,
	.need_bypass_shadow = true,
};
...
static const struct mtk_disp_postmask_data mt6881_postmask_driver_data = {
	.is_support_34bits = true,
	.need_bypass_shadow = true,
};
