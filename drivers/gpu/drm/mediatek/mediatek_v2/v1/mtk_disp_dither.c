							...
							enum mtk_ddp_io_cmd cmd, void *params)
{
	...
	case GET_PQ_CAPS:
	{
		...
		struct DISP_PQ_HW_CAPS *comp_caps = &pq_caps->caps[MTK_DISP_PQ_DITHER];
...
static void disp_dither_remove(struct platform_device *pdev)
{
...
static const struct mtk_disp_dither_data mt6993_dither_driver_data = {
	.support_shadow     = false,
	.need_bypass_shadow = true,
};
...
static const struct mtk_disp_dither_data mt6858_dither_driver_data = {
	.support_shadow     = false,
	.need_bypass_shadow = true,
};

static const struct mtk_disp_dither_data mt6881_dither_driver_data = {
	.support_shadow     = false,
	.need_bypass_shadow = true,
};
...
static const struct of_device_id mtk_disp_dither_driver_dt_match[] = {
	...
	{ .compatible = "mediatek,mt6993-disp-dither",
	  .data = &mt6993_dither_driver_data},
	{ .compatible = "mediatek,mt6858-disp-dither",
	  .data = &mt6858_dither_driver_data},
	{ .compatible = "mediatek,mt6881-disp-dither",
	  .data = &mt6881_dither_driver_data},
	{},
};
