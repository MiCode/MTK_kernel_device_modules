...
struct mtk_panel_params {
	...
	int skip_hfp_min_check; // not recommend, may cause flickering due to line time unbalance
	unsigned int output_valid_us;
};
...
struct mtk_panel_funcs {
	...
	int (*fod_state_check_v2)(struct drm_panel *panel, void *dsi_drv, mtk_dsi_ddic_cmd cb, void *handle, struct mtk_dsi_cmd_option *cmd_opt);
	...
	int (*doze_suspend_v2)(struct drm_panel *panel, void *dsi_drv, mtk_dsi_ddic_cmd cb, void *handle, struct mtk_dsi_cmd_option *cmd_opt);
	...
	void (*set_cabc_mode)(struct drm_panel *panel, int mode);
	int (*set_dynamic_elvss_level)(struct drm_panel *panel, int level);
	int (*get_ic_type)(struct drm_panel *panel, u32 *ic_type);
#ifdef CONFIG_MI_DISP_FP_STATE
	void (*fp_state_restore_backlight)(struct mtk_dsi *dsi);
#endif
#ifdef CONFIG_MI_DISP_ESD_CHECK
 	void (*esd_restore_backlight)(struct drm_panel *panel);
	void (*esd_restore_backlight_v2)(struct drm_panel *panel, void *dsi_drv,
