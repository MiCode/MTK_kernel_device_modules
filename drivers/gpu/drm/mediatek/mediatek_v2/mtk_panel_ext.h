...
/* P16 code for BUGP16-1163 by p-zhangyundan at 2025/5/14 start */
	...
	unsigned int ext_cmd_start;
	unsigned int ext_cmd_counts;
#endif
...
/* P16 code for HQFEAT-94010 by zhangyundan at 2025/3/10 start */
	...
	int (*hdr_set_cmdq)(struct drm_panel *panel, void *dsi_drv,
			    dcs_write_gce cb, void *handle, bool en);
	void (*hdr_get_state)(struct drm_panel *panel, bool *state);
