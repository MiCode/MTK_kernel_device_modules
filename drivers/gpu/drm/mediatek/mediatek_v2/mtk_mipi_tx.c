...
static int mtk_mipi_tx_pll_dphy_config_mt6991(struct mtk_mipi_tx *mipi_tx)
{
	...
	mtk_mipi_tx_clear_bits(mipi_tx, MIPITX_PLL_CON4, RG_DSI_PLL_ICHP_DEF);
	mtk_mipi_tx_set_bits(mipi_tx, MIPITX_PLL_CON1, RG_DSI_PLL_LVROD_EN_DEF);

	mtk_mipi_tx_update_bits(mipi_tx, MIPITX_PLL_CON1,
							RG_DSI_PLL_RST_DLY_DEF, 0x1 << 23);
	mtk_mipi_tx_update_bits(mipi_tx, MIPITX_PLL_CON1,
