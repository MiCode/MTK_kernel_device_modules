...
static struct mtk_drm_helper help_info[] = {
	...
	{MTK_DRM_OPT_FRAME_SUBMIT, 0, "MTK_DRM_OPT_FRAME_SUBMIT"},
#if defined(DRM_RETRIGGER_ENABLE)
	{MTK_DRM_OPT_RETRIGGER, 0, "MTK_DRM_OPT_RETRIGGER"},
#else
	{MTK_DRM_OPT_RETRIGGER, 0, "MTK_DRM_OPT_RETRIGGER_EXTERNAL"},
#endif
	{MTK_DRM_OPT_DSI_LPC_EN, 0, "MTK_DRM_OPT_DSI_LPC_EN"},
	{MTK_DRM_OPT_PROP_INHERITANCE, 0, "MTK_DRM_OPT_PROP_INHERITANCE"},
	{MTK_DRM_OPT_PKT_POOL, 0, "MTK_DRM_OPT_PKT_POOL"},
...
void mtk_drm_helper_init(struct device *dev, struct mtk_drm_helper **helper_opt)
{
	...
	mtk_drm_helper_set_opt_by_name(tmp_opt,
			"MTK_DRM_OPT_DSI_UNDERRUN_AEE", 1);
#endif
	*helper_opt = tmp_opt;
}
