...
#define DPTX_TIMEOUT_THRESHOLD 10000000000ULL
...
extern void mtk_dp_dvo_prepare_clk(void);
...
extern void mhal_DVO_VideoClock(bool enable, int resolution);
extern void mhal_DPTx_ModeCopy(struct drm_display_mode *mode);
extern void mtk_dp_dvo_PatternGenEn(int mode);
extern int mtk_dp_dvo_CheckSum(void);
extern void mtk_dp_intf_PatternGenEn(int mode);
