...
#ifndef __MTK_DRM_DP_INTF_REGS_H
#define __MTK_DRM_DP_INTF_REGS_H
...
#define DPI_YUV			0x54
#define DPI_YUV_EN			BIT(0)
#define DPI_YUV422_EN		BIT(2)
...
#define DPI_MATRIX_SET		0x54
#define INT_MATRIX_SEL_MASK		GENMASK(7, 4)

#define MATRIX_SEL_RGB_TO_JPEG		0
#define MATRIX_SEL_RGB_TO_BT601		2

#define DPI_BUF_CON0			0x0210
#define BUF_BUF_EN			BIT(0)
#define BUF_BUF_FIFO_UNDERFLOW_DONT_BLOCK			BIT(4)

#define DPI_BUF_RW_TIMES			0x0220
#define DPI_BUF_SODI_HIGH			0x0224
#define DPI_BUF_SODI_LOW			0x0228

#define DPI_CONFIG_1TNP			0x0250
#define DPI_CONFIG_1T1P		0x00
#define DPI_CONFIG_1T2P		BIT(1)
#define DPI_CONFIG_1T4P		BIT(2)
#define DPI_CONFIG_1TNP_MASK		GENMASK(3, 0)
