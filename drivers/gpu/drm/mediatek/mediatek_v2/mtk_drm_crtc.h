...
#define PRIMARY_OVL_EXT_LAYER_NR 2L
#else
...
#define DISP_SLOT_BIF_EN (DISP_SLOT_MUTEX6_DEBUG + 0x4)
#define DISP_SLOT_BIF_CONDITION (DISP_SLOT_BIF_EN + 0x4)
#define DISP_SLOT_UNDERRUNED (DISP_SLOT_BIF_CONDITION + 0x4)
...
#define DISP_SLOT_OD_SRAM_IDX (DISP_SLOT_CUR_HRT_VAL_ODRW_STASH + 0x4)
#define DISP_SLOT_DBI_COUNT_ERROR (DISP_SLOT_OD_SRAM_IDX + 0x4)
...
#define DISP_SLOT_DBI_COUNT_SW_TRIGGER (DISP_SLOT_DBI_IR_DROP_CHECK_SUM + 0x4) // dbi cmd mode
#define DISP_SLOT_DBI_COUNT_SINGLE_TRIGGER_NEXT (DISP_SLOT_DBI_COUNT_SW_TRIGGER + 0x4) // dbi vdo mode
#define DISP_SLOT_DBI_COUNT_CLK_OFF_REQ (DISP_SLOT_DBI_COUNT_SINGLE_TRIGGER_NEXT + 0x4) // dbi vdo mode
#define DISP_SLOT_DBI_COUNT_SINGLE_TRIGGER_CUR (DISP_SLOT_DBI_COUNT_CLK_OFF_REQ + 0x4) // dbi vdo mode
#define DISP_SLOT_TRIGGER_LOOP_SKIP_MERGE (DISP_SLOT_DBI_COUNT_SINGLE_TRIGGER_CUR + 0x4)
