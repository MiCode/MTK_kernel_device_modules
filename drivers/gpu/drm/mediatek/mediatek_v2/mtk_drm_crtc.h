...
#define DISP_SLOT_DBI_COUNT_CLK_OFF_REQ (DISP_SLOT_DBI_COUNT_SW_TRIGGER + 0x4)
#define DISP_SLOT_DBI_COUNT_BIF_SKIP (DISP_SLOT_DBI_COUNT_CLK_OFF_REQ + 0x4)
#define DISP_SLOT_TRIGGER_LOOP_SKIP_MERGE (DISP_SLOT_DBI_COUNT_BIF_SKIP + 0x4)
