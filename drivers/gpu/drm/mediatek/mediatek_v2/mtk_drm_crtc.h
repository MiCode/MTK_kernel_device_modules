...
#define DISP_SLOT_FIRST_EVENT_LOOP (DISP_SLOT_TRIGGER_LOOP_SKIP_MERGE + 0x4)

/* For idlemgr by wb*/
#define DISP_SLOT_IDLEMGR_BY_WB_STATUS (DISP_SLOT_FIRST_EVENT_LOOP + 0x4)
...
struct mtk_drm_crtc {
	...
	unsigned int mode_switch_flag;			// bit0~9: ovlsys0 exdma0~9
											// bit10~19: ovlsys0 exdma0~9
	...
	int balance_compensate;
	struct mutex sol_lock;
	bool doze_into_suspend;

	atomic_t dbi_set_freq_floor_cnt0;
	atomic_t dbi_set_freq_floor_cnt1;
	atomic_t dbi_bl_chg_reg_num;
