...
#define ULTRA_FLD_RG_SEL_PREULTRA REG_FLD_MSB_LSB(19, 18)
#define ULTRA_FLD_RG_SEL_ULTRA REG_FLD_MSB_LSB(17, 16)
				...
				struct cmdq_pkt *handle)
{
	...
	if (panel_ext && panel_ext->round_corner_en) {
		...
		value = (REG_FLD_VAL((ULTRA_FLD_PREULTRA_BUF_SRC), 0) |
			 ...
			 REG_FLD_VAL((ULTRA_FLD_RG_SEL_ULTRA), 1) |
			 REG_FLD_VAL((ULTRA_FLD_RG_SEL_PREULTRA), 1));
