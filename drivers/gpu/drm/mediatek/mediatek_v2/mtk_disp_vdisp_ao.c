...
#define	IRQ_TABLE_DISP_DSI1_MT6991		(0x36)	//456
//#define	IRQ_TABLE_DISP_DSI2_MT6991		(0x37)	//457
...
static void mtk_vdisp_ao_int_sel_g1_MT6991(void)
{
	...
	SET_VAL_MASK(value, mask, IRQ_TABLE_DISP_DSI1_MT6991, CPU_INTSEL_BIT_06);
//	SET_VAL_MASK(value, mask, IRQ_TABLE_DISP_DSI2_MT6991, CPU_INTSEL_BIT_07);
