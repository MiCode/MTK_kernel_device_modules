...
struct mtk_disp_oddmr_data {
	...
	unsigned int dbi_bl_chg_reg_num;
};
...
struct mtk_disp_oddmr_dbi_data {
	...
	struct mtk_drm_dmr_fps_dbv_change_cfg fps_dbv_change_cfg_nomask;
...
bool mtk_oddmr_dbi_need_ddren_wa(struct mtk_ddp_comp *comp);
