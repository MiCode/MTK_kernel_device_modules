...
int mtk_dump_reg(struct mtk_ddp_comp *comp)
{
	...
	case DDP_COMPONENT_OVL2_OUTPROC0:
	case DDP_COMPONENT_OVL2_OUTPROC1:
	case DDP_COMPONENT_OVL2_OUTPROC2:
	case DDP_COMPONENT_OVL2_OUTPROC3:
	...
	case DDP_COMPONENT_OVL2_BLENDER1:
	case DDP_COMPONENT_OVL2_BLENDER2:
	case DDP_COMPONENT_OVL2_BLENDER3:
	case DDP_COMPONENT_OVL2_BLENDER4:
	case DDP_COMPONENT_OVL2_BLENDER5:
	case DDP_COMPONENT_OVL2_BLENDER6:
	case DDP_COMPONENT_OVL2_BLENDER7:
