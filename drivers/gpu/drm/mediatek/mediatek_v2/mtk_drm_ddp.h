...
#define MT6991_OVLSYS_MISC	(0x0F0)
#define OVLSYS_RESET_FLOW BIT(31)
...
#define MT6993_OVLSYS_MISC	(0x0F0)
#define OVLSYS_RESET_FLOW BIT(31)
...
void mtk_crtc_bif_sodi_config_MT6993(struct mtk_drm_crtc *mtk_crtc, struct cmdq_pkt *handle, bool en);
