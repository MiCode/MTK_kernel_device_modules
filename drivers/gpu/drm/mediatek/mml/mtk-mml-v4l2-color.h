...
static const struct mml_m2m_format mml_m2m_formats[] = {
	{
		...
		.depth		= { 12 },
#if IS_ENABLED(CONFIG_MTK_MML_AUTO_HOST)
		.row_depth	= { 8 },
#else
		.row_depth	= { 12 },
#endif
		...
		.pixelformat	= V4L2_PIX_FMT_BGR32_AFBC,
		.mml_color	= MML_FMT_BGRA8888_AFBC,
		.depth		= { 32 },
		.row_depth	= { 32 },
		.num_planes	= 1,
		.walign		= 5,
		...
		.pixelformat	= V4L2_PIX_FMT_BGRA1010102_AFBC,
		.mml_color	= MML_FMT_BGRA1010102_AFBC,
		.depth		= { 32 },
		.row_depth	= { 32 },
		.num_planes	= 1,
		.walign		= 5,
