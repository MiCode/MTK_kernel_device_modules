...
enum mml_ycbcr_profile {
	/* 0: MML_YCBCR_ENC_BT601 and MML_COLOR_RANGE_LIMITED */
	MML_YCBCR_PROFILE_BT601,
	/* 1: MML_YCBCR_ENC_BT709 and MML_COLOR_RANGE_LIMITED */
	MML_YCBCR_PROFILE_BT709,
	/* 2: MML_YCBCR_ENC_BT601 and MML_COLOR_RANGE_FULL */
	MML_YCBCR_PROFILE_JPEG,
	MML_YCBCR_PROFILE_FULL_BT601 = MML_YCBCR_PROFILE_JPEG,
	/* 3: MML_YCBCR_ENC_BT2020 and MML_COLOR_RANGE_LIMITED */
	MML_YCBCR_PROFILE_BT2020,
	/* 4: MML_YCBCR_ENC_BT709 and MML_COLOR_RANGE_FULL */
	MML_YCBCR_PROFILE_FULL_BT709,
	/* 5: MML_YCBCR_ENC_BT2020 and MML_COLOR_RANGE_FULL */
...
enum mml_ycbcr_encoding {
	MML_YCBCR_ENC_BT709 = 1,	/* V4L2_YCBCR_ENC_709 */
	MML_YCBCR_ENC_BT601 = 6,	/* V4L2_YCBCR_ENC_601, 170M, 470M, sRGB, JPEG, P3 */
