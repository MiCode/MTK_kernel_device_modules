...
#define VDISP_SHRMEM_BITWISE     MEM_VDISP_AVS_STEP(VDISP_SHRMEM_BITWISE_IDX)
#define VDISP_SHRMEM_BITWISE_VAL readl(VDISP_SHRMEM_BITWISE)
#define VDISP_AVS_DISABLE_BIT       0
#define VDISP_AVS_DBG_MODE_BIT      1
#define VDISP_AVS_AGING_FAST_EN_BIT 2
#define VDISP_AVS_AGING_ACK_BIT     3
#define VDISP_AVS_AGING_DISABLE_BIT 4

#define MEM_VDISP_AVS_RO_CURR   MEM_VDISP_AVS_STEP(6)
