...
struct gpufreq_adj_info g_mcl50_adj[] = {
	ADJOP(0, 0, 68750, VSRAM_LEVEL_0),	/*  0 sign off */
	ADJOP(1, 0, 68750, VSRAM_LEVEL_0),
	ADJOP(2, 0, 68125, VSRAM_LEVEL_0),
	ADJOP(3, 0, 67500, VSRAM_LEVEL_0),
	ADJOP(4, 0, 66875, VSRAM_LEVEL_0),
	ADJOP(5, 0, 66250, VSRAM_LEVEL_0),
	ADJOP(6, 0, 65625, VSRAM_LEVEL_0),
	ADJOP(7, 0, 65000, VSRAM_LEVEL_0),
	...
	ADJOP(14, 0, 61875, 0),
	ADJOP(15, 0, 61250, 0),
	ADJOP(16, 0, 60625, 0),	/* 16 sign off */
	ADJOP(17, 0, 60625, 0),
	ADJOP(18, 0, 60000, 0),
	ADJOP(19, 0, 59375, 0),
	ADJOP(20, 0, 58750, 0),
	...
	ADJOP(30, 0, 56250, 0),
	ADJOP(31, 0, 56250, 0),
	ADJOP(32, 0, 55625, 0),	/* 32 sign off */
	ADJOP(33, 0, 55625, 0),
	ADJOP(34, 0, 55625, 0),
	ADJOP(35, 0, 55625, 0),
	ADJOP(36, 0, 55000, 0),
	...
	ADJOP(38, 0, 55000, 0),
	ADJOP(39, 0, 55000, 0),
	ADJOP(40, 0, 54375, 0),	/* 40 sign off */
};
