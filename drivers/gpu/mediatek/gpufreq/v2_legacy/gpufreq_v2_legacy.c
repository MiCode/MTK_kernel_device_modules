...
#if IS_ENABLED(CONFIG_MTK_PBM) && !IS_ENABLED(CONFIG_MTK_GPU_MT6877_SUPPORT) && !IS_ENABLED(CONFIG_MTK_GPU_MT6761_SUPPORT) && !IS_ENABLED(CONFIG_MTK_GPU_MT6765_SUPPORT)
	register_pbm_gpu_notify(&pbm_cb);
#endif /* CONFIG_MTK_PBM */

//todo mark for not ready
#if IS_ENABLED(CONFIG_DEVAPC_ARCH_MULTI) && !IS_ENABLED(CONFIG_MTK_GPU_MT6877_SUPPORT) && !IS_ENABLED(CONFIG_MTK_GPU_MT6761_SUPPORT) && !IS_ENABLED(CONFIG_MTK_GPU_MT6765_SUPPORT)
