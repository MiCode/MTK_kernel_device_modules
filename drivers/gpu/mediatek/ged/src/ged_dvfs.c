...
#if !IS_ENABLED(CONFIG_MTK_LEGACY_THERMAL) && !IS_ENABLED(CONFIG_MTK_PLAT_POWER_6781) && !IS_ENABLED(CONFIG_MTK_GPU_LEGACY) && !IS_ENABLED(CONFIG_MTK_GPU_MT6855_SUPPORT)
