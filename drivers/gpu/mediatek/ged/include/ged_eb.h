...
#define SYSRAM_GPU_EB_LOG_DUMP_UNCOM_TIME             \
(\
(FASTDVFS_GPU_EB_LOG_DUMP_UNCOM_TIME*SYSRAM_LOG_SIZE) \
)
...
static struct {
	...
	{"freq_top", EB_TOP, SYSRAM_GPU_EB_LOG_DUMP_TOP_FREQ},
	{"freq_stack", EB_STACK, SYSRAM_GPU_EB_LOG_DUMP_STACK_FREQ},
	{"freq_v_stack", EB_VIRTUAL_STACK, SYSRAM_GPU_EB_LOG_DUMP_STACK_FREQ},
	{"loading_gpu", EB_GPU_LOADING, SYSRAM_GPU_EB_LOG_DUMP_LOADING1},
