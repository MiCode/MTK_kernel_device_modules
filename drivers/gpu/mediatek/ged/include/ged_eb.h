...
enum gpu_fastdvfs_counter {
	...
	FASTDVFS_GPU_EB_GED_MIN_OPPIDX = 77,
	FASTDVFS_GPU_PWR_HINT = 78,
	FASTDVFS_GPU_EB_LOG_DUMP_TOP_FREQ = 79,
	FASTDVFS_GPU_EB_LOG_DUMP_STACK_FREQ = 89,
	FASTDVFS_GPU_EB_LOG_DUMP_GPU_LOADING  = 99,
	FASTDVFS_GPU_EB_LOG_DUMP_ITER_LOADING = 109,
	FASTDVFS_GPU_EB_LOG_DUMP_MCU_LOADING  = 119,
	FASTDVFS_GPU_EB_LOG_DUMP_POWER_STATE  = 129,
	FASTDVFS_GPU_EB_LOG_DUMP_DEBUG_COUNT  = 139,
	FASTDVFS_GPU_EB_LOG_DUMP_SOC_TIMER_HI = 149,
	FASTDVFS_GPU_EB_LOG_DUMP_SOC_TIMER_LO = 159,
...
#define SYSRAM_GPU_EB_LOG_DUMP_GPU_LOADING \
( \
(FASTDVFS_GPU_EB_LOG_DUMP_GPU_LOADING*SYSRAM_LOG_SIZE) \
)
#define SYSRAM_GPU_EB_LOG_DUMP_ITER_LOADING \
( \
(FASTDVFS_GPU_EB_LOG_DUMP_ITER_LOADING*SYSRAM_LOG_SIZE) \
)
#define SYSRAM_GPU_EB_LOG_DUMP_MCU_LOADING \
( \
(FASTDVFS_GPU_EB_LOG_DUMP_MCU_LOADING*SYSRAM_LOG_SIZE) \
)
...
static struct {
	...
	{"top", EB_TOP, SYSRAM_GPU_EB_LOG_DUMP_TOP_FREQ},
	{"stack", EB_STACK, SYSRAM_GPU_EB_LOG_DUMP_STACK_FREQ},
	{"gpu_loading", EB_GPU_LOADING, SYSRAM_GPU_EB_LOG_DUMP_GPU_LOADING},
	{"iter_loading", EB_ITER_LOADING, SYSRAM_GPU_EB_LOG_DUMP_ITER_LOADING},
	{"mcu_loading", EB_MCU_LOADING, SYSRAM_GPU_EB_LOG_DUMP_MCU_LOADING},
