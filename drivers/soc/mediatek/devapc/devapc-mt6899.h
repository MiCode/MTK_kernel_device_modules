...
#ifndef __DEVAPC_MT6899_H__
#define __DEVAPC_MT6899_H__
...
enum OTHER_TYPES_INDEX {
	...
	/* These following enum members have been removed. Now keep it for common code. */
	CONN_VIO_INDEX = 0,
	MDP_VIO_INDEX = 0,
	DISP2_VIO_INDEX = 0,
	MMSYS_VIO_INDEX = 0,
...
/* The enum has been removed. Now keep it for common code. */
...
/* For SRAM range Parser */
#define SRAM_START_ADDR				(0x100000)
#define SRAM_END_ADDR				(0x140000)

/* For EMI L3CACHE range Parser */
...
#define IMG_END_ADDR				(0x15805FFF)
#define CAM_START_ADDR				(0x1A000000)
#define CAM_END_ADDR				(0x1AFFFFFF)
#define CODEC_START_ADDR			(0x16000000)
#define CODEC_END_ADDR				(0x160BFFFF)
#define DISP_START_ADDR				(0x14000000)
#define DISP_END_ADDR				(0x1FFFFFFF)
...
#define GPU1_PD_END				(0xC4FFFF)

static const struct mtk_device_info mt6899_devices_infra[] = {
...
static const struct mtk_device_info mt6899_devices_infra1[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	...
	{0, 8, 16, "CONN_S", true},
	{0, 9, 17, "INFRA2HFRP_APB_S", true},
	{0, 10, 18, "DEBUG_TRACKER_APB1_S", true},
	{0, 11, 19, "BCRM_INFRA_PDN1_APB_S", true},
	{0, 12, 20, "DEVICE_APC_INFRA_PDN1_APB_S", true},
	{0, 13, 21, "INFRACFG_PDN_APB_S", true},
	{0, 14, 22, "ERSI0_APB_S", true},
	{0, 15, 23, "ERSI1_APB_S", true},
	{0, 16, 24, "ERSI2_APB_S", true},
	{0, 17, 25, "ERSI3_APB_S", true},
	{0, 18, 26, "ERSI4_APB_S", true},
	{0, 19, 27, "M4_MPU_APB_S", true},
	...
	{0, 53, 110, "INFRA2PERI_S", true},
	{0, 54, 111, "INFRA2PERI_S-1", true},
	{0, 55, 112, "INFRA2PERI_S-2", true},
	{0, 56, 113, "INFRA2PERI_S-3", true},
	{0, 57, 114, "INFRA2MM_S", true},
	{0, 58, 115, "INFRA2MM_S-1", true},
	{0, 59, 116, "INFRA2MM_S-2", true},
	{0, 60, 117, "INFRA2MM_S-3", true},
	{0, 61, 118, "L3C_S", true},
	{0, 62, 119, "L3C_S-1", true},
	{0, 87, 144, "L3C_S-44", true},
	{0, 63, 120, "L3C_S-20", true},
	{0, 64, 121, "L3C_S-21", true},
	{0, 65, 122, "L3C_S-22", true},
	{0, 66, 123, "L3C_S-23", true},
	{0, 67, 124, "L3C_S-24", true},
	{0, 68, 125, "L3C_S-25", true},
	{0, 69, 126, "L3C_S-26", true},
	{0, 70, 127, "L3C_S-27", true},
	{0, 71, 128, "L3C_S-28", true},
	{0, 72, 129, "L3C_S-29", true},
	{0, 73, 130, "L3C_S-30", true},
	{0, 74, 131, "L3C_S-31", true},
	{0, 75, 132, "L3C_S-32", true},
	{0, 76, 133, "L3C_S-33", true},
	{0, 77, 134, "L3C_S-34", true},
	{0, 78, 135, "L3C_S-35", true},
	{0, 79, 136, "L3C_S-36", true},
	{0, 80, 137, "L3C_S-37", true},
	{0, 81, 138, "L3C_S-38", true},
	{0, 82, 139, "L3C_S-39", true},
	{0, 83, 140, "L3C_S-40", true},
	{0, 84, 141, "L3C_S-41", true},
	{0, 85, 142, "L3C_S-42", true},
	{0, 86, 143, "L3C_S-43", true},
	{0, 88, 147, "VLPSYS_S", true},
	{0, 89, 153, "MFG_S_S", true},
	{1, 0, 62, "ADSPSYS_S", true},
	{2, 0, 63, "MD_AP_S", true},
	{2, 1, 64, "MD_AP_S-1", true},
	{2, 2, 65, "MD_AP_S-2", true},
	{2, 3, 66, "MD_AP_S-3", true},
	{2, 4, 67, "MD_AP_S-4", true},
	{2, 5, 68, "MD_AP_S-5", true},
	{2, 6, 69, "MD_AP_S-6", true},
	{2, 7, 70, "MD_AP_S-7", true},
	{2, 8, 71, "MD_AP_S-8", true},
	{2, 9, 72, "MD_AP_S-9", true},
	{2, 10, 73, "MD_AP_S-10", true},
	{2, 11, 74, "MD_AP_S-11", true},
	{2, 12, 75, "MD_AP_S-12", true},
	{2, 13, 76, "MD_AP_S-13", true},
	{2, 14, 77, "MD_AP_S-14", true},
	{2, 15, 78, "MD_AP_S-15", true},
	{2, 16, 79, "MD_AP_S-16", true},
	{2, 17, 80, "MD_AP_S-17", true},
	{2, 18, 81, "MD_AP_S-18", true},
	{2, 19, 82, "MD_AP_S-19", true},
	{2, 20, 83, "MD_AP_S-20", true},
	{2, 21, 84, "MD_AP_S-21", true},
	{2, 22, 85, "MD_AP_S-22", true},
	{2, 23, 86, "MD_AP_S-23", true},
	{2, 24, 87, "MD_AP_S-24", true},
	{2, 25, 88, "MD_AP_S-25", true},
	{2, 26, 89, "MD_AP_S-26", true},
	{2, 27, 90, "MD_AP_S-27", true},
	{2, 28, 91, "MD_AP_S-28", true},
	{2, 29, 92, "MD_AP_S-29", true},
	{2, 30, 93, "MD_AP_S-30", true},
	{2, 31, 94, "MD_AP_S-31", true},
	{2, 32, 95, "MD_AP_S-32", true},
	{2, 33, 96, "MD_AP_S-33", true},
	{2, 34, 97, "MD_AP_S-34", true},
	{2, 35, 98, "MD_AP_S-35", true},
	{2, 36, 99, "MD_AP_S-36", true},
	{2, 37, 100, "MD_AP_S-37", true},
	{2, 38, 101, "MD_AP_S-38", true},
	{2, 39, 102, "MD_AP_S-39", true},
	{2, 40, 103, "MD_AP_S-40", true},
	{2, 41, 104, "MD_AP_S-41", true},
	{2, 42, 105, "MD_AP_S-42", true},
	{2, 43, 106, "MD_AP_S-43", true},
	{2, 44, 107, "MD_AP_S-44", true},
	{2, 45, 108, "MD_AP_S-45", true},
	{2, 46, 109, "MD_AP_S-46", true},
	...
	{-1, -1, 238, "CQDMA", false},
	{-1, -1, 239, "DEVICE_APC_INFRA_AO1", false},
	{-1, -1, 240, "DEVICE_APC_INFRA_PDN1", false},
};

static const struct mtk_device_info mt6899_devices_peri_par[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	...
	{0, 21, 21, "PERI_FAKE_ENG_MI20_APB_S", true},
	{0, 22, 22, "PERI_FAKE_ENG_MI21_APB_S", true},
	{0, 23, 23, "SSUSB_S", true},
	{0, 24, 24, "SSUSB_S-1", true},
	{0, 25, 25, "SSUSB_S-2", true},
	...
	{0, 32, 32, "UFS0_S", true},
	{0, 33, 33, "UFS0_S-1", true},
	{0, 34, 34, "UFS0_S-2", true},
	{0, 35, 35, "UFS0_S-3", true},
	{0, 36, 36, "UFS0_S-4", true},
	{0, 37, 37, "UFS0_S-5", true},
	{0, 38, 38, "UFS0_S-6", true},
	{0, 39, 39, "UFS0_S-7", true},
	{0, 40, 40, "UFS0_S-8", true},
	{0, 41, 41, "UFS0_S-9", true},
	{0, 42, 42, "PCIE_S", true},
	{0, 43, 43, "PCIE_S-1", true},
	{0, 44, 44, "PCIE_S-2", true},
	{0, 45, 45, "PCIE_S-3", true},
	{0, 46, 46, "PCIE_S-4", true},
	{0, 47, 47, "PCIE_S-5", true},
	{0, 48, 48, "PCIE_S-6", true},
	{0, 49, 49, "PCIE_S-7", true},
	{0, 50, 50, "PCIE_S-8", true},
	{0, 51, 51, "PCIE_S-9", true},
	{0, 52, 52, "PCIE_S-10", true},
	{0, 53, 53, "PCIE_S-11", true},
	{0, 54, 54, "PCIE_S-12", true},
	{0, 55, 55, "MBIST_AO_APB_S", true},
	{0, 56, 56, "BCRM_PERI_PAR_AO_APB_S", true},
	{0, 57, 57, "PERICFG_AO_APB_S", true},
	{0, 58, 58, "DEBUG_CTRL_PERI_PAR_AO_APB_S", true},
	{0, 59, 59, "DEVICE_APC_PERI_PAR_AO_APB_S", true},
	...
	{-1, -1, 92, "Decode_error", true},
	{-1, -1, 93, "APDMA", false},
	{-1, -1, 94, "IIC_P2P_REMPA", false},
	{-1, -1, 95, "DEVICE_APC_PERI _AO", false},
	{-1, -1, 96, "DEVICE_APC_PERI_PDN", false},
};

static const struct mtk_device_info mt6899_devices_vlp[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	...
	{0, 28, 28, "SPM_APB_S", true},
	{0, 29, 29, "SPM_APB_S-1", true},
	{0, 30, 30, "SPM_APB_S-2", true},
	{0, 31, 31, "SPM_APB_S-3", true},
	{0, 32, 32, "SPM_APB_S-4", true},
	{0, 33, 33, "SPM_APB_S-5", true},
	{0, 34, 34, "SPM_APB_S-6", true},
	{0, 35, 35, "SPM_APB_S-7", true},
	{0, 36, 36, "SPM_APB_S-8", true},
	{0, 37, 37, "SPM_APB_S-9", true},
	{0, 38, 38, "SPM_APB_S-10", true},
	{0, 39, 39, "SPM_APB_S-11", true},
	{0, 40, 40, "SPM_APB_S-12", true},
	{0, 41, 41, "SPM_APB_S-13", true},
	{0, 42, 42, "SYS_TIMER_APB_S", true},
	{0, 43, 43, "SYS_TIMER_APB_S-1", true},
	{0, 44, 44, "SYS_TIMER_APB_S-2", true},
	{0, 45, 45, "SYS_TIMER_APB_S-3", true},
	{0, 46, 46, "SYS_TIMER_APB_S-4", true},
	{0, 47, 47, "SYS_TIMER_APB_S-5", true},
	{0, 48, 48, "SYS_TIMER_APB_S-6", true},
	{0, 49, 49, "SYS_TIMER_APB_S-7", true},
	{0, 50, 50, "SYS_TIMER_APB_S-8", true},
	{0, 51, 51, "SYS_TIMER_APB_S-9", true},
	{0, 52, 52, "SYS_TIMER_APB_S-10", true},
	{0, 53, 53, "SYS_TIMER_APB_S-11", true},
	{0, 54, 54, "SYS_TIMER_APB_S-12", true},
	{0, 55, 55, "SYS_TIMER_APB_S-13", true},
	{0, 56, 56, "VLPCFG_AO_APB_S", true},
	{0, 57, 58, "SRCLKEN_RC_APB_S", true},
	{0, 58, 59, "TOPRGU_APB_S", true},
	{0, 59, 60, "APXGPT_APB_S", true},
	{0, 60, 61, "KP_APB_S", true},
	{0, 61, 62, "DVFSRC_APB_S", true},
	{0, 62, 63, "MBIST_APB_S", true},
	{0, 63, 65, "VLP_CKSYS_APB_S", true},
	{0, 64, 66, "TIA_APB_S", true},
	{0, 65, 67, "PMIF1_APB_S", true},
	{0, 66, 68, "PMIF2_APB_S", true},
	{0, 67, 69, "PMIF3_APB_S", true},
	{0, 68, 70, "PWM_VLP_APB_S", true},
	{0, 69, 71, "DEVICE_APC_VLP_AO_APB_S", true},
	{0, 70, 72, "DEVICE_APC_VLP_APB_S", true},
	{0, 71, 73, "BCRM_VLP_AO_APB_S", true},
	{0, 72, 74, "DEBUG_CTRL_VLP_AO_APB_S", true},
	{0, 73, 75, "VLPCFG_APB_S", true},
	{0, 74, 76, "SPMI_P_MST_APB_S", true},
	{0, 75, 77, "SPMI_M_MST_APB_S", true},
	{0, 76, 78, "EFUSE_DEBUG_AO_APB_S", true},
	{0, 77, 79, "AP_CIRQ_EINT_APB_S", true},
	{0, 78, 80, "DPSW_CTRL_APB_S", true},
	{0, 79, 81, "DPSW_CENTRAL_CTRL_APB_S", true},
	{0, 80, 82, "DPMSR_APB_S", true},
	{0, 81, 83, "DBG_tracker", true},
	{0, 82, 84, "SUBSYS_PM_GP_APB_S", true},
	{0, 83, 85, "UARTHUB_WAKEUP_APB_S", true},
	{-1, -1, 86, "OOB_way_en", true},
	{-1, -1, 87, "OOB_way_en", true},
	{-1, -1, 88, "OOB_way_en", true},
	{-1, -1, 89, "OOB_way_en", true},
	...
	{-1, -1, 122, "PMIF2", false},
	{-1, -1, 123, "PMIF3", false},
	{-1, -1, 124, "DEVICE_APC_VLP _AO", false},
	{-1, -1, 125, "DEVICE_APC_VLP_PDN", false},
};

static const struct mtk_device_info mt6899_devices_adsp[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	{0, 0, 0, "INFRA_S", true},
...
static const struct mtk_device_info mt6899_devices_mminfra[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	...
	{0, 45, 45, "MMINFRA_APB_S-29", true},
	{0, 46, 46, "MMINFRA_APB_S-30", true},
	{0, 47, 47, "MMINFRA_APB_S-31", true},
	{0, 48, 48, "MMINFRA_APB_S-32", true},
	{0, 49, 49, "MMINFRA_APB_S-33", true},
	{0, 50, 50, "MMINFRA_APB_S-34", true},
	{0, 51, 51, "MMINFRA_APB_S-35", true},
	{0, 52, 52, "MMINFRA_APB_S-36", true},
	{0, 53, 53, "MMINFRA_APB_S-37", true},
	{0, 54, 54, "MMINFRA_APB_S-38", true},
	{0, 55, 55, "MMINFRA_APB_S-51", true},
	{0, 56, 56, "DAPC_PDN_S", true},
	{0, 57, 57, "BCRM_PDN_S", true},
	{0, 58, 58, "HFRP_APB_S", true},
	{0, 59, 59, "HFRP_APB_S-1", true},
	{0, 60, 60, "VENC1_APB_S", true},
	{0, 61, 61, "VENC1_APB_S-1", true},
	{0, 62, 62, "VENC1_APB_S-2", true},
	{0, 63, 63, "VENC1_APB_S-3", true},
	{0, 64, 64, "VENC1_APB_S-4", true},
	{0, 65, 65, "VENC1_APB_S-5", true},
	{0, 66, 66, "VENC1_APB_S-6", true},
	{0, 67, 67, "VENC1_APB_S-7", true},
	{0, 68, 68, "VENC1_APB_S-11", true},
	{0, 69, 69, "VENC1_APB_S-12", true},
	{0, 70, 70, "VENC1_APB_S-13", true},
	{0, 71, 71, "VENC1_APB_S-14", true},
	{0, 72, 72, "VENC1_APB_S-15", true},
	{0, 73, 73, "VENC1_APB_S-16", true},
	{0, 74, 74, "VENC1_APB_S-17", true},
	{0, 75, 75, "VENC1_APB_S-18", true},
	...
	{0, 91, 91, "CCU_APB_S", true},
	{0, 92, 92, "CCU_APB_S-1", true},
	{0, 93, 93, "CCU_APB_S-2", true},
	{0, 94, 94, "CCU_APB_S-3", true},
	{0, 95, 95, "CCU_APB_S-4", true},
	{0, 96, 96, "CCU_APB_S-5", true},
	{0, 97, 97, "CCU_APB_S-6", true},
	{0, 98, 98, "CCU_APB_S-7", true},
	{0, 99, 99, "CCU_APB_S-8", true},
	{0, 100, 100, "CCU_APB_S-9", true},
	{0, 101, 101, "CCU_APB_S-10", true},
	{0, 102, 102, "CCU_APB_S-11", true},
	{0, 103, 103, "CCU_APB_S-12", true},
	{0, 104, 104, "CCU_APB_S-13", true},
	{0, 105, 105, "CCU_APB_S-14", true},
	{0, 106, 106, "CCU_APB_S-15", true},
	{0, 107, 107, "CCU_APB_S-16", true},
	{0, 108, 108, "CCU_APB_S-17", true},
	{0, 109, 109, "CCU_APB_S-18", true},
	{0, 110, 110, "CCU_APB_S-19", true},
	{0, 111, 111, "CCU_APB_S-20", true},
	{0, 112, 112, "CCU_APB_S-21", true},
	{0, 113, 113, "CCU_APB_S-22", true},
	{0, 114, 114, "CCU_APB_S-23", true},
	{0, 115, 115, "CCU_APB_S-24", true},
	{0, 116, 116, "CCU_APB_S-25", true},
	{0, 117, 117, "CCU_APB_S-26", true},
	{0, 118, 118, "CCU_APB_S-27", true},
	{0, 119, 119, "CCU_APB_S-28", true},
	{0, 120, 120, "CCU_APB_S-29", true},
	{0, 121, 121, "CCU_APB_S-30", true},
	{0, 122, 122, "CCU_APB_S-31", true},
	{0, 123, 123, "CCU_APB_S-32", true},
	{0, 124, 124, "CCU_APB_S-33", true},
	{0, 125, 125, "CCU_APB_S-34", true},
	{0, 126, 126, "IMG_APB_S", true},
	{0, 127, 127, "IMG_APB_S-1", true},
	{0, 128, 128, "IMG_APB_S-2", true},
	{0, 129, 129, "IMG_APB_S-3", true},
	{0, 130, 130, "IMG_APB_S-4", true},
	{0, 131, 131, "IMG_APB_S-5", true},
	{0, 132, 132, "IMG_APB_S-6", true},
	{0, 133, 133, "IMG_APB_S-7", true},
	{0, 134, 134, "IMG_APB_S-8", true},
	{0, 135, 135, "IMG_APB_S-9", true},
	{0, 136, 136, "IMG_APB_S-10", true},
	{0, 137, 137, "IMG_APB_S-11", true},
	{0, 138, 138, "IMG_APB_S-12", true},
	{0, 139, 139, "IMG_APB_S-13", true},
	{0, 140, 140, "IMG_APB_S-14", true},
	{0, 141, 141, "IMG_APB_S-15", true},
	{0, 142, 142, "IMG_APB_S-16", true},
	{0, 143, 143, "IMG_APB_S-17", true},
	{0, 144, 144, "IMG_APB_S-18", true},
	{0, 145, 145, "IMG_APB_S-19", true},
	{0, 146, 146, "IMG_APB_S-20", true},
	{0, 147, 147, "IMG_APB_S-21", true},
	{0, 148, 148, "IMG_APB_S-22", true},
	{0, 149, 149, "IMG_APB_S-23", true},
	{0, 150, 150, "IMG_APB_S-24", true},
	{0, 151, 151, "IMG_APB_S-25", true},
	{0, 152, 152, "IMG_APB_S-26", true},
	{0, 153, 153, "IMG_APB_S-27", true},
	{0, 154, 154, "IMG_APB_S-28", true},
	{0, 155, 155, "IMG_APB_S-29", true},
	{0, 156, 156, "IMG_APB_S-30", true},
	{0, 157, 157, "IMG_APB_S-31", true},
	{0, 158, 158, "IMG_APB_S-32", true},
	{0, 159, 159, "IMG_APB_S-33", true},
	{0, 160, 160, "IMG_APB_S-34", true},
	{0, 161, 161, "IMG_APB_S-35", true},
	{0, 162, 162, "IMG_APB_S-36", true},
	{0, 163, 163, "IMG_APB_S-37", true},
	{0, 164, 164, "IMG_APB_S-38", true},
	{0, 165, 165, "IMG_APB_S-39", true},
	{0, 166, 166, "IMG_APB_S-40", true},
	{0, 167, 167, "IMG_APB_S-41", true},
	{0, 168, 168, "IMG_APB_S-42", true},
	{0, 169, 169, "IMG_APB_S-43", true},
	{0, 170, 170, "IMG_APB_S-44", true},
	{0, 171, 171, "IMG_APB_S-45", true},
	{0, 172, 172, "IMG_APB_S-46", true},
	{0, 173, 173, "IMG_APB_S-47", true},
	{0, 174, 174, "IMG_APB_S-48", true},
	{0, 175, 175, "IMG_APB_S-49", true},
	{0, 176, 176, "IMG_APB_S-50", true},
	{0, 177, 177, "IMG_APB_S-51", true},
	{0, 178, 178, "IMG_APB_S-52", true},
	{0, 179, 179, "IMG_APB_S-53", true},
	{0, 180, 180, "IMG_APB_S-54", true},
	{0, 181, 181, "IMG_APB_S-55", true},
	{0, 182, 182, "IMG_APB_S-56", true},
	{0, 183, 183, "IMG_APB_S-57", true},
	{0, 184, 184, "IMG_APB_S-58", true},
	{0, 185, 185, "IMG_APB_S-59", true},
	{0, 186, 186, "IMG_APB_S-60", true},
	{0, 187, 187, "IMG_APB_S-61", true},
	{0, 188, 188, "IMG_APB_S-62", true},
	{0, 189, 189, "IMG_APB_S-63", true},
	{0, 190, 190, "IMG_APB_S-64", true},
	{0, 191, 191, "IMG_APB_S-65", true},
	{0, 192, 192, "IMG_APB_S-66", true},
	{0, 193, 193, "IMG_APB_S-67", true},
	{0, 194, 194, "IMG_APB_S-68", true},
	{0, 195, 195, "IMG_APB_S-69", true},
	{0, 196, 196, "IMG_APB_S-70", true},
	{0, 197, 197, "IMG_APB_S-71", true},
	{0, 198, 198, "IMG_APB_S-72", true},
	{0, 199, 199, "IMG_APB_S-73", true},
	{0, 200, 200, "IMG_APB_S-74", true},
	{0, 201, 201, "IMG_APB_S-75", true},
	{0, 202, 202, "IMG_APB_S-76", true},
	{0, 203, 203, "IMG_APB_S-77", true},
	{0, 204, 204, "IMG_APB_S-78", true},
	{0, 205, 205, "IMG_APB_S-79", true},
	{0, 206, 206, "IMG_APB_S-80", true},
	{0, 207, 207, "IMG_APB_S-81", true},
	{0, 208, 208, "IMG_APB_S-82", true},
	{0, 209, 209, "CAM_APB_S", true},
	{0, 210, 210, "CAM_APB_S-1", true},
	{0, 211, 211, "CAM_APB_S-2", true},
	{0, 212, 212, "CAM_APB_S-3", true},
	{0, 213, 213, "CAM_APB_S-4", true},
	{0, 214, 214, "CAM_APB_S-5", true},
	{0, 215, 215, "CAM_APB_S-6", true},
	{0, 216, 216, "CAM_APB_S-7", true},
	{0, 217, 217, "CAM_APB_S-8", true},
	{0, 218, 218, "CAM_APB_S-9", true},
	{0, 219, 219, "CAM_APB_S-10", true},
	{0, 220, 220, "CAM_APB_S-11", true},
	{0, 221, 221, "CAM_APB_S-12", true},
	{0, 222, 222, "CAM_APB_S-13", true},
	{0, 223, 223, "CAM_APB_S-14", true},
	{0, 224, 224, "CAM_APB_S-15", true},
	{0, 225, 225, "CAM_APB_S-16", true},
	{0, 226, 226, "CAM_APB_S-17", true},
	{0, 227, 227, "CAM_APB_S-18", true},
	{0, 228, 228, "CAM_APB_S-19", true},
	{0, 229, 229, "CAM_APB_S-20", true},
	{0, 230, 230, "CAM_APB_S-21", true},
	{0, 231, 231, "CAM_APB_S-22", true},
	{0, 232, 232, "CAM_APB_S-23", true},
	{0, 233, 233, "CAM_APB_S-24", true},
	{0, 234, 234, "CAM_APB_S-25", true},
	{0, 235, 235, "CAM_APB_S-26", true},
	{0, 236, 236, "CAM_APB_S-27", true},
	{0, 237, 237, "CAM_APB_S-28", true},
	{0, 238, 238, "CAM_APB_S-29", true},
	{0, 239, 239, "CAM_APB_S-30", true},
	{0, 240, 240, "CAM_APB_S-31", true},
	{0, 241, 241, "CAM_APB_S-32", true},
	{0, 242, 242, "CAM_APB_S-33", true},
	{0, 243, 243, "CAM_APB_S-34", true},
	{0, 244, 244, "CAM_APB_S-35", true},
	{0, 245, 245, "CAM_APB_S-36", true},
	{0, 246, 246, "CAM_APB_S-37", true},
	{0, 247, 247, "CAM_APB_S-38", true},
	{0, 248, 248, "CAM_APB_S-39", true},
	{0, 249, 249, "CAM_APB_S-40", true},
	{0, 250, 250, "CAM_APB_S-41", true},
	{0, 251, 251, "CAM_APB_S-42", true},
	{0, 252, 252, "CAM_APB_S-43", true},
	{0, 253, 253, "CAM_APB_S-44", true},
	{0, 254, 254, "CAM_APB_S-45", true},
	{0, 255, 255, "CAM_APB_S-46", true},
	{1, 0, 256, "CAM_APB_S-47", true},
	{1, 1, 257, "CAM_APB_S-48", true},
	{1, 2, 258, "CAM_APB_S-49", true},
	{1, 3, 259, "CAM_APB_S-50", true},
	{1, 4, 260, "CAM_APB_S-51", true},
	{1, 5, 261, "CAM_APB_S-52", true},
	{1, 6, 262, "CAM_APB_S-53", true},
	{1, 7, 263, "CAM_APB_S-54", true},
	{1, 8, 264, "CAM_APB_S-55", true},
	{1, 9, 265, "CAM_APB_S-56", true},
	{1, 10, 266, "CAM_APB_S-57", true},
	{1, 11, 267, "CAM_APB_S-58", true},
	{1, 12, 268, "CAM_APB_S-59", true},
	{1, 13, 269, "CAM_APB_S-60", true},
	{1, 14, 270, "CAM_APB_S-61", true},
	{1, 15, 271, "CAM_APB_S-62", true},
	{1, 16, 272, "CAM_APB_S-63", true},
	{1, 17, 273, "CAM_APB_S-64", true},
	{1, 18, 274, "CAM_APB_S-65", true},
	{1, 19, 275, "CAM_APB_S-66", true},
	{1, 20, 276, "CAM_APB_S-67", true},
	{1, 21, 277, "CAM_APB_S-68", true},
	{1, 22, 278, "CAM_APB_S-69", true},
	{1, 23, 279, "CAM_APB_S-70", true},
	{1, 24, 280, "CAM_APB_S-71", true},
	{1, 25, 281, "CAM_APB_S-72", true},
	{1, 26, 282, "CAM_APB_S-73", true},
	{1, 27, 283, "CAM_APB_S-74", true},
	{1, 28, 284, "CAM_APB_S-75", true},
	{1, 29, 285, "CAM_APB_S-76", true},
	{1, 30, 286, "CAM_APB_S-77", true},
	{1, 31, 287, "CAM_APB_S-78", true},
	{1, 32, 288, "CAM_APB_S-79", true},
	{1, 33, 289, "CAM_APB_S-80", true},
	{1, 34, 290, "CAM_APB_S-81", true},
	{1, 35, 291, "CAM_APB_S-82", true},
	{1, 36, 292, "CAM_APB_S-83", true},
	{1, 37, 293, "CAM_APB_S-84", true},
	{1, 38, 294, "CAM_APB_S-85", true},
	{1, 39, 295, "CAM_APB_S-86", true},
	{1, 40, 296, "CAM_APB_S-87", true},
	{1, 41, 297, "CAM_APB_S-88", true},
	{1, 42, 298, "CAM_APB_S-89", true},
	{1, 43, 299, "CAM_APB_S-90", true},
	{1, 44, 300, "CAM_APB_S-91", true},
	{1, 45, 301, "CAM_APB_S-92", true},
	{1, 46, 302, "CAM_APB_S-93", true},
	{1, 47, 303, "CAM_APB_S-94", true},
	{1, 48, 304, "CAM_APB_S-95", true},
	{1, 49, 305, "CAM_APB_S-96", true},
	{1, 50, 306, "CAM_APB_S-97", true},
	{1, 51, 307, "CAM_APB_S-98", true},
	{1, 52, 308, "CAM_APB_S-99", true},
	{1, 53, 309, "CAM_APB_S-100", true},
	{1, 54, 310, "CAM_APB_S-101", true},
	{1, 55, 311, "CAM_APB_S-102", true},
	{1, 56, 312, "CAM_APB_S-103", true},
	{1, 57, 313, "CAM_APB_S-104", true},
	{1, 58, 314, "CAM_APB_S-105", true},
	{1, 59, 315, "CAM_APB_S-106", true},
	{1, 60, 316, "CAM_APB_S-107", true},
	{1, 61, 317, "CAM_APB_S-108", true},
	{1, 62, 318, "CAM_APB_S-109", true},
	{1, 63, 319, "CAM_APB_S-110", true},
	{1, 64, 320, "CAM_APB_S-111", true},
	{1, 65, 321, "CAM_APB_S-112", true},
	{1, 66, 322, "CAM_APB_S-113", true},
	{1, 67, 323, "CAM_APB_S-114", true},
	{1, 68, 324, "CAM_APB_S-115", true},
	{1, 69, 325, "CAM_APB_S-116", true},
	{1, 70, 326, "CAM_APB_S-117", true},
	{1, 71, 327, "CAM_APB_S-118", true},
	{1, 72, 328, "CAM_APB_S-119", true},
	{1, 73, 329, "CAM_APB_S-120", true},
	{1, 74, 330, "CAM_APB_S-121", true},
	{1, 75, 331, "DISP_APB_S", true},
	{1, 76, 332, "DISP_APB_S-1", true},
	{1, 77, 333, "DISP_APB_S-2", true},
	{1, 78, 334, "DISP_APB_S-3", true},
	{1, 79, 335, "DISP_APB_S-4", true},
	{1, 80, 336, "DISP_APB_S-5", true},
	{1, 81, 337, "DISP_APB_S-6", true},
	{1, 82, 338, "DISP_APB_S-7", true},
	{1, 83, 339, "DISP_APB_S-8", true},
	{1, 84, 340, "DISP_APB_S-9", true},
	{1, 85, 341, "DISP_APB_S-10", true},
	{1, 86, 342, "DISP_APB_S-11", true},
	{1, 87, 343, "DISP_APB_S-12", true},
	{1, 88, 344, "DISP_APB_S-13", true},
	{1, 89, 345, "DISP_APB_S-14", true},
	{1, 90, 346, "DISP_APB_S-15", true},
	{1, 91, 347, "DISP_APB_S-16", true},
	{1, 92, 348, "DISP_APB_S-17", true},
	{1, 93, 349, "DISP_APB_S-18", true},
	{1, 94, 350, "DISP_APB_S-19", true},
	{1, 95, 351, "DISP_APB_S-20", true},
	{1, 96, 352, "DISP_APB_S-21", true},
	{1, 97, 353, "DISP_APB_S-22", true},
	{1, 98, 354, "DISP_APB_S-23", true},
	{1, 99, 355, "DISP_APB_S-24", true},
	{1, 100, 356, "DISP_APB_S-25", true},
	{1, 101, 357, "DISP_APB_S-26", true},
	{1, 102, 358, "DISP_APB_S-27", true},
	{1, 103, 359, "DISP_APB_S-28", true},
	{1, 104, 360, "DISP_APB_S-29", true},
	{1, 105, 361, "DISP_APB_S-30", true},
	{1, 106, 362, "DISP_APB_S-31", true},
	{1, 107, 363, "DISP_APB_S-32", true},
	{1, 108, 364, "DISP_APB_S-33", true},
	{1, 109, 365, "DISP_APB_S-34", true},
	{1, 110, 366, "DISP_APB_S-35", true},
	{1, 111, 367, "DISP_APB_S-36", true},
	{1, 112, 368, "DISP_APB_S-37", true},
	{1, 113, 369, "DISP_APB_S-38", true},
	{1, 114, 370, "DISP_APB_S-39", true},
	{1, 115, 371, "DISP_APB_S-40", true},
	{1, 116, 372, "DISP_APB_S-41", true},
	{1, 117, 373, "DISP_APB_S-42", true},
	{1, 118, 374, "DISP_APB_S-43", true},
	{1, 119, 375, "DISP_APB_S-44", true},
	{1, 120, 376, "DISP_APB_S-45", true},
	{1, 121, 377, "DISP_APB_S-46", true},
	{1, 122, 378, "DISP_APB_S-47", true},
	{1, 123, 379, "DISP_APB_S-48", true},
	{1, 124, 380, "DISP_APB_S-49", true},
	{1, 125, 381, "DISP_APB_S-50", true},
	{1, 126, 382, "DISP_APB_S-51", true},
	{1, 127, 383, "DISP_APB_S-52", true},
	{1, 128, 384, "DISP_APB_S-53", true},
	{1, 129, 385, "DISP_APB_S-54", true},
	{1, 130, 386, "DISP_APB_S-55", true},
	{1, 131, 387, "DISP_APB_S-56", true},
	{1, 132, 388, "DISP_APB_S-57", true},
	{1, 133, 389, "DISP_APB_S-58", true},
	{1, 134, 390, "DISP_APB_S-59", true},
	{1, 135, 391, "DISP_APB_S-60", true},
	{1, 136, 392, "DISP_APB_S-61", true},
	{1, 137, 393, "DISP_APB_S-62", true},
	{1, 138, 394, "DISP_APB_S-63", true},
	{1, 139, 395, "DISP_APB_S-64", true},
	{1, 140, 396, "DISP_APB_S-65", true},
	{1, 141, 397, "DISP_APB_S-66", true},
	{1, 142, 398, "DISP_APB_S-67", true},
	{1, 143, 399, "DISP_APB_S-68", true},
	{1, 144, 400, "DISP_APB_S-69", true},
	{1, 145, 401, "DISP_APB_S-70", true},
	{1, 146, 402, "DISP_APB_S-71", true},
	{1, 147, 403, "DISP_APB_S-72", true},
	{1, 148, 404, "DISP_APB_S-73", true},
	{1, 149, 405, "DISP_APB_S-74", true},
	{1, 150, 406, "DISP_APB_S-75", true},
	{1, 151, 407, "DISP_APB_S-76", true},
	{1, 152, 408, "DISP_APB_S-77", true},
	{1, 153, 409, "DISP_APB_S-78", true},
	{1, 154, 410, "DISP_APB_S-79", true},
	{1, 155, 411, "DISP_APB_S-80", true},
	{1, 156, 412, "DISP_APB_S-81", true},
	{1, 157, 413, "DISP_APB_S-82", true},
	{1, 158, 414, "DISP_APB_S-83", true},
	{1, 159, 415, "DISP_APB_S-84", true},
	{1, 160, 416, "DISP_APB_S-85", true},
	{1, 161, 417, "DISP_APB_S-86", true},
	{1, 162, 418, "DISP_APB_S-87", true},
	{1, 163, 419, "DISP_APB_S-88", true},
	{1, 164, 420, "DISP_APB_S-89", true},
	{1, 165, 421, "DISP_APB_S-90", true},
	{1, 166, 422, "DISP_APB_S-91", true},
	{1, 167, 423, "DISP_APB_S-92", true},
	{1, 168, 424, "DISP_APB_S-93", true},
	{1, 169, 425, "DISP_APB_S-94", true},
	{1, 170, 426, "DISP_APB_S-95", true},
	{1, 171, 427, "DISP_APB_S-96", true},
	{1, 172, 428, "DISP_APB_S-97", true},
	{1, 173, 429, "DISP_APB_S-98", true},
	{1, 174, 430, "DISP_APB_S-99", true},
	{1, 175, 431, "DISP_APB_S-100", true},
	{1, 176, 432, "DISP_APB_S-101", true},
	{1, 177, 433, "DISP_APB_S-102", true},
	{1, 178, 434, "DISP_APB_S-103", true},
	{1, 179, 435, "DISP_APB_S-104", true},
	{1, 180, 436, "DISP_APB_S-105", true},
	{1, 181, 437, "DISP_APB_S-106", true},
	{1, 182, 438, "DISP_APB_S-107", true},
	{1, 183, 439, "DISP_APB_S-108", true},
	{1, 184, 440, "DISP_APB_S-109", true},
	{1, 185, 441, "DISP_APB_S-110", true},
	{1, 186, 442, "DISP_APB_S-111", true},
	{1, 187, 443, "DISP_APB_S-112", true},
	{1, 188, 444, "DISP_APB_S-113", true},
	{1, 189, 445, "DISP_APB_S-114", true},
	{1, 190, 446, "DISP_APB_S-115", true},
	{1, 191, 447, "DISP_APB_S-116", true},
	{1, 192, 448, "DISP_APB_S-117", true},
	{1, 193, 449, "DISP_APB_S-118", true},
	{1, 194, 450, "DISP_APB_S-119", true},
	{1, 195, 451, "DISP_APB_S-120", true},
	{1, 196, 452, "DISP_APB_S-121", true},
	{1, 197, 453, "DISP_APB_S-122", true},
	{1, 198, 454, "DISP_APB_S-123", true},
	{1, 199, 455, "DISP_APB_S-124", true},
	{1, 200, 456, "DISP_APB_S-125", true},
	{1, 201, 457, "DISP_APB_S-126", true},
	{1, 202, 458, "DISP_APB_S-127", true},
	{1, 203, 459, "DISP_APB_S-128", true},
	{1, 204, 460, "DISP_APB_S-129", true},
	{1, 205, 461, "DISP_APB_S-130", true},
	{1, 206, 462, "DISP_APB_S-131", true},
	{1, 207, 463, "DISP_APB_S-132", true},
	{1, 208, 464, "DISP_APB_S-133", true},
	{1, 209, 465, "DISP_APB_S-134", true},
	{1, 210, 466, "DISP_APB_S-135", true},
	{1, 211, 467, "DISP_APB_S-136", true},
	{1, 212, 468, "DISP_APB_S-137", true},
	{1, 213, 469, "DISP_APB_S-138", true},
	{1, 214, 470, "DISP_APB_S-139", true},
	{1, 215, 471, "DISP_APB_S-140", true},
	{1, 216, 472, "DISP_APB_S-141", true},
	{1, 217, 473, "DISP_APB_S-142", true},
	{1, 218, 474, "DISP_APB_S-143", true},
	{1, 219, 475, "DISP_APB_S-144", true},
	{1, 220, 476, "DISP_APB_S-145", true},
	{1, 221, 477, "DISP_APB_S-146", true},
	{1, 222, 478, "DISP_APB_S-147", true},
	{1, 223, 479, "DISP_APB_S-148", true},
	{1, 224, 480, "DISP_APB_S-149", true},
	{1, 225, 481, "DISP_APB_S-150", true},
	{1, 226, 482, "DISP_APB_S-151", true},
	{1, 227, 483, "DISP_APB_S-152", true},
	{1, 228, 484, "DISP_APB_S-153", true},
	{1, 229, 485, "DISP_APB_S-154", true},
	{1, 230, 486, "DISP_APB_S-155", true},
	{1, 231, 487, "DISP_APB_S-156", true},
	{1, 232, 488, "DISP_APB_S-157", true},
	{1, 233, 489, "DISP_APB_S-158", true},
	{1, 234, 490, "DISP_APB_S-159", true},
	{1, 235, 491, "DISP_APB_S-160", true},
	{1, 236, 492, "DISP_APB_S-161", true},
	{1, 237, 493, "DISP_APB_S-162", true},
	{1, 238, 494, "DISP_APB_S-163", true},
	{1, 239, 495, "DISP_APB_S-164", true},
	{1, 240, 496, "DISP_APB_S-165", true},
	{1, 241, 497, "DISP_APB_S-166", true},
	{1, 242, 498, "DISP_APB_S-167", true},
	{1, 243, 499, "DISP_APB_S-168", true},
	{1, 244, 500, "DISP_APB_S-169", true},
	{1, 245, 501, "DISP_APB_S-170", true},
	{1, 246, 502, "DISP_APB_S-171", true},
	{1, 247, 503, "DISP_APB_S-172", true},
	{1, 248, 504, "DISP_APB_S-173", true},
	{1, 249, 505, "DISP_APB_S-174", true},
	{1, 250, 506, "DISP_APB_S-175", true},
	{1, 251, 507, "DISP_APB_S-176", true},
	{1, 252, 508, "DISP_APB_S-177", true},
	{1, 253, 509, "DISP_APB_S-178", true},
	{1, 254, 510, "DISP_APB_S-179", true},
	{1, 255, 511, "DISP_APB_S-180", true},
	{2, 0, 512, "DISP_APB_S-181", true},
	{2, 1, 513, "DISP_APB_S-182", true},
	{2, 2, 514, "DISP_APB_S-183", true},
	{2, 3, 515, "DISP_APB_S-184", true},
	{2, 4, 516, "DISP_APB_S-185", true},
	{2, 5, 517, "DISP_APB_S-186", true},
	{2, 6, 518, "DISP_APB_S-187", true},
	{2, 7, 520, "HRE_APB_S", true},
	{2, 8, 529, "MMINFRA_AO_APB_S", true},
	{2, 9, 530, "DAPC_AO_S", true},
	{2, 10, 531, "BCRM_AO_S", true},
	{2, 11, 532, "DEBUG_CTL_AO_S", true},
	{-1, -1, 533, "OOB_way_en", true},
	{-1, -1, 534, "OOB_way_en", true},
	{-1, -1, 535, "OOB_way_en", true},
	{-1, -1, 536, "OOB_way_en", true},
	{-1, -1, 537, "OOB_way_en", true},
	{-1, -1, 538, "OOB_way_en", true},
	{-1, -1, 539, "OOB_way_en", true},
	{-1, -1, 540, "OOB_way_en", true},
	...
	{-1, -1, 554, "Decode_error", true},
	{-1, -1, 555, "Decode_error", true},
	{-1, -1, 556, "Decode_error", true},
	{-1, -1, 557, "Decode_error", true},
	{-1, -1, 558, "Decode_error", true},
	{-1, -1, 559, "GCE_D", false},
	{-1, -1, 560, "GCE_M", false},
	{-1, -1, 561, "DEVICE_APC_MM_AO", false},
	{-1, -1, 562, "DEVICE_APC_MM_PDN", false},
};

static const struct mtk_device_info mt6899_devices_mmup[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	...
	{0, 17, 17, "pbus_tracker", true},
	{0, 18, 18, "pCACHE0", true},
	{0, 19, 19, "pslv_cfgreg_sec", true},
	{0, 20, 20, "p_mbox0", true},
	{0, 21, 21, "p_mbox1", true},
	{0, 22, 22, "p_mbox2", true},
	{0, 23, 23, "p_mbox3", true},
	{0, 24, 24, "p_mbox4", true},
	{0, 25, 25, "pslv_rsv00", true},
	{0, 26, 26, "pslv_rsv01", true},
	{0, 27, 27, "pslv_rsv02", true},
	{0, 28, 28, "pslv_rsv03", true},
	{0, 29, 29, "pslv_rsv04", true},
	{0, 30, 30, "pslv_dvfsrc_vmm", true},
	{0, 31, 31, "pslv_dvfsrc_vdisp", true},
	{0, 32, 32, "pslv_dpsw_vdec", true},
	{0, 33, 33, "pslv_dpsw_vdisp", true},
	{0, 34, 34, "pslv_hfrp_pwr_ctrl", true},
	{0, 35, 35, "HWCCF_S", true},
	{0, 36, 36, "pslv_sub_pm", true},
	{0, 37, 37, "pslv_sub_pm_reg", true},
	{0, 38, 38, "pslv_hw_vote", true},
	{0, 39, 39, "p_main_BCRM_PDN", true},
};

static const struct mtk_device_info mt6899_devices_gpu[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	{0, 0, 0, "MFG_MALI_IP", true},
	{0, 1, 1, "MFG_SMMU_ELA(NO USE)", true},
	{0, 2, 2, "MFG_MPU", true},
	{0, 3, 3, "MFG_DFD_V2P0", true},
	{0, 4, 4, "MFG_SECURE_REG", true},
	{0, 5, 5, "MFG_IPS_SES", true},
	{0, 6, 6, "MFG_TOP_AXUSER_CONFIG", true},
	{0, 7, 7, "MFG_SMMU_ELA(NO USE)", true},
	{0, 8, 8, "MFG_VGPU_BRISKET_0", true},
	{0, 9, 9, "MFG_VGPU_GPM", true},
	{0, 10, 10, "MFG_SENSOR_NETWORK", true},
	{0, 11, 11, "MFG_DVFS_HINT", true},
	{0, 12, 12, "MFG_EVENT_COUNTING_GPM_SENSOR_SC0", true},
	{0, 13, 13, "MFG_EVENT_COUNTING_GPM_SENSOR_SC1", true},
	{0, 14, 14, "MFG_BRISKET_GPM_ST0", true},
	{0, 15, 15, "MFG_EVENT_COUNTING_GPM_SENSOR_SC2", true},
	{0, 16, 16, "MFG_EVENT_COUNTING_GPM_SENSOR_SC3", true},
	{0, 17, 17, "MFG_BRISKET_GPM_ST2", true},
	{0, 18, 18, "MFG_EVENT_COUNTING_GPM_SENSOR_SC4", true},
	{0, 19, 19, "MFG_EVENT_COUNTING_GPM_SENSOR_SC5", true},
	{0, 20, 20, "MFG_BRISKET_GPM_ST3", true},
	{0, 21, 21, "MFG_EVENT_COUNTING_GPM_SENSOR_SC6", true},
	{0, 22, 22, "MFG_EVENT_COUNTING_GPM_SENSOR_SC7", true},
	{0, 23, 23, "MFG_BRISKET_GPM_ST4", true},
	{0, 24, 24, "MFG_EVENT_COUNTING_GPM_SENSOR_SC8", true},
	{0, 25, 25, "MFG_EVENT_COUNTING_GPM_SENSOR_SC9", true},
	{0, 26, 26, "MFG_BRISKET_GPM_ST5", true},
	{0, 27, 27, "MFG_EVENT_COUNTING_GPM_SENSOR_SC10", true},
	{0, 28, 28, "MFG_EVENT_COUNTING_GPM_SENSOR_SC11", true},
	{0, 29, 29, "MFG_BRISKET_GPM_ST6", true},
	{0, 30, 30, "MFG_GPM_IPS_SES_CG", true},
};

static const struct mtk_device_info mt6899_devices_gpu1[] = {
	/* sys_idx, ctrl_idx, vio_idx, device, vio_irq */
	{0, 0, 0, "MFG_GPU EB_TCM", true},
	{0, 1, 1, "RESERVE", true},
	{0, 2, 2, "MFG_GPU_EB_AUTODMA", true},
	{0, 3, 3, "MFG_GPU EB_CKCTRL", true},
	{0, 4, 4, "MFG_GPU EB_INTC", true},
	{0, 5, 5, "MFG_GPU EB_DMA", true},
	{0, 6, 6, "MFG_GPU EB_CFGREG", true},
	{0, 7, 7, "MFG_GPU EB_SCUAPB", true},
	{0, 8, 8, "MFG_GPU EB_DBGAPB", true},
	{0, 9, 9, "MFG_GPU EB_MBOX", true},
	{0, 10, 10, "MFG_CPE_CONTROL", true},
	{0, 11, 11, "RESERVE", true},
	{0, 12, 12, "MFG_HBVC_WRAP", true},
	{0, 13, 13, "MFG_RPCTOP_REG", true},
	{0, 14, 14, "MFG_PLL", true},
	{0, 15, 15, "MFG_VDNR_VGPU_devapc_ao", true},
	{0, 16, 16, "MFG_VDNR_VGPU_devapc_vio", true},
	{0, 17, 17, "MFG_VDNR_VCORE_devapc_ao", true},
	{0, 18, 18, "MFG_VDNR_VCORE_devapc_vio", true},
	{0, 19, 19, "MFG_DPMSR", true},
	{0, 20, 20, "MFG_DFD_V3P6", true},
	{0, 21, 21, "MFG_PTP_THERMAL_CTRL", true},
	{0, 22, 22, "RESERVE", true},
};

enum DEVAPC_VIO_SLAVE_NUM {
	VIO_SLAVE_NUM_INFRA = ARRAY_SIZE(mt6899_devices_infra),
	VIO_SLAVE_NUM_INFRA1 = ARRAY_SIZE(mt6899_devices_infra1),
	VIO_SLAVE_NUM_PERI_PAR = ARRAY_SIZE(mt6899_devices_peri_par),
	VIO_SLAVE_NUM_VLP = ARRAY_SIZE(mt6899_devices_vlp),
	VIO_SLAVE_NUM_ADSP = ARRAY_SIZE(mt6899_devices_adsp),
	VIO_SLAVE_NUM_MMINFRA = ARRAY_SIZE(mt6899_devices_mminfra),
	VIO_SLAVE_NUM_MMUP = ARRAY_SIZE(mt6899_devices_mmup),
	VIO_SLAVE_NUM_GPU = ARRAY_SIZE(mt6899_devices_gpu),
	VIO_SLAVE_NUM_GPU1 = ARRAY_SIZE(mt6899_devices_gpu1),
};

#endif /* __DEVAPC_MT6899_H__ */
