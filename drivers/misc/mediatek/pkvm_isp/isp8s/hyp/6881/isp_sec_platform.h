...
#define CAMA_BASE       0x1a700000
#define CAMB_BASE       0x1a900000

#define CAMA_RMSBASE    0x1a740000
#define CAMB_RMSBASE    0x1a940000

#define CAMA_YUVBASE    0x1a780000
#define CAMB_YUVBASE    0x1a980000

#define RAWA_ROOT_BASE  0x1a7e0000
#define RAWB_ROOT_BASE  0x1a9e0000

#define RMSA_ROOT_BASE  0x1a800000
#define RMSB_ROOT_BASE  0x1aa00000

#define YUVA_ROOT_BASE  0x1a820000
#define YUVB_ROOT_BASE  0x1aa20000
...
/*Offset*/
// RAWA_ROOT_BASE: 0x1a7e2000 | RAWB_ROOT_BASE  0x1a9e2000 | RAWC_ROOT_BASE  0x1abe2000
#define CAMCTL_ROOT_CID                     0x0     //0x1a7e2000
#define CAMCTL_ROOT_STAT_PROT_EN            0x10    //0x1a7e010
#define CAMCTL_ROOT_STAT_PROT_SIZE0         0x14    //0x1a7e2014
#define CAMCTL_ROOT_STAT_PROT_SIZE1         0x18    //0x1a7e2018
#define CAMCTL_ROOT_STAT_PROT_SIZE2         0x1C    //0x1a7e201c
#define CAMCTL_ROOT_STAT_PROT_SIZE3         0x20    //0x1a7e2020
#define CAMCTL_ROOT_STAT_PROT_SIZE4         0x24    //0x1a7e2024
#define CAMCTL_ROOT_STAT_PROT_SIZE5         0x28    //0x1a7e2028
#define CAMCTL_ROOT_STAT_PROT_SIZE6         0x2C    //0x1a7e202c
#define CAMCTL_ROOT_STAT_PROT_SIZE7         0x30    //0x1a7e2030
#define CAMCTL_ROOT_RAW_SEL_SECURE_LOCK     0x38    //0x1a7e2038
...
#define CAMRAWDMA_ROOT_SECURE_CTRL          0x1000  //0x1a7e3000
#define CAMRAWDMA_ROOT_DOMAIN_REGISTER_2    0x100C  //0x1a7e300c
#define CAMRAWDMA_ROOT_DOMAIN_REGISTER_3    0x1010  //0x1a7e3010
#define CAMRAWDMA_ROOT_DOMAIN_REGISTER_6    0x101C  //0x1a7e301c
#define CAMRAWDMA_ROOT_DOMAIN_REGISTER_9    0x1028  //0x1a7e3028
#define CAMRAWDMA_ROOT_SECURE_REGISTER_0    0x1048  //0x1a7e3048
#define CAMRAWDMA_ROOT_SECURE_REGISTER_1    0x1060  //0x1a7e3060
// YUVA_ROOT_BASE  0x3a822000
#define CAMYUVDMA_ROOT_SECURE_CTRL          0x1000  //0x1a823000
#define CAMYUVDMA_ROOT_DOMAIN_REGISTER_0    0x1004  //0x1a823004
#define CAMYUVDMA_ROOT_DOMAIN_REGISTER_1    0x1008  //0x1a823008
#define CAMYUVDMA_ROOT_DOMAIN_REGISTER_2    0x100C  //0x1a82300c
#define CAMYUVDMA_ROOT_DOMAIN_REGISTER_3    0x1010  //0x1a823010
#define CAMYUVDMA_ROOT_DOMAIN_REGISTER_4    0x1014  //0x1a823014
#define CAMYUVDMA_ROOT_SECURE_REGISTER_0    0x1018  //0x1a823018
/*Offset end*/
/*Default value*/
...
typedef union {
	struct /* 0x1A7E2024 */ {
		FIELD CAMCTL_ROOT_tsfs_w_hsize                                    : 12;    /*  0..11, 0x00000fff */
		FIELD rsv_12                                                      :  4;    /* 12..15, 0x0000f000 */
		FIELD CAMCTL_ROOT_tsfs_w_vsize                                    : 12;    /* 16..27, 0x0fff0000 */
...
typedef union {
	struct /* 0x1A801018 */ {
		FIELD CAMCTL3_ROOT_TSFS_W_HSIZE                                   : 12;    /*  0..11, 0x00000fff */
		FIELD rsv_12                                                      :  4;    /* 12..15, 0x0000f000 */
		FIELD CAMCTL3_ROOT_TSFS_W_VSIZE                                   : 12;    /* 16..27, 0x0fff0000 */
		FIELD rsv_28                                                      :  4;    /* 28..31, 0xf0000000 */
	} Bits;
	UINT32 Raw;
