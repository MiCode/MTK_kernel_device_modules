			       ...
			       bool debug)
{
	...
	start_dma = xhci_trb_virt_to_dma_(td->start_seg, td->first_trb);
	...
	do {
		...
		end_trb_dma = xhci_trb_virt_to_dma_(cur_seg, td->last_trb);
			   ...
			   struct xhci_transfer_event *event)
{
	...
	trace_xhci_handle_transfer_(ep_ring, (struct xhci_generic_trb *) ep_trb);
