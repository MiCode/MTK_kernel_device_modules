...
static struct tx_power mt6768_mdpm_tx_pwr[TX_DBM_NUM] = {
	...
	[TX_C2K_DBM] = {
		...
		.rfhw = &rfhw_6768[TX_C2K_DBM],
	}
};

static struct mdpm_scenario mt6768_mdpm_scen[SCENARIO_NUM] = {
	[S_STANDBY] = {
		.scenario_reg = 0,
		.scenario_name = "S_STANDBY",
		.scenario_power = &md_scen_power_6768[S_STANDBY],
	...
	[S_2G_CONNECT] = {
		...
		.scenario_power = &md_scen_power_6768[S_2G_CONNECT],
	...
	[S_3G_C2K_TALKING] = {
		.scenario_reg = 1 << 2,
		.scenario_name = "S_3G_C2K_TALKING",
		.scenario_power = &md_scen_power_6768[S_3G_C2K_TALKING],
		.tx_power_rat = {RAT_3G, RAT_C2K, 0, 0, 0},
		.tx_power_rat_sum = true,
	},

	[S_3G_4G_C2K_PAGING] = {
		.scenario_reg = 1 << 3,
		.scenario_name = "S_3G_4G_C2K_PAGING",
		.scenario_power = &md_scen_power_6768[S_3G_4G_C2K_PAGING],
		.tx_power_rat = {RAT_3G, RAT_C2K, RAT_4G, 0, 0},
		.tx_power_rat_sum = true,
	},

	[S_3G_C2K_DATALINK] = {
		.scenario_reg = 1 << 4,
		.scenario_name = "S_3G_C2K_DATALINK",
		.scenario_power = &md_scen_power_6768[S_3G_C2K_DATALINK],
		.tx_power_rat = {RAT_3G, RAT_C2K, 0, 0, 0},
		.tx_power_rat_sum = true,
	},
	...
	[S_4G_DL_1CC] = {
		.scenario_reg = 1 << 5,
		.scenario_name = "S_4G_DL_1CC",
		.scenario_power = &md_scen_power_6768[S_4G_DL_1CC],
		.tx_power_rat = {RAT_4G, 0, 0, 0, 0},
		.tx_power_rat_sum = false,
	},

	[S_4G_DL_2CC] = {
		.scenario_reg = 1 << 7 | 1 << 6,
		.scenario_name = "S_4G_DL_2CC",
		.scenario_power = &md_scen_power_6768[S_4G_DL_2CC],
		.tx_power_rat = {RAT_4G, 0, 0, 0, 0},
		.tx_power_rat_sum = false,
	}
};

static int mt6768_scen_priority[SCENARIO_NUM] = {
	S_4G_DL_2CC,
	S_4G_DL_1CC,
	S_3G_C2K_DATALINK,
	S_3G_4G_C2K_PAGING,
