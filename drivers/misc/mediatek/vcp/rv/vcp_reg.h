...
#define VCP_EE_STAGE             VCP_A_GENERAL_REG0
...
#define VCP_INFRA_SLP_PROT_EN                   (vcpreg.infra_cfg + 0x0008)
#define VCP_INFRA_SEMAPHORE                     (vcpreg.infra_cfg  + 0x0018)
#define VCP_INFRA_VCP2SPM_VOL_LV                (vcpreg.infra_cfg + 0x0020)
#define VCP_INFRA_TO_SPM_REG                    (vcpreg.infra_cfg + 0x0094)
#define VCP_INFRA_GIPC_IN_SET                   (vcpreg.infra_cfg + 0x0098)
#define VCP_INFRA_GIPC_IN_CLR                   (vcpreg.infra_cfg + 0x009c)
#define VCP_INFRA_TO_INFRA_TX                   (vcpreg.infra_cfg + 0x0108)
#define VCP_INFRA_GPR_DEBUG_HINT                (vcpreg.infra_cfg + 0x0140)
#define VCP_INFRA_BUS_DEBUG_OUT                 (vcpreg.infra_cfg + 0x0150)
#define VCP_INFRA_DDREN_NEW_CTRL                (vcpreg.infra_cfg + 0x01B0)
#define VCP_INFRA_DDREN_NEW_CTRL2               (vcpreg.infra_cfg + 0x01B8)
#define VCP_INFRA_APSRC_CTRL2                   (vcpreg.infra_cfg + 0x01BC)

#define VCP_INFRA_CORE0_SW_RSTN_CLR             (vcpreg.infra_cfg_core0 + 0x0000)
#define VCP_INFRA_CORE1_SW_RSTN_CLR             (vcpreg.infra_cfg_core1 + 0x0000)
#define VCP_INFRA_CORE0_SW_RSTN_SET             (vcpreg.infra_cfg_core0 + 0x0004)
#define VCP_INFRA_CORE1_SW_RSTN_SET             (vcpreg.infra_cfg_core1 + 0x0004)
#define VCP_INFRA_CORE0_DBG_CTRL                (vcpreg.infra_cfg_core0 + 0x0010)
#define VCP_INFRA_CORE0_CLK_SYS_REQ             (vcpreg.infra_cfg_core0 + 0x0020)
#define VCP_INFRA_CORE0_BUS_REQ                 (vcpreg.infra_cfg_core0 + 0x0024)
#define VCP_INFRA_CORE0_APSRC_REQ               (vcpreg.infra_cfg_core0 + 0x0028)
#define VCP_INFRA_CORE0_DDREN_REQ               (vcpreg.infra_cfg_core0 + 0x002C)
#define VCP_INFRA_CORE1_DBG_CTRL                (vcpreg.infra_cfg_core1 + 0x0010)
#define VCP_INFRA_CORE0_WDT_IRQ                 (vcpreg.infra_cfg_core0 + 0x0030)
#define VCP_INFRA_CORE1_WDT_IRQ                 (vcpreg.infra_cfg_core1 + 0x0030)
#define VCP_INFRA_CORE0_WDT_CFG                 (vcpreg.infra_cfg_core0 + 0x0034)
#define VCP_INFRA_CORE1_WDT_CFG                 (vcpreg.infra_cfg_core1 + 0x0034)

#define VCP_INFRA_CORE0_STATUS                  (vcpreg.infra_cfg_core0 + 0x0070)
#define VCP_INFRA_CORE0_MON_PC                  (vcpreg.infra_cfg_core0 + 0x0080)
#define VCP_INFRA_CORE0_MON_LR                  (vcpreg.infra_cfg_core0 + 0x0084)
#define VCP_INFRA_CORE0_MON_SP                  (vcpreg.infra_cfg_core0 + 0x0088)
#define VCP_INFRA_CORE0_TBUF_WPTR               (vcpreg.infra_cfg_core0 + 0x008c)
#define VCP_INFRA_CORE0_MON_PC_LATCH            (vcpreg.infra_cfg_core0 + 0x00d0)
#define VCP_INFRA_CORE0_MON_LR_LATCH            (vcpreg.infra_cfg_core0 + 0x00d4)
#define VCP_INFRA_CORE0_MON_SP_LATCH            (vcpreg.infra_cfg_core0 + 0x00d8)
#define VCP_INFRA_CORE0_T1_MON_PC               (vcpreg.infra_cfg_core0 + 0x0160)
#define VCP_INFRA_CORE0_T1_MON_LR               (vcpreg.infra_cfg_core0 + 0x0164)
#define VCP_INFRA_CORE0_T1_MON_SP               (vcpreg.infra_cfg_core0 + 0x0168)
#define VCP_INFRA_CORE0_T1_MON_PC_LATCH         (vcpreg.infra_cfg_core0 + 0x0170)
#define VCP_INFRA_CORE0_T1_MON_LR_LATCH         (vcpreg.infra_cfg_core0 + 0x0174)
#define VCP_INFRA_CORE0_T1_MON_SP_LATCH         (vcpreg.infra_cfg_core0 + 0x0178)

#define VCP_INFRA_CORE1_STATUS                  (vcpreg.infra_cfg_core1 + 0x0070)
#define VCP_INFRA_CORE1_MON_PC                  (vcpreg.infra_cfg_core1 + 0x0080)
#define VCP_INFRA_CORE1_MON_LR                  (vcpreg.infra_cfg_core1 + 0x0084)
#define VCP_INFRA_CORE1_MON_SP                  (vcpreg.infra_cfg_core1 + 0x0088)
#define VCP_INFRA_CORE1_TBUF_WPTR               (vcpreg.infra_cfg_core1 + 0x008c)
#define VCP_INFRA_CORE1_MON_PC_LATCH            (vcpreg.infra_cfg_core1 + 0x00d0)
#define VCP_INFRA_CORE1_MON_LR_LATCH            (vcpreg.infra_cfg_core1 + 0x00d4)
#define VCP_INFRA_CORE1_MON_SP_LATCH            (vcpreg.infra_cfg_core1 + 0x00d8)
#define VCP_INFRA_CORE1_T1_MON_PC               (vcpreg.infra_cfg_core1 + 0x0160)
#define VCP_INFRA_CORE1_T1_MON_LR               (vcpreg.infra_cfg_core1 + 0x0164)
#define VCP_INFRA_CORE1_T1_MON_SP               (vcpreg.infra_cfg_core1 + 0x0168)
#define VCP_INFRA_CORE1_T1_MON_PC_LATCH         (vcpreg.infra_cfg_core1 + 0x0170)
#define VCP_INFRA_CORE1_T1_MON_LR_LATCH         (vcpreg.infra_cfg_core1 + 0x0174)
#define VCP_INFRA_CORE1_T1_MON_SP_LATCH         (vcpreg.infra_cfg_core1 + 0x0178)

#define VCP_INFRA_CORE0_TBUF_DATA31_0           (vcpreg.infra_cfg_core0 + 0x00e0)
#define VCP_INFRA_CORE0_TBUF_DATA63_32          (vcpreg.infra_cfg_core0 + 0x00e4)
#define VCP_INFRA_CORE0_TBUF_DATA95_64          (vcpreg.infra_cfg_core0 + 0x00e8)
#define VCP_INFRA_CORE0_TBUF_DATA127_96         (vcpreg.infra_cfg_core0 + 0x00ec)
#define VCP_INFRA_CORE0_TBUF1_DATA31_0          (vcpreg.infra_cfg_core0 + 0x00f0)
#define VCP_INFRA_CORE0_TBUF1_DATA63_32         (vcpreg.infra_cfg_core0 + 0x00f4)
#define VCP_INFRA_CORE0_TBUF1_DATA95_64         (vcpreg.infra_cfg_core0 + 0x00f8)
#define VCP_INFRA_CORE0_TBUF1_DATA127_96        (vcpreg.infra_cfg_core0 + 0x00fc)

#define VCP_INFRA_CORE1_TBUF_DATA31_0           (vcpreg.infra_cfg_core1 + 0x00e0)
#define VCP_INFRA_CORE1_TBUF_DATA63_32          (vcpreg.infra_cfg_core1 + 0x00e4)
#define VCP_INFRA_CORE1_TBUF_DATA95_64          (vcpreg.infra_cfg_core1 + 0x00e8)
#define VCP_INFRA_CORE1_TBUF_DATA127_96         (vcpreg.infra_cfg_core1 + 0x00ec)
#define VCP_INFRA_CORE1_TBUF1_DATA31_0          (vcpreg.infra_cfg_core1 + 0x00f0)
#define VCP_INFRA_CORE1_TBUF1_DATA63_32         (vcpreg.infra_cfg_core1 + 0x00f4)
#define VCP_INFRA_CORE1_TBUF1_DATA95_64         (vcpreg.infra_cfg_core1 + 0x00f8)
#define VCP_INFRA_CORE1_TBUF1_DATA127_96        (vcpreg.infra_cfg_core1 + 0x00fc)

#define VCP_INFRA_GENERAL_REG0                  (vcpreg.infra_cfg_core0 + 0x0040)
#define VCP_INFRA_GENERAL_REG1                  (vcpreg.infra_cfg_core0 + 0x0044)
#define VCP_INFRA_GENERAL_REG2                  (vcpreg.infra_cfg_core0 + 0x0048)
#define VCP_INFRA_GENERAL_REG3                  (vcpreg.infra_cfg_core0 + 0x004C)
#define VCP_INFRA_GENERAL_REG4                  (vcpreg.infra_cfg_core0 + 0x0050)
#define VCP_INFRA_GENERAL_REG5                  (vcpreg.infra_cfg_core0 + 0x0054)
#define VCP_INFRA_GPR_C0_H0_REBOOT              VCP_INFRA_GENERAL_REG5
#define VCP_INFRA_GPR_C1_H0_REBOOT              (vcpreg.infra_cfg_core1 + 0x0054)
#define VCP_INFRA_GENERAL_REG6                  (vcpreg.infra_cfg_core0 + 0x0058)
#define VCP_INFRA_GPR_C0_H1_REBOOT              VCP_INFRA_GENERAL_REG6
#define VCP_INFRA_GPR_C1_H1_REBOOT              (vcpreg.infra_cfg_core1 + 0x0058)
#define VCP_INFRA_GENERAL_REG7                  (vcpreg.infra_cfg_core0 + 0x005C)

/* intc reg*/
#define VCP_INFRA_IRQ_STA0                      (vcpreg.infra_cfg_intc + 0x0000)
#define VCP_INFRA_IRQ_STA1                      (vcpreg.infra_cfg_intc + 0x0004)
#define VCP_INFRA_IRQ_STA2                      (vcpreg.infra_cfg_intc + 0x0008)
#define VCP_INFRA_IRQ_EN0                       (vcpreg.infra_cfg_intc + 0x0018)
#define VCP_INFRA_IRQ_EN1                       (vcpreg.infra_cfg_intc + 0x001C)
#define VCP_INFRA_IRQ_EN2                       (vcpreg.infra_cfg_intc + 0x0020)
#define VCP_INFRA_IRQ_SLP0                      (vcpreg.infra_cfg_intc + 0x0030)
#define VCP_INFRA_IRQ_SLP1                      (vcpreg.infra_cfg_intc + 0x0034)
#define VCP_INFRA_IRQ_SLP2                      (vcpreg.infra_cfg_intc + 0x0038)

/* pwr ctl */
#define VCP_INFRA_SLP_EN                        (vcpreg.infra_cfg_pwr)
#define VCP_INFRA_POWER_STATUS                  (vcpreg.infra_cfg_pwr + 0x068)

/* bus debug reg */
#define VCP_INFRA_BUS_DBG_CON                   (vcpreg.infra_bus_debug)
#define VCP_INFRA_BUS_DBG_RESULT0               (vcpreg.infra_bus_debug + 0x408)

/* bus tracker */
#define VCP_INFRA_BUS_TRACKER_CON               (vcpreg.infra_bus_tracker)
#define VCP_INFRA_BUS_TRACKER_AR_TRACK0         (vcpreg.infra_bus_tracker + 0x0100)
