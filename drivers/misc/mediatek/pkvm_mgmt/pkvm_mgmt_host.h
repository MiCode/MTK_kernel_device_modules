...
void kvm_nvhe_sym(hyp_pmm_debug_hypmmu)(struct user_pt_regs *);
...
/* interface for KVM IOMMU */
void kvm_nvhe_sym(hyp_pmm_kvm_secure_pages)(u32 *pmm_ipc, u32 count, u8 attr);
