...
struct dbg_mux_sel_value {
	...
	int dbg_sel[13];
	//Max of MUX_SEL_COUNT_MT6853, MUX_SEL_COUNT_MT6873, MUX_SEL_COUNT_MT6885, MUX_SEL_COUNT_MT6877
};
...
static struct dbg_mux_sel_info info_table_mt6877[] = {
	{0x29010, 1,  1 }, //vcore_dbg_sel
	{0x29010, 4,  2 }, //vcore_dbg_sel0
	{0x29010, 7,  5 }, //vcore_dbg_sel1
	{0x20138, 2,  0 }, //conn_dbg0_sel
...
#define MUX_SEL_COUNT_MT6877 \
	(sizeof(info_table_mt6877) / sizeof(struct dbg_mux_sel_info))

static struct dbg_mux_sel_value value_table_mt6877[] = {
	{"VCORE2EMI_N0_GALS_TX",      0x2901C,
...
#define TOTAL_MUX_COUNT_MT6877 \
	(sizeof(value_table_mt6877) / sizeof(struct dbg_mux_sel_value))

static struct reg_dump_info range_table_mt6877[] = {
...
#define SEGMENT_COUNT_MT6877 \
	(sizeof(range_table_mt6877) / sizeof(struct reg_dump_info))
...
static struct dbg_hw_info hw_info_set[PLATFORM_COUNT] = {
	...
	{MUX_SEL_COUNT_MT6877,
	 TOTAL_MUX_COUNT_MT6877,
	 SEGMENT_COUNT_MT6877,
	 info_table_mt6877,
	 value_table_mt6877,
	 range_table_mt6877},
};
