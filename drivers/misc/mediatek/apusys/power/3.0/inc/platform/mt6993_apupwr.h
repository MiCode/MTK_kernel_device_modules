...
#ifndef __MT6993_APUPWR_H__
#define __MT6993_APUPWR_H__
...
// ARE user entry begin ofs : 0x10b0 (dec:4272), div 4 bytes = 1068 entries
// called 1070 entries for safety
#define ARE_ENTRY_BEGIN	1070
#define ARE_ENTRIES(x, y) ((((y) - (x)) + 1) * 2)
#define ARE_ENTRY(x) (((x) * 2) + ARE_ENTRY_BEGIN)
...
#define APU_RPC_TOP_SEL_2         0x002C
#define APU_RPC_HW_CON_1          0x0030
...
#define APU_RPC_USR_VOTE_SET	  0x0050
...
#define APUSYS_AO_SRAM_CONFIG (0xC0)
#define APUSYS_AO_SRAM_SET    (0xC4)
#define APUSYS_AO_SRAM_CLR    (0xC8)
...
// MT6661-BP SPMI-P mt6661_3_buck1 (in mt6993 for vapu)
#define BUCK_VAPU_PMIC_ID			(0x3)   // slave id
#define BUCK_VAPU_PMIC_REG_VOSEL_ADDR		(0x240) // vosel

#define BUCK_VAPU_PMIC_REG_EN_ADDR		(0x1487)// en stat
#define BUCK_VAPU_PMIC_REG_EN_SET_ADDR		(0x1488)// en set
#define BUCK_VAPU_PMIC_REG_EN_CLR_ADDR		(0x1489)// en clr
#define BUCK_VAPU_PMIC_REG_EN_SHIFT		(0)     // en shift

#define BUCK_VAPU_PMIC_NLIM_EN			(2)
#define BUCK_VAPU_PMIC_NLIM_ADDR		(0x1494)

// MT6661-CP SPMI-P mt6661_5_lnc0_s_11 (in mt6993 for vsram_apu)
#define LDO_VSRAM_PMIC_ID			(0x5)   // slave id
#define LDO_VSRAM_PMIC_REG_VOSEL_ADDR		(0x245) // vosel

#define LDO_VSRAM_PMIC_REG_EN_ADDR		(0x2107)// en stat
#define LDO_VSRAM_PMIC_REG_EN_SET_ADDR		(0x2108)// en set
#define LDO_VSRAM_PMIC_REG_EN_CLR_ADDR		(0x2109)// en clr
#define LDO_VSRAM_PMIC_REG_EN_SHIFT		(0)     // en shift

#define LDO_VSRAM_PMIC_REG_EN_LP_ADDR		(0x2107)// en lp stat
#define LDO_VSRAM_PMIC_REG_EN_LP_SET_ADDR	(0x2108)// en lp set
#define LDO_VSRAM_PMIC_REG_EN_LP_CLR_ADDR	(0x2109)// en lp clr
#define LDO_VSRAM_PMIC_REG_EN_LP_SHIFT		(1)     // en lp shift
...
// engine CG control
#define CG_CON_OFFSET		0x0
#define CG_SET_OFFSET		0x4
#define CG_CLR_OFFSET		0x8

// dummy reg to test
#define MVPU_TOP_SPARE0		0x314
#define MDLA_SPARE_0		0xF0
