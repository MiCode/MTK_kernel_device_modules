...
#define UARTHUB_WAKEUP_SPM_26M_ULPOSC_REQ_CTRL_ADDR            (UARTHUB_WAKEUP_BASE_MT6991 + 0x00)
#define UARTHUB_WAKEUP_SPM_26M_ULPOSC_ACK_STA_ADDR             (UARTHUB_WAKEUP_BASE_MT6991 + 0x04)
#define UARTHUB_WAKEUP_SSPM_WAKEUP_IRQ_STA_ADDR                (UARTHUB_WAKEUP_BASE_MT6991 + 0x08)
#define UARTHUB_WAKEUP_SSPM_WAKEUP_IRQ_STA_EN_ADDR             (UARTHUB_WAKEUP_BASE_MT6991 + 0x0C)
#define UARTHUB_WAKEUP_SSPM_WAKEUP_IRQ_STA_CLR_ADDR            (UARTHUB_WAKEUP_BASE_MT6991 + 0x10)
#define UARTHUB_WAKEUP_SSPM_WAKEUP_IRQ_STA_MASK_ADDR           (UARTHUB_WAKEUP_BASE_MT6991 + 0x14)
#define UARTHUB_WAKEUP_SPM_NOACK_TIMEOUT_SET_ADDR              (UARTHUB_WAKEUP_BASE_MT6991 + 0x18)
#define UARTHUB_WAKEUP_UARTHUB_NOACK_TIMEOUT_SET_ADDR          (UARTHUB_WAKEUP_BASE_MT6991 + 0x1C)
