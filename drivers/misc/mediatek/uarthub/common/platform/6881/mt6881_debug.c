...
static int uarthub_get_peri_uart_pad_mode_mt6881(void);
static int uarthub_get_gpio_trx_info_mt6881(struct uarthub_gpio_trx_info *info);
#endif

static int uarthub_dump_debug_monitor_packet_info_mode_mt6881(const char *tag);
static int uarthub_dump_debug_monitor_check_data_mode_mt6881(const char *tag);
static int uarthub_dump_debug_monitor_crc_result_mode_mt6881(const char *tag);
...
struct uarthub_debug_ops_struct mt6881_plat_debug_data = {
	.uarthub_plat_get_intfhub_base_addr = uarthub_get_intfhub_base_addr_mt6881,
	.uarthub_plat_get_uartip_base_addr = uarthub_get_uartip_base_addr_mt6881,
	.uarthub_plat_dump_uartip_debug_info = uarthub_dump_uartip_debug_info_mt6881,
	.uarthub_plat_dump_intfhub_debug_info = uarthub_dump_intfhub_debug_info_mt6881,
	.uarthub_plat_dump_debug_monitor = uarthub_dump_debug_monitor_mt6881,
	.uarthub_plat_debug_monitor_ctrl = uarthub_debug_monitor_ctrl_mt6881,
	.uarthub_plat_debug_monitor_stop = uarthub_debug_monitor_stop_mt6881,
	.uarthub_plat_debug_monitor_clr = uarthub_debug_monitor_clr_mt6881,
	.uarthub_plat_dump_debug_tx_rx_count = uarthub_dump_debug_tx_rx_count_mt6881,
	.uarthub_plat_dump_debug_clk_info = uarthub_dump_debug_clk_info_mt6881,
	.uarthub_plat_dump_debug_byte_cnt_info = uarthub_dump_debug_byte_cnt_info_mt6881,
	.uarthub_plat_dump_debug_apdma_uart_info = uarthub_dump_debug_apdma_uart_info_mt6881,
	.uarthub_plat_dump_sspm_log = uarthub_dump_sspm_log_mt6881,
	.uarthub_plat_trigger_fpga_testing = uarthub_trigger_fpga_testing_mt6881,
	.uarthub_plat_trigger_dvt_ut_testing = uarthub_trigger_dvt_ut_testing_mt6881,
#if UARTHUB_SUPPORT_DVT
	.uarthub_plat_verify_combo_connect_sta = uarthub_verify_combo_connect_sta_mt6881,
#endif
};
...
int uarthub_get_uart_mux_info_mt6881(void)
{
	if (!topckgen_base_remap_addr_mt6881) {
		pr_notice("[%s] topckgen_base_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	}

	return (UARTHUB_REG_READ_BIT(topckgen_base_remap_addr_mt6881 + CLK_CFG_6,
...
int uarthub_get_uarthub_mux_info_mt6881(void)
{
	...
	return UARTHUB_REG_READ_BIT(topckgen_base_remap_addr_mt6881 + CLK_CFG_16,
...
int uarthub_get_uarthub_cg_info_mt6881(int *p_topckgen_cg, int *p_peri_cg)
{
	...
	topckgen_cg = (UARTHUB_REG_READ_BIT(topckgen_base_remap_addr_mt6881 + CLK_CFG_16,
		CLK_CFG_16_PDN_UARTHUB_BCLK_MASK) >> CLK_CFG_16_PDN_UARTHUB_BCLK_SHIFT);

	peri_cg = (UARTHUB_REG_READ_BIT(pericfg_ao_remap_addr_mt6881 + PERI_CG_1,
...
#if !(UARTHUB_SUPPORT_FPGA)
int uarthub_get_peri_uart_pad_mode_mt6881(void)
{
	if (!pericfg_ao_remap_addr_mt6881) {
		pr_notice("[%s] pericfg_ao_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	...
	/* 1: UART_PAD mode */
	/* 0: UARTHUB mode */
	return (UARTHUB_REG_READ_BIT(pericfg_ao_remap_addr_mt6881 + PERI_UART_WAKEUP,
...
int uarthub_get_uart_src_clk_info_mt6881(void)
{
	...
	return (UARTHUB_REG_READ_BIT(pericfg_ao_remap_addr_mt6881 + PERI_CLOCK_CON,
	...
	int *p_spm_res_uarthub, int *p_spm_res_internal, int *p_spm_res_26m_off)
{
	...
	spm_res_uarthub = (UARTHUB_REG_READ_BIT(
		spm_remap_addr_mt6881 + SPM_REQ_STA_11,
	...
	spm_res_internal = UARTHUB_REG_READ(spm_remap_addr_mt6881 + MD32PCM_SCU_CTRL1);
	spm_res_26m_off = UARTHUB_REG_READ(spm_remap_addr_mt6881 + MD32PCM_SCU_CTRL0);
...
#if !(UARTHUB_SUPPORT_FPGA)
int uarthub_get_gpio_trx_info_mt6881(struct uarthub_gpio_trx_info *info)
{
	if (!info) {
	...
	if (!gpio_base_remap_addr_mt6881) {
		pr_notice("[%s] gpio_base_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	}

	if (!iocfg_rm_remap_addr_mt6881) {
		pr_notice("[%s] iocfg_rm_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	}

	UARTHUB_READ_GPIO(info->tx_mode, GPIO_BASE_ADDR, gpio_base_remap_addr_mt6881,
		GPIO_HUB_MODE_TX, GPIO_HUB_MODE_TX_MASK, GPIO_HUB_MODE_TX_VALUE);
	UARTHUB_READ_GPIO(info->rx_mode, GPIO_BASE_ADDR, gpio_base_remap_addr_mt6881,
		GPIO_HUB_MODE_RX, GPIO_HUB_MODE_RX_MASK, GPIO_HUB_MODE_RX_VALUE);
	UARTHUB_READ_GPIO_BIT(info->tx_dir, GPIO_BASE_ADDR, gpio_base_remap_addr_mt6881,
		GPIO_HUB_DIR_TX, GPIO_HUB_DIR_TX_MASK, GPIO_HUB_DIR_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_dir, GPIO_BASE_ADDR, gpio_base_remap_addr_mt6881,
		GPIO_HUB_DIR_RX, GPIO_HUB_DIR_RX_MASK, GPIO_HUB_DIR_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_ies, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_IES_TX, GPIO_HUB_IES_TX_MASK, GPIO_HUB_IES_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_ies, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_IES_RX, GPIO_HUB_IES_RX_MASK, GPIO_HUB_IES_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_pu, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_PUPD_TX, GPIO_HUB_PUPD_TX_MASK, GPIO_HUB_PUPD_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_pu, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_PUPD_RX, GPIO_HUB_PUPD_RX_MASK, GPIO_HUB_PUPD_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_drv, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_DRV_TX, GPIO_HUB_DRV_TX_MASK, GPIO_HUB_DRV_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_drv, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_DRV_RX, GPIO_HUB_DRV_RX_MASK, GPIO_HUB_DRV_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_smt, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_SMT_TX, GPIO_HUB_SMT_TX_MASK, GPIO_HUB_SMT_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_smt, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_SMT_RX, GPIO_HUB_SMT_RX_MASK, GPIO_HUB_SMT_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_tdsel, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_TDSEL_TX, GPIO_HUB_TDSEL_TX_MASK, GPIO_HUB_TDSEL_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_tdsel, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_TDSEL_RX, GPIO_HUB_TDSEL_RX_MASK, GPIO_HUB_TDSEL_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_rdsel, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_RDSEL_TX, GPIO_HUB_RDSEL_TX_MASK, GPIO_HUB_RDSEL_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_rdsel, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_RDSEL_RX, GPIO_HUB_RDSEL_RX_MASK, GPIO_HUB_RDSEL_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->tx_sec_en, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_SEC_EN_TX, GPIO_HUB_SEC_EN_TX_MASK, GPIO_HUB_SEC_EN_TX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_sec_en, IOCFG_RM_BASE_ADDR, iocfg_rm_remap_addr_mt6881,
		GPIO_HUB_SEC_EN_RX, GPIO_HUB_SEC_EN_RX_MASK, GPIO_HUB_SEC_EN_RX_SHIFT);
	UARTHUB_READ_GPIO_BIT(info->rx_din, GPIO_BASE_ADDR, gpio_base_remap_addr_mt6881,
	...
	const char *tag, struct mutex *uartip_lock)
{
	...
	if (apuart_base_map_mt6881[3] != NULL)
		print_ap = 1;
...
int uarthub_dump_intfhub_debug_info_mt6881(const char *tag)
{
	...
	ret = snprintf(dmp_info_buf + len, DBG_LOG_LEN - len,
		"[%s][%s][%s] IDBG=[0x%x]",
		def_tag, ((tag == NULL) ? "null" : tag), MT6881_UARTHUB_DUMP_VERSION, val);
	if (ret > 0)
		len += ret;

	val = uarthub_is_apb_bus_clk_enable_mt6881();
	ret = snprintf(dmp_info_buf + len, DBG_LOG_LEN - len,
		",APB_BUS=[%d]", val);
	if (ret > 0)
		len += ret;
	...
	val = uarthub_get_uarthub_cg_info_mt6881(&topckgen_cg, &peri_cg);
	if (val >= 0) {
	...
	val = uarthub_get_uart_src_clk_info_mt6881();
	if (val >= 0) {
	...
	val = uarthub_get_peri_uart_pad_mode_mt6881();
	if (val >= 0) {
		/* the expect value is 0x0 */
		ret = snprintf(dmp_info_buf + len, DBG_LOG_LEN - len,
	...
	val = uarthub_get_spm_res_info_mt6881(
	...
	val = uarthub_get_hwccf_univpll_on_info_mt6881();
	if (val >= 0) {
		/* the expect value is 0x1 */
		ret = snprintf(dmp_info_buf + len, DBG_LOG_LEN - len,
			",UNIVPLL=[%d]", val);
	...
	val = uarthub_get_uart_mux_info_mt6881();
	if (val >= 0) {
	...
	val = uarthub_get_uarthub_mux_info_mt6881();
	if (val >= 0) {
		/* the expect value is 0x1 */
		ret = snprintf(dmp_info_buf + len, DBG_LOG_LEN - len,
			",HUB_MUX=[0x%x(%s)]", val,
	...
	len = 0;
	val = uarthub_get_gpio_trx_info_mt6881(&gpio_base_addr);
	if (val == 0) {
	...
	ret = snprintf(dmp_info_buf, DBG_LOG_LEN,
		...
		def_tag, ((tag == NULL) ? "null" : tag), MT6881_UARTHUB_DUMP_VERSION,
		dev0_sta, dev1_sta, dev2_sta);
	if (ret > 0)
		len += ret;
#endif
...
{
	uarthub_dump_debug_monitor_packet_info_mode_mt6881(tag);
	uarthub_dump_debug_monitor_check_data_mode_mt6881(tag);
	uarthub_dump_debug_monitor_crc_result_mode_mt6881(tag);
...
int uarthub_dump_debug_monitor_packet_info_mode_mt6881(const char *tag)
{
...
int uarthub_dump_debug_monitor_check_data_mode_mt6881(const char *tag)
{
	int debug_monitor_sel = 0;
...
int uarthub_dump_debug_monitor_crc_result_mode_mt6881(const char *tag)
{
	int debug_monitor_sel = 0;
...
int uarthub_dump_debug_tx_rx_count_mt6881(const char *tag, int trigger_point)
{
	...
	if (uarthub_is_apb_bus_clk_enable_mt6881() == 0) {
...
int uarthub_dump_debug_clk_info_mt6881(const char *tag)
{
	...
	val = uarthub_get_spm_sys_timer_mt6881(&timer_h, &timer_l);
	if (val == 1) {
		ret = snprintf(dmp_info_buf + len, DBG_LOG_LEN - len,
...
int uarthub_dump_debug_apdma_uart_info_mt6881(const char *tag)
{
	...
	pr_info("[%s][%s] 0=[0x%x],4=[0x%x],8=[0x%x],c=[0x%x],10=[0x%x],14=[0x%x],18=[0x%x]\n",
		def_tag, ((tag == NULL) ? "null" : tag),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x00),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x04),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x08),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x0c),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x10),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x14),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x18));

	pr_info("[%s][%s] 1c=[0x%x],20=[0x%x],24=[0x%x],28=[0x%x],2c=[0x%x],30=[0x%x],34=[0x%x]\n",
		def_tag, ((tag == NULL) ? "null" : tag),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x1c),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x20),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x24),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x28),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x2c),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x30),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x34));

	pr_info("[%s][%s] 38=[0x%x],3c=[0x%x],40=[0x%x],44=[0x%x],48=[0x%x],4c=[0x%x],50=[0x%x]\n",
		def_tag, ((tag == NULL) ? "null" : tag),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x38),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x3c),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x40),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x44),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x48),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x4c),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x50));

	pr_info("[%s][%s] 54=[0x%x],58=[0x%x],5c=[0x%x],60=[0x%x],64=[0x%x]\n",
		def_tag, ((tag == NULL) ? "null" : tag),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x54),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x58),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x5c),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x60),
		UARTHUB_REG_READ(apdma_uart_tx_int_remap_addr_mt6881 + 0x64));
...
char g_buf_m6881[UARTHUB_TMP_BUF_SZ];
...
int uarthub_dump_sspm_log_mt6881(const char *tag)
{
	...
	g_buf_m6881[0] = '\0';
	log_addr = UARTHUB_LOG_IRQ_IDX_ADDR(sys_sram_remap_addr_mt6881);
	...
	pr_info("[%s][%s] [%x] %s",
		def_tag, ((tag == NULL) ? "null" : tag), irq_idx, g_buf_m6881);

	log_addr = UARTHUB_LOG_TSK_IDX_ADDR(sys_sram_remap_addr_mt6881);
	...
	log_addr = UARTHUB_CK_CNT_ADDR(sys_sram_remap_addr_mt6881);
	val = UARTHUB_REG_READ(log_addr);

	log_addr = UARTHUB_LAST_CK_ON(sys_sram_remap_addr_mt6881);
	v1 = UARTHUB_REG_READ(log_addr);
	v2 = UARTHUB_REG_READ(log_addr + 4);

	log_addr = UARTHUB_LAST_CK_ON_CNT(sys_sram_remap_addr_mt6881);
...
int uarthub_trigger_dvt_ut_testing_mt6881(int type)
{
	...
	int (*dvt_func[])(void) = {
		uarthub_ut_ip_help_info_mt6881,
		uarthub_ut_ip_host_tx_packet_loopback_mt6881,
		uarthub_ut_ip_timeout_init_fsm_ctrl_mt6881,
		uarthub_ut_ip_clear_rx_data_irq_mt6881,
		uarthub_ut_ip_verify_debug_monitor_packet_info_mode_mt6881,
		uarthub_ut_ip_verify_debug_monitor_check_data_mode_mt6881,
		uarthub_ut_ip_verify_debug_monitor_crc_result_mode_mt6881
	};
...
int uarthub_verify_combo_connect_sta_mt6881(int type, int rx_delay_ms)
{
	...
	if (type == 0)
		state = uarthub_verify_cmm_trx_connsys_sta_mt6881(rx_delay_ms);
	else if (type == 1)
		state = uarthub_verify_cmm_loopback_sta_mt6881();
	else
...
int uarthub_start_sample_baud_rate_mt6881(int dev_index)
{
	if (dev_index < 0 || dev_index > UARTHUB_MAX_NUM_DEV_HOST) {
		pr_notice("[%s] not support dev_index(%d)\n", __func__, dev_index);
		return UARTHUB_ERR_DEV_INDEX_NOT_SUPPORT;
...
int uarthub_stop_sample_baud_rate_mt6881(void)
{
	int cg_en = 0;
