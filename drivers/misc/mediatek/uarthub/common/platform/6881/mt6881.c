...
#include "inc/mt6881.h"
#include "inc/mt6881_debug.h"
#if (UARTHUB_SUPPORT_FPGA) || (UARTHUB_SUPPORT_DVT)
#include "ut/mt6881_ut_test.h"
#endif
...
void __iomem *gpio_base_remap_addr_mt6881;
void __iomem *pericfg_ao_remap_addr_mt6881;
void __iomem *topckgen_base_remap_addr_mt6881;
void __iomem *intfhub_base_remap_addr_mt6881;
void __iomem *apdma_uart_tx_int_remap_addr_mt6881;
void __iomem *spm_remap_addr_mt6881;
void __iomem *apmixedsys_remap_addr_mt6881;
void __iomem *iocfg_rm_remap_addr_mt6881;
void __iomem *sys_sram_remap_addr_mt6881;

void __iomem *uartip_base_map_mt6881[UARTHUB_MAX_NUM_DEV_HOST + 1] = { 0 };
void __iomem *apuart_base_map_mt6881[4] = { 0 };

int uarthub_dev_baud_rate_mt6881[UARTHUB_MAX_NUM_DEV_HOST + 1] = {
...
unsigned long INTFHUB_BASE_MT6881;
...
static struct clk *clk_top_univpll_d6_d4_208m;
static struct clk *clk_top_tck_26m_mx9;
#endif
#endif

static int uarthub_is_ready_state_mt6881(void);
static int uarthub_config_host_baud_rate_mt6881(int dev_index, int rate_index);
static int uarthub_config_cmm_baud_rate_mt6881(int rate_index);
static int uarthub_irq_mask_ctrl_mt6881(int mask);
static int uarthub_irq_clear_ctrl_mt6881(int irq_type);
static int uarthub_is_uarthub_clk_enable_mt6881(void);
static int uarthub_reset_to_ap_enable_only_mt6881(int ap_only);
static int uarthub_reset_flow_control_mt6881(void);
static int uarthub_is_assert_state_mt6881(void);
static int uarthub_assert_state_ctrl_mt6881(int assert_ctrl);
static int uarthub_get_host_status_mt6881(int dev_index);
static int uarthub_get_host_wakeup_status_mt6881(void);
static int uarthub_get_host_set_fw_own_status_mt6881(void);
static int uarthub_is_host_trx_idle_mt6881(int dev_index, enum uarthub_trx_type trx);
static int uarthub_get_host_byte_cnt_mt6881(int dev_index, enum uarthub_trx_type trx);
static int uarthub_get_cmm_byte_cnt_mt6881(enum uarthub_trx_type trx);
static int uarthub_config_crc_ctrl_mt6881(int enable);
static int uarthub_config_host_fifoe_ctrl_mt6881(int dev_index, int enable);
static int uarthub_get_rx_error_crc_info_mt6881(
	int dev_index, int *p_crc_error_data, int *p_crc_result);
static int uarthub_get_trx_timeout_info_mt6881(
	int dev_index, enum uarthub_trx_type trx,
	int *p_timeout_counter, int *p_pkt_counter);
static int uarthub_get_irq_err_type_mt6881(void);
static int uarthub_init_remap_reg_mt6881(void);
static int uarthub_deinit_unmap_reg_mt6881(void);
static int uarthub_pll_clk_on_mt6881(int on, const char *tag);

#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
static int uarthub_init_default_config_mt6881(void);
static int uarthub_init_trx_timeout_mt6881(void);
static int uarthub_init_debug_monitor_mt6881(void);
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
static int uarthub_sspm_irq_clear_ctrl_mt6881(int irq_type);
static int uarthub_sspm_irq_get_sta_mt6881(void);
static int uarthub_sspm_irq_mask_ctrl_mt6881(int irq_type, int is_mask);
#endif

struct uarthub_ops_struct mt6881_plat_data = {
	.core_ops = &mt6881_plat_core_data,
	.debug_ops = &mt6881_plat_debug_data,
#if (UARTHUB_SUPPORT_FPGA) || (UARTHUB_SUPPORT_DVT)
	.ut_test_ops = &mt6881_plat_ut_test_data,
#endif
};

struct uarthub_core_ops_struct mt6881_plat_core_data = {
	.uarthub_plat_is_apb_bus_clk_enable = uarthub_is_apb_bus_clk_enable_mt6881,
	.uarthub_plat_get_hwccf_univpll_on_info = uarthub_get_hwccf_univpll_on_info_mt6881,
	.uarthub_plat_is_ready_state = uarthub_is_ready_state_mt6881,
	.uarthub_plat_uarthub_init = uarthub_uarthub_init_mt6881,
	.uarthub_plat_uarthub_exit = uarthub_uarthub_exit_mt6881,
	.uarthub_plat_uarthub_open = uarthub_uarthub_open_mt6881,
	.uarthub_plat_uarthub_close = uarthub_uarthub_close_mt6881,
	.uarthub_plat_config_host_baud_rate = uarthub_config_host_baud_rate_mt6881,
	.uarthub_plat_config_cmm_baud_rate = uarthub_config_cmm_baud_rate_mt6881,
	.uarthub_plat_irq_mask_ctrl = uarthub_irq_mask_ctrl_mt6881,
	.uarthub_plat_irq_clear_ctrl = uarthub_irq_clear_ctrl_mt6881,
	.uarthub_plat_is_uarthub_clk_enable = uarthub_is_uarthub_clk_enable_mt6881,
	.uarthub_plat_set_host_loopback_ctrl = uarthub_set_host_loopback_ctrl_mt6881,
	.uarthub_plat_set_cmm_loopback_ctrl = uarthub_set_cmm_loopback_ctrl_mt6881,
	.uarthub_plat_reset_to_ap_enable_only = uarthub_reset_to_ap_enable_only_mt6881,
	.uarthub_plat_reset_flow_control = uarthub_reset_flow_control_mt6881,
	.uarthub_plat_is_assert_state = uarthub_is_assert_state_mt6881,
	.uarthub_plat_assert_state_ctrl = uarthub_assert_state_ctrl_mt6881,
	.uarthub_plat_is_bypass_mode = uarthub_is_bypass_mode_mt6881,
	.uarthub_plat_get_host_status = uarthub_get_host_status_mt6881,
	.uarthub_plat_get_host_wakeup_status = uarthub_get_host_wakeup_status_mt6881,
	.uarthub_plat_get_host_set_fw_own_status = uarthub_get_host_set_fw_own_status_mt6881,
	.uarthub_plat_is_host_trx_idle = uarthub_is_host_trx_idle_mt6881,
	.uarthub_plat_set_host_trx_request = uarthub_set_host_trx_request_mt6881,
	.uarthub_plat_clear_host_trx_request = uarthub_clear_host_trx_request_mt6881,
	.uarthub_plat_get_host_byte_cnt = uarthub_get_host_byte_cnt_mt6881,
	.uarthub_plat_get_cmm_byte_cnt = uarthub_get_cmm_byte_cnt_mt6881,
	.uarthub_plat_config_crc_ctrl = uarthub_config_crc_ctrl_mt6881,
	.uarthub_plat_config_bypass_ctrl = uarthub_config_bypass_ctrl_mt6881,
	.uarthub_plat_config_host_fifoe_ctrl = uarthub_config_host_fifoe_ctrl_mt6881,
	.uarthub_plat_get_rx_error_crc_info = uarthub_get_rx_error_crc_info_mt6881,
	.uarthub_plat_get_trx_timeout_info = uarthub_get_trx_timeout_info_mt6881,
	.uarthub_plat_get_irq_err_type = uarthub_get_irq_err_type_mt6881,
	.uarthub_plat_init_remap_reg = uarthub_init_remap_reg_mt6881,
	.uarthub_plat_deinit_unmap_reg = uarthub_deinit_unmap_reg_mt6881,
#if !(UARTHUB_SUPPORT_FPGA)
	.uarthub_plat_get_spm_sys_timer = uarthub_get_spm_sys_timer_mt6881,
#endif

#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
	.uarthub_plat_sspm_irq_clear_ctrl = uarthub_sspm_irq_clear_ctrl_mt6881,
	.uarthub_plat_sspm_irq_get_sta = uarthub_sspm_irq_get_sta_mt6881,
	.uarthub_plat_sspm_irq_mask_ctrl = uarthub_sspm_irq_mask_ctrl_mt6881,
#endif
};

int uarthub_is_apb_bus_clk_enable_mt6881(void)
{
#if !(UARTHUB_SUPPORT_FPGA)
	int state = 0;

	if (!pericfg_ao_remap_addr_mt6881) {
		pr_notice("[%s] pericfg_ao_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	}

	/* PERI_CG_1[25] = PERI_UARTHUB_pclk_CG */
	/* PERI_CG_1[24] = PERI_UARTHUB_hclk_CG */
	state = (UARTHUB_REG_READ_BIT(pericfg_ao_remap_addr_mt6881 + PERI_CG_1,
...
int uarthub_get_hwccf_univpll_on_info_mt6881(void)
{
#if UNIVPLL_CTRL_EN
	if (!apmixedsys_remap_addr_mt6881) {
		pr_notice("[%s] apmixedsys_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	}

	return (UARTHUB_REG_READ_BIT(apmixedsys_remap_addr_mt6881 + UNIVPLL_PLLEN_ALL,
...
int uarthub_is_ready_state_mt6881(void)
{
	return DEV0_STA_GET_dev0_intfhub_ready(DEV0_STA_ADDR);
}

int uarthub_config_baud_rate_m6881(void __iomem *dev_base, int rate_index)
{
	if (!dev_base) {
...
int uarthub_config_host_baud_rate_mt6881(int dev_index, int rate_index)
{
	int iRtn = 0;
	...
	iRtn = uarthub_config_baud_rate_m6881(uartip_base_map_mt6881[dev_index], rate_index);
	if (iRtn != 0) {
...
int uarthub_config_cmm_baud_rate_mt6881(int rate_index)
{
	int iRtn = 0;

	iRtn = uarthub_config_baud_rate_m6881(
		uartip_base_map_mt6881[uartip_id_cmm], rate_index);
	if (iRtn != 0) {
...
int uarthub_irq_mask_ctrl_mt6881(int mask)
{
	if (mask == 0)
...
int uarthub_irq_clear_ctrl_mt6881(int irq_type)
{
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
int uarthub_sspm_irq_clear_ctrl_mt6881(int irq_type)
{
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
int uarthub_sspm_irq_get_sta_mt6881(void)
{
	int mask = 0;
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
int uarthub_sspm_irq_mask_ctrl_mt6881(int irq_type, int is_mask)
{
	int mask = 0;
...
int uarthub_is_uarthub_clk_enable_mt6881(void)
{
#if !(UARTHUB_SUPPORT_FPGA)
	int state = 0;
	...
	if (!spm_remap_addr_mt6881) {
		pr_notice("[%s] spm_remap_addr_mt6881 is NULL\n", __func__);
		return -1;
	}
	...
	state = uarthub_get_hwccf_univpll_on_info_mt6881();
	...
	state = uarthub_get_spm_res_info_mt6881(
...
int uarthub_set_host_loopback_ctrl_mt6881(int dev_index, int tx_to_rx, int enable)
{
	if (dev_index < 0 || dev_index >= UARTHUB_MAX_NUM_DEV_HOST) {
		pr_notice("[%s] not support dev_index(%d)\n", __func__, dev_index);
		return UARTHUB_ERR_DEV_INDEX_NOT_SUPPORT;
...
int uarthub_set_cmm_loopback_ctrl_mt6881(int tx_to_rx, int enable)
{
	if (tx_to_rx == 0)
...
int uarthub_reset_to_ap_enable_only_mt6881(int ap_only)
{
	...
	dev1_fifoe = FCR_RD_GET_FIFOE(FCR_RD_ADDR(uartip_base_map_mt6881[uartip_id_md]));
	dev2_fifoe = FCR_RD_GET_FIFOE(FCR_RD_ADDR(uartip_base_map_mt6881[uartip_id_adsp]));
	...
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_cmm]), 0xC0);
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_ap]), 0xC0);
#if MD_CHANNEL_EN
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_md]), 0xC0);
#endif
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_adsp]), 0xC0);

	/* sw_rst4 */
	CON4_SET_sw4_rst(CON4_ADDR, 1);

	/* enable uarthub FIFO for UART0/1/2/CMM */
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_cmm]), 0xC1);
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_ap]), 0xC1);

#if MD_CHANNEL_EN
	if (dev1_fifoe == 1 && ap_only == 0)
		UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_md]), 0xC1);
#endif

	if (dev2_fifoe == 1 && ap_only == 0)
		UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[uartip_id_adsp]), 0xC1);
...
int uarthub_reset_flow_control_mt6881(void)
{
	...
	debug8.dev0 = UARTHUB_REG_READ(DEBUG_8(uartip_base_map_mt6881[uartip_id_ap]));
	debug8.dev1 = UARTHUB_REG_READ(DEBUG_8(uartip_base_map_mt6881[uartip_id_md]));
	debug8.dev2 = UARTHUB_REG_READ(DEBUG_8(uartip_base_map_mt6881[uartip_id_adsp]));
	debug8.cmm = UARTHUB_REG_READ(DEBUG_8(uartip_base_map_mt6881[uartip_id_cmm]));
	...
	debug1.dev0 = UARTHUB_REG_READ(DEBUG_1(uartip_base_map_mt6881[uartip_id_ap]));
	debug1.dev1 = UARTHUB_REG_READ(DEBUG_1(uartip_base_map_mt6881[uartip_id_md]));
	debug1.dev2 = UARTHUB_REG_READ(DEBUG_1(uartip_base_map_mt6881[uartip_id_adsp]));
	debug1.cmm = UARTHUB_REG_READ(DEBUG_1(uartip_base_map_mt6881[uartip_id_cmm]));
	...
	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++) {
		uarthub_dev_base = uartip_base_map_mt6881[i];
...
int uarthub_is_assert_state_mt6881(void)
{
	int state = 0;
...
int uarthub_assert_state_ctrl_mt6881(int assert_ctrl)
{
	if (assert_ctrl == uarthub_is_assert_state_mt6881()) {
		if (assert_ctrl == 1)
	...
	if (assert_ctrl == 1) {
		...
		uarthub_irq_clear_ctrl_mt6881(BIT_0xFFFF_FFFF);
		uarthub_irq_mask_ctrl_mt6881(0);
	}

	return 0;
}

int uarthub_is_bypass_mode_mt6881(void)
{
	int state = 0;
...
int uarthub_usb_rx_pin_ctrl_mt6881(void __iomem *dev_base, int enable)
{
	if (!dev_base) {
		pr_notice("[%s] dev_base is not been init\n", __func__);
		return -1;
...
int uarthub_uarthub_init_mt6881(struct platform_device *pdev)
{
	/* default assert mode enable */
	/* assert mode enable --> BT off or assert state*/
	uarthub_assert_state_ctrl_mt6881(1);
	...
	/* init uarthub config */
	uarthub_init_default_config_mt6881();

	/* bypass mode enable */
	uarthub_config_bypass_ctrl_mt6881(0);

	/* crc enable */
	uarthub_config_crc_ctrl_mt6881(1);

	/* config tx/rx timeout */
	uarthub_init_trx_timeout_mt6881();

	/* config debug monitor to check data mode */
	uarthub_init_debug_monitor_mt6881();

#if UARTHUB_INFO_LOG
	uarthub_dump_intfhub_debug_info_mt6881(__func__);
	uarthub_dump_uartip_debug_info_mt6881(__func__, NULL);
#endif
#else
#if UARTHUB_INFO_LOG
	uarthub_dump_debug_clk_info_mt6881(__func__);
#endif
#endif
...
int uarthub_uarthub_exit_mt6881(void)
{
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
...
int uarthub_pll_clk_on_mt6881(int on, const char *tag)
{
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
	if (on != 0 && on != 1) {
...
#if UARTHUB_INFO_LOG
	uarthub_dump_debug_clk_info_mt6881(tag);
#endif
#endif
...
int uarthub_uarthub_open_mt6881(void)
{
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
	uarthub_pll_clk_on_mt6881(1, __func__);
	uarthub_init_default_config_mt6881();
	uarthub_config_crc_ctrl_mt6881(1);
	uarthub_init_trx_timeout_mt6881();
	uarthub_init_debug_monitor_mt6881();
...
int uarthub_uarthub_close_mt6881(void)
{
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
	uarthub_pll_clk_on_mt6881(0, __func__);
#if UARTHUB_INFO_LOG
	uarthub_dump_intfhub_debug_info_mt6881(__func__);
	uarthub_dump_uartip_debug_info_mt6881(__func__, NULL);
#endif
...
int uarthub_uart_src_clk_ctrl(enum uarthub_clk_opp clk_opp)
{
	...
	UARTHUB_REG_WRITE_MASK(pericfg_ao_remap_addr_mt6881 + PERI_CLOCK_CON,
...
int uarthub_uart_mux_sel_ctrl(enum uarthub_clk_opp clk_opp)
{
	...
	if (clk_opp != uarthub_clk_26m && clk_opp != uarthub_clk_208m) {
		pr_notice("[%s] clk_opp value is not support(%d)\n", __func__, clk_opp);
		return UARTHUB_ERR_ENUM_NOT_SUPPORT;
	}
#if SUPPORT_HWCCF
	...
	if (IS_ERR_OR_NULL(clk_top_univpll_d6_d4_208m)) {
		pr_notice("[%s] clk_top_univpll_d6_d4_208m is not init\n", __func__);
		return -1;
	}
	...
	ret = clk_set_parent(clk_top_uart_sel, ((clk_opp == uarthub_clk_208m) ?
		clk_top_univpll_d6_d4_208m : clk_top_tck_26m_mx9));

	if (ret)
		pr_notice("[%s] uart_sel set clk parent to %s failed, %d\n",
			__func__,
			((clk_opp == uarthub_clk_208m) ? "clk208m" : "clk26m"), ret);
#else
	UARTHUB_REG_WRITE(topckgen_base_remap_addr_mt6881 + CLK_CFG_6_CLR,
		CLK_CFG_6_UART_SEL_MASK);//need to check is CLK_CFG_6_CLR ?

	UARTHUB_REG_WRITE(topckgen_base_remap_addr_mt6881 + CLK_CFG_6_SET,
		CLK_CFG_6_UART_SEL_208M);

	UARTHUB_REG_WRITE(topckgen_base_remap_addr_mt6881 + CLK_CFG_UPDATE,
...
int uarthub_univpll_clk_init(struct platform_device *pdev)
{
	...
	clk_top_univpll_d6_d4_208m = devm_clk_get(&pdev->dev, "clk_top_univpll_d6_d4_208m");
	if (IS_ERR_OR_NULL(clk_top_univpll_d6_d4_208m)) {
		pr_notice("[%s] cannot get clk_top_univpll_d6_d4_208m clock.\n",
			__func__);
		return PTR_ERR(clk_top_univpll_d6_d4_208m);
	}
	pr_info("[%s] clk_top_univpll_d6_d4_208m=[%p]\n",
		__func__, clk_top_univpll_d6_d4_208m);
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
int uarthub_init_default_config_mt6881(void)
{
	void __iomem *uarthub_dev_base = NULL;
	int baud_rate = 0;
	int i = 0;

	if (uartip_base_map_mt6881[uartip_id_ap] == NULL ||
			uartip_base_map_mt6881[uartip_id_md] == NULL ||
			uartip_base_map_mt6881[uartip_id_adsp] == NULL ||
			uartip_base_map_mt6881[uartip_id_cmm] == NULL) {
		pr_notice("[%s] uartip_base_map_mt6881[ap/md/adsp/cmm] is not all init\n",
			__func__);
		return -1;
	}

	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++)
		uarthub_usb_rx_pin_ctrl_mt6881(uartip_base_map_mt6881[i], 1);

	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++) {
		uarthub_dev_base = uartip_base_map_mt6881[i];
		baud_rate = uarthub_dev_baud_rate_mt6881[i];

		if (baud_rate >= 0)
			uarthub_config_baud_rate_m6881(uarthub_dev_base, baud_rate);
	...
	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++)
		uarthub_usb_rx_pin_ctrl_mt6881(uartip_base_map_mt6881[i], 0);

	mdelay(2);

	/* 0x4c = 0x3,  rx/tx channel dma enable */
	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++)
		UARTHUB_REG_WRITE(DMA_EN_ADDR(uartip_base_map_mt6881[i]), 0x3);

	/* 0x08 = 0xC7, fifo control register */
	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++) {
		UARTHUB_REG_WRITE(RXTRI_AD_ADDR(uartip_base_map_mt6881[i]), 0x19);
		UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[i]), 0xC7);
	}
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
int uarthub_init_trx_timeout_mt6881(void)
{
...
#if !(SSPM_DRIVER_EN) || (UARTHUB_SUPPORT_FPGA)
int uarthub_init_debug_monitor_mt6881(void)
{
...
int uarthub_init_remap_reg_mt6881(void)
{
	gpio_base_remap_addr_mt6881 = ioremap(GPIO_BASE_ADDR, 0x500);
	pericfg_ao_remap_addr_mt6881 = ioremap(PERICFG_AO_BASE_ADDR, 0x100);
	topckgen_base_remap_addr_mt6881 = ioremap(TOPCKGEN_BASE_ADDR, 0x100);
	uartip_base_map_mt6881[uartip_id_ap] = ioremap(UARTHUB_DEV_0_BASE_ADDR, 0x100);
	uartip_base_map_mt6881[uartip_id_md] = ioremap(UARTHUB_DEV_1_BASE_ADDR, 0x100);
	uartip_base_map_mt6881[uartip_id_adsp] = ioremap(UARTHUB_DEV_2_BASE_ADDR, 0x100);
	uartip_base_map_mt6881[uartip_id_cmm] = ioremap(UARTHUB_CMM_BASE_ADDR, 0x100);
	intfhub_base_remap_addr_mt6881 = ioremap(UARTHUB_INTFHUB_BASE_ADDR, 0x100);
	apuart_base_map_mt6881[1] = ioremap(UART1_BASE_ADDR, 0x100);
	apuart_base_map_mt6881[2] = ioremap(UART2_BASE_ADDR, 0x100);
	apuart_base_map_mt6881[3] = ioremap(UART3_BASE_ADDR, 0x100);
	apdma_uart_tx_int_remap_addr_mt6881 = ioremap(AP_DMA_UART_TX_INT_FLAG_ADDR, 0x100);
#if !(UARTHUB_SUPPORT_FPGA)
	spm_remap_addr_mt6881 = ioremap(SPM_BASE_ADDR, 0x1000);
#endif
	apmixedsys_remap_addr_mt6881 = ioremap(APMIXEDSYS_BASE_ADDR, 0x500);
	iocfg_rm_remap_addr_mt6881 = ioremap(IOCFG_RM_BASE_ADDR, 100);
	sys_sram_remap_addr_mt6881 = ioremap(SYS_SRAM_BASE_ADDR, 0x200);

	INTFHUB_BASE_MT6881 = (unsigned long) intfhub_base_remap_addr_mt6881;

	return 0;
}

int uarthub_deinit_unmap_reg_mt6881(void)
{
	int i = 0;
#if UARTHUB_SUPPORT_FPGA
	uarthub_core_close();
	...
	if (gpio_base_remap_addr_mt6881) {
		iounmap(gpio_base_remap_addr_mt6881);
		gpio_base_remap_addr_mt6881 = NULL;
	}

	if (pericfg_ao_remap_addr_mt6881) {
		iounmap(pericfg_ao_remap_addr_mt6881);
		pericfg_ao_remap_addr_mt6881 = NULL;
	}

	if (topckgen_base_remap_addr_mt6881) {
		iounmap(topckgen_base_remap_addr_mt6881);
		topckgen_base_remap_addr_mt6881 = NULL;
	}

	for (i = 0; i <= UARTHUB_MAX_NUM_DEV_HOST; i++) {
		if (uartip_base_map_mt6881[i]) {
			iounmap(uartip_base_map_mt6881[i]);
			uartip_base_map_mt6881[i] = NULL;
		}
	}

	for (i = 0; i < 4; i++) {
		if (apuart_base_map_mt6881[i]) {
			iounmap(apuart_base_map_mt6881[i]);
			apuart_base_map_mt6881[i] = NULL;
		}
	}

	if (apdma_uart_tx_int_remap_addr_mt6881) {
		iounmap(apdma_uart_tx_int_remap_addr_mt6881);
		apdma_uart_tx_int_remap_addr_mt6881 = NULL;
	}

	if (spm_remap_addr_mt6881) {
		iounmap(spm_remap_addr_mt6881);
		spm_remap_addr_mt6881 = NULL;
	}

	if (apmixedsys_remap_addr_mt6881) {
		iounmap(apmixedsys_remap_addr_mt6881);
		apmixedsys_remap_addr_mt6881 = NULL;
	}

	if (iocfg_rm_remap_addr_mt6881) {
		iounmap(iocfg_rm_remap_addr_mt6881);
		iocfg_rm_remap_addr_mt6881 = NULL;
	}

	if (sys_sram_remap_addr_mt6881) {
		iounmap(sys_sram_remap_addr_mt6881);
		sys_sram_remap_addr_mt6881 = NULL;
	}
...
#if !(UARTHUB_SUPPORT_FPGA)
int uarthub_get_spm_sys_timer_mt6881(uint32_t *hi, uint32_t *lo)
{
	if (hi == NULL || lo == NULL) {
	...
	*hi = UARTHUB_REG_READ(spm_remap_addr_mt6881 + SPM_SYS_TIMER_H);
	*lo = UARTHUB_REG_READ(spm_remap_addr_mt6881 + SPM_SYS_TIMER_L);

	return 1;
}
#endif

int uarthub_get_host_status_mt6881(int dev_index)
{
	int state = 0;
...
int uarthub_get_host_wakeup_status_mt6881(void)
{
...
int uarthub_get_host_set_fw_own_status_mt6881(void)
{
	int state0 = 0, state1 = 0, state2 = 0;
	int dev0_sw_rx_mask = 0, dev1_sw_rx_mask = 0, dev2_sw_rx_mask = 0;
	int dev0_sw_tx_mask = 0, dev1_sw_tx_mask = 0, dev2_sw_tx_mask = 0;
...
int uarthub_is_host_trx_idle_mt6881(int dev_index, enum uarthub_trx_type trx)
{
	int state = -1;
...
int uarthub_set_host_trx_request_mt6881(int dev_index, enum uarthub_trx_type trx)
{
	if (dev_index < 0 || dev_index >= UARTHUB_MAX_NUM_DEV_HOST) {
		pr_notice("[%s] not support dev_index(%d)\n", __func__, dev_index);
		return UARTHUB_ERR_DEV_INDEX_NOT_SUPPORT;
...
int uarthub_clear_host_trx_request_mt6881(int dev_index, enum uarthub_trx_type trx)
{
	if (dev_index < 0 || dev_index >= UARTHUB_MAX_NUM_DEV_HOST) {
		pr_notice("[%s] not support dev_index(%d)\n", __func__, dev_index);
		return UARTHUB_ERR_DEV_INDEX_NOT_SUPPORT;
...
int uarthub_get_host_byte_cnt_mt6881(int dev_index, enum uarthub_trx_type trx)
{
	int byte_cnt = -1;
	void __iomem *uarthub_dev_base = NULL;
	...
	uarthub_dev_base = uartip_base_map_mt6881[dev_index];
...
int uarthub_get_cmm_byte_cnt_mt6881(enum uarthub_trx_type trx)
{
	int byte_cnt = -1;
	...
	if (trx == RX)
		byte_cnt = UARTHUB_DEBUG_GET_OP_RX_REQ_VAL(
			uartip_base_map_mt6881[uartip_id_cmm]);
	else if (trx == TX)
...
int uarthub_config_crc_ctrl_mt6881(int enable)
{
	CON2_SET_crc_en(CON2_ADDR, enable);
	return 0;
}

int uarthub_config_bypass_ctrl_mt6881(int enable)
{
	CON2_SET_intfhub_bypass(CON2_ADDR, enable);
	return 0;
}

int uarthub_config_host_fifoe_ctrl_mt6881(int dev_index, int enable)
{
	if (dev_index < 0 || dev_index >= UARTHUB_MAX_NUM_DEV_HOST) {
		pr_notice("[%s] not support dev_index(%d)\n", __func__, dev_index);
		return UARTHUB_ERR_DEV_INDEX_NOT_SUPPORT;
	...
	UARTHUB_REG_WRITE(FCR_ADDR(uartip_base_map_mt6881[dev_index]), (0xC0 | enable));
	return 0;
}

int uarthub_get_rx_error_crc_info_mt6881(int dev_index, int *p_crc_error_data, int *p_crc_result)
{
	if (dev_index < 0 || dev_index >= UARTHUB_MAX_NUM_DEV_HOST) {
		pr_notice("[%s] not support dev_index(%d)\n", __func__, dev_index);
		return UARTHUB_ERR_DEV_INDEX_NOT_SUPPORT;
...
int uarthub_get_trx_timeout_info_mt6881(
	int dev_index, enum uarthub_trx_type trx,
	int *p_timeout_counter, int *p_pkt_counter)
{
	if (dev_index < 0 || dev_index >= UARTHUB_MAX_NUM_DEV_HOST) {
...
int uarthub_get_irq_err_type_mt6881(void)
{
