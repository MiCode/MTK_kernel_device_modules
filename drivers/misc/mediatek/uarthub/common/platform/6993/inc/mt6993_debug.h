...
#ifndef MT6993_DEBUG_H
#define MT6993_DEBUG_H

#define UARTHUB_DEBUG_MAX_CHAR_PER_LINE 256
#define UARTHUB_DEBUG_REMAP_ADDR(_dev, _dev_idx) _dev##_base_map_mt6993[_dev_idx]
...
#define UARTHUB_DEBUG_READ_CODA_ID_REG(_coda_id) \
	do {\
		_coda_id.dev0 = UARTHUB_REG_READ(_coda_id##_ADDR(uartip_base_map_mt6993[uartip_id_ap]));\
		_coda_id.dev1 = UARTHUB_REG_READ(_coda_id##_ADDR(uartip_base_map_mt6993[uartip_id_md]));\
		_coda_id.dev2 = UARTHUB_REG_READ(_coda_id##_ADDR(uartip_base_map_mt6993[uartip_id_adsp]));\
		_coda_id.cmm = UARTHUB_REG_READ(_coda_id##_ADDR(uartip_base_map_mt6993[uartip_id_cmm]));\
		if (apuart_base_map_mt6993[3] != NULL) {\
			_coda_id.ap = UARTHUB_REG_READ(_coda_id##_ADDR(apuart_base_map_mt6993[3]));\
		}\
	} while (0)
