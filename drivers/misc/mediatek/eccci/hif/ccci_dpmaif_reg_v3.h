...
/* dpmaif_ap_misc */
#define NRL2_DPMAIF_AP_MISC_SRAM_INIT_SET0     (BASE_DPMAIF_AP_MISC + 0xC0)
#define NRL2_DPMAIF_AP_MISC_SRAM_INIT_SET1     (BASE_DPMAIF_AP_MISC + 0xC4)

/*DPMAIF PD MD MISC CONFIG: 0x1022C000, pd_md_misc_base */
...
#define DPMAIF_AO_DL_MODE_SEL            (BASE_DPMAIF_PD_MD_MISC + 0x0400)
