...
char Tp_name[HARDWARE_MAX_ITEM_LONGTH];//req xiechongchong01.wt 20210810 add for hardware info
...
static long hardwareinfo_ioctl(struct file *file, unsigned int cmd,unsigned long arg)
{
        ...
        case HARDWARE_GPS_GET:
            ...
            hardwareinfo_num = HARDWARE_GPS;
                break;
        //+bug682130,jiyanan.wt,20210811,ADD,add wcn info
        ...
        case HARDWARE_BATTERY_ID_GET:
                ...
                break;
	//+Bug682128 caijiaqi.wt,MODIFIY,20210817,ADD for S88006
