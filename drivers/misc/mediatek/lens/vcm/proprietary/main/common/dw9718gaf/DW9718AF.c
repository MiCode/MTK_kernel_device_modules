...
/*
 * DW9718GAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9718GAF_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long DW9718GAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9718GAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9718GAF_GetFileName(unsigned char *pFileName)
{
	...
	*FileString = '\0';
	...
	strscpy(pFileName, FileString, AF_MOTOR_NAME);
	LOG_INF("FileName : %s\n", pFileName);
	#else
	pFileName[0] = '\0';
	#endif
