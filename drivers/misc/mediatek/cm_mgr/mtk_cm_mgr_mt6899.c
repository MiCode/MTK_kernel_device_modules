...
u32 cm_mgr_get_perfs_mt6899(int num)
{
...
static int platform_cm_mgr_probe(struct platform_device *pdev)
{
	...
	local_hk.cm_mgr_get_perfs = cm_mgr_get_perfs_mt6899;
	local_hk.check_cm_mgr_status = check_cm_mgr_status_mt6899;
