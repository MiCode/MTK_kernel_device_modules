...
struct lpm_spm_wake_status {
	u32 r12;                  /* SPM_BK_WAKE_EVENT_L */
	u32 r12_h;                /* SPM_BK_WAKE_EVENT_H */
	u32 r12_last_suspend;     /* last suspend SPM_BK_WAKE_EVENT_L */
	u32 r12_h_last_suspend;   /* last suspend SPM_BK_WAKE_EVENT_H */
	u32 raw_sta;              /* SPM_WAKEUP_L_STA */
	u32 raw_h_sta;            /* SPM_WAKEUP_h_STA */
	u32 raw_ext_sta;          /* SPM_WAKEUP_EXT_STA */
	u32 md32pcm_wakeup_sta;   /* MD32CPM_WAKEUP_L_STA */
	u32 md32pcm_wakeup_h_sta; /* MD32PCM_WAKEUP_H_STA */
	...
	u32 req_sta13;            /* SRC_REQ_STA_13 */
	u32 req_sta14;            /* SRC_REQ_STA_14 */
	u32 req_sta15;            /* SRC_REQ_STA_15 */
	u32 req_sta16;            /* SRC_REQ_STA_16 */
	u32 req_sta17;            /* SRC_REQ_STA_17 */
	u32 req_sta_rsv0;         /* SRC_REQ_STA_RSV_0 */
	u32 req_sta_rsv1;         /* SRC_REQ_STA_RSV_1 */
	u32 req_sta_rsv2;         /* SRC_REQ_STA_RSV_2 */
	u32 req_sta_rsv3;         /* SRC_REQ_STA_RSV_3 */
	u32 req_sta_rsv4;         /* SRC_REQ_STA_RSV_4 */
	u32 req_sta_rsv5;         /* SRC_REQ_STA_RSV_5 */
	u32 req_sta_rsv6;         /* SRC_REQ_STA_RSV_6 */
	u32 req_sta_rsv7;         /* SRC_REQ_STA_RSV_7 */
	...
	u32 apsrc_cnt;		  /* Common scen apsrc */
	u32 emi_cnt;		  /* Common scen emi */
	u32 vrf18_cnt;		  /* Common scen vrf18 */
	u32 infra_cnt;		  /* Common scen infra */
	u32 pmic_cnt;		  /* Common scen pmic */
	u32 vcore_cnt;		  /* Common scen vcore */
	...
	u32 debug_spare10;        /* PCM_WDT_LATCH_SPARE_10 */
	u32 debug_spare11;        /* PCM_WDT_LATCH_SPARE_11 */
	u32 debug_spare12;        /* PCM_WDT_LATCH_SPARE_12 */
	u32 debug_spare13;        /* PCM_WDT_LATCH_SPARE_13 */
	u32 debug_spare14;        /* PCM_WDT_LATCH_SPARE_14 */
	u32 debug_spare15;        /* PCM_WDT_LATCH_SPARE_15 */
	...
	u32 src_req_0;            /* SPM_SRC_REQ */
	u32 src_req_1;            /* SPM_SRC_REQ_1 */
	u32 log_index;
	u32 is_abort;
...
/* FIXME: check SPM Flag/Flag1 Define */
/* --- SPM Flag Define --- */
