...
#define SPM_HW_CG_CHECK_MASK_0 (0xff)
#define SPM_HW_CG_CHECK_SHIFT_0 (17)
...
const char *wakesrc_str[32] = {
	...
	[14] = " R12_RESERVED_BIT14",
	[15] = " R12_RESERVED_BIT15",
	[16] = " R12_PERI_MERGED_B",
	[17] = " R12_DEBUGTOP_FLAG_IRQ_B",
	[18] = " R12_SYSTIMER_EVENT_B",
	[19] = " R12_EINT_EVENT_SECURE_B",
	[20] = " R12_RESERVED_BIT20",
	[21] = " R12_THERM_CTRL_EVENT_B",
	[22] = " R12_SYS_CIRQ_IRQ_B",
	[23] = " R12_RESERVED_BIT23",
	[24] = " R12_CSYSPWREQ_B",
	[25] = " R12_MD_WDT_B",
	[26] = " R12_AP2AP_PEER_WAKEUP_B",
	[27] = " R12_RESERVED_BIT27",
	[28] = " R12_CPU_WAKEUP",
	[29] = " R12_APUSYS_WAKE_HOST",
	[30] = " R12_RESERVED_BIT30",
...
struct subsys_req plat_subsys_req[] = {
	{"md", SPM_REQ_STA_7, (0x1FF << 14), 0, 0, 0},
	{"conn", SPM_REQ_STA_3, (0x7F << 25), SPM_REQ_STA_4, 0x3, 0},
	{"disp", SPM_REQ_STA_4, (0x3FFF << 9), 0, 0, 0},
	{"scp", SPM_REQ_STA_9, (0xFF << 3), 0, 0, 0},
	{"adsp", SPM_REQ_STA_0, (0xFF << 7), 0, 0, 0},
	{"ufs", SPM_REQ_STA_10, (0xFF << 4), 0, 0, 0},
	{"apu", SPM_REQ_STA_0, 0x7F, 0, 0, 0},
	{"mm_proc", SPM_REQ_STA_7, (0x7F << 23), 0, 0, 0},
	{"srclkeni", SPM_REQ_STA_9, (0x3F << 11), 0, 0, 0},
...
static int lpm_get_common_status(void)
{
	...
	help->wakesrc->debug_flag2 = plat_mmio_read(PCM_WDT_LATCH_SPARE_2);
...
static int __init mt6899_dbg_device_initcall(void)
{
	int ret;
...
static int __init mt6899_dbg_late_initcall(void)
{
...
int __init mt6899_dbg_init(void)
{
	int ret = 0;

	ret = mt6899_dbg_device_initcall();
	if (ret)
		goto mt6899_dbg_init_fail;

	ret = mt6899_dbg_late_initcall();
	if (ret)
		goto mt6899_dbg_init_fail;

	return 0;

mt6899_dbg_init_fail:
	return -EAGAIN;
}

void __exit mt6899_dbg_exit(void)
{
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("mt6899 low power debug module");
