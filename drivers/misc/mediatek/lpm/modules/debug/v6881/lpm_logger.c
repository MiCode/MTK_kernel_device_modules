...
#define SPM_HW_CG_CHECK_SHIFT1 (32 - SPM_HW_CG_CHECK_SHIFT)
...
static char *pwr_ctrl_str[PW_MAX_COUNT] = {
	...
	[PW_REG_CAM_VCORE_REQ_MASK_B] = "reg_cam_vcore_req_mask_b",
	...
	[PW_REG_GCE_M2_APSRC_REQ_MASK_B] = "reg_gce_m2_apsrc_req_mask_b",
	[PW_REG_GCE_M2_DDREN_REQ_MASK_B] = "reg_gce_m2_ddren_req_mask_b",
	[PW_REG_GCE_M2_EMI_REQ_MASK_B] = "reg_gce_m2_emi_req_mask_b",
	...
	[PW_REG_IMG_VCORE_REQ_MASK_B] = "reg_img_vcore_req_mask_b",
	...
	[PW_REG_PCIE_EMI_REQ_MASK_B] = "reg_pcie_emi_req_mask_b",
	[PW_REG_PCIE_INFRA_REQ_MASK_B] = "reg_pcie_infra_req_mask_b",
	[PW_REG_PCIE_PMIC_REQ_MASK_B] = "reg_pcie_pmic_req_mask_b",
	[PW_REG_PCIE_SRCCLKENA_MASK_B] = "reg_pcie_srcclkena_mask_b",
	[PW_REG_PCIE_VCORE_REQ_MASK_B] = "reg_pcie_vcore_req_mask_b",
	...
	[PW_REG_UARTHUB_INFRA_REQ_MASK_B] = "reg_uarthub_infra_req_mask_b",
	[PW_REG_UARTHUB_PMIC_REQ_MASK_B] = "reg_uarthub_pmic_req_mask_b",
	[PW_REG_UARTHUB_SRCCLKENA_MASK_B] = "reg_uarthub_srcclkena_mask_b",
	[PW_REG_UARTHUB_VCORE_REQ_MASK_B] = "reg_uarthub_vcore_req_mask_b",
	[PW_REG_UARTHUB_VRF18_REQ_MASK_B] = "reg_uarthub_vrf18_req_mask_b",
	...
	[PW_REG_MM_IOMMU_APSRC_REQ_MASK_B] = "reg_mm_iommu_apsrc_req_mask_b",
	[PW_REG_MM_IOMMU_DDREN_REQ_MASK_B] = "reg_mm_iommu_ddren_req_mask_b",
	[PW_REG_MM_IOMMU_EMI_REQ_MASK_B] = "reg_mm_iommu_emi_req_mask_b",
...
struct subsys_req plat_subsys_req[] = {
	...
	{"scp", SPM_REQ_STA_10, (0x7 << 29), SPM_REQ_STA_11, 0x1F, 0},
	{"ufs", SPM_REQ_STA_11, (0x3 << 30), SPM_REQ_STA_12, 0x1F, 0},
	{"apu", SPM_REQ_STA_0, 0x7F, 0, 0, 0},
	{"gce_d", SPM_REQ_STA_6, (0x3 << 19), 0, 0, 0},
	{"gce_m", SPM_REQ_STA_6, (0x3 << 22), 0, 0, 0},
	{"gce_m2", SPM_REQ_STA_6, (0x3 << 25), 0, 0, 0},
	{"srclkeni", SPM_REQ_STA_11, (0x3F << 5), 0, 0, 0},
...
static int lpm_get_wakeup_status(void)
{
	...
	help->wakesrc->cg_check_sta =
		...
		((plat_mmio_read(SPM_REQ_STA_4) & SPM_HW_CG_CHECK_MASK1) << SPM_HW_CG_CHECK_SHIFT1));
...
static int __init mt6881_dbg_device_initcall(void)
{
	int ret;
...
static int __init mt6881_dbg_late_initcall(void)
{
...
int __init mt6881_dbg_init(void)
{
	int ret = 0;

	ret = mt6881_dbg_device_initcall();
	if (ret)
		goto mt6881_dbg_init_fail;

	ret = mt6881_dbg_late_initcall();
	if (ret)
		goto mt6881_dbg_init_fail;

	return 0;

mt6881_dbg_init_fail:
	return -EAGAIN;
}

void __exit mt6881_dbg_exit(void)
{
...
module_init(mt6881_dbg_init);
module_exit(mt6881_dbg_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("mt6881 low power debug module");
