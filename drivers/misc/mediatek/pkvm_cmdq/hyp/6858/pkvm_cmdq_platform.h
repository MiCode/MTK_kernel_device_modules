...
/* FDVT LARB12 PORT*/
#define FDVT_PORT_BASE_GDOMAIN   0x1B00FF80
#define FDVT_P0_GDOMIAN   (FDVT_PORT_BASE_GDOMAIN + 0x000)
#define FDVT_P1_GDOMIAN   (FDVT_PORT_BASE_GDOMAIN + 0x004)
#define FDVT_P2_GDOMIAN   (FDVT_PORT_BASE_GDOMAIN + 0x008)
#define FDVT_P3_GDOMIAN   (FDVT_PORT_BASE_GDOMAIN + 0x00c)
#define FDVT_PORT_BASE   0x1B00F380
#define FDVT_P0   (FDVT_PORT_BASE + 0x000)
#define FDVT_P1   (FDVT_PORT_BASE + 0x004)
#define FDVT_P2   (FDVT_PORT_BASE + 0x008)
#define FDVT_P3   (FDVT_PORT_BASE + 0x00c)
