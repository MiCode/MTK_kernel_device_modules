...
#define CMDQ_MAX_SECURE_CORE_COUNT	(3)
/* TZMP sw token */
...
#define CMDQ_THR_SECURITY(base, id)        (base + (0x080 * id) + 0x118)
...
#define DAPC_BASE3		DEVAPC_MMINFRA_AO_SYS2_BASE

#define DAPC_REG_PA(sys, idx)	(dapc_base_pa[sys] + idx * 0x4)

#define DAPC_SYS_CNT		3

#define CMDQ_DAPC_SYS1_CNT	256
#define CMDQ_DAPC_SYS2_CNT	256
#define CMDQ_DAPC_SYS3_CNT	23
/* this count contains DAPC SYS1 + SYS2 */
#define CMDQ_MAX_DAPC_COUNT	(CMDQ_DAPC_SYS1_CNT + CMDQ_DAPC_SYS2_CNT + CMDQ_DAPC_SYS3_CNT)
...
#define MDP_HWID	0xFF
#define MDP_THR_IDX	0xFF
