...
/* CO-TMS */
#define DCXO_DIG_CDAC_CW0		(0x7dd)
#define DCXO_DIG_AAC_ESR_CW0		(0x7b8)
#define GPIO_ANA_CON6			(0xc6)
#define RG_XO_CDAC_FPM_ADDR		(DCXO_DIG_CDAC_CW0)
#define RG_XO_CDAC_FPM_MASK		(0xff)
#define RG_XO_CDAC_FPM_SHIFT		(0)
#define RG_XO_AAC_FPM_SWEN_ADDR		(DCXO_DIG_AAC_ESR_CW0)
#define RG_XO_AAC_FPM_SWEN_MASK		(0x1)
#define RG_XO_AAC_FPM_SWEN_SHIFT	(0)
#define RG_XO_HEATER_SEL_ADDR		(GPIO_ANA_CON6)
#define RG_XO_HEATER_SEL_MASK		(0x7)
...
struct plat_xodata mt6687_tb_data = {
