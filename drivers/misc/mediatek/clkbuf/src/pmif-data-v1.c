...
#define RC_INF_EN_LV1_ADDR		(0x190)
#define RC_INF_EN_LV1_MASK		(0x3)
#define RC_INF_EN_LV1_SHIFT		(0)
#define CONN_INF_EN_LV1_ADDR		(0x190)
#define CONN_INF_EN_LV1_MASK		(0x1)
#define CONN_INF_EN_LV1_SHIFT		(1)
#define NFC_INF_EN_LV1_ADDR		(0x190)
#define NFC_INF_EN_LV1_MASK		(0x1)
#define NFC_INF_EN_LV1_SHIFT		(0)
#define CONN_CMD_DEST_LV1_ADDR		(0x194)
#define CONN_CLR_CMD_DEST_LV1_ADDR	(CONN_CMD_DEST_LV1_ADDR)
#define CONN_CLR_CMD_DEST_LV1_MASK	(0xFFFF)
#define CONN_CLR_CMD_DEST_LV1_SHIFT	(0)
#define CONN_SET_CMD_DEST_LV1_ADDR	(0x19C)
#define CONN_SET_CMD_DEST_LV1_MASK	(0xFFFF)
#define CONN_SET_CMD_DEST_LV1_SHIFT	(0)
#define CONN_CMD_LV1_ADDR		(0x198)
#define CONN_CLR_CMD_LV1_ADDR		(CONN_CMD_LV1_ADDR)
#define CONN_CLR_CMD_LV1_MASK		(0xFFFF)
#define CONN_CLR_CMD_LV1_SHIFT		(0)
#define CONN_SET_CMD_LV1_ADDR		(0x1A0)
#define CONN_SET_CMD_LV1_MASK		(0xFFFF)
#define CONN_SET_CMD_LV1_SHIFT		(0)
#define NFC_CMD_DEST_LV1_ADDR		(0x1A4)
#define NFC_CLR_CMD_DEST_LV1_ADDR	(NFC_CMD_DEST_LV1_ADDR)
#define NFC_CLR_CMD_DEST_LV1_MASK	(0xFFFF)
#define NFC_CLR_CMD_DEST_LV1_SHIFT	(0)
#define NFC_SET_CMD_DEST_LV1_ADDR	(0x1AC)
#define NFC_SET_CMD_DEST_LV1_MASK	(0xFFFF)
#define NFC_SET_CMD_DEST_LV1_SHIFT	(0)
#define NFC_CMD_LV1_ADDR			(0x1A8)
#define NFC_CLR_CMD_LV1_ADDR		(NFC_CMD_LV1_ADDR)
#define NFC_CLR_CMD_LV1_MASK		(0xFFFF)
#define NFC_CLR_CMD_LV1_SHIFT		(0)
#define NFC_SET_CMD_LV1_ADDR		(0x1B0)
#define NFC_SET_CMD_LV1_MASK		(0xFFFF)
#define NFC_SET_CMD_LV1_SHIFT		(0)
#define SLP_PROTECT_LV1_ADDR		(0x3E8)
#define SLP_PROTECT_LV1_MASK		(0xFFFFFFFF)
#define SLP_PROTECT_LV1_SHIFT		(0)
#define MODE_CTRL_LV1_ADDR		(0x400)
...
struct pmif_m pmif_m_lv1 = {
	...
	SET_REG_BY_NAME(conn_clr_addr, CONN_CLR_CMD_DEST_LV1)
	SET_REG_BY_NAME(conn_set_addr, CONN_SET_CMD_DEST_LV1)
	SET_REG_BY_NAME(conn_clr_cmd, CONN_CLR_CMD_LV1)
	SET_REG_BY_NAME(conn_set_cmd, CONN_SET_CMD_LV1)
	SET_REG_BY_NAME(nfc_clr_addr, NFC_CLR_CMD_DEST_LV1)
	SET_REG_BY_NAME(nfc_set_addr, NFC_SET_CMD_DEST_LV1)
	SET_REG_BY_NAME(nfc_clr_cmd, NFC_CLR_CMD_LV1)
	SET_REG_BY_NAME(nfc_set_cmd, NFC_SET_CMD_LV1)
	SET_REG_BY_NAME(mode_ctrl, MODE_CTRL_LV1)
	SET_REG_BY_NAME(slp_ctrl, SLP_PROTECT_LV1)
};
...
struct plat_pmifdata pmif_data_lv1 = {
	.pmif_m = &pmif_m_lv1,
};
