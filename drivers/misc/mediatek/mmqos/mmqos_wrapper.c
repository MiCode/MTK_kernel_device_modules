...
static struct wrapper_data wrapper_data_mt6991 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
...
static struct wrapper_data wrapper_data_mt6877 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
static struct wrapper_data wrapper_data_mt6781 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
...
static struct wrapper_data wrapper_data_mt6858 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
static struct wrapper_data wrapper_data_mt6881 = {
	.max_ostd = 40,
	.icc_dst_id = SLAVE_COMMON(0),
};
...
static const struct of_device_id of_mmqos_wrapper_match_tbl[] = {
	...
	{
		.compatible = "mediatek,mt6781-mmqos-wrapper",
		.data = &wrapper_data_mt6781,
	},
	{
	...
	{
		.compatible = "mediatek,mt6858-mmqos-wrapper",
		.data = &wrapper_data_mt6858,
	},
	{
		.compatible = "mediatek,mt6881-mmqos-wrapper",
		.data = &wrapper_data_mt6881,
	},
	{}
};
