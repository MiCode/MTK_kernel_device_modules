...
#define MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG1_MASK ((0x1U << 0))
#define MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG2_MASK ((0xffffffU << 2))
#define MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG0_ON ((0x1U << 0))
#define MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG2_ON ((0xa0c8fU << 3))
...
bool dcm_mcusys_par_wrap_core0_stall_dcm_is_on(void)
{
	...
	ret &= ((reg_read(MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG1) &
		...
		MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG2_ON);
...
#define MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG1_MASK ((0x1U << 0))
#define MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG2_MASK ((0xffffffU << 2))
#define MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG0_ON ((0x1U << 1))
#define MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG2_ON ((0xa0c8fU << 3))
...
bool dcm_mcusys_par_wrap_core1_stall_dcm_is_on(void)
{
	...
	ret &= ((reg_read(MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG1) &
		...
		MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG2_ON);
...
#define MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG1_MASK ((0x1U << 0))
#define MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG2_MASK ((0xffffffU << 2))
#define MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG0_ON ((0x1U << 2))
#define MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG2_ON ((0xa0c8fU << 3))
...
bool dcm_mcusys_par_wrap_core2_stall_dcm_is_on(void)
{
	...
	ret &= ((reg_read(MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG1) &
		...
		MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG2_ON);
...
#define MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG1_MASK ((0x1U << 0))
#define MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG2_MASK ((0xffffffU << 2))
#define MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG0_ON ((0x1U << 3))
#define MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG2_ON ((0xa0c8fU << 3))
...
bool dcm_mcusys_par_wrap_core3_stall_dcm_is_on(void)
{
	...
	ret &= ((reg_read(MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG1) &
		...
		MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG2_ON);
