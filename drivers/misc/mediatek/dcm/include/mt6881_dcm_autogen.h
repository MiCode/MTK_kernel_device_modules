...
#define MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG1              (MCUSYS_PAR_WRAP_BASE + 0x18c210)
#define MCUSYS_PAR_WRAP_MP0_DCM_CFG0                      (MCUSYS_PAR_WRAP_BASE + 0x27c)
#define MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG1              (MCUSYS_PAR_WRAP_BASE + 0x19c210)
#define MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG1              (MCUSYS_PAR_WRAP_BASE + 0x1ac210)
#define MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG1              (MCUSYS_PAR_WRAP_BASE + 0x1bc210)
#define CHABERTON_CORE4_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x1c0210)
#define CHABERTON_CORE5_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x1d0210)
#define CHABERTON_CORE6_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x1e0210)
#define CHABERTON_CORE7_CONFIG_REG_STALL_DCM_CONF         (MCUSYS_PAR_WRAP_BASE + 0x1f0210)
