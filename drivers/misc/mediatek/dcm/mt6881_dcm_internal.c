...
#define DCM_NODE "mediatek,mt6881-dcm"
...
void dcm_dump_regs(void)
{
	...
	REG_DUMP(MCUSYS_PAR_WRAP_CORE0_STALL_DCM_REG1);
	REG_DUMP(MCUSYS_PAR_WRAP_CORE1_STALL_DCM_REG1);
	REG_DUMP(MCUSYS_PAR_WRAP_CORE2_STALL_DCM_REG1);
	REG_DUMP(MCUSYS_PAR_WRAP_CORE3_STALL_DCM_REG1);
...
static int __init mt6881_dcm_init(void)
{
	int ret = 0;
...
static void __exit mt6881_dcm_exit(void)
{
}
MODULE_SOFTDEP("pre:mtk_dcm.ko");
module_init(mt6881_dcm_init);
module_exit(mt6881_dcm_exit);
