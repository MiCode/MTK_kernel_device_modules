...
#include "mbraink_v8668_wifi.h"

#define MAX_WIFI_DATA_CNT 8192

void mbraink_v8668_get_wifi_rate_data(int current_idx,
...
void mbraink_v8668_get_wifi_radio_data(struct mbraink_wifi2mbr_lls_radio_data *radio_buffer)
{
	unsigned short len = 0;
	enum wifi2mbr_status ret = WIFI2MBR_FAILURE;
...
void mbraink_v8668_get_wifi_ac_data(struct mbraink_wifi2mbr_lls_ac_data *ac_buffer)
{
	unsigned short len = 0;
	enum wifi2mbr_status ret = WIFI2MBR_FAILURE;
...
void mbraink_v8668_get_wifi_lp_data(struct mbraink_wifi2mbr_lp_ratio_data *lp_buffer)
{
	unsigned short len = 0;
	enum wifi2mbr_status ret = WIFI2MBR_FAILURE;
...
void mbraink_v8668_get_wifi_txtimeout_data(int current_idx,
...
void mbraink_v8668_get_wifi_pcie_data(int current_idx,
...
void mbraink_v8668_get_wifi_tx_power_data(struct mbraink_wifi2mbr_tx_power_data *txpwr_buffer)
{
	unsigned short len = 0;
...
void mbraink_v8668_get_wifi_rxtxperf_data(int current_idx,
...
void mbraink_v8668_get_wifi_wakeupinfo_data(int current_idx,
...
static int mbraink_v8668_set_wifi_data(struct wifi2mbr_data *wifi_data)
{
...
static struct mbraink_wifi_ops mbraink_v8668_wifi_ops = {
	.get_wifi_rate_data = mbraink_v8668_get_wifi_rate_data,
	.get_wifi_radio_data = mbraink_v8668_get_wifi_radio_data,
	.get_wifi_ac_data = mbraink_v8668_get_wifi_ac_data,
	.get_wifi_lp_data = mbraink_v8668_get_wifi_lp_data,
	.get_wifi_txtimeout_data = mbraink_v8668_get_wifi_txtimeout_data,
	.get_wifi_pcie_data = mbraink_v8668_get_wifi_pcie_data,
	.get_wifi_tx_power_data = mbraink_v8668_get_wifi_tx_power_data,
	.get_wifi_rxtxperf_data = mbraink_v8668_get_wifi_rxtxperf_data,
	.get_wifi_wakeupinfo_data = mbraink_v8668_get_wifi_wakeupinfo_data,
};

static struct wifi2mbraink_set_ops mbraink_v8668_wifi_set_ops = {
	.set_data = mbraink_v8668_set_wifi_data,
};
...
int mbraink_v8668_wifi_init(void)
{
	...
	ret = register_mbraink_wifi_ops(&mbraink_v8668_wifi_ops);
	if (ret) {
		pr_info("Failed to register mbraink wifi ops: %d\n", ret);
		return ret;
	}

	ret = register_platform_to_bridge_ops(&mbraink_v8668_wifi_set_ops);
	if (ret)
