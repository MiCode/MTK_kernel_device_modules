...
static void mbraink_v8668_gpu_setOpMode(int OpMode)
{
	gOpMode = OpMode;
}

static int mbraink_v8668_gpu_getOpMode(void)
{
	return gOpMode;
}

static ssize_t mbraink_v8668_gpu_getTimeoutCouterReport(char *pBuf)
{
	ssize_t size = 0;
...
void fpsgo2mbrain_hint_perfinfo(unsigned long cmd, struct render_frame_info *iter)
{
	...
	opMode = mbraink_v8668_gpu_getOpMode();
...
static int mbraink_v8668_gpu_setFeatureEnable(bool bEnable)
{
	if (bEnable == true) {
...
unsigned long long mbraink_v8668_gpu_getQ2QTimeoutInNS(void)
{
...
static int mbraink_v8668_gpu_getOppInfo(struct mbraink_gpu_opp_info *gOppInfo)
{
	int ret = 0;
	int i = 0;
...
static int mbraink_v8668_gpu_getStateInfo(struct mbraink_gpu_state_info *gStateInfo)
{
	int ret = 0;
...
static int mbraink_v8668_gpu_getLoadingInfo(struct mbraink_gpu_loading_info *gLoadingInfo)
{
	int ret = 0;
...
static struct mbraink_gpu_ops mbraink_v8668_gpu_ops = {
	.setFeatureEnable = mbraink_v8668_gpu_setFeatureEnable,
	.getTimeoutCounterReport = mbraink_v8668_gpu_getTimeoutCouterReport,
	.getOppInfo = mbraink_v8668_gpu_getOppInfo,
	.getStateInfo = mbraink_v8668_gpu_getStateInfo,
	.getLoadingInfo = mbraink_v8668_gpu_getLoadingInfo,
	.setOpMode = mbraink_v8668_gpu_setOpMode,
};
...
int mbraink_v8668_gpu_init(void)
{
	...
	ret = register_mbraink_gpu_ops(&mbraink_v8668_gpu_ops);
	return ret;
}
...
int mbraink_v8668_gpu_deinit(void)
{
	...
	ret = mbraink_v8668_gpu_setFeatureEnable(false);
	return ret;
}
