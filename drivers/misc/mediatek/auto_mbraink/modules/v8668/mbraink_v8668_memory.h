 ...
 */
#ifndef MBRAINK_V8668_MEMORY_H
#define MBRAINK_V8668_MEMORY_H
...
struct mbraink_v8668_slbc_info {
...
int mbraink_v8668_memory_init(struct device *dev);
int mbraink_v8668_memory_deinit(struct device *dev);

#if IS_ENABLED(CONFIG_DEVICE_MODULES_SCSI_UFS_MEDIATEK)
int ufs2mbrain_event_notify(struct ufs_mbrain_event *event);
#endif

#endif /*end of MBRAINK_V8668_MEMORY_H*/
