...
#include "mbraink_v8668_camera.h"

static int mbraink_v8668_set_camera_hw_info(struct ht_mbrain ht_data_to_mbrain)
{
...
static struct bridge2platform_ops mbraink_bridge_v8668_camera_ops = {
	.set_data = mbraink_v8668_set_camera_hw_info,
};
...
int mbraink_v8668_camera_init(void)
{
	...
	ret = register_mbraink_bridge_platform_camera_ops(&mbraink_bridge_v8668_camera_ops);
	if (ret != 0) {
