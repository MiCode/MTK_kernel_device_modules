...
static int mbraink_v8668_audio_getIdleRatioInfo(
...
static struct mbraink_audio_ops mbraink_v8668_audio_ops = {
	.setUdmFeatureEn = NULL,
	.getIdleRatioInfo = mbraink_v8668_audio_getIdleRatioInfo,
};
...
int mbraink_v8668_audio_init(void)
{
	...
	ret = register_mbraink_audio_ops(&mbraink_v8668_audio_ops);
	if (ret != 0)
