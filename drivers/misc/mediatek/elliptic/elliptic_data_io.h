...
#define ELLIPTIC_SCP_IPI_MSG_FIFO_NUM 64
#define ELLIPTIC_DATA_FIFO_SIZE (PAGE_SIZE * (ELLIPTIC_SCP_IPI_MSG_FIFO_NUM >> 3))
...
#define ELLIPTIC_ENABLE_DEBUG_LOG   9
#define ELLIPTIC_OUTCHANNEL   10
...
#define ELLIPTIC_ULTRASOUND_PARAM_ID_ENGINE_BINPAYLOAD	20
#define ELLIPTIC_ULTRASOUND_PARAM_ID_GRYO_FREQ 320
