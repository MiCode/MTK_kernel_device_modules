	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	case ELLIPTIC_SYSTEM_CONFIGURATION_WARM_UP:
		...
		break;
	case ELLIPTIC_SYSTEM_CONFIGURATION_BINPAYLOAD:
		ucontrol->value.integer.value[0] =
			elliptic_system_configuration_cache.force_binpayload;
		break;
	default:
	...
	struct snd_ctl_elem_value *ucontrol)
{
	...
	case ELLIPTIC_SYSTEM_CONFIGURATION_BINPAYLOAD:
		elliptic_system_configuration_cache.force_binpayload =
			ucontrol->value.integer.value[0];
		param.type = ESCPT_BINPAYLOAD;
		param.force_binpayload =
			elliptic_system_configuration_cache.force_binpayload;
		break;
	default:
		return -EINVAL;
...
static const struct snd_kcontrol_new ultrasound_filter_mixer_controls[] = {
    ...
    SOC_SINGLE_EXT("Ultrasound Binpayload",
    ELLIPTIC_SYSTEM_CONFIGURATION,
    ELLIPTIC_SYSTEM_CONFIGURATION_BINPAYLOAD,
    1,
    0,
    elliptic_system_configuration_param_get,
    elliptic_system_configuration_param_put),
