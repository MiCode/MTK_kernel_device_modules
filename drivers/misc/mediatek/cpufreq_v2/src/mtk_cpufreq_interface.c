...
/* cpuferq cpu level */
static int cpufreq_cpu_level_proc_show(struct seq_file *m, void *v)
{
	seq_printf(m, "cpufreq cpu level = %d\n", _mt_cpufreq_get_cpu_level());
...
PROC_FOPS_RO(cpufreq_cpu_level);
