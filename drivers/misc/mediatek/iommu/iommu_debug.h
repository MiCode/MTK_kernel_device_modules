...
static inline void mtk_smmu_ste_cd_info_dump(struct seq_file *s, u32 smmu_type, u32 sid, u32 ssid)
{
}
...
static inline int mtk_smmu_get_port_tf_ids(u32 smmu_id, int port, u32 *tf_ids, u32 ids_num)
{
	return 0;
}
