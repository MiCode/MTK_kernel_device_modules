...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE_30, 27, 30),
...
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_SRCDISCONNECT, 0, 15),
...
EXPORT_SYMBOL(tcpc_reset_typec_debounce_timer);
...
EXPORT_SYMBOL(tcpc_reset_typec_try_timer);
...
EXPORT_SYMBOL(tcpci_timer_init);
...
EXPORT_SYMBOL(tcpci_timer_deinit);
