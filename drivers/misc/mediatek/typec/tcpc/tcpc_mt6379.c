...
/* PMU: For cc open */
#define MT6379_REG_CORECTRL2			0x06
#define MT6379_REG_SPMI_TXDRV2			0x2B
#define MT6379_REG_PD_EVT			0x6A
#define MT6379_REG_PD_STAT			0x8A

/* PD: Standard TCPC V10 address */
#define TCPC_V10_REG_VID			0x400
#define TCPC_V10_REG_PID			0x402
#define TCPC_V10_REG_DID			0x404
#define TCPC_V10_REG_TYPEC_REV			0x406
#define TCPC_V10_REG_PD_REV			0x408
#define TCPC_V10_REG_PDIF_REV			0x40A
#define TCPC_V10_REG_ALERT			0x410
#define TCPC_V10_REG_ALERT_MASK			0x412
#define TCPC_V10_REG_POWER_STATUS_MASK		0x414
#define TCPC_V10_REG_FAULT_STATUS_MASK		0x415
#define TCPC_V10_REG_EXT_STATUS_MASK		0x416
#define TCPC_V10_REG_TCPC_CTRL			0x419
#define TCPC_V10_REG_ROLE_CTRL			0x41A
#define TCPC_V10_REG_FAULT_CTRL			0x41B
#define TCPC_V10_REG_POWER_CTRL			0x41C
#define TCPC_V10_REG_CC_STATUS			0x41D
#define TCPC_V10_REG_POWER_STATUS		0x41E
#define TCPC_V10_REG_FAULT_STATUS		0x41F
#define TCPC_V10_REG_EXT_STATUS			0x420
#define TCPC_V10_REG_COMMAND			0x423
#define TCPC_V10_REG_MSG_HDR_INFO		0x42E
#define TCPC_V10_REG_RX_DETECT			0x42F
#define TCPC_V10_REG_RX_BYTE_CNT		0x430
#define TCPC_V10_REG_RX_BUF_FRAME_TYPE		0x431
#define TCPC_V10_REG_RX_HDR			0x432
#define TCPC_V10_REG_RX_DATA			0x434
#define TCPC_V10_REG_TRANSMIT			0x450
#define TCPC_V10_REG_TX_BYTE_CNT		0x451
#define TCPC_V10_REG_TX_HDR			0x452
#define TCPC_V10_REG_TX_DATA			0x454
#define TCPC_V10_REG_VBUS_VOLTAGE_L		0x470
#define TCPC_V10_REG_VBUS_SINK_DISCONNECT_THD	0x472
#define TCPC_V10_REG_VBUS_STOP_DISCHARGE_THD	0x474
#define TCPC_V10_REG_VBUS_VOLTAGE_ALARM_HI	0x476
#define TCPC_V10_REG_VBUS_VOLTAGE_ALARM_LO	0x478

/* PD: Vendor Register Define */
#define MT6379_REG_PHYCTRL1			0x480
#define MT6379_REG_PHYCTRL2			0x481
#define MT6379_REG_PHYCTRL3			0x482
#define MT6379_REG_PHYCTRL7			0x486
#define MT6379_REG_PHYCTRL8			0x489
#define MT6379_REG_VCONCTRL1			0x48A
#define MT6379_REG_VCONCTRL2			0x48B
#define MT6379_REG_VCONCTRL3			0x48C
#define MT6379_REG_SYSCTRL1			0x48F
#define MT6379_REG_SYSCTRL2			0x490
#define MT6379_REG_MTMASK1			0x491
#define MT6379_REG_MTMASK2			0x492
#define MT6379_REG_MTMASK3			0x493
#define MT6379_REG_MTMASK4			0x494
#define MT6379_REG_MTMASK5			0x495
#define MT6379_REG_MTMASK6			0x496
#define MT6379_REG_MTMASK7			0x497
#define MT6379_REG_MTINT1			0x498
#define MT6379_REG_MTINT2			0x499
#define MT6379_REG_MTINT3			0x49A
#define MT6379_REG_MTINT4			0x49B
#define MT6379_REG_MTINT5			0x49C
#define MT6379_REG_MTINT6			0x49D
#define MT6379_REG_MTINT7			0x49E
#define MT6379_REG_MTST1			0x49F
#define MT6379_REG_MTST2			0x4A0
#define MT6379_REG_MTST3			0x4A1
#define MT6379_REG_MTST4			0x4A2
#define MT6379_REG_MTST5			0x4A3
#define MT6379_REG_MTST6			0x4A4
#define MT6379_REG_MTST7			0x4A5
#define MT6379_REG_PHYCTRL9			0x4AC
#define MT6379_REG_SYSCTRL3			0x4B0
#define MT6379_REG_TCPCCTRL1			0x4B1
#define MT6379_REG_TCPCCTRL2			0x4B2
#define MT6379_REG_TCPCCTRL3			0x4B3
#define MT6379_REG_LPWRCTRL3			0x4BB
#define MT6379_REG_LPWRCTRL5			0x4BD
#define MT6379_REG_WATCHDOGCTRL			0x4BE
#define MT6379_REG_I2CTORSTCTRL			0x4BF
#define MT6379_REG_VCONN_LATCH			0x4C0
#define MT6379_REG_HILOCTRL9			0x4C8
#define MT6379_REG_HILOCTRL10			0x4C9
#define MT6379_REG_SHIELDCTRL1			0x4CA
#define MT6379_REG_FRS_CTRL2			0x4CC
#define MT6379_REG_TYPECOTPCTRL			0x4CD
#define MT6379_REG_FODCTRL			0x4CF
#define MT6379_REG_WD12MODECTRL			0x4D0
#define MT6379_REG_WD1PATHEN			0x4D1
#define MT6379_REG_WD1MISCCTRL			0x4D2
#define MT6379_REG_WD2PATHEN			0x4D3
#define MT6379_REG_WD2MISCCTRL			0x4D4
#define MT6379_REG_WD1PULLST			0x4D5
#define MT6379_REG_WD1DISCHGST			0x4D6
#define MT6379_REG_WD2PULLST			0x4D7
#define MT6379_REG_WD2DISCHGST			0x4D8
#define MT6379_REG_WD0MODECTRL			0x4D9
#define MT6379_REG_WD0SET			0x4DA
#define MT6379_REG_WDSET			0x4DB
#define MT6379_REG_WDSET1			0x4DC
#define MT6379_REG_TXHRSTCTRL			0x4DD
#define MT6379_REG_RXLIQIDLECTRL		0x4E2
...
#define MT6379_MSK_VCON_FAULT			(MT6379_MSK_VCON_OVCC1 | MT6379_MSK_VCON_OVCC2 | \
						 MT6379_MSK_VCON_RVP | MT6379_MSK_VCON_UVP |	 \
						 MT6379_MSK_VCON_SHTGND)
/* MT6379_REG_MTINT3: 0x49A */
...
#define MT6379_MSK_VBUS_TO_CC			(MT6379_MSK_VBUS_TO_CC1 | MT6379_MSK_VBUS_TO_CC2)

/* MT6379_REG_MTINT4: 0x49B */
...
#define MT6379_MSK_FOD_ALL			(MT6379_MSK_FOD_DONE | MT6379_MSK_FOD_OV |	\
						 MT6379_MSK_FOD_LR | MT6379_MSK_FOD_HR |	\
						 MT6379_MSK_FOD_DISCHGF)

/* MT6379_REG_MTINT5: 0x49C */
...
#define MT6379_MSK_VCONN_UVP_OCP_CPEN		(MT6379_MSK_VCONN_UVP_CPEN | \
						 MT6379_MSK_VCONN_OCP_CPEN)

/* MT6379_REG_VCONN_LATCH: 0x4C0 */
...
#define MT6379_MSK_VCONN_LATCH_EN		(MT6379_MSK_RCP_LATCH_EN | MT6379_MSK_OVP_LATCH_EN \
						 MT6379_MSK_RVP_LATCH_EN | MT6379_MSK_UVP_LATCH_EN)

/* MT6379_REG_HILOCTRL10: 0x4C9 */
#define MT6379_MSK_HIDET_CC1_CMPEN		BIT(1)
#define MT6379_MSK_HIDET_CC2_CMPEN		BIT(4)
#define MT6379_MSK_HIDET_CC_CMPEN		(MT6379_MSK_HIDET_CC1_CMPEN | \
						 MT6379_MSK_HIDET_CC2_CMPEN)

/* MT6379_REG_SHIELDCTRL1: 0x4CA */
...
/* MT6379_REG_WD0MODECTRL: 0x4D9 */
#define MT6379_MSK_WD0MODE_EN			BIT(4)

/* MT6379_REG_WD0SET: 0x4DA */
#define MT6379_MSK_WD0PULL_STS			BIT(7)

/* MT6379_REG_WDSET: 0x4DB */
...
static const u16 mt6379_wd_path_reg[MT6379_WD_CHAN_NUM] = {
...
static const u16 mt6379_wd_miscctrl_reg[MT6379_WD_CHAN_NUM] = {
	MT6379_REG_WD1MISCCTRL,
	MT6379_REG_WD2MISCCTRL,
};

static const u16 mt6379_wd_status_reg[MT6379_WD_CHAN_NUM] = {
