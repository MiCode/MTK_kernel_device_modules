...
#include "sc820cs_truly_front_i_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC820CS_TRULY_FRONT_I_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
 ...
 { 3264, 2448,    0,    0, 3264, 2448, 3264, 2448, 0000,  306, 3264, 1836,    0,    0, 3264, 1836},  // video
...
#define SC820CS_SENSOR_GAIN_MAP_SIZE  5
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor8(0x36ea,0x2b);
    write_cmos_sensor8(0x36eb,0x0c);
    write_cmos_sensor8(0x36ec,0x5a);
    ...
    write_cmos_sensor8(0x330f,0x04);
    write_cmos_sensor8(0x3310,0x02);
    write_cmos_sensor8(0x3314,0x15);
    write_cmos_sensor8(0x3317,0x04);
    ...
    write_cmos_sensor8(0x3347,0x0f);
    ...
    write_cmos_sensor8(0x481d,0x17);
    write_cmos_sensor8(0x481f,0x05);
    write_cmos_sensor8(0x4821,0x0b);
	...
	write_cmos_sensor8(0x3651,0x9c);
...
static void custom1_setting(void)
{
    ...
    write_cmos_sensor8(0x36e9,0x44);
    write_cmos_sensor8(0x37f9,0x24);
    write_cmos_sensor8(0x301f,0x25);
    write_cmos_sensor8(0x3205,0xc7);
...
#if 1
static kal_uint16 read_cmos_sensor_sc820cs_truly_otp(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pu_send_cmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
...
static void sc820cs_truly_fusion_id_read(void)
{
	int i;
	for (i=0; i<11; i++) {
		fusion_id_front[i] = read_cmos_sensor_sc820cs_truly_otp(0x10+i);
	pr_err("%s %d zengx fusion_id_front[%d]=0x%2x\n",__func__, __LINE__, i, fusion_id_front[i]);
	}
}
static void sc820cs_truly_sn_id_read(void)
{
	int i;
	for (i=0; i<25; i++) {
	        sn_front[i] = read_cmos_sensor_sc820cs_truly_otp(0x1F87+i);
...
#if 1
                    sc820cs_truly_fusion_id_read();
                    sc820cs_truly_sn_id_read();
#endif
                    return ERROR_NONE;
                }
...
UINT32 SC820CS_TRULY_FRONT_I_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
