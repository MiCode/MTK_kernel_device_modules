 ...
 *============================================================================
 *
 * Version:  V20240220175208 by GC-S-TEAM
 *

 */
#define PFX "gc08a3_sunny_mipiraw_Sensor"
...
#include "gc08a3_sunny_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A3_SUNNY_MIPI_RAW_SENSOR_ID,
...
static kal_uint16 read_cmos_sensor_gc08a3_eeprom(kal_uint32 addr)
{
        kal_uint16 get_byte = 0;
        char pu_send_cmd[2] = {
                (char)((addr >> 8) & 0xff),
...
static void gc08a3_fusion_id_read(void)
{
        int i;
        for (i=0; i<12; i++) {
                fusion_id_main[i] = read_cmos_sensor_gc08a3_eeprom(0x10+i);
                pr_debug("%s %d fusion_id_front[%d]=0x%2x\n",__func__, __LINE__, i, fusion_id_main[i]);
        }
}

static void gc08a3_sn_read(void)
{
        int i;
        for (i=0; i<14; i++) {
                sn_main[i] = read_cmos_sensor_gc08a3_eeprom(0x1F92+i);
...
static kal_uint16 gc08a3_3264x1840_addr_data[] = {
	...
	/*MIPI*/    
	0x0114, 0x03,                                     
	0x0180, 0x67, //[3:0]dphy_mipi_di0x              
	0x0181, 0xf0, 
	0x0185, 0x01, 
	0x0115, 0x30, 
	0x011b, 0x12, 
...
{
	pr_debug("[%s] hs_video_Start, 1280x720@30.11fps\n", __func__);
...
{
	pr_debug("[%s] slim_video_Start, 1280x720@30.11fps\n", __func__);
	table_write_cmos_sensor(gc08a3_1280x720_addr_data,
		sizeof(gc08a3_1280x720_addr_data)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				gc08a3_fusion_id_read();
                                gc08a3_sn_read();
                                //get_sensor_module_id();
				return ERROR_NONE;
			}
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ_BY_SCENARIO:
		    ...
		    case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			    ...
			    *feature_para_len = 4;
			    break;
		    case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			    *feature_return_para_32 = imgsensor_info.normal_video.pclk;
			    *feature_para_len = 4;
			    break;
		    case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
			    *feature_return_para_32 = imgsensor_info.hs_video.pclk;
			    *feature_para_len = 4;
			    break;
		    case MSDK_SCENARIO_ID_SLIM_VIDEO:
			    *feature_return_para_32 = imgsensor_info.slim_video.pclk;
			    *feature_para_len = 4;
			    break;
		    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		    default:
			    *feature_return_para_32 = imgsensor_info.pre.pclk;
			    *feature_para_len = 4;
			    break;
		    }
		break;
	case SENSOR_FEATURE_GET_PERIOD_BY_SCENARIO:
		switch (*feature_data) {
            case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			    *feature_return_para_16++ = imgsensor_info.cap.linelength;//imgsensor.line_length;
			    *feature_return_para_16 = imgsensor_info.cap.framelength;//imgsensor.frame_length;
			    *feature_para_len = 4;
			    break;
			case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			    *feature_return_para_16++ = imgsensor_info.normal_video.linelength;//imgsensor.line_length;
			    *feature_return_para_16 = imgsensor_info.normal_video.framelength;//imgsensor.frame_length;
			    *feature_para_len = 4;
			    break;
			case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
			    *feature_return_para_16++ = imgsensor_info.hs_video.linelength;//imgsensor.line_length;
			    *feature_return_para_16 = imgsensor_info.hs_video.framelength;//imgsensor.frame_length;
			    *feature_para_len = 4;
			    break;
		    case MSDK_SCENARIO_ID_SLIM_VIDEO:
			    *feature_return_para_16++ = imgsensor_info.slim_video.linelength;//imgsensor.line_length;
			    *feature_return_para_16 = imgsensor_info.slim_video.framelength;//imgsensor.frame_length;
			    *feature_para_len = 4;
			    break;
			case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
			default:
...
UINT32 GC08A3_SUNNY_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
