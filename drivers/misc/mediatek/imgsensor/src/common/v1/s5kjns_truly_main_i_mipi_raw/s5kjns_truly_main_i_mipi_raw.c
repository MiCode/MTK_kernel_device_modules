...
#include "s5kjns_truly_main_i_mipi_raw.h"
...
#define PFX "S5KJNS_TRULY_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJNS_TRULY_MAIN_I_SENSOR_ID ,
	...
	.isp_driving_current = ISP_DRIVING_2MA,//ISP_DRIVING_8MA
...
{ 4080, 3072,0,0, 4080, 3072, 4080, 3072,0, 0, 4080, 3072, 0, 0, 4080, 3072},
//normal_video
{ 4080, 3072,0,0, 4080, 3072, 4080, 3072,0, 388, 4080, 2296, 0, 0, 4080, 2296},
//hs_video
...
static void s5kjns_fusion_id_read(void)
{
	int i;
	for (i=0; i<6; i++) {
		fusion_id_main[i] = read_cmos_sensor_s5kjns(0x0010+i);
...
static void set_shutter(kal_uint32 shutter)
{
	...
	if (shutter < SHUTTER_1) {
		...
		LOG_INF("cxclong_shutter =%d, new_framelength =%d\n", long_shutter,new_framelength);
	}
...
UINT32 S5KJNS_TRULY_MAIN_I_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
