...
#define XIAOMI_IOC_SET_ONOFF_SINGLE_LED    _IOR(FLASHLIGHT_MAGIC, 1007, int)
#define XIAOMI_IOC_SET_TORCH_SINGLE_CUR    _IOR(FLASHLIGHT_MAGIC, 1008, int)
#define XIAOMI_IOC_SET_FLASH_SINGLE_CUR    _IOR(FLASHLIGHT_MAGIC, 1009, int)
#endif /* _FLASHLIGHT_H */
