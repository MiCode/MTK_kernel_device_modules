...
enum scp_reserve_mem_id_t {
	...
	ULTRA_MEM_ID,
	SENS_SUPER_MEM_ID = 8,
	SENS_SHARE_BUFFER_W_MEM_ID = 9,
	SENS_LIST_MEM_ID = SENS_SHARE_BUFFER_W_MEM_ID, // for legacy platform
	SENS_SHARE_BUFFER_R_MEM_ID = 10,
	SENS_DEBUG_MEM_ID = SENS_SHARE_BUFFER_R_MEM_ID, // for legacy platform
	SENS_CUSTOM_W_MEM_ID = 11,
	SENS_CUSTOM_R_MEM_ID = 12,
	SCP_AOV_MEM_ID,
	SCP_SPK_MEM_ID,
	SCP_AOD_MEM_ID = 15,
	SCP_CONNSYS_MEM_ID,
