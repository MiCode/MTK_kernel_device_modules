...
#define KERNEL_VERSION 3000

#define PDAROIARRAYMAX 128
#define FIXROIARRAYMAX 36
...
#define PDA_CFG_254_REG (0x5fc)
#define PDA_CFG_255_REG (0x600)
...
union _REG_PDA_CFG_254_ {
	struct /* 0x05FC */
	{
		unsigned int  PDA_RGN_IW_95    :  16;
...
struct _pda_a_reg_t_ {
	...
	union _REG_PDA_CFG_254_          PDA_CFG_254;
	union _REG_PDA_CFG_255_          PDA_CFG_255;
};
