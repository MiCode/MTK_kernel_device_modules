...
static void ISP_ConfigDMAControl(enum ISP_DEV_NODE_ENUM module)
{
	...
	if (IS_NEW_MMQOS_POLICY(g_platform_id)) {
		LOG_INF("Apply new dma mmqos policy\n");
		ISP_WR32(CAM_REG_IMGO_CON(module), 0x80000600);		//IMGO 1536
		ISP_WR32(CAM_REG_IMGO_CON2(module), 0x0099004C);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_IMGO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_IMGO_DRS(module), 0x81330099);		//urgent:20%/10%

		ISP_WR32(CAM_REG_RRZO_CON(module), 0x80000300);		//RRZO 768
		ISP_WR32(CAM_REG_RRZO_CON2(module), 0x004C0026);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_RRZO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_RRZO_DRS(module), 0x8099004C);		//urgent:20%/10%

		ISP_WR32(CAM_REG_PDO_CON(module), 0x80000060);		//PDO 96
		ISP_WR32(CAM_REG_PDO_CON2(module), 0x00090004);		//ultra: 10%/5%
		ISP_WR32(CAM_REG_PDO_CON3(module), 0x00000000);		//always pre-ultra
		ISP_WR32(CAM_REG_PDO_DRS(module), 0x80130009);		//urgent:20%/10%

		ISP_WR32(CAM_REG_TSFSO_CON(module), 0x80000080);	//TSFSO 128
		ISP_WR32(CAM_REG_TSFSO_CON2(module), 0x00C00006);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_TSFSO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_TSFSO_DRS(module), 0x8019000C);	//urgent:20%/10%

		ISP_WR32(CAM_REG_AAO_CON(module), 0x80000100);		//AAO 256
		ISP_WR32(CAM_REG_AAO_CON2(module), 0x0190000C);		//ultra: 10%/5%
		ISP_WR32(CAM_REG_AAO_CON3(module), 0x00000000);		//always pre-ultra
		ISP_WR32(CAM_REG_AAO_DRS(module), 0x80330019);		//urgent:20%/10%

		ISP_WR32(CAM_REG_AAHO_CON(module), 0x80000080);		//AAHO 128
		ISP_WR32(CAM_REG_AAHO_CON2(module), 0x00000000);	//always ultra
		ISP_WR32(CAM_REG_AAHO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_AAHO_DRS(module), 0x8019000C);		//urgent:20%/10%

		ISP_WR32(CAM_REG_AFO_CON(module), 0x80000180);		//AFO 384
		ISP_WR32(CAM_REG_AFO_CON2(module), 0x00260013);		//ultra: 10%/5%
		ISP_WR32(CAM_REG_AFO_CON3(module), 0x00000000);		//always pre-ultra
		ISP_WR32(CAM_REG_AFO_DRS(module), 0x804C0026);		//urgent:20%/10%

		ISP_WR32(CAM_REG_FLKO_CON(module), 0x80000020);		//FLKO 32
		ISP_WR32(CAM_REG_FLKO_CON2(module), 0x00300001);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_FLKO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_FLKO_DRS(module), 0x80060003);		//urgent:20%/10%

		ISP_WR32(CAM_REG_LTMSO_CON(module), 0x80000080);	//LTMSO 128
		ISP_WR32(CAM_REG_LTMSO_CON2(module), 0x00C00006);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_LTMSO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_LTMSO_DRS(module), 0x8019000C);	//urgent:20%/10%

		ISP_WR32(CAM_REG_LCESO_CON(module), 0x80000040);	//LCESO 64
		ISP_WR32(CAM_REG_LCESO_CON2(module), 0x00600003);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_LCESO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_LCESO_DRS(module), 0x800C0006);	//urgent:20%/10%

		ISP_WR32(CAM_REG_LCESHO_CON(module), 0x80000040);	//LCESO 64
		ISP_WR32(CAM_REG_LCESHO_CON2(module), 0x00600003);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_LCESHO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_LCESHO_DRS(module), 0x800C0006);	//urgent:20%/10%

		ISP_WR32(CAM_REG_RSSO_CON(module), 0x80000060);		//RSSO 96
		ISP_WR32(CAM_REG_RSSO_CON2(module), 0x00090004);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_RSSO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_RSSO_DRS(module), 0x80130009);		//urgent:20%/10%

		ISP_WR32(CAM_REG_LMVO_CON(module), 0x80000020);		//LMVO 32
		ISP_WR32(CAM_REG_LMVO_CON2(module), 0x00300001);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_LMVO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_LMVO_DRS(module), 0x80060003);		//urgent:20%/10%

		ISP_WR32(CAM_REG_UFEO_CON(module), 0x80000020);		//UFEo 32
		ISP_WR32(CAM_REG_UFEO_CON2(module), 0x00300001);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_UFEO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_UFEO_DRS(module), 0x80060003);		//urgent:20%/10%

		ISP_WR32(CAM_REG_UFGO_CON(module), 0x80000020);		//UFGO 32
		ISP_WR32(CAM_REG_UFGO_CON2(module), 0x00300001);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_UFGO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_UFGO_DRS(module), 0x80060003);		//urgent:20%/10%

		ISP_WR32(CAM_REG_YUVO_CON(module), 0x80000280);		//YUVO 640
		ISP_WR32(CAM_REG_YUVO_CON2(module), 0x00400020);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_YUVO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_YUVO_DRS(module), 0x80800040);		//urgent:20%/10%

		ISP_WR32(CAM_REG_YUVBO_CON(module), 0x80000140);	//YUVBO 320
		ISP_WR32(CAM_REG_YUVBO_CON2(module), 0x00200010);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_YUVBO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_YUVBO_DRS(module), 0x80400020);	//urgent:20%/10%

		ISP_WR32(CAM_REG_YUVCO_CON(module), 0x800000A0);	//YUVCO 160
		ISP_WR32(CAM_REG_YUVCO_CON2(module), 0x00100008);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_YUVCO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_YUVCO_DRS(module), 0x80200010);	//urgent:20%/10%

		ISP_WR32(CAM_REG_CRZO_CON(module), 0x80000040);		//CRZO 64
		ISP_WR32(CAM_REG_CRZO_CON2(module), 0x00600003);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_CRZO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_CRZO_DRS(module), 0x800C0006);		//urgent:20%/10%

		ISP_WR32(CAM_REG_CRZBO_CON(module), 0x80000020);	//CRZBO 32
		ISP_WR32(CAM_REG_CRZBO_CON2(module), 0x00300001);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_CRZBO_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_CRZBO_DRS(module), 0x80060003);	//urgent:20%/10%

		ISP_WR32(CAM_REG_CRZO_R2_CON(module), 0x80000080);	//CRZO_R2 128
		ISP_WR32(CAM_REG_CRZO_R2_CON2(module), 0x00C00006);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_CRZO_R2_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_CRZO_R2_DRS(module), 0x8019000C);	//urgent:20%/10%

		ISP_WR32(CAM_REG_RSSO_R2_CON(module), 0x80000060);	//RSSO_R2 96
		ISP_WR32(CAM_REG_RSSO_R2_CON2(module), 0x00090004);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_RSSO_R2_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_RSSO_R2_DRS(module), 0x80130009);	//urgent:20%/10%

		/* RDMA */
		ISP_WR32(CAM_REG_RAWI_R2_CON(module), 0x80000300);	//RAWI_R2 768
		ISP_WR32(CAM_REG_RAWI_R2_CON2(module), 0x004C0026);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_RAWI_R2_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_RAWI_R2_DRS(module), 0x8099004C);	//urgent:20%/10%

		ISP_WR32(CAM_REG_RAWI_R3_CON(module), 0x80000300);	//RAWI_R3 768
		ISP_WR32(CAM_REG_RAWI_R3_CON2(module), 0x004C0026);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_RAWI_R3_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_RAWI_R3_DRS(module), 0x8099004C);	//urgent:20%/10%

		ISP_WR32(CAM_REG_UFDI_R2_CON(module), 0x80000020);	//UFDI_R2 32
		ISP_WR32(CAM_REG_UFDI_R2_CON2(module), 0x00300001);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_UFDI_R2_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_UFDI_R2_DRS(module), 0x80060003);	//urgent:20%/10%

		ISP_WR32(CAM_REG_PDI_CON(module), 0x80000060);		//PDI 96
		ISP_WR32(CAM_REG_PDI_CON2(module), 0x00090004);		//ultra: 10%/5%
		ISP_WR32(CAM_REG_PDI_CON3(module), 0x00000000);		//always pre-ultra
		ISP_WR32(CAM_REG_PDI_DRS(module), 0x80130009);		//urgent:20%/10%

		ISP_WR32(CAM_REG_BPCI_CON(module), 0x80000060);		//BPCI 96
		ISP_WR32(CAM_REG_BPCI_CON2(module), 0x00090004);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_BPCI_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_BPCI_DRS(module), 0x80130009);		//urgent:20%/10%

		ISP_WR32(CAM_REG_BPCI_R2_CON(module), 0x80000060);	//BPCI_R2 96
		ISP_WR32(CAM_REG_BPCI_R2_CON2(module), 0x00090004);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_BPCI_R2_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_BPCI_R2_DRS(module), 0x80130009);	//urgent:20%/10%

		ISP_WR32(CAM_REG_BPCI_R3_CON(module), 0x80000060);	//BPCI_R3 96
		ISP_WR32(CAM_REG_BPCI_R3_CON2(module), 0x00090004);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_BPCI_R3_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_BPCI_R3_DRS(module), 0x80130009);	//urgent:20%/10%

		ISP_WR32(CAM_REG_LSCI_CON(module), 0x80000080);		//LCSI 128
		ISP_WR32(CAM_REG_LSCI_CON2(module), 0x00C00006);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_LSCI_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_LSCI_DRS(module), 0x8019000C);		//urgent:20%/10%

		ISP_WR32(CAM_REG_CQI_R1_CON(module), 0x80000040);	//CQI_R1 64
		ISP_WR32(CAM_REG_CQI_R1_CON2(module), 0x00600003);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_CQI_R1_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_CQI_R1_DRS(module), 0x800C0006);	//urgent:20%/10%

		ISP_WR32(CAM_REG_CQI_R2_CON(module), 0x80000040);	//CQI_R2 64
		ISP_WR32(CAM_REG_CQI_R2_CON2(module), 0x00600003);	//ultra: 10%/5%
		ISP_WR32(CAM_REG_CQI_R2_CON3(module), 0x00000000);	//always pre-ultra
		ISP_WR32(CAM_REG_CQI_R2_DRS(module), 0x800C0006);	//urgent:20%/10%
		...
		LOG_INF("Apply default dma mmqos policy\n");
		/* WDMA */
	...
	if (((IrqStatus & SOF_INT_ST) && isStagger == 0) ||
		...
		if (IspInfo.DebugMask & ISP_DBG_INT) {
			...
			if (sec_on)
				...
				IRQ_LOG_KEEPER(
				module, m_CurrentPPB, _LOG_INF,
				"%s,%s,CAM_%c P1_SOF_%d_%d(0x%08x_0x%08x,0x%08x_0x%08x,0x%08x,0x%08x,0x%x/0x%x),int_us:%d,FBC:0x%08x,cq:0x%08x_0x%08x 0x%08x_0x%08x 0x%08x_0x%08x,Don(0x%08x_0x%08x 0x%08x_0x%08x,0x%08x_0x%08x 0x%08x_0x%08x),DMA(0x%x_0x%x,0x%x_0x%x,0x%x_0x%x,0x%x_0x%x,0x%x_0x%x,0x%x_0x%x),CTL_EN(0x%x_0x%x 0x%x_0x%x 0x%x_0x%x),CTL_EN2(0x%x_0x%x 0x%x_0x%x 0x%x_0x%x), AFO(0x%x), AAHO(0x%x, 0x%x_0x%x), TSFSO(0x%x_0x%x 0x%x_0x%x), LSCI(0x%x_0x%x)\n",
				...
				(unsigned int)ISP_RD32(CAM_REG_AAHO_XSIZE(ISP_CAM_A_IDX)),
				(unsigned int)ISP_RD32(CAM_REG_AAHO_YSIZE(ISP_CAM_A_IDX)),
