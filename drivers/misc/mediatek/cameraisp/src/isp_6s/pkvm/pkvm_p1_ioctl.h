...
#define CAM_PKVM_SET_DAPC_REG   \
	_IOW(CAM_PKVM_MAGIC, CAM_PKVM_CMD_SET_DAPC_REG, struct SecMgr_RegInfo_PKVM)

#define CAM_PKVM_SET_SEC_CAM    \
	_IOW(CAM_PKVM_MAGIC, CAM_PKVM_CMD_SET_SEC_CAM, uint32_t)
...
#define CAM_PKVM_UNINIT          \
	_IO(CAM_PKVM_MAGIC, CAM_PKVM_CMD_UNINIT)
