...
void mbraink_v6991_get_wifi_rxtxperf_data(int current_idx,
...
static int mbraink_v6991_set_wifi_data(struct wifi2mbr_data *wifi_data)
{
...
static struct wifi2mbraink_set_ops mbraink_v6991_wifi_set_ops = {
	.set_data = mbraink_v6991_set_wifi_data,
};
...
int mbraink_v6991_wifi_init(void)
{
	...
	ret = register_platform_to_bridge_ops(&mbraink_v6991_wifi_set_ops);
	if (ret)
