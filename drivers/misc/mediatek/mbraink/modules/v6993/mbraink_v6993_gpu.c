...
static void mbraink_v6993_gpu_setOpMode(int OpMode)
{
	gOpMode = OpMode;
}

static int mbraink_v6993_gpu_getOpMode(void)
{
	return gOpMode;
}

static ssize_t mbraink_v6993_gpu_getTimeoutCouterReport(char *pBuf)
{
	ssize_t size = 0;
...
unsigned long long mbraink_v6993_gpu_getQ2QTimeoutInNS(void)
{
...
static int mbraink_v6993_gpu_getStateInfo(struct mbraink_gpu_state_info *gStateInfo)
{
	int ret = 0;
...
static int mbraink_v6993_gpu_getLoadingInfo(struct mbraink_gpu_loading_info *gLoadingInfo)
{
	int ret = 0;
...
static struct mbraink_gpu_ops mbraink_v6993_gpu_ops = {
	.setFeatureEnable = mbraink_v6993_gpu_setFeatureEnable,
	.getTimeoutCounterReport = mbraink_v6993_gpu_getTimeoutCouterReport,
	.getOppInfo = mbraink_v6993_gpu_getOppInfo,
	.getStateInfo = mbraink_v6993_gpu_getStateInfo,
	.getLoadingInfo = mbraink_v6993_gpu_getLoadingInfo,
	.setOpMode = mbraink_v6993_gpu_setOpMode,
};
...
int mbraink_v6993_gpu_init(void)
{
	...
	ret = register_mbraink_gpu_ops(&mbraink_v6993_gpu_ops);
	return ret;
}
...
int mbraink_v6993_gpu_deinit(void)
{
	...
	ret = mbraink_v6993_gpu_setFeatureEnable(false);
	return ret;
}
