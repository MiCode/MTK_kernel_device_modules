...
int mbraink_v6993_get_touch_ghost_info(struct mbraink_touch_ghost_info *touch_ghost_info)
{
	int ret = 0;
...
static struct mbraink_touch_ops mbraink_v6993_touch_ops = {
	.get_touch_ghost_info = mbraink_v6993_get_touch_ghost_info,
};
...
int mbraink_v6993_touch_init(void)
{
	...
	ret = register_mbraink_touch_ops(&mbraink_v6993_touch_ops);
