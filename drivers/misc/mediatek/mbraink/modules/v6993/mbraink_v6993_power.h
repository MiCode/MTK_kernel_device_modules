 ...
 */
#ifndef MBRAINK_V6993_POWER_H
#define MBRAINK_V6993_POWER_H
...
#define MMDVFS_USER_DATA_SZ (1024)
#define MMDVFS_TOTAL_SZ (MAX_POWER_HD_SZ+MMDVFS_DATA_SZ)
#define MMDVFS_USER_TOTAL_SZ (MAX_POWER_HD_SZ+MMDVFS_USER_DATA_SZ)
