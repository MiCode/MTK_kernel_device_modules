...
const struct adspsys_description mt6877_adspsys_desc = {
	.platform_name = "mt6877",
	.version = 1,
	.semaphore_ways = 3,
	.semaphore_ctrl = 2,
...
const struct adsp_core_description mt6877_adsp_c0_desc = {
	.id = 0,
	.name = "adsp_0",
	.sharedmems = {
...
static const struct of_device_id adspsys_of_ids[] = {
	{ .compatible = "mediatek,mt6877-adspsys", .data = &mt6877_adspsys_desc},
	{}
};

static const struct of_device_id adsp_core_of_ids[] = {
	{ .compatible = "mediatek,mt6877-adsp_core_0", .data = &mt6877_adsp_c0_desc},
	{}
};
