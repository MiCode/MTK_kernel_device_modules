...
static const struct dvfsrc_dbgfs_data mt6881_dvfsrc_debugfs_data = {
	.regs = mt6881_regs,
};
...
static const struct of_device_id of_mtk_dvfsrc_dbgfs_match_tbl[] = {
	...
	},
	{
		...
		{
		.compatible = "mediatek,mt6881-dvfsrc-debugfs",
		.data = &mt6881_dvfsrc_debugfs_data,
	},
	{}
};
