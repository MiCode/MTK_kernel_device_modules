...
static const struct dvfsrc_debug_data mt6993_data = {
	.version = 0x6993,
	.config = &mt6993_dvfsrc_config,
	.opps_desc = dvfsrc_opp_common_desc,
	.num_opp_desc = 0,
	.ceiling_support = true,
	.qos_mm_mode_en = true,
...
static struct dvfsrc_opp dvfsrc_opp_mt6858[] = {
	{0, 0, 0, 0},
	{1, 0, 0, 0},
	{2, 0, 0, 0},
	{3, 0, 0, 0},
...
static struct dvfsrc_opp_desc dvfsrc_opp_mt6858_desc[] = {
	MT_DVFSRC_OPP(4, 6, dvfsrc_opp_mt6858),
};

static const struct dvfsrc_debug_data mt6858_data = {
	.version = 0x6858,
	.config = &mt6897_dvfsrc_config,
...
static struct dvfsrc_opp dvfsrc_opp_mt6881[] = {
	{0, 0, 0, 0},
	{1, 0, 0, 0},
	{2, 0, 0, 0},
	{3, 0, 0, 0},
...
static struct dvfsrc_opp_desc dvfsrc_opp_mt6881_desc[] = {
	MT_DVFSRC_OPP(5, 8, dvfsrc_opp_mt6881),
};

static const struct dvfsrc_debug_data mt6881_data = {
	.version = 0x6881,
	.config = &mt6897_dvfsrc_config,
...
static void mtk_dvfsrc_helper_remove(struct platform_device *pdev)
{
	struct device *dev = &pdev->dev;
...
#endif
#if IS_ENABLED(CONFIG_MTK_DVFSRC_VSMR)
	ret = mtk_dvfsrc_vsmr_init();
	if (ret) {
		platform_driver_unregister(&mtk_dvfsrc_helper_driver);
		return ret;
	}
