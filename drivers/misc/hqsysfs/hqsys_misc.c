...
static const struct attribute_group hq_misc_attrs_groups = {
	.attrs = hq_misc_attrs,
};

static const struct attribute_group *hq_misc_grpups[] = {
	&hq_misc_attrs_groups,
	NULL,
};
