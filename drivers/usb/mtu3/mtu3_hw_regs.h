...
#define SSUSB_SPM_REQ_DRAM_SW \
	(SSUSB_SPM_APSRC_REQ | SSUSB_SPM_DDR_EN | SSUSB_SPM_EMI_EN)
#define SSUSB_SPM_REQ_DRAM_HW (SSUSB_SPM_HW_APSRC_REQ | \
	SSUSB_SPM_HW_DDREN_REQ | SSUSB_SPM_HW_EMI_REQ)
