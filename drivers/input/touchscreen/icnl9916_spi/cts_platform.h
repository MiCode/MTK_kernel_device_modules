...
#define cts_err(fmt, ...)   \
    cts_log(CTS_DRIVER_LOG_ERROR, "%s(%d):<E>CTS-" LOG_TAG " " fmt"\n", __func__, __LINE__, ##__VA_ARGS__)
#define cts_warn(fmt, ...)  \
    cts_log(CTS_DRIVER_LOG_WARN,  "%s(%d):<W>CTS-" LOG_TAG " " fmt"\n", __func__, __LINE__, ##__VA_ARGS__)
#define cts_info(fmt, ...)  \
    cts_log(CTS_DRIVER_LOG_INFO,  "%s(%d):<I>CTS-" LOG_TAG " " fmt"\n", __func__, __LINE__, ##__VA_ARGS__)
#define cts_dbg(fmt, ...)   \
    cts_log(CTS_DRIVER_LOG_DEBUG, "%s(%d):<D>CTS-" LOG_TAG " " fmt"\n", __func__, __LINE__,##__VA_ARGS__)
