...
#if IS_ENABLED(CONFIG_MIEV)
	xiaomi_touch_mievent_report_int(TOUCH_EVENT_PARAM_ERR, 0, "TpParamParseFail", "ICNL", ERROR_DTS_PARSE);
#endif
            return ret;
        }
    }
...
int cts_plat_init_gesture(struct cts_platform_data *pdata)
{
    ...
    //pdata->ts_input_dev->event = cts_gesture_switch;
