...
static int tp_data_dump_proc_show(struct seq_file *file, void* data)
{
    ...
    FTS_INFO("into data dump show");
//printk 0 90 180 270 rawdata
    seq_printf(file,"\nRAW DATA\n");
#if 0 // 0
