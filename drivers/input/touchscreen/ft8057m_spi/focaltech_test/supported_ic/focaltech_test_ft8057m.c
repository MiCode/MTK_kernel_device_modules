...
*******************************************************************************/
static int ft8057m_short_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
...
static int ft8057m_open_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
    bool tmp_result = false;
...
static int ft8057m_cb_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    bool tmp_result = false;
    int byte_num = 0;
...
static int ft8057m_rawdata_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    bool tmp_result = false;
    int *rawdata = NULL;
...
static int ft8057m_fast_calibration(void)
{
    int ret = 0;
    u8 val = 0;
    int i = 0;
...
static int ft8057m_lcdnoise_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
    bool tmp_result = false;
...
static int start_test_ft8057m(void)
{
    int ret = 0;
    ...
    if (true == test_item->short_test) {
        ret = ft8057m_short_test(tdata, &temp_result);
    ...
    if (true == test_item->open_test) {
        ret = ft8057m_open_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
    ...
    if (true == test_item->cb_test) {
        ret = ft8057m_cb_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
    ...
    if (true == test_item->rawdata_test) {
        ret = ft8057m_rawdata_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
    ...
    if (true == test_item->lcdnoise_test) {
        ret = ft8057m_lcdnoise_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
...
struct test_funcs test_func_ft8057m = {
    .ctype = {0x28},
    .hwtype = IC_HW_INCELL,
    .key_num_total = 0,
    .start_test = start_test_ft8057m,
};
