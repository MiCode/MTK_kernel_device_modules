...
bool ps_send_touch_event_probe = false;
EXPORT_SYMBOL(ps_send_touch_event_probe);
int (*tp_ps_send_touch_event)(int32_t data)=NULL;
EXPORT_SYMBOL(tp_ps_send_touch_event);
/*
 * DATA STRUCTURES
 ****************************************************************************************
 */
...
static int lct_creat_proc_tp_entry(void)
{
    lct_tp_p->proc_entry_tp = proc_create_data(TP_PROXIMITY_SWITCH_NAME, 0666, NULL, &lct_proc_tp_proximity_switch_fops, NULL);
