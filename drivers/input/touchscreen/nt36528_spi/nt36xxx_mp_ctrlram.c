 ...
 *
 * $Revision: 117770 $
 * $Date: 2023-04-28 09:39:41 +0800 (週五, 28 四月 2023) $
 *
...
#define SHORT_TEST_CSV_FILE "/data/vendor/touchpad/ShortTest.csv"
#define OPEN_TEST_CSV_FILE "/data/vendor/touchpad/OpenTest.csv"
#define FW_RAWDATA_CSV_FILE "/data/vendor/touchpad/FWRawdataTest.csv"
#define FW_CC_CSV_FILE "/data/vendor/touchpad/FWCCTest.csv"
#define NOISE_TEST_CSV_FILE "/data/vendor/touchpad/NoiseTest.csv"
#define PEN_FW_RAW_TEST_CSV_FILE "/data/vendor/touchpad/PenFWRawTest.csv"
#define PEN_NOISE_TEST_CSV_FILE "/data/vendor/touchpad/PenNoiseTest.csv"
...
int lct_nvt_tp_selftest_callback(unsigned char cmd)
{
	...
	//---Download MP FW---
	nvt_update_firmware(nvt_tp_mp_name);
	if (nvt_get_fw_info()) {
...
static int32_t nvt_selftest_open(struct inode *inode, struct file *file)
{
	...
	//---Download MP FW---
	if (nvt_update_firmware(nvt_tp_mp_name) < 0) {
