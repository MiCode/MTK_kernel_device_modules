...
#include "../../../gpu/drm/mediatek/mediatek_v2/drm_notifier_odm.h"
#endif
...
#define SIL_REGISTER_CLIENT(a)      \
    do {                            \
        msm_drm_register_client(a); \
    } while (0)
#else
...
#define LOG_MSG_DEBUG(level, fmt, args...) \
    do {                                   \
