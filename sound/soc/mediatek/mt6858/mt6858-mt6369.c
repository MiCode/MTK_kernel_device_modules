...
/*
 *  mt6858-mt6369.c  --  mt6858 mt6369 ALSA SoC machine driver
 *
 ...
 * mt6858_mt6369_spk_amp_event()
 */
#define EXT_SPK_AMP_W_NAME "Ext_Speaker_Amp"
#define MT6369_PROBE_DONE 1

#if IS_ENABLED(CONFIG_SND_SOC_MT6369_ACCDET) && !defined(SKIP_ACCDET)
#include "../../codecs/mt6369-accdet.h"
#endif


static struct snd_soc_card mt6858_mt6369_soc_card;

struct mt6858_compress_info compr_info;

static const char *const mt6858_spk_type_str[] = {MTK_SPK_NOT_SMARTPA_STR,
						  MTK_SPK_RICHTEK_RT5509_STR,
						  MTK_SPK_MEDIATEK_MT6660_STR,
						  MTK_SPK_RICHTEK_RT5512_STR,
						  MTK_SPK_GOODIX_TFA98XX_STR};

static const char *const mt6858_spk_i2s_type_str[] = {
	MTK_SPK_I2S_0_STR,
	MTK_SPK_I2S_1_STR,
	MTK_SPK_I2S_2_STR,
	MTK_SPK_I2S_3_STR,
...
static const struct soc_enum mt6858_spk_type_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6858_spk_type_str),
			    mt6858_spk_type_str),
...
static int mt6858_spk_i2s_out_type_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6858_spk_i2s_in_type_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6858_compress_info_get(struct snd_kcontrol *kcontrol,
				    unsigned int __user *data, unsigned int size)
{
	...
	if (copy_to_user(data, &compr_info, sizeof(struct mt6858_compress_info))) {
...
static int mt6858_mt6369_spk_amp_event(struct snd_soc_dapm_widget *w,
...
static const struct snd_soc_dapm_widget mt6858_mt6369_widgets[] = {
	SND_SOC_DAPM_SPK(EXT_SPK_AMP_W_NAME, mt6858_mt6369_spk_amp_event),
};

static const struct snd_soc_dapm_route mt6858_mt6369_routes[] = {
...
static const struct snd_soc_dapm_route mt6858_mt6369_routes_dummy[] = {};

static const struct snd_kcontrol_new mt6858_mt6369_controls[] = {
	SOC_DAPM_PIN_SWITCH(EXT_SPK_AMP_W_NAME),
	SOC_ENUM_EXT("MTK_SPK_TYPE_GET", mt6858_spk_type_enum[0],
		     mt6858_spk_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6858_spk_type_enum[1],
 ...
 * BE i2s need assign snd_soc_ops = mt6858_mt6369_i2s_ops
 */
static int mt6858_mt6369_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6858_mt6369_i2s_ops = {
	.hw_params = mt6858_mt6369_i2s_hw_params,
};

static int mt6858_mt6369_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6858_afe_gpio_is_prepared(MT6858_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6858_afe_gpio_is_prepared(MT6858_AFE_GPIO_DAT_MISO1_ON);
...
static int mt6858_mt6369_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	ops.enable_dc_compensation = mt6858_enable_dc_compensation;
	ops.set_lch_dc_compensation = mt6858_set_lch_dc_compensation;
	ops.set_rch_dc_compensation = mt6858_set_rch_dc_compensation;
	ops.adda_dl_gain_control = mt6858_adda_dl_gain_control;
	ops.set_adda_predistortion = mt6858_set_adda_predistortion;
	...
	/* mtkaif calibration */
	mt6858_mt6369_mtkaif_calibration(rtd);
...
static int mt6858_i2s_hw_params_fixup(struct snd_soc_pcm_runtime *rtd,
				      struct snd_pcm_hw_params *params)
{
...
static const struct snd_pcm_hardware mt6858_mt6369_vow_hardware = {
...
static int mt6858_mt6369_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6858_mt6369_vow_hardware);

	mt6858_afe_gpio_request(afe, true, MT6858_DAI_VOW, 0);
...
static void mt6858_mt6369_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
...
static const struct snd_soc_ops mt6858_mt6369_vow_ops = {
	.startup = mt6858_mt6369_vow_startup,
	.shutdown = mt6858_mt6369_vow_shutdown,
};
...
static struct snd_soc_dai_link mt6858_mt6369_dai_links[] = {
	/* Front End DAI links */
	{
		.name = "Playback_1",
	...
	},
	{
		...
		.ops = &mt6858_mt6369_i2s_ops,
		.no_pcm = 1,
		.dpcm_capture = 1,
		.ignore_suspend = 1,
		.be_hw_params_fixup = mt6858_i2s_hw_params_fixup,
...
static struct snd_soc_card mt6858_mt6369_soc_card = {
	.name = "mt6858-mt6369",
	.owner = THIS_MODULE,
	.dai_link = mt6858_mt6369_dai_links,
	.num_links = ARRAY_SIZE(mt6858_mt6369_dai_links),

	.controls = mt6858_mt6369_controls,
	.num_controls = ARRAY_SIZE(mt6858_mt6369_controls),
	.dapm_widgets = mt6858_mt6369_widgets,
	.num_dapm_widgets = ARRAY_SIZE(mt6858_mt6369_widgets),
	.dapm_routes = mt6858_mt6369_routes,
	.num_dapm_routes = ARRAY_SIZE(mt6858_mt6369_routes),
};

static int mt6858_mt6369_bypass_primary_codec(struct platform_device *pdev)
{
	struct snd_soc_card *card = &mt6858_mt6369_soc_card;
	int i;
	struct snd_soc_dai_link *dai_link;
	...
	card->dapm_routes = mt6858_mt6369_routes_dummy;
	card->num_dapm_routes = ARRAY_SIZE(mt6858_mt6369_routes_dummy);
	return 0;
}

static int mt6858_mt6369_dev_probe(struct platform_device *pdev)
{
	struct snd_soc_card *card = &mt6858_mt6369_soc_card;
...
static const struct of_device_id mt6858_mt6369_dt_match[] = {
	{.compatible = "mediatek,mt6858-mt6369-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6858_mt6369_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6858_mt6369_driver = {
	.driver = {
		.name = "mt6858-mt6369",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6858_mt6369_dt_match,
#endif
		.pm = &mt6858_mt6369_pm_ops,
	},
	.probe = mt6858_mt6369_dev_probe,
};

module_platform_driver(mt6858_mt6369_driver);

/* Module information */
MODULE_DESCRIPTION("MT6858 mt6369 ALSA SoC machine driver");
MODULE_AUTHOR("Shawn Sung <shawn.sung@mediatek.com>");
MODULE_LICENSE("GPL");
MODULE_ALIAS("mt6858 mt6369 soc card");
