...
static const struct snd_pcm_hardware mt6858_hostless_hardware = {
...
static const struct snd_soc_dapm_route mtk_dai_hostless_routes[] = {
	...
	{"I2SOUT1_CH1", "HW_SRC_2_OUT_CH1", "Hostless_HW_SRC_2_IN_DL"},
	{"I2SOUT1_CH2", "HW_SRC_2_OUT_CH2", "Hostless_HW_SRC_2_IN_DL"},
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6858_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_SRC_0_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_SRC_0_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_SRC_1_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_SRC_1_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_SRC_2_OUT,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_SRC_2_IN,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_HW_GAIN_AAUDIO,
		.capture = {
	...
	},
	{
		...
		.id = MT6858_DAI_HOSTLESS_SRC_AAUDIO,
		.playback = {
...
int mt6858_dai_hostless_register(struct mtk_base_afe *afe)
{
