...
static int mt6858_gain0_get(struct snd_kcontrol *kcontrol,
...
static int mt6858_gain0_set(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6858_gain1_get(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6858_gain1_set(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6858_gain_l_set(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6858_gain_l_get(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6858_gain_r_set(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6858_gain_r_get(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_hw_gain_controls[] = {
	SOC_SINGLE_EXT("HW Gain 1", SND_SOC_NOPM, 0, 0x8E432E, 0,
		       mt6858_gain0_get, mt6858_gain0_set),
	SOC_SINGLE_EXT("HW Gain 2", SND_SOC_NOPM, 0, 0x8E432E, 0,
		       mt6858_gain1_get, mt6858_gain1_set),
	SOC_SINGLE_EXT("HW Gain 0 L", AFE_GAIN0_CON1_L,
		   0, 0xffffffff, 0,
		   mt6858_gain_l_get, mt6858_gain_l_set),
	SOC_SINGLE_EXT("HW Gain 0 R", AFE_GAIN0_CON1_R,
		   0, 0xffffffff, 0,
		   mt6858_gain_r_get, mt6858_gain_r_set),
				  ...
				  struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6858_rate_transform(afe->dev, rate, dai->id);
