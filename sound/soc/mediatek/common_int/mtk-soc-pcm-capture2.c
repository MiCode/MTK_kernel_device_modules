...
static int mtk_capture2_pcm_close(struct snd_soc_component *component,
...
static int mtk_capture2_pcm_prepare(struct snd_soc_component *component,
				    struct snd_pcm_substream *substream)
{
...
mtk_capture2_pcm_pointer(struct snd_soc_component *component,
			 struct snd_pcm_substream *substream)
{
...
static int mtk_capture2_pcm_hw_params(struct snd_soc_component *component,
				      struct snd_pcm_substream *substream,
...
static int mtk_capture2_pcm_hw_free(struct snd_soc_component *component,
				    struct snd_pcm_substream *substream)
{
	AudDrv_Emi_Clk_Off();
...
static int mtk_capture2_pcm_open(struct snd_soc_component *component,
				 struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	int ret = 0;
	...
	if (ret < 0) {
		...
		mtk_capture2_pcm_close(component, substream);
		return ret;
	}
	return 0;
}
...
static int mtk_capture2_pcm_trigger(struct snd_soc_component *component,
				    struct snd_pcm_substream *substream,
				    int cmd)
{
	switch (cmd) {
...
static int mtk_capture2_pcm_copy(struct snd_soc_component *component,
				 struct snd_pcm_substream *substream,
...
static struct page *mtk_capture2_pcm_page(struct snd_soc_component *component,
					  struct snd_pcm_substream *substream,
