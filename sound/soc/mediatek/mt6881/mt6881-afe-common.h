...
enum {
	...
	MT6881_DAI_ADDA_CH56,
	MT6881_DAI_AP_DMIC,
	MT6881_DAI_AP_DMIC_CH34,
	MT6881_DAI_AP_DMIC_CH56,
	MT6881_DAI_VOW,
	...
	MT6881_DAI_HW_GAIN_2,
	MT6881_DAI_HW_GAIN_3,
	MT6881_DAI_SRC_0,
	MT6881_DAI_SRC_1,
	MT6881_DAI_SRC_2,
	MT6881_DAI_SRC_3,
	...
	MT6881_DAI_HOSTLESS_HW_GAIN_AAUDIO,
	MT6881_DAI_HOSTLESS_SRC_AAUDIO,
	MT6881_DAI_HOSTLESS_SPEECH,
	MT6881_DAI_HOSTLESS_BT,
	MT6881_DAI_HOSTLESS_SPH_ECHO_REF,
	MT6881_DAI_HOSTLESS_SPK_INIT,
	MT6881_DAI_HOSTLESS_IMPEDANCE,
	MT6881_DAI_HOSTLESS_SRC_0,
	MT6881_DAI_HOSTLESS_SRC_1,
	MT6881_DAI_HOSTLESS_SRC_2,
	MT6881_DAI_HOSTLESS_SRC_3,
	MT6881_DAI_HOSTLESS_HW_SRC_0_OUT,
	MT6881_DAI_HOSTLESS_HW_SRC_0_IN,
	MT6881_DAI_HOSTLESS_HW_SRC_1_OUT,
	MT6881_DAI_HOSTLESS_HW_SRC_1_IN,
	MT6881_DAI_HOSTLESS_HW_SRC_2_OUT,
	MT6881_DAI_HOSTLESS_HW_SRC_2_IN,
	MT6881_DAI_HOSTLESS_SRC_BARGEIN,
	MT6881_DAI_HOSTLESS_UL1,
	MT6881_DAI_HOSTLESS_UL2,
	MT6881_DAI_HOSTLESS_UL3,
	MT6881_DAI_HOSTLESS_UL4,
#if IS_ENABLED(CONFIG_SND_SOC_MTK_AUTO_AUDIO)
	MT6881_DAI_HOSTLESS_UL5,
	MT6881_DAI_HOSTLESS_UL6,
	MT6881_DAI_HOSTLESS_UL37,
#else
	MT6881_DAI_HOSTLESS_UL24,
#endif
	MT6881_DAI_HOSTLESS_DSP_DL,
	MT6881_DAI_NUM,
	/* use for mtkaif calibration specail setting */
	MT6881_DAI_MTKAIF = MT6881_DAI_NUM,
	MT6881_DAI_MISO_ONLY,
...
#define MT6881_FAST_MEMIF MT6881_MEMIF_DL2
#define MT6881_DEEP_MEMIF MT6881_MEMIF_DL3
#define MT6881_VOIP_MEMIF MT6881_MEMIF_DL1
#define MT6881_MMAP_DL_MEMIF MT6881_MEMIF_DL4
#define MT6881_MMAP_UL_MEMIF MT6881_MEMIF_VUL2
#define MT6881_BARGE_IN_MEMIF MT6881_MEMIF_VUL_CM0

// adsp define
#define MT6881_DSP_PRIMARY_MEMIF MT6881_MEMIF_DL0
#define MT6881_DSP_DEEPBUFFER_MEMIF MT6881_MEMIF_DL3
#define MT6881_DSP_VOIP_MEMIF MT6881_MEMIF_DL1
#define MT6881_DSP_PLAYBACKDL_MEMIF MT6881_MEMIF_DL4
#define MT6881_DSP_PLAYBACKUL_MEMIF MT6881_MEMIF_VUL4
...
struct mt6881_compress_info {
	int card;
	int device;
	int dir;
	char id[64];
};
struct mt6881_afe_private {
	struct clk **clk;
	struct regmap *topckgen;
	struct regmap *apmixed;
	struct regmap *infracfg;
	struct regmap *pmic_regmap;
	int irq_cnt[MT6881_MEMIF_NUM];
	...
	int voip_rx_state;
	/* xrun assert */
	int xrun_assert[MT6881_MEMIF_NUM];

	/* dai */
	bool dai_on[MT6881_DAI_NUM];
	void *dai_priv[MT6881_DAI_NUM];
...
int mt6881_set_local_afe(struct mtk_base_afe *afe);

unsigned int mt6881_general_rate_transform(struct device *dev,
		unsigned int rate);
unsigned int mt6881_general_rate_transform_inverse(struct device *dev,
		unsigned int rate);
unsigned int mt6881_rate_transform(struct device *dev,
				   unsigned int rate, int aud_blk);
int mt6881_dai_set_priv(struct mtk_base_afe *afe, int id,
			int priv_size, const void *priv_data);

int mt6881_enable_dc_compensation(bool enable);
...
int mt6881_afe_set_clk_always_on(struct mtk_base_afe *afe, bool enable);
