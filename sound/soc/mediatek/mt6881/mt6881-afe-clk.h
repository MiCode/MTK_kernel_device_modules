...
/*
 * mt6881-afe-clk.h  --  Mediatek 6881 afe clock ctrl definition
 *
 * Copyright (c) 2023 MediaTek Inc.
 * Author: Shu-wei Hsu <Shu-wei.Hsu@mediatek.com>
 */

#ifndef _MT6881_AFE_CLOCK_CTRL_H_
#define _MT6881_AFE_CLOCK_CTRL_H_

#define AP_PLL_CON3 0x0008
#define PLLEN_ALL 0x0070
#define PLLEN_ALL_SET 0x0084
#define PLLEN_ALL_CLR 0x0088

#define APLL1_CON1 0x02cc
#define APLL1_CON2 0x02d0
#define APLL1_TUNER_CON0 0x0024

#define APLL2_CON1 0x032e4
#define APLL2_CON2 0x02e8
#define APLL2_TUNER_CON0 0x0028
...
enum {
	...
	CLK_AFE_DL1_DAC_AUDIO,
	CLK_AFE_DL1_DAC_HIRES_AUDIO,
	CLK_AFE_DL1_PREDIS_AUDIO,
	CLK_AFE_UL0_ADC_AUDIO,
	CLK_AFE_UL0_ADC_HIRES_AUDIO,
	CLK_AFE_UL1_ADC_AUDIO,
	CLK_AFE_UL1_ADC_HIRES_AUDIO,
	CLK_AFE_CQDMA_BUS_AUDIO,
	CLK_CKSYS_REG_AUD_1_SEL,
	CLK_CKSYS_REG_AUD_2_SEL,
	CLK_CKSYS_REG_AUD_ENGEN1_SEL,
	CLK_CKSYS_REG_AUD_ENGEN2_SEL,
	CLK_CKSYS_REG_AUD_INTBUS_SEL,
	CLK_CKSYS_REG_AUDIO_H_SEL,
	CLK_PERICFG_AO_REG_PERI_AUDIO0_AUDIO,
	CLK_PERICFG_AO_REG_PERI_AUDIO1_AUDIO,
	CLK_PERICFG_AO_REG_PERI_AUDIO2_AUDIO,
	CLK_CKSYS_REG_APLL1,
	CLK_CKSYS_REG_APLL1_D2,
	CLK_CKSYS_REG_APLL1_D4,
	CLK_CKSYS_REG_APLL2,
	CLK_CKSYS_REG_APLL2_D2,
	CLK_CKSYS_REG_APLL2_D4,
	CLK_CKSYS_REG_APLL_IN1_MCK_SEL,
	CLK_CKSYS_REG_APLL12_CK_DIV_IN1	,
	CLK_CKSYS_REG_APLL_FMI2S_MCK_SEL,
	CLK_CKSYS_REG_APLL12_CK_DIV_FMI2S,
	CLK_CKSYS_REG_TCK_26M_MX9,
	CLK_NUM
};
...
int mt6881_set_audio_int_bus_parent(struct mtk_base_afe *afe, int clk_id);
