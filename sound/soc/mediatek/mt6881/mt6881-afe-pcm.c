...
static bool mt6881_is_volatile_reg(struct device *dev, unsigned int reg)
{
	...
	//case AFE_VOWIF_CFG:
	//case AFE_VOWIF_MON:
	case AFE_SE_DOMAIN_SIDEBAND0:
	case AFE_SE_DOMAIN_SIDEBAND1:
	case AFE_SE_DOMAIN_SIDEBAND2:
	case AFE_SE_DOMAIN_SIDEBAND3:
	case AFE_SE_DOMAIN_SIDEBAND4:
	case AFE_SE_DOMAIN_SIDEBAND5:
	case AFE_SE_DOMAIN_SIDEBAND6:
	case AFE_SE_DOMAIN_SIDEBAND7:
	case AFE_SE_DOMAIN_SIDEBAND8:
	case AFE_SE_DOMAIN_SIDEBAND9:
	case AFE_SE_DOMAIN_SIDEBAND10:
	case AFE_SE_DOMAIN_SIDEBAND11:
#if IS_ENABLED(CONFIG_NEBULA_SND_PASSTHROUGH)
