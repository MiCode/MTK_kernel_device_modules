 ...
 *  Author: indsay Tsai <lindsay.tsai@mediatek.com>
 */
...
static const struct snd_kcontrol_new mtk_adda_dl_ch1_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_48CH_CH1", AFE_CONN014_2, I_DL_48CH_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH1", AFE_CONN014_3, I_DL44_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH1", AFE_CONN014_3, I_DL45_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH1", AFE_CONN014_3, I_DL46_CH1, 1, 0),
...
static const struct snd_kcontrol_new mtk_adda_dl_ch2_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_48CH_CH2", AFE_CONN015_2, I_DL_48CH_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH2", AFE_CONN015_3, I_DL44_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH2", AFE_CONN015_3, I_DL45_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH2", AFE_CONN015_3, I_DL46_CH2, 1, 0),
...
static const struct snd_kcontrol_new mtk_adda_dl_ch3_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_48CH_CH3", AFE_CONN016_2, I_DL_48CH_CH3, 1, 0),

	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH1", AFE_CONN016_3, I_DL44_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH1", AFE_CONN016_3, I_DL45_CH1, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH1", AFE_CONN016_3, I_DL46_CH1, 1, 0),
...
static const struct snd_kcontrol_new mtk_adda_dl_ch4_mix[] = {
	...
	SOC_DAPM_SINGLE_AUTODISABLE("DL_48CH_CH4", AFE_CONN017_2, I_DL_48CH_CH4, 1, 0),

	SOC_DAPM_SINGLE_AUTODISABLE("DL23_CH2", AFE_CONN017_3, I_DL44_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL24_CH2", AFE_CONN017_3, I_DL45_CH2, 1, 0),
	SOC_DAPM_SINGLE_AUTODISABLE("DL25_CH2", AFE_CONN017_3, I_DL46_CH2, 1, 0),
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (mtkaif_dmic) {
			...
			regmap_update_bits(afe->regmap, AFE_MTKAIF0_RX_CFG0,
					   ...
					   0x0);
			mtk_adda_ul_src_dmic(afe, MT6881_DAI_ADDA);
		}
		break;
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (mtkaif_dmic) {
			...
			regmap_update_bits(afe->regmap,
					   ...
					   0x0);
			mtk_adda_ul_src_dmic(afe, MT6881_DAI_ADDA_CH34);
		}
	...
	case SND_SOC_DAPM_POST_PMD:
		...
		//if (mtkaif_adda6_only) {
			regmap_update_bits(afe->regmap,
					   AFE_MTKAIF1_RX_CFG2,
					   RG_MTKAIF1_RXIF_SYNC_WORD1_DISABLE_MASK_SFT,
					   0x0 << RG_MTKAIF1_RXIF_SYNC_WORD1_DISABLE_SFT);
		//}
		break;
	default:
		break;
			     ...
			     int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6881_afe_gpio_request(afe, true, MT6881_DAI_ADDA, 1);
		//mtk_adda_ul_src_dmic(afe, MT6881_DAI_AP_DMIC);
		mt6881_afe_gpio_request(afe, true, MT6881_DAI_AP_DMIC, 1);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* should delayed 1/fs(smallest is 8k) = 125us before afe off */
		udelay(125);
		mt6881_afe_gpio_request(afe, false, MT6881_DAI_ADDA, 1);
		mt6881_afe_gpio_request(afe, false, MT6881_DAI_AP_DMIC, 1);
				  ...
				  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6881_afe_gpio_request(afe, true, MT6881_DAI_ADDA_CH34, 1);
		mt6881_afe_gpio_request(afe, true, MT6881_DAI_AP_DMIC_CH34, 1);
		break;
	case SND_SOC_DAPM_POST_PMD:
		/* should delayed 1/fs(smallest is 8k) = 125us before afe off */
		udelay(125);
		mt6881_afe_gpio_request(afe, false, MT6881_DAI_ADDA_CH34, 1);
		mt6881_afe_gpio_request(afe, false, MT6881_DAI_AP_DMIC_CH34, 1);
		break;
	default:
		break;
	}
...
static bool is_adda_mtkaif_need_phase_delay(struct mt6881_afe_private *afe_priv)
{
	if (mt6881_afe_gpio_is_prepared(MT6881_AFE_GPIO_DAT_MISO0_ON) &&
	...
	if (mt6881_afe_gpio_is_prepared(MT6881_AFE_GPIO_DAT_MISO1_ON) &&
...
/* mtkaif dmic */
static const char *const mt6881_adda_off_on_str[] = {
	"Off", "On"
};

static const struct soc_enum mt6881_adda_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6881_adda_off_on_str),
			    mt6881_adda_off_on_str),
};

static int mt6881_adda_ap_dmic_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda_ap_dmic_set(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda_dmic_get(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda_dmic_set(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda6_only_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda6_only_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda_dl_max_vol_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_adda_dl_max_vol_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_vow_enable_get(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static int mt6881_vow_enable_set(struct snd_kcontrol *kcontrol,
				 struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_adda_controls[] = {
	...
	SOC_ENUM_EXT("MTKAIF_DMIC", mt6881_adda_enum[0],
		     mt6881_adda_dmic_get, mt6881_adda_dmic_set),
	SOC_ENUM_EXT("MTKAIF_ADDA6_ONLY", mt6881_adda_enum[0],
		     mt6881_adda6_only_get, mt6881_adda6_only_set),
	SOC_SINGLE_EXT("ADDA_DL_MAX_VOL",
		       SND_SOC_NOPM, 0, 0x1, 0,
		       mt6881_adda_dl_max_vol_get,
		       mt6881_adda_dl_max_vol_set),
	SOC_SINGLE_EXT("VOW_ENABLE",
		       SND_SOC_NOPM, 0, 0x1, 0,
		       mt6881_vow_enable_get,
		       mt6881_vow_enable_set),
	SOC_ENUM_EXT("AP DMIC Used", mt6881_adda_enum[0],
		     mt6881_adda_ap_dmic_get, mt6881_adda_ap_dmic_set),
};
...
static const struct snd_soc_dapm_route mtk_dai_adda_routes[] = {
	...
	{"ADDA_DL_CH1", "DL_48CH_CH1", "DL_48CH"},
	{"ADDA_DL_CH2", "DL_48CH_CH2", "DL_48CH"},
	...
	{"ADDA Playback", NULL, "afe_dl0_dac_predis_audio"},
	{"ADDA Playback", NULL, "afe_dl0_dac_hires_audio",
	 mtk_afe_dac_hires_connect},
	{"ADDA CH34 Playback", NULL, "afe_dl1_dac_audio"},
	{"ADDA CH34 Playback", NULL, "afe_dl1_dac_predis_audio"},
	{"ADDA CH34 Playback", NULL, "afe_dl1_dac_hires_audio",
	 mtk_afe_dac_hires_connect},
	...
	{"afe_dl1_dac_hires_audio", NULL, "clk_top_audio_h_sel"},
...
int mt6881_dai_adda_register(struct mtk_base_afe *afe)
{
	...
	/* set dai priv */
	ret = mt6881_dai_set_priv(afe, MT6881_DAI_ADDA,
				  sizeof(struct mtk_afe_adda_priv), NULL);
	if (ret)
		return ret;

	ret = mt6881_dai_set_priv(afe, MT6881_DAI_ADDA_CH34,
				  sizeof(struct mtk_afe_adda_priv), NULL);
	if (ret)
		return ret;
	/* get ap mic type */
	...
	afe_priv->dai_priv[MT6881_DAI_AP_DMIC] =
		afe_priv->dai_priv[MT6881_DAI_ADDA];
	afe_priv->dai_priv[MT6881_DAI_AP_DMIC_CH34] =
		afe_priv->dai_priv[MT6881_DAI_ADDA_CH34];
