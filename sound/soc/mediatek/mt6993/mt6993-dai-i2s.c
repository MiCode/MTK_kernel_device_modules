			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mtk_afe_i2s_priv *i2sin4_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN4];
	struct mtk_afe_i2s_priv *i2sin5_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN5];
	struct mtk_afe_i2s_priv *i2sin6_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN6];
			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mt6993_afe_private *afe_priv = afe->platform_priv;
	struct mtk_afe_i2s_priv *i2sin4_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN4];
	struct mtk_afe_i2s_priv *i2sout4_priv = afe_priv->dai_priv[MT6993_DAI_I2S_OUT4];
	struct mtk_afe_i2s_priv *i2sin5_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN5];
	struct mtk_afe_i2s_priv *i2sin6_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN6];
	unsigned int value = 0;
			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mtk_afe_i2s_priv *i2sout4_priv = afe_priv->dai_priv[MT6993_DAI_I2S_OUT4];
	struct mtk_afe_i2s_priv *i2sin5_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN5];
	struct mtk_afe_i2s_priv *i2sout5_priv = afe_priv->dai_priv[MT6993_DAI_I2S_OUT5];
	struct mtk_afe_i2s_priv *i2sin6_priv = afe_priv->dai_priv[MT6993_DAI_I2S_IN6];
	unsigned int value = ucontrol->value.integer.value[0];
...
/* low jitter control */
static const char *const mt6993_i2s_hd_str[] = {
	"Normal", "Low_Jitter"
};

static const struct soc_enum mt6993_i2s_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6993_i2s_hd_str),
			    mt6993_i2s_hd_str),
};

static int mt6993_i2s_hd_get(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6993_i2s_hd_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_dai_i2s_controls[] = {
	SOC_ENUM_EXT(MTK_AFE_I2SIN0_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN1_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN2_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN4_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN5_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN6_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT0_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT1_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT2_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT4_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT5_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT6_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_FMI2S_MASTER_KCONTROL_NAME, mt6993_i2s_enum[0],
		     mt6993_i2s_hd_get, mt6993_i2s_hd_set),
			    ...
			    int event)
{
	...
	id = i2s_priv->id - MT6993_DAI_I2S_IN0;
			  ...
			  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6993_apll1_enable(afe);
		else
			mt6993_apll2_enable(afe);
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6993_apll1_disable(afe);
		else
			mt6993_apll2_disable(afe);
		break;
	default:
		break;
	}
			     ...
			     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt6993_mck_enable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	case SND_SOC_DAPM_POST_PMD:
		i2s_priv->mclk_rate = 0;
		mt6993_mck_disable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	default:
		break;
	}
				    ...
				    struct snd_soc_dapm_widget *sink)
{
	...
	/* which apll */
	cur_apll = mt6993_get_apll_by_name(afe, source->name);

	/* choose APLL from i2s rate */
	i2s_need_apll = mt6993_get_apll_by_rate(afe, i2s_priv->rate);
		...
		struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6993_rate_transform(afe->dev,
				rate, dai->id);
			      ...
			      int i2s_id)
{
	...
	int id = i2s_id - MT6993_DAI_I2S_IN0;
	struct mtk_base_etdm_data etdm_data;
	unsigned int rate = params_rate(params);
	unsigned int rate_reg = mt6993_rate_transform(afe->dev,
				rate, i2s_id);
				  ...
				  int clk_id, unsigned int freq, int dir)
{
	...
	apll = mt6993_get_apll_by_rate(afe, freq);
	apll_rate = mt6993_get_apll_rate(afe, apll);
...
static const struct mtk_afe_i2s_priv mt6993_i2s_priv[DAI_I2S_NUM] = {
	[DAI_I2SIN0] = {
		.id = MT6993_DAI_I2S_IN0,
		.mclk_id = MT6993_I2SIN0_MCK,
		.share_property_name = "i2sin0-share",
		.share_i2s_id = -1,
	},
	[DAI_I2SIN1] = {
		.id = MT6993_DAI_I2S_IN1,
		.mclk_id = MT6993_I2SIN1_MCK,
	...
	[DAI_I2SOUT0] = {
		...
		.share_i2s_id = MT6993_DAI_I2S_IN0,
	},
	[DAI_I2SOUT1] = {
		.id = MT6993_DAI_I2S_OUT1,
		.mclk_id = MT6993_I2SIN1_MCK,
		.share_property_name = "i2sout1-share",
		.share_i2s_id = MT6993_DAI_I2S_IN1,
	},
	[DAI_I2SOUT2] = {
		.id = MT6993_DAI_I2S_OUT2,
		.mclk_id = MT6993_I2SIN0_MCK,
		.share_property_name = "i2sout2-share",
		.share_i2s_id = MT6993_DAI_I2S_IN2,
	},
	[DAI_I2SOUT3] = {
		.id = MT6993_DAI_I2S_OUT3,
		.mclk_id = MT6993_I2SIN0_MCK,
		.share_property_name = "i2sout3-share",
		.share_i2s_id = MT6993_DAI_I2S_IN3,
	},
	[DAI_I2SOUT4] = {
		.id = MT6993_DAI_I2S_OUT4,
		.mclk_id = MT6993_I2SIN0_MCK,
		.share_property_name = "i2sout4-share",
		.share_i2s_id = MT6993_DAI_I2S_IN4,
	},
	[DAI_I2SOUT5] = {
		.id = MT6993_DAI_I2S_OUT5,
		.mclk_id = MT6993_I2SIN0_MCK,
	...
	[DAI_I2SOUT6] = {
		...
		.mclk_id = MT6993_I2SIN0_MCK,
		.share_property_name = "i2sout6-share",
		.share_i2s_id = MT6993_DAI_I2S_IN6,
	},
	[DAI_FMI2S_MASTER] = {
		.id = MT6993_DAI_FM_I2S_MASTER,
		.mclk_id = MT6993_FMI2S_MCK,
...
int mt6993_dai_i2s_get_share(struct mtk_base_afe *afe)
{
	struct mt6993_afe_private *afe_priv = afe->platform_priv;
	...
	for (i = 0; i < DAI_I2S_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[mt6993_i2s_priv[i].id];
		property_name = mt6993_i2s_priv[i].share_property_name;
...
int mt6993_dai_i2s_set_priv(struct mtk_base_afe *afe)
{
	int i;
	int ret;

	for (i = 0; i < DAI_I2S_NUM; i++) {
		ret = mt6993_dai_set_priv(afe, mt6993_i2s_priv[i].id,
...
static int mt6993_dai_i2s_config(struct mtk_base_afe *afe, int i2s_id,
				bool enable)
{
	struct mt6993_afe_private *afe_priv = afe->platform_priv;
	struct mtk_afe_i2s_priv *i2s_priv = afe_priv->dai_priv[i2s_id];
	...
	/* set share i2s */
	if (i2s_priv && i2s_priv->share_i2s_id >= 0)
		ret = mt6993_dai_i2s_config(afe, i2s_priv->share_i2s_id, true);


	return ret;
}

static int mt6993_dai_clk_always_on(struct mtk_base_afe *afe, int dai_id,
				  bool enable)
{
	dev_info(afe->dev, "%s(), id %d, enable %d\n", __func__, dai_id, enable);

	if (dai_id >= MT6993_DAI_I2S_IN0 && dai_id <= MT6993_DAI_I2S_OUT6)
		mt6993_dai_i2s_config(afe, dai_id, enable);

	return 0;
}

int mt6993_afe_set_clk_always_on(struct mtk_base_afe *afe,
					bool enable)
{
	struct mt6993_afe_private *afe_priv = afe->platform_priv;
	...
	for (id = MT6993_DAI_I2S_IN0; id < MT6993_DAI_I2S_OUT6; id++) {
		...
		if (dai_attr->bclk_ao || dai_attr->lrck_ao)
			mt6993_dai_clk_always_on(afe, id, enable);
...
EXPORT_SYMBOL_GPL(mt6993_afe_set_clk_always_on);

int mt6993_dai_i2s_register(struct mtk_base_afe *afe)
{
	...
	ret = mt6993_dai_i2s_set_priv(afe);
	if (ret)
		return ret;

	/* parse share i2s */
	ret = mt6993_dai_i2s_get_share(afe);
	if (ret)
		return ret;
