...
enum scp_audio_ipi_id {
	...
	SCP_AUDIO_IPI_LOGGER_ENABLE = 2,
	SCP_AUDIO_IPI_LOGGER_WAKEUP = 3,
	SCP_AUDIO_IPI_LOGGER_INIT = 4,
	SCP_AUDIO_IPI_DBG_CMDS = 5,
	SCP_AUDIO_IPI_CLOCK_LOCK = 6,
	SCP_AUDIO_IPI_DBG_INIT = 7,
	SCP_AUDIO_IPI_TRAX_DONE = 8,
