			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mtk_afe_i2s_priv *i2sin4_priv = afe_priv->dai_priv[MT6899_DAI_I2S_IN4];
	struct mtk_afe_i2s_priv *i2sin6_priv = afe_priv->dai_priv[MT6899_DAI_I2S_IN6];
			 ...
			 struct snd_ctl_elem_value *ucontrol)
{
	...
	struct mt6899_afe_private *afe_priv = afe->platform_priv;
	struct mtk_afe_i2s_priv *i2sin4_priv = afe_priv->dai_priv[MT6899_DAI_I2S_IN4];
	struct mtk_afe_i2s_priv *i2sout4_priv = afe_priv->dai_priv[MT6899_DAI_I2S_OUT4];
	struct mtk_afe_i2s_priv *i2sin6_priv = afe_priv->dai_priv[MT6899_DAI_I2S_IN6];
	unsigned int value = 0;
...
static int mtk_is_i2s_low_power(int i2s_num)
{
	...
	i2s_bit_shift = i2s_num - MT6899_DAI_I2S_IN0;
	if (i2s_bit_shift < 0 || i2s_bit_shift > MT6899_DAI_I2S_MAX_NUM) {
...
/* low jitter control */
static const char *const mt6899_i2s_hd_str[] = {
	"Normal", "Low_Jitter"
};

static const struct soc_enum mt6899_i2s_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6899_i2s_hd_str),
			    mt6899_i2s_hd_str),
};

static int mt6899_i2s_hd_get(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6899_i2s_hd_set(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct snd_kcontrol_new mtk_dai_i2s_controls[] = {
	SOC_ENUM_EXT(MTK_AFE_I2SIN0_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN1_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN2_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN4_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SIN6_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT0_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT1_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT2_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT4_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_I2SOUT6_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
	SOC_ENUM_EXT(MTK_AFE_FMI2S_MASTER_KCONTROL_NAME, mt6899_i2s_enum[0],
		     mt6899_i2s_hd_get, mt6899_i2s_hd_set),
			    ...
			    int event)
{
	...
	id = i2s_priv->id - MT6899_DAI_I2S_IN0;
	...
	case SND_SOC_DAPM_PRE_PMU:
		mt6899_afe_gpio_request(afe, true, i2s_priv->id, 0);
		break;
	case SND_SOC_DAPM_POST_PMD:
		mt6899_afe_gpio_request(afe, false, i2s_priv->id, 0);
		break;
	default:
		break;
	}
			  ...
			  int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6899_apll1_enable(afe);
		else
			mt6899_apll2_enable(afe);
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (strcmp(w->name, APLL1_W_NAME) == 0)
			mt6899_apll1_disable(afe);
		else
			mt6899_apll2_disable(afe);
		break;
	default:
		break;
	}
			     ...
			     int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		mt6899_mck_enable(afe, i2s_priv->mclk_id, i2s_priv->mclk_rate);
		break;
	case SND_SOC_DAPM_POST_PMD:
		i2s_priv->mclk_rate = 0;
		mt6899_mck_disable(afe, i2s_priv->mclk_id);
		break;
	default:
		break;
	}
				    ...
				    struct snd_soc_dapm_widget *sink)
{
	...
	/* which apll */
	cur_apll = mt6899_get_apll_by_name(afe, source->name);

	/* choose APLL from i2s rate */
	i2s_need_apll = mt6899_get_apll_by_rate(afe, i2s_priv->rate);
		...
		struct snd_soc_dai *dai)
{
	...
	unsigned int rate_reg = mt6899_rate_transform(afe->dev,
				rate, dai->id);
				  ...
				  struct snd_soc_dai *dai)
{
	struct mtk_base_afe *afe = snd_soc_dai_get_drvdata(dai);
	struct mt6899_afe_private *afe_priv = afe->platform_priv;
	int id = dai->id - MT6899_DAI_I2S_IN0;
	...
	dev_info(afe->dev, "%s(), %s(%d), stream %d, rate %d channels %d format %d\n",
		 __func__, dai->name, dai->id, substream->stream, rate, channels, format);
	...
	case SNDRV_PCM_TRIGGER_SUSPEND:
		...
		case DAI_I2SOUT6:
			mtk_regmap_update_bits(afe->regmap, etdm_data.enable_reg,
					       ...
					       0x0,
					       etdm_data.enable_shift);
			if (is_etdm_in_pad_top(dai->id) && etdm_data.pad_top_ck_en_reg != -1) {
				mtk_regmap_update_bits(afe->regmap,
			      ...
			      int i2s_id)
{
	...
	int id = i2s_id - MT6899_DAI_I2S_IN0;
	struct mtk_base_etdm_data etdm_data;
	unsigned int rate = params_rate(params);
	unsigned int rate_reg = mt6899_rate_transform(afe->dev,
				rate, i2s_id);
				  ...
				  int clk_id, unsigned int freq, int dir)
{
	...
	apll = mt6899_get_apll_by_rate(afe, freq);
	apll_rate = mt6899_get_apll_rate(afe, apll);
...
static const struct mtk_afe_i2s_priv mt6899_i2s_priv[DAI_I2S_NUM] = {
	[DAI_I2SIN0] = {
		.id = MT6899_DAI_I2S_IN0,
		.mclk_id = MT6899_I2SIN0_MCK,
		.share_property_name = "i2sin0-share",
		.share_i2s_id = -1,
	},
	[DAI_I2SIN1] = {
		.id = MT6899_DAI_I2S_IN1,
		.mclk_id = MT6899_I2SIN1_MCK,
	...
	[DAI_I2SOUT0] = {
		...
		.share_i2s_id = MT6899_DAI_I2S_IN0,
	},
	[DAI_I2SOUT1] = {
		.id = MT6899_DAI_I2S_OUT1,
		.mclk_id = MT6899_I2SIN1_MCK,
		.share_property_name = "i2sout1-share",
		.share_i2s_id = MT6899_DAI_I2S_IN1,
	},
	[DAI_I2SOUT2] = {
		.id = MT6899_DAI_I2S_OUT2,
		.mclk_id = MT6899_I2SIN0_MCK,
		.share_property_name = "i2sout2-share",
		.share_i2s_id = MT6899_DAI_I2S_IN2,
	},
	[DAI_I2SOUT4] = {
		.id = MT6899_DAI_I2S_OUT4,
		.mclk_id = MT6899_I2SIN0_MCK,
		.share_property_name = "i2sout4-share",
		.share_i2s_id = MT6899_DAI_I2S_IN4,
	},
	[DAI_I2SOUT6] = {
		.id = MT6899_DAI_I2S_OUT6,
		.mclk_id = MT6899_I2SIN0_MCK,
		.share_property_name = "i2sout6-share",
		.share_i2s_id = MT6899_DAI_I2S_IN6,
	},
	[DAI_FMI2S_MASTER] = {
		.id = MT6899_DAI_FM_I2S_MASTER,
		.mclk_id = MT6899_FMI2S_MCK,
...
static int etdm_parse_dt(struct mtk_base_afe *afe)
{
	...
	dev_info(afe->dev, "%s(): I2S_IN_NUM=%d, I2S_OUT_NUM=%d\n", __func__, I2S_IN_NUM, I2S_OUT_NUM);
	...
	for (i = 0; i < I2S_OUT_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[MT6899_DAI_I2S_OUT0 + i];
	...
	for (i = 0; i < I2S_IN_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[MT6899_DAI_I2S_IN0 + i];
...
int mt6899_dai_i2s_get_share(struct mtk_base_afe *afe)
{
	struct mt6899_afe_private *afe_priv = afe->platform_priv;
	...
	for (i = 0; i < DAI_I2S_NUM; i++) {
		i2s_priv = afe_priv->dai_priv[mt6899_i2s_priv[i].id];
		property_name = mt6899_i2s_priv[i].share_property_name;
...
int mt6899_dai_i2s_set_priv(struct mtk_base_afe *afe)
{
	int i;
	int ret;

	for (i = 0; i < DAI_I2S_NUM; i++) {
		ret = mt6899_dai_set_priv(afe, mt6899_i2s_priv[i].id,
...
int mt6899_dai_i2s_register(struct mtk_base_afe *afe)
{
	...
	ret = mt6899_dai_i2s_set_priv(afe);
	if (ret)
		return ret;

	/* parse share i2s */
	ret = mt6899_dai_i2s_get_share(afe);
	if (ret)
		return ret;
